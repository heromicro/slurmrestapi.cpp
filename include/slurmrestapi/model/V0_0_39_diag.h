...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_diag_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_diag_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_stats_msg> getStatistics() const;
    bool statisticsIsSet() const;
    void unsetStatistics();

    void setStatistics(const std::shared_ptr<V0_0_39_stats_msg>& value);
...
protected:
    ...
    std::shared_ptr<V0_0_39_stats_msg> m_Statistics;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_diag_H_ */
