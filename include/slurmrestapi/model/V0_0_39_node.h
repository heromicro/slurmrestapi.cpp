...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_ext_sensors_data> getExternalSensors() const;
    bool externalSensorsIsSet() const;
    void unsetExternal_sensors();

    void setExternalSensors(const std::shared_ptr<V0_0_39_ext_sensors_data>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_power_mgmt_data> getPower() const;
    bool powerIsSet() const;
    void unsetPower();

    void setPower(const std::shared_ptr<V0_0_39_power_mgmt_data>& value);
...
protected:
    ...
    bool m_EnergyIsSet;
    std::shared_ptr<V0_0_39_ext_sensors_data> m_External_sensors;
    bool m_External_sensorsIsSet;
    utility::string_t m_Extra;
    bool m_ExtraIsSet;
    std::shared_ptr<V0_0_39_power_mgmt_data> m_Power;
    bool m_PowerIsSet;
