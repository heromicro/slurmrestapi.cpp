...
/*
 * V0_0_40_openapi_wckey_removed_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_wckey_removed_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_wckey_removed_resp_H_
...
/// 
/// </summary>
class  V0_0_40_openapi_wckey_removed_resp
    : public ModelBase
{
public:
    V0_0_40_openapi_wckey_removed_resp();
    virtual ~V0_0_40_openapi_wckey_removed_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_40_openapi_wckey_removed_resp members

    /// <summary>
    /// 
    /// </summary>
    std::vector<utility::string_t>& getDeletedWckeys();
    bool deletedWckeysIsSet() const;
    void unsetDeleted_wckeys();

    void setDeletedWckeys(const std::vector<utility::string_t>& value);
...
protected:
    std::vector<utility::string_t> m_Deleted_wckeys;
    bool m_Deleted_wckeysIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_wckey_removed_resp_H_ */
