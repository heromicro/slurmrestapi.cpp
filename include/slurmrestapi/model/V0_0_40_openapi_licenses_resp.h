...
/*
 * V0_0_40_openapi_licenses_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_licenses_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_licenses_resp_H_
...
/// 
/// </summary>
class  V0_0_40_openapi_licenses_resp
    : public ModelBase
{
public:
    V0_0_40_openapi_licenses_resp();
    virtual ~V0_0_40_openapi_licenses_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_40_openapi_licenses_resp members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<V0_0_40_license>>& getLicenses();
    bool licensesIsSet() const;
    void unsetLicenses();

    void setLicenses(const std::vector<std::shared_ptr<V0_0_40_license>>& value);
...
protected:
    std::vector<std::shared_ptr<V0_0_40_license>> m_Licenses;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_licenses_resp_H_ */
