...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_reservation_info_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_reservation_info_H_
...
#include "slurmrestapi/model/V0_0_39_reservation_core_spec.h"
...
class V0_0_39_reservation_info_purge_completed;
...
/// 
/// </summary>
class  V0_0_39_reservation_info
    : public ModelBase
{
public:
    V0_0_39_reservation_info();
    virtual ~V0_0_39_reservation_info();
    ...
    /////////////////////////////////////////////
    /// V0_0_39_reservation_info members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<V0_0_39_reservation_core_spec>>& getCoreSpecializations();
    bool coreSpecializationsIsSet() const;
    void unsetCore_specializations();

    void setCoreSpecializations(const std::vector<std::shared_ptr<V0_0_39_reservation_core_spec>>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_reservation_info_purge_completed> getPurgeCompleted() const;
    bool purgeCompletedIsSet() const;
    void unsetPurge_completed();

    void setPurgeCompleted(const std::shared_ptr<V0_0_39_reservation_info_purge_completed>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_uint32_no_val> getWatts() const;
    bool wattsIsSet() const;
    void unsetWatts();

    void setWatts(const std::shared_ptr<V0_0_39_uint32_no_val>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<V0_0_39_reservation_core_spec>> m_Core_specializations;
    ...
    std::shared_ptr<V0_0_39_reservation_info_purge_completed> m_Purge_completed;
    bool m_Purge_completedIsSet;
    int64_t m_Start_time;
    bool m_Start_timeIsSet;
    std::shared_ptr<V0_0_39_uint32_no_val> m_Watts;
    bool m_WattsIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_reservation_info_H_ */
