...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_37_account_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_37_account_H_
...
public:
    ...
    /////////////////////////////////////////////
    /// Dbv0_0_37_account members

    /// <summary>
    /// List of assigned associations
    /// </summary>
    std::vector<std::shared_ptr<Dbv0_0_37_association_short_info>>& getAssociations();
    bool associationsIsSet() const;
    void unsetAssociations();

    void setAssociations(const std::vector<std::shared_ptr<Dbv0_0_37_association_short_info>>& value);
...
protected:
    std::vector<std::shared_ptr<Dbv0_0_37_association_short_info>> m_Associations;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_37_account_H_ */
