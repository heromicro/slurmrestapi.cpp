...
/*
 * V0_0_41_openapi_nodes_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_nodes_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_nodes_resp_H_
...
class V0_0_41_openapi_nodes_resp_last_update;
...
/// 
/// </summary>
class  V0_0_41_openapi_nodes_resp
    : public ModelBase
{
public:
    V0_0_41_openapi_nodes_resp();
    virtual ~V0_0_41_openapi_nodes_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_41_openapi_nodes_resp members

    /// <summary>
    /// List of nodes
    /// </summary>
    std::vector<std::shared_ptr<V0_0_41_openapi_nodes_resp_nodes_inner>>& getNodes();
    bool nodesIsSet() const;
    void unsetNodes();

    void setNodes(const std::vector<std::shared_ptr<V0_0_41_openapi_nodes_resp_nodes_inner>>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_openapi_nodes_resp_last_update> getLastUpdate() const;
    bool lastUpdateIsSet() const;
    void unsetLast_update();

    void setLastUpdate(const std::shared_ptr<V0_0_41_openapi_nodes_resp_last_update>& value);
...
protected:
    std::vector<std::shared_ptr<V0_0_41_openapi_nodes_resp_nodes_inner>> m_Nodes;
    bool m_NodesIsSet;
    std::shared_ptr<V0_0_41_openapi_nodes_resp_last_update> m_Last_update;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_nodes_resp_H_ */
