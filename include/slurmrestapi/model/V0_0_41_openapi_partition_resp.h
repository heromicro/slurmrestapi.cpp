...
/*
 * V0_0_41_openapi_partition_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_partition_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_partition_resp_H_
...
class V0_0_41_openapi_partition_resp_last_update;
...
/// 
/// </summary>
class  V0_0_41_openapi_partition_resp
    : public ModelBase
{
public:
    V0_0_41_openapi_partition_resp();
    virtual ~V0_0_41_openapi_partition_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_41_openapi_partition_resp members

    /// <summary>
    /// List of partitions
    /// </summary>
    std::vector<std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner>>& getPartitions();
    bool partitionsIsSet() const;
    void unsetPartitions();

    void setPartitions(const std::vector<std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner>>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_openapi_partition_resp_last_update> getLastUpdate() const;
    bool lastUpdateIsSet() const;
    void unsetLast_update();

    void setLastUpdate(const std::shared_ptr<V0_0_41_openapi_partition_resp_last_update>& value);
...
protected:
    std::vector<std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner>> m_Partitions;
    bool m_PartitionsIsSet;
    std::shared_ptr<V0_0_41_openapi_partition_resp_last_update> m_Last_update;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_partition_resp_H_ */
