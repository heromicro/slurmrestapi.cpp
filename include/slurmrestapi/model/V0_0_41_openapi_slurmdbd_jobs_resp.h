...
/*
 * V0_0_41_openapi_slurmdbd_jobs_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_slurmdbd_jobs_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_slurmdbd_jobs_resp_H_
...
/// 
/// </summary>
class  V0_0_41_openapi_slurmdbd_jobs_resp
    : public ModelBase
{
public:
    V0_0_41_openapi_slurmdbd_jobs_resp();
    virtual ~V0_0_41_openapi_slurmdbd_jobs_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_41_openapi_slurmdbd_jobs_resp members

    /// <summary>
    /// jobs
    /// </summary>
    std::vector<std::shared_ptr<V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner>>& getJobs();
    bool jobsIsSet() const;
    void unsetJobs();

    void setJobs(const std::vector<std::shared_ptr<V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner>>& value);
...
protected:
    std::vector<std::shared_ptr<V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner>> m_Jobs;
    bool m_JobsIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_slurmdbd_jobs_resp_H_ */
