...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_38_pings_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_38_pings_H_
...
public:
    ...
    /// </summary>
    std::vector<std::shared_ptr<V0_0_38_ping>>& getPings();
    bool pingsIsSet() const;
    void unsetPings();

    void setPings(const std::vector<std::shared_ptr<V0_0_38_ping>>& value);
...
protected:
    ...
    bool m_ErrorsIsSet;
    std::vector<std::shared_ptr<V0_0_38_ping>> m_Pings;
    bool m_PingsIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_38_pings_H_ */
