...
/*
 * V0_0_40_openapi_reservation_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_reservation_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_reservation_resp_H_
...
/// 
/// </summary>
class  V0_0_40_openapi_reservation_resp
    : public ModelBase
{
public:
    V0_0_40_openapi_reservation_resp();
    virtual ~V0_0_40_openapi_reservation_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_40_openapi_reservation_resp members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<V0_0_40_reservation_info>>& getReservations();
    bool reservationsIsSet() const;
    void unsetReservations();

    void setReservations(const std::vector<std::shared_ptr<V0_0_40_reservation_info>>& value);
...
protected:
    std::vector<std::shared_ptr<V0_0_40_reservation_info>> m_Reservations;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_reservation_resp_H_ */
