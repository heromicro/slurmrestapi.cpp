...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_job_array_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_job_array_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getTaskId() const;
    bool taskIdIsSet() const;
    void unsetTask_id();

    void setTaskId(const std::shared_ptr<V0_0_40_uint32_no_val>& value);
...
protected:
    ...
    bool m_LimitsIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Task_id;
    bool m_Task_idIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_job_array_H_ */
