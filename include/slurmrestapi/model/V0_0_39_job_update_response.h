...
/// 
/// </summary>
class  V0_0_39_job_update_response
    : public ModelBase
{
public:
    V0_0_39_job_update_response();
    virtual ~V0_0_39_job_update_response();
    ...
    /////////////////////////////////////////////
    /// V0_0_39_job_update_response members
    ...
    /// Result per ArrayJob
    /// </summary>
    std::vector<std::shared_ptr<V0_0_39_job_array_response_msg_inner>>& getResults();
    bool resultsIsSet() const;
    void unsetResults();

    void setResults(const std::vector<std::shared_ptr<V0_0_39_job_array_response_msg_inner>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<V0_0_39_job_array_response_msg_inner>> m_Results;
    bool m_ResultsIsSet;
};
