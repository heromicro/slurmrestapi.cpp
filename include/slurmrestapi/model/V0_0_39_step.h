...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_job_reservation> getStep() const;
    bool stepIsSet() const;
    void unsetStep();

    void setStep(const std::shared_ptr<V0_0_39_job_reservation>& value);
...
protected:
    ...
    std::shared_ptr<V0_0_39_job_reservation> m_Step;
    bool m_StepIsSet;
