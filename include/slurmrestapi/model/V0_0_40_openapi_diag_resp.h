...
/*
 * V0_0_40_openapi_diag_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_diag_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_diag_resp_H_
...
/// 
/// </summary>
class  V0_0_40_openapi_diag_resp
    : public ModelBase
{
public:
    V0_0_40_openapi_diag_resp();
    virtual ~V0_0_40_openapi_diag_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_40_openapi_diag_resp members

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_stats_msg> getStatistics() const;
    bool statisticsIsSet() const;
    void unsetStatistics();

    void setStatistics(const std::shared_ptr<V0_0_40_stats_msg>& value);
...
protected:
    std::shared_ptr<V0_0_40_stats_msg> m_Statistics;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_diag_resp_H_ */
