...
/*
 * V0_0_41_openapi_job_submit_response.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_job_submit_response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_job_submit_response_H_
...
/// 
/// </summary>
class  V0_0_41_openapi_job_submit_response
    : public ModelBase
{
public:
    V0_0_41_openapi_job_submit_response();
    virtual ~V0_0_41_openapi_job_submit_response();
    ...
    /////////////////////////////////////////////
    /// V0_0_41_openapi_job_submit_response members

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_openapi_job_submit_response_result> getResult() const;
    bool resultIsSet() const;
    void unsetResult();

    void setResult(const std::shared_ptr<V0_0_41_openapi_job_submit_response_result>& value);
...
protected:
    std::shared_ptr<V0_0_41_openapi_job_submit_response_result> m_Result;
    bool m_ResultIsSet;
    int32_t m_Job_id;
    bool m_Job_idIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_job_submit_response_H_ */
