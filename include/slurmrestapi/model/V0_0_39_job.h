...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_job_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_job_H_
...
#include "slurmrestapi/model/V0_0_39_job_reservation.h"
#include "slurmrestapi/model/V0_0_39_job_tres.h"
#include "slurmrestapi/model/V0_0_39_job_time.h"
#include "slurmrestapi/model/V0_0_39_job_mcs.h"
#include <vector>
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_job_comment> getComment() const;
    bool commentIsSet() const;
    void unsetComment();

    void setComment(const std::shared_ptr<V0_0_39_job_comment>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_job_array> getArray() const;
    bool arrayIsSet() const;
    void unsetarray();

    void setArray(const std::shared_ptr<V0_0_39_job_array>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_assoc_short> getAssociation() const;
    bool associationIsSet() const;
    void unsetAssociation();

    void setAssociation(const std::shared_ptr<V0_0_39_assoc_short>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_job_exit_code> getDerivedExitCode() const;
    bool derivedExitCodeIsSet() const;
    void unsetDerived_exit_code();

    void setDerivedExitCode(const std::shared_ptr<V0_0_39_job_exit_code>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_job_time> getTime() const;
    bool timeIsSet() const;
    void unsetTime();

    void setTime(const std::shared_ptr<V0_0_39_job_time>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_job_het> getHet() const;
    bool hetIsSet() const;
    void unsetHet();

    void setHet(const std::shared_ptr<V0_0_39_job_het>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_job_mcs> getMcs() const;
    bool mcsIsSet() const;
    void unsetMcs();

    void setMcs(const std::shared_ptr<V0_0_39_job_mcs>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_job_required> getRequired() const;
    bool requiredIsSet() const;
    void unsetRequired();

    void setRequired(const std::shared_ptr<V0_0_39_job_required>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_job_reservation> getReservation() const;
    bool reservationIsSet() const;
    void unsetReservation();

    void setReservation(const std::shared_ptr<V0_0_39_job_reservation>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_job_state> getState() const;
    bool stateIsSet() const;
    void unsetState();

    void setState(const std::shared_ptr<V0_0_39_job_state>& value);

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<V0_0_39_step>>& getSteps();
    bool stepsIsSet() const;
    void unsetSteps();

    void setSteps(const std::vector<std::shared_ptr<V0_0_39_step>>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_job_tres> getTres() const;
    bool tresIsSet() const;
    void unsetTres();

    void setTres(const std::shared_ptr<V0_0_39_job_tres>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_wckey_tag> getWckey() const;
    bool wckeyIsSet() const;
    void unsetWckey();

    void setWckey(const std::shared_ptr<V0_0_39_wckey_tag>& value);
...
protected:
    ...
    bool m_AccountIsSet;
    std::shared_ptr<V0_0_39_job_comment> m_Comment;
    bool m_CommentIsSet;
    int32_t m_Allocation_nodes;
    bool m_Allocation_nodesIsSet;
    std::shared_ptr<V0_0_39_job_array> m_array;
    bool m_arrayIsSet;
    std::shared_ptr<V0_0_39_assoc_short> m_Association;
    ...
    std::shared_ptr<V0_0_39_job_exit_code> m_Derived_exit_code;
    bool m_Derived_exit_codeIsSet;
    std::shared_ptr<V0_0_39_job_time> m_Time;
    bool m_TimeIsSet;
    ...
    bool m_GroupIsSet;
    std::shared_ptr<V0_0_39_job_het> m_Het;
    bool m_HetIsSet;
    int32_t m_Job_id;
    bool m_Job_idIsSet;
    ...
    std::shared_ptr<V0_0_39_job_mcs> m_Mcs;
    bool m_McsIsSet;
    ...
    bool m_QosIsSet;
    std::shared_ptr<V0_0_39_job_required> m_Required;
    bool m_RequiredIsSet;
    utility::string_t m_Kill_request_user;
    bool m_Kill_request_userIsSet;
    std::shared_ptr<V0_0_39_job_reservation> m_Reservation;
    bool m_ReservationIsSet;
    utility::string_t m_Script;
    bool m_ScriptIsSet;
    std::shared_ptr<V0_0_39_job_state> m_State;
    bool m_StateIsSet;
    std::vector<std::shared_ptr<V0_0_39_step>> m_Steps;
    bool m_StepsIsSet;
    utility::string_t m_Submit_line;
    bool m_Submit_lineIsSet;
    std::shared_ptr<V0_0_39_job_tres> m_Tres;
    bool m_TresIsSet;
    utility::string_t m_Used_gres;
    bool m_Used_gresIsSet;
    utility::string_t m_User;
    bool m_UserIsSet;
    std::shared_ptr<V0_0_39_wckey_tag> m_Wckey;
    bool m_WckeyIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_job_H_ */
