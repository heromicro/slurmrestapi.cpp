...
/*
 * V0_0_40_acct_gather_energy.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_acct_gather_energy_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_acct_gather_energy_H_
...
{
public:
    V0_0_40_acct_gather_energy();
    virtual ~V0_0_40_acct_gather_energy();
    ...
    /////////////////////////////////////////////
    /// V0_0_40_acct_gather_energy members
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getCurrentWatts() const;
    bool currentWattsIsSet() const;
    void unsetCurrent_watts();

    void setCurrentWatts(const std::shared_ptr<V0_0_40_uint32_no_val>& value);
...
protected:
    ...
    std::shared_ptr<V0_0_40_uint32_no_val> m_Current_watts;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_acct_gather_energy_H_ */
