...
/*
 * V0_0_40_openapi_accounts_add_cond_resp_str.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_accounts_add_cond_resp_str_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_accounts_add_cond_resp_str_H_
...
/// 
/// </summary>
class  V0_0_40_openapi_accounts_add_cond_resp_str
    : public ModelBase
{
public:
    V0_0_40_openapi_accounts_add_cond_resp_str();
    virtual ~V0_0_40_openapi_accounts_add_cond_resp_str();
    ...
    /////////////////////////////////////////////
    /// V0_0_40_openapi_accounts_add_cond_resp_str members

    /// <summary>
    /// added_accounts
    /// </summary>
    utility::string_t getAddedAccounts() const;
    bool addedAccountsIsSet() const;
    void unsetAdded_accounts();

    void setAddedAccounts(const utility::string_t& value);
...
protected:
    utility::string_t m_Added_accounts;
    bool m_Added_accountsIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_accounts_add_cond_resp_str_H_ */
