...
/*
 * V0_0_40_openapi_kill_jobs_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_kill_jobs_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_kill_jobs_resp_H_
...
/// 
/// </summary>
class  V0_0_40_openapi_kill_jobs_resp
    : public ModelBase
{
public:
    V0_0_40_openapi_kill_jobs_resp();
    virtual ~V0_0_40_openapi_kill_jobs_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_40_openapi_kill_jobs_resp members

    /// <summary>
    /// List of jobs signal responses
    /// </summary>
    std::vector<std::shared_ptr<V0_0_40_kill_jobs_resp_job>>& getStatus();
    bool statusIsSet() const;
    void unsetStatus();

    void setStatus(const std::vector<std::shared_ptr<V0_0_40_kill_jobs_resp_job>>& value);
...
protected:
    std::vector<std::shared_ptr<V0_0_40_kill_jobs_resp_job>> m_Status;
    bool m_StatusIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_kill_jobs_resp_H_ */
