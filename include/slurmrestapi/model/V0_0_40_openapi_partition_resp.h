...
/*
 * V0_0_40_openapi_partition_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_partition_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_partition_resp_H_
...
/// 
/// </summary>
class  V0_0_40_openapi_partition_resp
    : public ModelBase
{
public:
    V0_0_40_openapi_partition_resp();
    virtual ~V0_0_40_openapi_partition_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_40_openapi_partition_resp members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<V0_0_40_partition_info>>& getPartitions();
    bool partitionsIsSet() const;
    void unsetPartitions();

    void setPartitions(const std::vector<std::shared_ptr<V0_0_40_partition_info>>& value);
...
protected:
    std::vector<std::shared_ptr<V0_0_40_partition_info>> m_Partitions;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_partition_resp_H_ */
