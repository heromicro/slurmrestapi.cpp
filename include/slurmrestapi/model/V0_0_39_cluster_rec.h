...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_cluster_rec_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_cluster_rec_H_
...
#include "slurmrestapi/model/V0_0_39_cluster_rec_associations.h"
...
class V0_0_39_cluster_rec_associations;
class V0_0_39_tres;
...
public:
    ...
    /////////////////////////////////////////////
    /// V0_0_39_cluster_rec members

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_cluster_rec_controller> getController() const;
    bool controllerIsSet() const;
    void unsetController();

    void setController(const std::shared_ptr<V0_0_39_cluster_rec_controller>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_cluster_rec_associations> getAssociations() const;
    bool associationsIsSet() const;
    void unsetAssociations();

    void setAssociations(const std::shared_ptr<V0_0_39_cluster_rec_associations>& value);
...
protected:
    std::shared_ptr<V0_0_39_cluster_rec_controller> m_Controller;
    ...
    std::shared_ptr<V0_0_39_cluster_rec_associations> m_Associations;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_cluster_rec_H_ */
