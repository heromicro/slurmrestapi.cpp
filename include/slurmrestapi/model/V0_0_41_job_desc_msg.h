...
/*
 * V0_0_41_job_desc_msg.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_job_desc_msg_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_job_desc_msg_H_


#include "slurmrestapi/ModelBase.h"

#include "slurmrestapi/model/V0_0_41_job_desc_msg_segment_size.h"
#include "slurmrestapi/model/V0_0_41_job_desc_msg_kill_warning_delay.h"
...
#include "slurmrestapi/model/V0_0_41_job_desc_msg_begin_time.h"
#include "slurmrestapi/model/V0_0_41_job_desc_msg_distribution_plane_size.h"
#include "slurmrestapi/model/V0_0_41_job_desc_msg_required_switches.h"
...
{
public:
    V0_0_41_job_desc_msg();
    virtual ~V0_0_41_job_desc_msg();
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_job_desc_msg_begin_time> getBeginTime() const;
    bool beginTimeIsSet() const;
    void unsetBegin_time();

    void setBeginTime(const std::shared_ptr<V0_0_41_job_desc_msg_begin_time>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_job_desc_msg_crontab> getCrontab() const;
    bool crontabIsSet() const;
    void unsetCrontab();

    void setCrontab(const std::shared_ptr<V0_0_41_job_desc_msg_crontab>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_job_desc_msg_rlimits> getRlimits() const;
    bool rlimitsIsSet() const;
    void unsetRlimits();

    void setRlimits(const std::shared_ptr<V0_0_41_job_desc_msg_rlimits>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_job_desc_msg_distribution_plane_size> getDistributionPlaneSize() const;
    bool distributionPlaneSizeIsSet() const;
    void unsetDistribution_plane_size();

    void setDistributionPlaneSize(const std::shared_ptr<V0_0_41_job_desc_msg_distribution_plane_size>& value);

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<AnyType>>& getPowerFlags();
    bool powerFlagsIsSet() const;
    void unsetPower_flags();

    void setPowerFlags(const std::vector<std::shared_ptr<AnyType>>& value);
    ...
    /// </summary>
    int32_t getResvMpiPorts() const;
    bool resvMpiPortsIsSet() const;
    void unsetResv_mpi_ports();

    void setResvMpiPorts(int32_t value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_job_desc_msg_kill_warning_delay> getKillWarningDelay() const;
    bool killWarningDelayIsSet() const;
    void unsetKill_warning_delay();

    void setKillWarningDelay(const std::shared_ptr<V0_0_41_job_desc_msg_kill_warning_delay>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_job_desc_msg_memory_per_cpu> getMemoryPerNode() const;
    bool memoryPerNodeIsSet() const;
    void unsetMemory_per_node();

    void setMemoryPerNode(const std::shared_ptr<V0_0_41_job_desc_msg_memory_per_cpu>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_job_desc_msg_required_switches> getRequiredSwitches() const;
    bool requiredSwitchesIsSet() const;
    void unsetRequired_switches();

    void setRequiredSwitches(const std::shared_ptr<V0_0_41_job_desc_msg_required_switches>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_job_desc_msg_segment_size> getSegmentSize() const;
    bool segmentSizeIsSet() const;
    void unsetSegment_size();

    void setSegmentSize(const std::shared_ptr<V0_0_41_job_desc_msg_segment_size>& value);
...
protected:
    ...
    std::shared_ptr<V0_0_41_job_desc_msg_begin_time> m_Begin_time;
    ...
    std::shared_ptr<V0_0_41_job_desc_msg_crontab> m_Crontab;
    bool m_CrontabIsSet;
    int64_t m_Deadline;
    ...
    std::shared_ptr<V0_0_41_job_desc_msg_rlimits> m_Rlimits;
    bool m_RlimitsIsSet;
    ...
    std::shared_ptr<V0_0_41_job_desc_msg_distribution_plane_size> m_Distribution_plane_size;
    bool m_Distribution_plane_sizeIsSet;
    std::vector<std::shared_ptr<AnyType>> m_Power_flags;
    ...
    int32_t m_Resv_mpi_ports;
    bool m_Resv_mpi_portsIsSet;
    ...
    std::shared_ptr<V0_0_41_job_desc_msg_kill_warning_delay> m_Kill_warning_delay;
    ...
    std::shared_ptr<V0_0_41_job_desc_msg_memory_per_cpu> m_Memory_per_node;
    ...
    std::shared_ptr<V0_0_41_job_desc_msg_required_switches> m_Required_switches;
    bool m_Required_switchesIsSet;
    std::shared_ptr<V0_0_41_job_desc_msg_segment_size> m_Segment_size;
    bool m_Segment_sizeIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_job_desc_msg_H_ */
