...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_37_association_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_37_association_H_


#include "slurmrestapi/ModelBase.h"

#include "slurmrestapi/model/Dbv0_0_37_association_usage.h"
#include "slurmrestapi/model/Dbv0_0_37_association_min.h"
#include "slurmrestapi/model/Dbv0_0_37_association_max.h"
#include "slurmrestapi/model/Dbv0_0_37_association_default.h"
...
class Dbv0_0_37_association_default;
class Dbv0_0_37_association_max;
class Dbv0_0_37_association_min;
...
{
public:
    Dbv0_0_37_association();
    virtual ~Dbv0_0_37_association();
    ...
    /// 
    /// </summary>
    std::shared_ptr<Dbv0_0_37_association_default> getRDefault() const;
    bool rDefaultIsSet() const;
    void unsetr_default();

    void setRDefault(const std::shared_ptr<Dbv0_0_37_association_default>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<Dbv0_0_37_association_max> getMax() const;
    bool maxIsSet() const;
    void unsetMax();

    void setMax(const std::shared_ptr<Dbv0_0_37_association_max>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<Dbv0_0_37_association_min> getMin() const;
    bool minIsSet() const;
    void unsetMin();

    void setMin(const std::shared_ptr<Dbv0_0_37_association_min>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<Dbv0_0_37_association_usage> getUsage() const;
    bool usageIsSet() const;
    void unsetUsage();

    void setUsage(const std::shared_ptr<Dbv0_0_37_association_usage>& value);
...
protected:
    int32_t m_Is_default;
    bool m_Is_defaultIsSet;
    utility::string_t m_Account;
    bool m_AccountIsSet;
    utility::string_t m_Cluster;
    bool m_ClusterIsSet;
    std::shared_ptr<Dbv0_0_37_association_default> m_r_default;
    bool m_r_defaultIsSet;
    std::vector<utility::string_t> m_Flags;
    bool m_FlagsIsSet;
    std::shared_ptr<Dbv0_0_37_association_max> m_Max;
    bool m_MaxIsSet;
    std::shared_ptr<Dbv0_0_37_association_min> m_Min;
    bool m_MinIsSet;
    ...
    std::shared_ptr<Dbv0_0_37_association_usage> m_Usage;
    bool m_UsageIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_37_association_H_ */
