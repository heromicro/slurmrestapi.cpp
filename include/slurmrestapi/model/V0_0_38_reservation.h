...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_38_reservation_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_38_reservation_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_38_reservation_purge_completed> getPurgeCompleted() const;
    bool purgeCompletedIsSet() const;
    void unsetPurge_completed();

    void setPurgeCompleted(const std::shared_ptr<V0_0_38_reservation_purge_completed>& value);
...
protected:
    ...
    std::shared_ptr<V0_0_38_reservation_purge_completed> m_Purge_completed;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_38_reservation_H_ */
