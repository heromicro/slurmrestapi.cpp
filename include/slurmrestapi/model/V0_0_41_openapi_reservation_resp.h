...
/*
 * V0_0_41_openapi_reservation_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_reservation_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_reservation_resp_H_
...
class V0_0_41_openapi_reservation_resp_last_update;
...
/// 
/// </summary>
class  V0_0_41_openapi_reservation_resp
    : public ModelBase
{
public:
    V0_0_41_openapi_reservation_resp();
    virtual ~V0_0_41_openapi_reservation_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_41_openapi_reservation_resp members

    /// <summary>
    /// List of reservations
    /// </summary>
    std::vector<std::shared_ptr<V0_0_41_openapi_reservation_resp_reservations_inner>>& getReservations();
    bool reservationsIsSet() const;
    void unsetReservations();

    void setReservations(const std::vector<std::shared_ptr<V0_0_41_openapi_reservation_resp_reservations_inner>>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_openapi_reservation_resp_last_update> getLastUpdate() const;
    bool lastUpdateIsSet() const;
    void unsetLast_update();

    void setLastUpdate(const std::shared_ptr<V0_0_41_openapi_reservation_resp_last_update>& value);
...
protected:
    std::vector<std::shared_ptr<V0_0_41_openapi_reservation_resp_reservations_inner>> m_Reservations;
    bool m_ReservationsIsSet;
    std::shared_ptr<V0_0_41_openapi_reservation_resp_last_update> m_Last_update;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_reservation_resp_H_ */
