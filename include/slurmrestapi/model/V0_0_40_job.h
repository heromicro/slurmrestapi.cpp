...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_job_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_job_H_
...
class V0_0_40_step;
class V0_0_40_job_tres;
class V0_0_40_wckey_tag_struct;
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_job_array> getArray() const;
    bool arrayIsSet() const;
    void unsetarray();

    void setArray(const std::shared_ptr<V0_0_40_job_array>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_assoc_short> getAssociation() const;
    bool associationIsSet() const;
    void unsetAssociation();

    void setAssociation(const std::shared_ptr<V0_0_40_assoc_short>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_job_time> getTime() const;
    bool timeIsSet() const;
    void unsetTime();

    void setTime(const std::shared_ptr<V0_0_40_job_time>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_job_het> getHet() const;
    bool hetIsSet() const;
    void unsetHet();

    void setHet(const std::shared_ptr<V0_0_40_job_het>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_job_required> getRequired() const;
    bool requiredIsSet() const;
    void unsetRequired();

    void setRequired(const std::shared_ptr<V0_0_40_job_required>& value);
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<V0_0_40_step>>& getSteps();
    bool stepsIsSet() const;
    void unsetSteps();

    void setSteps(const std::vector<std::shared_ptr<V0_0_40_step>>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_job_tres> getTres() const;
    bool tresIsSet() const;
    void unsetTres();

    void setTres(const std::shared_ptr<V0_0_40_job_tres>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_wckey_tag_struct> getWckey() const;
    bool wckeyIsSet() const;
    void unsetWckey();

    void setWckey(const std::shared_ptr<V0_0_40_wckey_tag_struct>& value);
...
protected:
    ...
    std::shared_ptr<V0_0_40_job_array> m_array;
    bool m_arrayIsSet;
    std::shared_ptr<V0_0_40_assoc_short> m_Association;
    ...
    std::shared_ptr<V0_0_40_job_time> m_Time;
    bool m_TimeIsSet;
    ...
    bool m_GroupIsSet;
    std::shared_ptr<V0_0_40_job_het> m_Het;
    bool m_HetIsSet;
    int32_t m_Job_id;
    bool m_Job_idIsSet;
    ...
    bool m_QosIsSet;
    std::shared_ptr<V0_0_40_job_required> m_Required;
    ...
    bool m_StateIsSet;
    std::vector<std::shared_ptr<V0_0_40_step>> m_Steps;
    bool m_StepsIsSet;
    utility::string_t m_Submit_line;
    bool m_Submit_lineIsSet;
    std::shared_ptr<V0_0_40_job_tres> m_Tres;
    bool m_TresIsSet;
    utility::string_t m_Used_gres;
    bool m_Used_gresIsSet;
    utility::string_t m_User;
    bool m_UserIsSet;
    std::shared_ptr<V0_0_40_wckey_tag_struct> m_Wckey;
    bool m_WckeyIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_job_H_ */
