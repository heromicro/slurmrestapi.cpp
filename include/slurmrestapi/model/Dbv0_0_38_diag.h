...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_38_diag_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_38_diag_H_
...
/// 
/// </summary>
class  Dbv0_0_38_diag
    : public ModelBase
{
public:
    Dbv0_0_38_diag();
    virtual ~Dbv0_0_38_diag();
    ...
    /// 
    /// </summary>
    std::shared_ptr<Dbv0_0_38_diag_statistics> getStatistics() const;
    bool statisticsIsSet() const;
    void unsetStatistics();

    void setStatistics(const std::shared_ptr<Dbv0_0_38_diag_statistics>& value);
...
protected:
    ...
    bool m_ErrorsIsSet;
    std::shared_ptr<Dbv0_0_38_diag_statistics> m_Statistics;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_38_diag_H_ */
