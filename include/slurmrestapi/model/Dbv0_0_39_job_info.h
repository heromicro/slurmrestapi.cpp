...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_39_job_info_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_39_job_info_H_
...
/// 
/// </summary>
class  Dbv0_0_39_job_info
    : public ModelBase
{
public:
    Dbv0_0_39_job_info();
    virtual ~Dbv0_0_39_job_info();
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<V0_0_39_job>>& getJobs();
    bool jobsIsSet() const;
    void unsetJobs();

    void setJobs(const std::vector<std::shared_ptr<V0_0_39_job>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<V0_0_39_job>> m_Jobs;
    bool m_JobsIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_39_job_info_H_ */
