...
/*
 * V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_H_
...
class V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned;
...
public:
    ...
    virtual ~V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time();
    ...
    /////////////////////////////////////////////
    /// V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time members
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned> getPlanned() const;
    bool plannedIsSet() const;
    void unsetPlanned();

    void setPlanned(const std::shared_ptr<V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_job_desc_msg_time_limit> getLimit() const;
    bool limitIsSet() const;
    void unsetLimit();

    void setLimit(const std::shared_ptr<V0_0_41_job_desc_msg_time_limit>& value);
...
protected:
    ...
    int64_t m_End;
    bool m_EndIsSet;
    std::shared_ptr<V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned> m_Planned;
    bool m_PlannedIsSet;
    int64_t m_Start;
    bool m_StartIsSet;
    ...
    bool m_SystemIsSet;
    std::shared_ptr<V0_0_41_job_desc_msg_time_limit> m_Limit;
    bool m_LimitIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_H_ */
