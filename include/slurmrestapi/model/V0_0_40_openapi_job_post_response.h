...
/*
 * V0_0_40_openapi_job_post_response.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_job_post_response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_job_post_response_H_
...
/// 
/// </summary>
class  V0_0_40_openapi_job_post_response
    : public ModelBase
{
public:
    V0_0_40_openapi_job_post_response();
    virtual ~V0_0_40_openapi_job_post_response();
    ...
    /////////////////////////////////////////////
    /// V0_0_40_openapi_job_post_response members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<V0_0_40_job_array_response_msg_entry>>& getResults();
    bool resultsIsSet() const;
    void unsetResults();

    void setResults(const std::vector<std::shared_ptr<V0_0_40_job_array_response_msg_entry>>& value);
...
protected:
    std::vector<std::shared_ptr<V0_0_40_job_array_response_msg_entry>> m_Results;
    bool m_ResultsIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_job_post_response_H_ */
