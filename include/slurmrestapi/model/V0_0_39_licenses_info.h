...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_licenses_info_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_licenses_info_H_
...
/// 
/// </summary>
class  V0_0_39_licenses_info
    : public ModelBase
{
public:
    V0_0_39_licenses_info();
    virtual ~V0_0_39_licenses_info();
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<V0_0_39_license>>& getLicenses();
    bool licensesIsSet() const;
    void unsetLicenses();

    void setLicenses(const std::vector<std::shared_ptr<V0_0_39_license>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<V0_0_39_license>> m_Licenses;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_licenses_info_H_ */
