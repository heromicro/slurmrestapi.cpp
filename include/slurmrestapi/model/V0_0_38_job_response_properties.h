...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_38_job_response_properties_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_38_job_response_properties_H_


#include "slurmrestapi/ModelBase.h"

#include "slurmrestapi/model/V0_0_38_job_resources.h"
...
{
public:
    V0_0_38_job_response_properties();
    virtual ~V0_0_38_job_response_properties();
    ...
    /////////////////////////////////////////////
    /// V0_0_38_job_response_properties members
    ...
    /// billable TRES
    /// </summary>
    double getBillableTres() const;
    bool billableTresIsSet() const;
    void unsetBillable_tres();

    void setBillableTres(double value);
    ...
    /// job start deadline 
    /// </summary>
    int32_t getDeadline() const;
    bool deadlineIsSet() const;
    void unsetDeadline();

    void setDeadline(int32_t value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_38_job_resources> getJobResources() const;
    bool jobResourcesIsSet() const;
    void unsetJob_resources();

    void setJobResources(const std::shared_ptr<V0_0_38_job_resources>& value);
    ...
    /// </summary>
    int32_t getLastSchedEvaluation() const;
    bool lastSchedEvaluationIsSet() const;
    void unsetLast_sched_evaluation();

    void setLastSchedEvaluation(int32_t value);
    ...
    /// </summary>
    int32_t getMaxCpus() const;
    bool maxCpusIsSet() const;
    void unsetMax_cpus();

    void setMaxCpus(int32_t value);
    ...
    /// </summary>
    int32_t getHetJobId() const;
    bool hetJobIdIsSet() const;
    void unsetHet_job_id();

    void setHetJobId(int32_t value);
    ...
    /// </summary>
    int32_t getHetJobOffset() const;
    bool hetJobOffsetIsSet() const;
    void unsetHet_job_offset();

    void setHetJobOffset(int32_t value);
    ...
    /// </summary>
    int32_t getMinimumTmpDiskPerNode() const;
    bool minimumTmpDiskPerNodeIsSet() const;
    void unsetMinimum_tmp_disk_per_node();

    void setMinimumTmpDiskPerNode(int32_t value);
...
protected:
    ...
    int32_t m_Array_job_id;
    bool m_Array_job_idIsSet;
    int32_t m_Array_task_id;
    bool m_Array_task_idIsSet;
    int32_t m_Array_max_tasks;
    ...
    int32_t m_Job_id;
    bool m_Job_idIsSet;
    std::shared_ptr<V0_0_38_job_resources> m_Job_resources;
    bool m_Job_resourcesIsSet;
    utility::string_t m_Job_state;
    bool m_Job_stateIsSet;
    int32_t m_Last_sched_evaluation;
    ...
    int32_t m_Minimum_tmp_disk_per_node;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_38_job_response_properties_H_ */
