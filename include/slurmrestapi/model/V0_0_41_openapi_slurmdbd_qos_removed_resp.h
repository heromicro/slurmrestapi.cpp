...
/*
 * V0_0_41_openapi_slurmdbd_qos_removed_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_slurmdbd_qos_removed_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_slurmdbd_qos_removed_resp_H_
...
/// 
/// </summary>
class  V0_0_41_openapi_slurmdbd_qos_removed_resp
    : public ModelBase
{
public:
    V0_0_41_openapi_slurmdbd_qos_removed_resp();
    virtual ~V0_0_41_openapi_slurmdbd_qos_removed_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_41_openapi_slurmdbd_qos_removed_resp members

    /// <summary>
    /// removed QOS
    /// </summary>
    std::vector<utility::string_t>& getRemovedQos();
    bool removedQosIsSet() const;
    void unsetRemoved_qos();

    void setRemovedQos(const std::vector<utility::string_t>& value);
...
protected:
    std::vector<utility::string_t> m_Removed_qos;
    bool m_Removed_qosIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_slurmdbd_qos_removed_resp_H_ */
