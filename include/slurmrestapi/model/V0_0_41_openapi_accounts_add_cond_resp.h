...
/*
 * V0_0_41_openapi_accounts_add_cond_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_accounts_add_cond_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_accounts_add_cond_resp_H_
...
class V0_0_41_openapi_accounts_add_cond_resp_association_condition;
class V0_0_41_openapi_accounts_add_cond_resp_account;
...
/// 
/// </summary>
class  V0_0_41_openapi_accounts_add_cond_resp
    : public ModelBase
{
public:
    V0_0_41_openapi_accounts_add_cond_resp();
    virtual ~V0_0_41_openapi_accounts_add_cond_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_41_openapi_accounts_add_cond_resp members

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_openapi_accounts_add_cond_resp_association_condition> getAssociationCondition() const;
    bool associationConditionIsSet() const;
    void unsetAssociation_condition();

    void setAssociationCondition(const std::shared_ptr<V0_0_41_openapi_accounts_add_cond_resp_association_condition>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_openapi_accounts_add_cond_resp_account> getAccount() const;
    bool accountIsSet() const;
    void unsetAccount();

    void setAccount(const std::shared_ptr<V0_0_41_openapi_accounts_add_cond_resp_account>& value);
...
protected:
    std::shared_ptr<V0_0_41_openapi_accounts_add_cond_resp_association_condition> m_Association_condition;
    bool m_Association_conditionIsSet;
    std::shared_ptr<V0_0_41_openapi_accounts_add_cond_resp_account> m_Account;
    bool m_AccountIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_accounts_add_cond_resp_H_ */
