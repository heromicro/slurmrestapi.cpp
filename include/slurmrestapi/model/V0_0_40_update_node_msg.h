...
/*
 * V0_0_40_update_node_msg.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_update_node_msg_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_update_node_msg_H_
...
/// 
/// </summary>
class  V0_0_40_update_node_msg
    : public ModelBase
{
public:
    V0_0_40_update_node_msg();
    virtual ~V0_0_40_update_node_msg();
    ...
    /////////////////////////////////////////////
    /// V0_0_40_update_node_msg members
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getResumeAfter() const;
    bool resumeAfterIsSet() const;
    void unsetResume_after();

    void setResumeAfter(const std::shared_ptr<V0_0_40_uint32_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getWeight() const;
    bool weightIsSet() const;
    void unsetWeight();

    void setWeight(const std::shared_ptr<V0_0_40_uint32_no_val>& value);
...
protected:
    ...
    std::shared_ptr<V0_0_40_uint32_no_val> m_Resume_after;
    bool m_Resume_afterIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Weight;
    bool m_WeightIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_update_node_msg_H_ */
