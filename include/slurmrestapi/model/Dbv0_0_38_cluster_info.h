...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_38_cluster_info_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_38_cluster_info_H_
...
{
public:
    Dbv0_0_38_cluster_info();
    virtual ~Dbv0_0_38_cluster_info();
    ...
    /////////////////////////////////////////////
    /// Dbv0_0_38_cluster_info members

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<Dbv0_0_38_cluster_info_controller> getController() const;
    bool controllerIsSet() const;
    void unsetController();

    void setController(const std::shared_ptr<Dbv0_0_38_cluster_info_controller>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<Dbv0_0_38_cluster_info_associations> getAssociations() const;
    bool associationsIsSet() const;
    void unsetAssociations();

    void setAssociations(const std::shared_ptr<Dbv0_0_38_cluster_info_associations>& value);
    ...
    /// </summary>
    std::vector<std::shared_ptr<Dbv0_0_38_response_tres>>& getTres();
    bool tresIsSet() const;
    void unsetTres();

    void setTres(const std::vector<std::shared_ptr<Dbv0_0_38_response_tres>>& value);


protected:
    std::shared_ptr<Dbv0_0_38_cluster_info_controller> m_Controller;
    ...
    std::shared_ptr<Dbv0_0_38_cluster_info_associations> m_Associations;
    bool m_AssociationsIsSet;
    int32_t m_Rpc_version;
    bool m_Rpc_versionIsSet;
    std::vector<std::shared_ptr<Dbv0_0_38_response_tres>> m_Tres;
    bool m_TresIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_Dbv0_0_38_cluster_info_H_ */
