...
/*
 * V0_0_40_openapi_shares_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_shares_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_shares_resp_H_
...
/// 
/// </summary>
class  V0_0_40_openapi_shares_resp
    : public ModelBase
{
public:
    V0_0_40_openapi_shares_resp();
    virtual ~V0_0_40_openapi_shares_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_40_openapi_shares_resp members

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_shares_resp_msg> getShares() const;
    bool sharesIsSet() const;
    void unsetShares();

    void setShares(const std::shared_ptr<V0_0_40_shares_resp_msg>& value);
...
protected:
    std::shared_ptr<V0_0_40_shares_resp_msg> m_Shares;
    bool m_SharesIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_shares_resp_H_ */
