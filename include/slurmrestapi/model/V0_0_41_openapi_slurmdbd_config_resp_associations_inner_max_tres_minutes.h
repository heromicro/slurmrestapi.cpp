...
/*
 * V0_0_41_openapi_slurmdbd_config_resp_associations_inner_max_tres_minutes.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_slurmdbd_config_resp_associations_inner_max_tres_minutes_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_slurmdbd_config_resp_associations_inner_max_tres_minutes_H_
...
public:
    ...
    virtual ~V0_0_41_openapi_slurmdbd_config_resp_associations_inner_max_tres_minutes();
    ...
    /////////////////////////////////////////////
    /// V0_0_41_openapi_slurmdbd_config_resp_associations_inner_max_tres_minutes members
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_openapi_slurmdbd_config_resp_associations_inner_max_tres_minutes_per> getPer() const;
    bool perIsSet() const;
    void unsetPer();

    void setPer(const std::shared_ptr<V0_0_41_openapi_slurmdbd_config_resp_associations_inner_max_tres_minutes_per>& value);


protected:
    std::vector<std::shared_ptr<V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_steps_inner_tres_requested_max_inner>> m_Total;
    bool m_TotalIsSet;
    std::shared_ptr<V0_0_41_openapi_slurmdbd_config_resp_associations_inner_max_tres_minutes_per> m_Per;
    bool m_PerIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_slurmdbd_config_resp_associations_inner_max_tres_minutes_H_ */
