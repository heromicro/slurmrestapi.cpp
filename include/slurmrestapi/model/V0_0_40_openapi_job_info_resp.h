...
/*
 * V0_0_40_openapi_job_info_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_job_info_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_job_info_resp_H_
...
/// 
/// </summary>
class  V0_0_40_openapi_job_info_resp
    : public ModelBase
{
public:
    V0_0_40_openapi_job_info_resp();
    virtual ~V0_0_40_openapi_job_info_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_40_openapi_job_info_resp members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<V0_0_40_job_info>>& getJobs();
    bool jobsIsSet() const;
    void unsetJobs();

    void setJobs(const std::vector<std::shared_ptr<V0_0_40_job_info>>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint64_no_val> getLastBackfill() const;
    bool lastBackfillIsSet() const;
    void unsetLast_backfill();

    void setLastBackfill(const std::shared_ptr<V0_0_40_uint64_no_val>& value);
...
protected:
    std::vector<std::shared_ptr<V0_0_40_job_info>> m_Jobs;
    bool m_JobsIsSet;
    std::shared_ptr<V0_0_40_uint64_no_val> m_Last_backfill;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_job_info_resp_H_ */
