...
#ifndef HM_SLURM_CLIENT_MODEL_V0_0_39_step_statistics_H_
#define HM_SLURM_CLIENT_MODEL_V0_0_39_step_statistics_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_step_statistics_CPU> getCPU() const;
    bool cPUIsSet() const;
    void unsetCPU();

    void setCPU(const std::shared_ptr<V0_0_39_step_statistics_CPU>& value);
...
protected:
    std::shared_ptr<V0_0_39_step_statistics_CPU> m_CPU;
    bool m_CPUIsSet;
...
#endif /* HM_SLURM_CLIENT_MODEL_V0_0_39_step_statistics_H_ */
