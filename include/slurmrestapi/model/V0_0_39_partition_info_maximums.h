...
#ifndef HM_SLURM_CLIENT_MODEL_V0_0_39_partition_info_maximums_H_
#define HM_SLURM_CLIENT_MODEL_V0_0_39_partition_info_maximums_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_uint32_no_val> getCpusPerNode() const;
    bool cpusPerNodeIsSet() const;
    void unsetCpus_per_node();

    void setCpusPerNode(const std::shared_ptr<V0_0_39_uint32_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_uint32_no_val> getCpusPerSocket() const;
    bool cpusPerSocketIsSet() const;
    void unsetCpus_per_socket();

    void setCpusPerSocket(const std::shared_ptr<V0_0_39_uint32_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_39_uint32_no_val> getNodes() const;
    bool nodesIsSet() const;
    void unsetNodes();

    void setNodes(const std::shared_ptr<V0_0_39_uint32_no_val>& value);
...
protected:
    std::shared_ptr<V0_0_39_uint32_no_val> m_Cpus_per_node;
    bool m_Cpus_per_nodeIsSet;
    std::shared_ptr<V0_0_39_uint32_no_val> m_Cpus_per_socket;
    bool m_Cpus_per_socketIsSet;
    int64_t m_Memory_per_cpu;
    bool m_Memory_per_cpuIsSet;
    std::shared_ptr<V0_0_39_uint32_no_val> m_Nodes;
    bool m_NodesIsSet;
    int32_t m_Shares;
    bool m_SharesIsSet;
...
#endif /* HM_SLURM_CLIENT_MODEL_V0_0_39_partition_info_maximums_H_ */
