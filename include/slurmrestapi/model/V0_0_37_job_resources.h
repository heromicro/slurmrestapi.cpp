...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_37_job_resources_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_37_job_resources_H_
...
{
public:
    V0_0_37_job_resources();
    virtual ~V0_0_37_job_resources();
    ...
    /// node allocations
    /// </summary>
    std::vector<std::shared_ptr<V0_0_37_node_allocation>>& getAllocatedNodes();
    bool allocatedNodesIsSet() const;
    void unsetAllocated_nodes();

    void setAllocatedNodes(const std::vector<std::shared_ptr<V0_0_37_node_allocation>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<V0_0_37_node_allocation>> m_Allocated_nodes;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_37_job_resources_H_ */
