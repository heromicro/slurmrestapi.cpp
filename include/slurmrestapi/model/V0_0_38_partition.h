...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_38_partition_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_38_partition_H_
...
/// 
/// </summary>
class  V0_0_38_partition
    : public ModelBase
{
public:
    V0_0_38_partition();
    virtual ~V0_0_38_partition();
    ...
    /// </summary>
    int64_t getMaximumMemoryPerCpu() const;
    bool maximumMemoryPerCpuIsSet() const;
    void unsetMaximum_memory_per_cpu();

    void setMaximumMemoryPerCpu(int64_t value);

    /// <summary>
    /// default MB memory per allocated node
    /// </summary>
    int64_t getDefaultMemoryPerNode() const;
    bool defaultMemoryPerNodeIsSet() const;
    void unsetDefault_memory_per_node();

    void setDefaultMemoryPerNode(int64_t value);
...
protected:
    ...
    bool m_TresIsSet;
    int64_t m_Maximum_memory_per_cpu;
    bool m_Maximum_memory_per_cpuIsSet;
    int64_t m_Default_memory_per_node;
    bool m_Default_memory_per_nodeIsSet;
};
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_38_partition_H_ */
