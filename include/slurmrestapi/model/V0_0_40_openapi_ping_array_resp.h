...
/*
 * V0_0_40_openapi_ping_array_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_ping_array_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_ping_array_resp_H_
...
/// 
/// </summary>
class  V0_0_40_openapi_ping_array_resp
    : public ModelBase
{
public:
    V0_0_40_openapi_ping_array_resp();
    virtual ~V0_0_40_openapi_ping_array_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_40_openapi_ping_array_resp members

    /// <summary>
    /// 
    /// </summary>
    std::vector<std::shared_ptr<V0_0_40_controller_ping>>& getPings();
    bool pingsIsSet() const;
    void unsetPings();

    void setPings(const std::vector<std::shared_ptr<V0_0_40_controller_ping>>& value);
...
protected:
    std::vector<std::shared_ptr<V0_0_40_controller_ping>> m_Pings;
    bool m_PingsIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_openapi_ping_array_resp_H_ */
