...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_reservations_response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_reservations_response_H_
...
/// 
/// </summary>
class  V0_0_39_reservations_response
    : public ModelBase
{
public:
    V0_0_39_reservations_response();
    virtual ~V0_0_39_reservations_response();
    ...
    /////////////////////////////////////////////
    /// V0_0_39_reservations_response members
    ...
    /// 
    /// </summary>
    std::vector<std::shared_ptr<V0_0_39_reservation_info>>& getReservations();
    bool reservationsIsSet() const;
    void unsetReservations();

    void setReservations(const std::vector<std::shared_ptr<V0_0_39_reservation_info>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<V0_0_39_reservation_info>> m_Reservations;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_39_reservations_response_H_ */
