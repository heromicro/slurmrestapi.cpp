...
/*
 * V0_0_41_openapi_users_add_cond_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_users_add_cond_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_users_add_cond_resp_H_
...
/// 
/// </summary>
class  V0_0_41_openapi_users_add_cond_resp
    : public ModelBase
{
public:
    V0_0_41_openapi_users_add_cond_resp();
    virtual ~V0_0_41_openapi_users_add_cond_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_41_openapi_users_add_cond_resp members

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_openapi_users_add_cond_resp_association_condition> getAssociationCondition() const;
    bool associationConditionIsSet() const;
    void unsetAssociation_condition();

    void setAssociationCondition(const std::shared_ptr<V0_0_41_openapi_users_add_cond_resp_association_condition>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_openapi_users_add_cond_resp_user> getUser() const;
    bool userIsSet() const;
    void unsetUser();

    void setUser(const std::shared_ptr<V0_0_41_openapi_users_add_cond_resp_user>& value);
...
protected:
    std::shared_ptr<V0_0_41_openapi_users_add_cond_resp_association_condition> m_Association_condition;
    bool m_Association_conditionIsSet;
    std::shared_ptr<V0_0_41_openapi_users_add_cond_resp_user> m_User;
    bool m_UserIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_users_add_cond_resp_H_ */
