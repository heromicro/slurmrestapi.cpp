...
/*
 * V0_0_41_openapi_licenses_resp.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_licenses_resp_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_licenses_resp_H_
...
class V0_0_41_openapi_licenses_resp_licenses_inner;
class V0_0_41_openapi_licenses_resp_last_update;
...
/// 
/// </summary>
class  V0_0_41_openapi_licenses_resp
    : public ModelBase
{
public:
    V0_0_41_openapi_licenses_resp();
    virtual ~V0_0_41_openapi_licenses_resp();
    ...
    /////////////////////////////////////////////
    /// V0_0_41_openapi_licenses_resp members

    /// <summary>
    /// List of licenses
    /// </summary>
    std::vector<std::shared_ptr<V0_0_41_openapi_licenses_resp_licenses_inner>>& getLicenses();
    bool licensesIsSet() const;
    void unsetLicenses();

    void setLicenses(const std::vector<std::shared_ptr<V0_0_41_openapi_licenses_resp_licenses_inner>>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_41_openapi_licenses_resp_last_update> getLastUpdate() const;
    bool lastUpdateIsSet() const;
    void unsetLast_update();

    void setLastUpdate(const std::shared_ptr<V0_0_41_openapi_licenses_resp_last_update>& value);
...
protected:
    std::vector<std::shared_ptr<V0_0_41_openapi_licenses_resp_licenses_inner>> m_Licenses;
    bool m_LicensesIsSet;
    std::shared_ptr<V0_0_41_openapi_licenses_resp_last_update> m_Last_update;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_41_openapi_licenses_resp_H_ */
