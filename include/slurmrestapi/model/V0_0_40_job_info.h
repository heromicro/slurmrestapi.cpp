...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_job_info_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_job_info_H_
...
/// 
/// </summary>
class  V0_0_40_job_info
    : public ModelBase
{
public:
    V0_0_40_job_info();
    virtual ~V0_0_40_job_info();
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint64_no_val> getAccrueTime() const;
    bool accrueTimeIsSet() const;
    void unsetAccrue_time();

    void setAccrueTime(const std::shared_ptr<V0_0_40_uint64_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getArrayJobId() const;
    bool arrayJobIdIsSet() const;
    void unsetArray_job_id();

    void setArrayJobId(const std::shared_ptr<V0_0_40_uint32_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getArrayTaskId() const;
    bool arrayTaskIdIsSet() const;
    void unsetArray_task_id();

    void setArrayTaskId(const std::shared_ptr<V0_0_40_uint32_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getArrayMaxTasks() const;
    bool arrayMaxTasksIsSet() const;
    void unsetArray_max_tasks();

    void setArrayMaxTasks(const std::shared_ptr<V0_0_40_uint32_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint16_no_val> getCoresPerSocket() const;
    bool coresPerSocketIsSet() const;
    void unsetCores_per_socket();

    void setCoresPerSocket(const std::shared_ptr<V0_0_40_uint16_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_float64_no_val> getBillableTres() const;
    bool billableTresIsSet() const;
    void unsetBillable_tres();

    void setBillableTres(const std::shared_ptr<V0_0_40_float64_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint16_no_val> getCpusPerTask() const;
    bool cpusPerTaskIsSet() const;
    void unsetCpus_per_task();

    void setCpusPerTask(const std::shared_ptr<V0_0_40_uint16_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getCpuFrequencyMinimum() const;
    bool cpuFrequencyMinimumIsSet() const;
    void unsetCpu_frequency_minimum();

    void setCpuFrequencyMinimum(const std::shared_ptr<V0_0_40_uint32_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getCpuFrequencyMaximum() const;
    bool cpuFrequencyMaximumIsSet() const;
    void unsetCpu_frequency_maximum();

    void setCpuFrequencyMaximum(const std::shared_ptr<V0_0_40_uint32_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getCpuFrequencyGovernor() const;
    bool cpuFrequencyGovernorIsSet() const;
    void unsetCpu_frequency_governor();

    void setCpuFrequencyGovernor(const std::shared_ptr<V0_0_40_uint32_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint64_no_val> getDeadline() const;
    bool deadlineIsSet() const;
    void unsetDeadline();

    void setDeadline(const std::shared_ptr<V0_0_40_uint64_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getDelayBoot() const;
    bool delayBootIsSet() const;
    void unsetDelay_boot();

    void setDelayBoot(const std::shared_ptr<V0_0_40_uint32_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_process_exit_code_verbose> getDerivedExitCode() const;
    bool derivedExitCodeIsSet() const;
    void unsetDerived_exit_code();

    void setDerivedExitCode(const std::shared_ptr<V0_0_40_process_exit_code_verbose>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint64_no_val> getEligibleTime() const;
    bool eligibleTimeIsSet() const;
    void unsetEligible_time();

    void setEligibleTime(const std::shared_ptr<V0_0_40_uint64_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_process_exit_code_verbose> getExitCode() const;
    bool exitCodeIsSet() const;
    void unsetExit_code();

    void setExitCode(const std::shared_ptr<V0_0_40_process_exit_code_verbose>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getHetJobId() const;
    bool hetJobIdIsSet() const;
    void unsetHet_job_id();

    void setHetJobId(const std::shared_ptr<V0_0_40_uint32_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getHetJobOffset() const;
    bool hetJobOffsetIsSet() const;
    void unsetHet_job_offset();

    void setHetJobOffset(const std::shared_ptr<V0_0_40_uint32_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_job_res> getJobResources() const;
    bool jobResourcesIsSet() const;
    void unsetJob_resources();

    void setJobResources(const std::shared_ptr<V0_0_40_job_res>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint64_no_val> getLastSchedEvaluation() const;
    bool lastSchedEvaluationIsSet() const;
    void unsetLast_sched_evaluation();

    void setLastSchedEvaluation(const std::shared_ptr<V0_0_40_uint64_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getMaxCpus() const;
    bool maxCpusIsSet() const;
    void unsetMax_cpus();

    void setMaxCpus(const std::shared_ptr<V0_0_40_uint32_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getMaxNodes() const;
    bool maxNodesIsSet() const;
    void unsetMax_nodes();

    void setMaxNodes(const std::shared_ptr<V0_0_40_uint32_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint16_no_val> getTasksPerCore() const;
    bool tasksPerCoreIsSet() const;
    void unsetTasks_per_core();

    void setTasksPerCore(const std::shared_ptr<V0_0_40_uint16_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint16_no_val> getTasksPerTres() const;
    bool tasksPerTresIsSet() const;
    void unsetTasks_per_tres();

    void setTasksPerTres(const std::shared_ptr<V0_0_40_uint16_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint16_no_val> getTasksPerNode() const;
    bool tasksPerNodeIsSet() const;
    void unsetTasks_per_node();

    void setTasksPerNode(const std::shared_ptr<V0_0_40_uint16_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint16_no_val> getTasksPerSocket() const;
    bool tasksPerSocketIsSet() const;
    void unsetTasks_per_socket();

    void setTasksPerSocket(const std::shared_ptr<V0_0_40_uint16_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint16_no_val> getTasksPerBoard() const;
    bool tasksPerBoardIsSet() const;
    void unsetTasks_per_board();

    void setTasksPerBoard(const std::shared_ptr<V0_0_40_uint16_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getCpus() const;
    bool cpusIsSet() const;
    void unsetCpus();

    void setCpus(const std::shared_ptr<V0_0_40_uint32_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getNodeCount() const;
    bool nodeCountIsSet() const;
    void unsetNode_count();

    void setNodeCount(const std::shared_ptr<V0_0_40_uint32_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getTasks() const;
    bool tasksIsSet() const;
    void unsetTasks();

    void setTasks(const std::shared_ptr<V0_0_40_uint32_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint16_no_val> getMinimumCpusPerNode() const;
    bool minimumCpusPerNodeIsSet() const;
    void unsetMinimum_cpus_per_node();

    void setMinimumCpusPerNode(const std::shared_ptr<V0_0_40_uint16_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getMinimumTmpDiskPerNode() const;
    bool minimumTmpDiskPerNodeIsSet() const;
    void unsetMinimum_tmp_disk_per_node();

    void setMinimumTmpDiskPerNode(const std::shared_ptr<V0_0_40_uint32_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_job_info_power> getPower() const;
    bool powerIsSet() const;
    void unsetPower();

    void setPower(const std::shared_ptr<V0_0_40_job_info_power>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint64_no_val> getPreemptTime() const;
    bool preemptTimeIsSet() const;
    void unsetPreempt_time();

    void setPreemptTime(const std::shared_ptr<V0_0_40_uint64_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint64_no_val> getPreemptableTime() const;
    bool preemptableTimeIsSet() const;
    void unsetPreemptable_time();

    void setPreemptableTime(const std::shared_ptr<V0_0_40_uint64_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint64_no_val> getPreSusTime() const;
    bool preSusTimeIsSet() const;
    void unsetPre_sus_time();

    void setPreSusTime(const std::shared_ptr<V0_0_40_uint64_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint64_no_val> getResizeTime() const;
    bool resizeTimeIsSet() const;
    void unsetResize_time();

    void setResizeTime(const std::shared_ptr<V0_0_40_uint64_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint16_no_val> getSocketsPerNode() const;
    bool socketsPerNodeIsSet() const;
    void unsetSockets_per_node();

    void setSocketsPerNode(const std::shared_ptr<V0_0_40_uint16_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint64_no_val> getSubmitTime() const;
    bool submitTimeIsSet() const;
    void unsetSubmit_time();

    void setSubmitTime(const std::shared_ptr<V0_0_40_uint64_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint64_no_val> getSuspendTime() const;
    bool suspendTimeIsSet() const;
    void unsetSuspend_time();

    void setSuspendTime(const std::shared_ptr<V0_0_40_uint64_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getTimeLimit() const;
    bool timeLimitIsSet() const;
    void unsetTime_limit();

    void setTimeLimit(const std::shared_ptr<V0_0_40_uint32_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getTimeMinimum() const;
    bool timeMinimumIsSet() const;
    void unsetTime_minimum();

    void setTimeMinimum(const std::shared_ptr<V0_0_40_uint32_no_val>& value);

    /// <summary>
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint16_no_val> getThreadsPerCore() const;
    bool threadsPerCoreIsSet() const;
    void unsetThreads_per_core();

    void setThreadsPerCore(const std::shared_ptr<V0_0_40_uint16_no_val>& value);
...
protected:
    ...
    bool m_AccountIsSet;
    std::shared_ptr<V0_0_40_uint64_no_val> m_Accrue_time;
    ...
    std::shared_ptr<V0_0_40_uint32_no_val> m_Array_job_id;
    bool m_Array_job_idIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Array_task_id;
    bool m_Array_task_idIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Array_max_tasks;
    ...
    std::shared_ptr<V0_0_40_uint16_no_val> m_Cores_per_socket;
    bool m_Cores_per_socketIsSet;
    std::shared_ptr<V0_0_40_float64_no_val> m_Billable_tres;
    bool m_Billable_tresIsSet;
    std::shared_ptr<V0_0_40_uint16_no_val> m_Cpus_per_task;
    bool m_Cpus_per_taskIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Cpu_frequency_minimum;
    bool m_Cpu_frequency_minimumIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Cpu_frequency_maximum;
    bool m_Cpu_frequency_maximumIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Cpu_frequency_governor;
    bool m_Cpu_frequency_governorIsSet;
    utility::string_t m_Cpus_per_tres;
    bool m_Cpus_per_tresIsSet;
    utility::string_t m_Cron;
    bool m_CronIsSet;
    std::shared_ptr<V0_0_40_uint64_no_val> m_Deadline;
    bool m_DeadlineIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Delay_boot;
    bool m_Delay_bootIsSet;
    utility::string_t m_Dependency;
    bool m_DependencyIsSet;
    std::shared_ptr<V0_0_40_process_exit_code_verbose> m_Derived_exit_code;
    bool m_Derived_exit_codeIsSet;
    std::shared_ptr<V0_0_40_uint64_no_val> m_Eligible_time;
    ...
    std::shared_ptr<V0_0_40_process_exit_code_verbose> m_Exit_code;
    ...
    std::shared_ptr<V0_0_40_uint32_no_val> m_Het_job_id;
    bool m_Het_job_idIsSet;
    utility::string_t m_Het_job_id_set;
    bool m_Het_job_id_setIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Het_job_offset;
    bool m_Het_job_offsetIsSet;
    int32_t m_Job_id;
    bool m_Job_idIsSet;
    std::shared_ptr<V0_0_40_job_res> m_Job_resources;
    ...
    std::shared_ptr<V0_0_40_uint64_no_val> m_Last_sched_evaluation;
    ...
    std::shared_ptr<V0_0_40_uint32_no_val> m_Max_cpus;
    bool m_Max_cpusIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Max_nodes;
    ...
    int32_t m_Nice;
    bool m_NiceIsSet;
    std::shared_ptr<V0_0_40_uint16_no_val> m_Tasks_per_core;
    bool m_Tasks_per_coreIsSet;
    std::shared_ptr<V0_0_40_uint16_no_val> m_Tasks_per_tres;
    bool m_Tasks_per_tresIsSet;
    std::shared_ptr<V0_0_40_uint16_no_val> m_Tasks_per_node;
    bool m_Tasks_per_nodeIsSet;
    std::shared_ptr<V0_0_40_uint16_no_val> m_Tasks_per_socket;
    bool m_Tasks_per_socketIsSet;
    std::shared_ptr<V0_0_40_uint16_no_val> m_Tasks_per_board;
    bool m_Tasks_per_boardIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Cpus;
    bool m_CpusIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Node_count;
    bool m_Node_countIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Tasks;
    bool m_TasksIsSet;
    ...
    std::shared_ptr<V0_0_40_uint16_no_val> m_Minimum_cpus_per_node;
    bool m_Minimum_cpus_per_nodeIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Minimum_tmp_disk_per_node;
    bool m_Minimum_tmp_disk_per_nodeIsSet;
    std::shared_ptr<V0_0_40_job_info_power> m_Power;
    bool m_PowerIsSet;
    std::shared_ptr<V0_0_40_uint64_no_val> m_Preempt_time;
    bool m_Preempt_timeIsSet;
    std::shared_ptr<V0_0_40_uint64_no_val> m_Preemptable_time;
    bool m_Preemptable_timeIsSet;
    std::shared_ptr<V0_0_40_uint64_no_val> m_Pre_sus_time;
    ...
    bool m_Requeue;
    bool m_RequeueIsSet;
    std::shared_ptr<V0_0_40_uint64_no_val> m_Resize_time;
    ...
    std::shared_ptr<V0_0_40_uint16_no_val> m_Sockets_per_node;
    ...
    std::shared_ptr<V0_0_40_uint64_no_val> m_Submit_time;
    bool m_Submit_timeIsSet;
    std::shared_ptr<V0_0_40_uint64_no_val> m_Suspend_time;
    bool m_Suspend_timeIsSet;
    utility::string_t m_System_comment;
    bool m_System_commentIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Time_limit;
    bool m_Time_limitIsSet;
    std::shared_ptr<V0_0_40_uint32_no_val> m_Time_minimum;
    bool m_Time_minimumIsSet;
    std::shared_ptr<V0_0_40_uint16_no_val> m_Threads_per_core;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_job_info_H_ */
