...
/*
 * V0_0_40_job_desc_msg.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_job_desc_msg_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_job_desc_msg_H_
...
{
public:
    V0_0_40_job_desc_msg();
    virtual ~V0_0_40_job_desc_msg();
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint64_no_val> getBeginTime() const;
    bool beginTimeIsSet() const;
    void unsetBegin_time();

    void setBeginTime(const std::shared_ptr<V0_0_40_uint64_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_cron_entry> getCrontab() const;
    bool crontabIsSet() const;
    void unsetCrontab();

    void setCrontab(const std::shared_ptr<V0_0_40_cron_entry>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_job_desc_msg_rlimits> getRlimits() const;
    bool rlimitsIsSet() const;
    void unsetRlimits();

    void setRlimits(const std::shared_ptr<V0_0_40_job_desc_msg_rlimits>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint16_no_val> getKillWarningDelay() const;
    bool killWarningDelayIsSet() const;
    void unsetKill_warning_delay();

    void setKillWarningDelay(const std::shared_ptr<V0_0_40_uint16_no_val>& value);
    ...
    /// 
    /// </summary>
    std::shared_ptr<V0_0_40_uint32_no_val> getRequiredSwitches() const;
    bool requiredSwitchesIsSet() const;
    void unsetRequired_switches();

    void setRequiredSwitches(const std::shared_ptr<V0_0_40_uint32_no_val>& value);
...
protected:
    ...
    std::shared_ptr<V0_0_40_uint64_no_val> m_Begin_time;
    ...
    std::shared_ptr<V0_0_40_cron_entry> m_Crontab;
    bool m_CrontabIsSet;
    int64_t m_Deadline;
    ...
    std::shared_ptr<V0_0_40_job_desc_msg_rlimits> m_Rlimits;
    bool m_RlimitsIsSet;
    ...
    std::shared_ptr<V0_0_40_uint16_no_val> m_Kill_warning_delay;
    ...
    std::shared_ptr<V0_0_40_uint32_no_val> m_Required_switches;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_V0_0_40_job_desc_msg_H_ */
