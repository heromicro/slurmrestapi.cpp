...
std::vector<std::shared_ptr<V0_0_39_tres>>& V0_0_39_job_tres::getAllocated()
{
    return m_Allocated;
}

void V0_0_39_job_tres::setAllocated(const std::vector<std::shared_ptr<V0_0_39_tres>>& value)
{
    m_Allocated = value;
    m_AllocatedIsSet = true;
}

bool V0_0_39_job_tres::allocatedIsSet() const
{
    return m_AllocatedIsSet;
}

void V0_0_39_job_tres::unsetAllocated()
{
    m_AllocatedIsSet = false;
}
