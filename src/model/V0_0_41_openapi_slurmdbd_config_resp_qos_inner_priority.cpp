...
V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::toJson() const
{
...
bool V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int32_t V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_priority::unsetnumber()
{
    m_numberIsSet = false;
}
}
