...
std::vector<std::shared_ptr<V0_0_40_stats_msg_rpcs_by_type_inner>>& V0_0_39_stats_msg::getRpcsByMessageType()
{
    return m_Rpcs_by_message_type;
}

void V0_0_39_stats_msg::setRpcsByMessageType(const std::vector<std::shared_ptr<V0_0_40_stats_msg_rpcs_by_type_inner>>& value)
{
...
std::vector<std::shared_ptr<V0_0_40_stats_msg_rpcs_by_user_inner>>& V0_0_39_stats_msg::getRpcsByUser()
{
    return m_Rpcs_by_user;
}

void V0_0_39_stats_msg::setRpcsByUser(const std::vector<std::shared_ptr<V0_0_40_stats_msg_rpcs_by_user_inner>>& value)
{
