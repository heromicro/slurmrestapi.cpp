...
#include "slurmrestapi/model/V0_0_39_stats_msg.h"
...
V0_0_39_stats_msg::V0_0_39_stats_msg()
{
    m_Parts_packed = 0;
...
void V0_0_39_stats_msg::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_stats_msg::toJson() const
{
...
bool V0_0_39_stats_msg::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("req_time_start"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            int64_t refVal_setReqTimeStart;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("bf_when_last_cycle"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            int64_t refVal_setBfWhenLastCycle;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("rpcs_by_message_type"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_39_stats_msg_rpcs_by_type_inner>> refVal_setRpcsByMessageType;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("rpcs_by_user"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_39_stats_msg_rpcs_by_user_inner>> refVal_setRpcsByUser;
...
void V0_0_39_stats_msg::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_stats_msg::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_39_stats_msg::getPartsPacked() const
{
    return m_Parts_packed;
}

void V0_0_39_stats_msg::setPartsPacked(int32_t value)
{
    m_Parts_packed = value;
    m_Parts_packedIsSet = true;
}

bool V0_0_39_stats_msg::partsPackedIsSet() const
{
    return m_Parts_packedIsSet;
}

void V0_0_39_stats_msg::unsetParts_packed()
{
    m_Parts_packedIsSet = false;
}
int64_t V0_0_39_stats_msg::getReqTime() const
{
    return m_Req_time;
}

void V0_0_39_stats_msg::setReqTime(int64_t value)
{
    m_Req_time = value;
    m_Req_timeIsSet = true;
}

bool V0_0_39_stats_msg::reqTimeIsSet() const
{
    return m_Req_timeIsSet;
}

void V0_0_39_stats_msg::unsetReq_time()
{
    m_Req_timeIsSet = false;
}
int64_t V0_0_39_stats_msg::getReqTimeStart() const
{
    return m_Req_time_start;
}

void V0_0_39_stats_msg::setReqTimeStart(int64_t value)
{
    m_Req_time_start = value;
    m_Req_time_startIsSet = true;
}

bool V0_0_39_stats_msg::reqTimeStartIsSet() const
{
    return m_Req_time_startIsSet;
}

void V0_0_39_stats_msg::unsetReq_time_start()
{
    m_Req_time_startIsSet = false;
}
int32_t V0_0_39_stats_msg::getServerThreadCount() const
{
    return m_Server_thread_count;
}

void V0_0_39_stats_msg::setServerThreadCount(int32_t value)
{
    m_Server_thread_count = value;
    m_Server_thread_countIsSet = true;
}

bool V0_0_39_stats_msg::serverThreadCountIsSet() const
{
    return m_Server_thread_countIsSet;
}

void V0_0_39_stats_msg::unsetServer_thread_count()
{
    m_Server_thread_countIsSet = false;
}
int32_t V0_0_39_stats_msg::getAgentQueueSize() const
{
    return m_Agent_queue_size;
}

void V0_0_39_stats_msg::setAgentQueueSize(int32_t value)
{
    m_Agent_queue_size = value;
    m_Agent_queue_sizeIsSet = true;
}

bool V0_0_39_stats_msg::agentQueueSizeIsSet() const
{
    return m_Agent_queue_sizeIsSet;
}

void V0_0_39_stats_msg::unsetAgent_queue_size()
{
    m_Agent_queue_sizeIsSet = false;
}
int32_t V0_0_39_stats_msg::getAgentCount() const
{
    return m_Agent_count;
}

void V0_0_39_stats_msg::setAgentCount(int32_t value)
{
    m_Agent_count = value;
    m_Agent_countIsSet = true;
}

bool V0_0_39_stats_msg::agentCountIsSet() const
{
    return m_Agent_countIsSet;
}

void V0_0_39_stats_msg::unsetAgent_count()
{
    m_Agent_countIsSet = false;
}
int32_t V0_0_39_stats_msg::getAgentThreadCount() const
{
    return m_Agent_thread_count;
}

void V0_0_39_stats_msg::setAgentThreadCount(int32_t value)
{
    m_Agent_thread_count = value;
    m_Agent_thread_countIsSet = true;
}

bool V0_0_39_stats_msg::agentThreadCountIsSet() const
{
    return m_Agent_thread_countIsSet;
}

void V0_0_39_stats_msg::unsetAgent_thread_count()
{
    m_Agent_thread_countIsSet = false;
}
int32_t V0_0_39_stats_msg::getDbdAgentQueueSize() const
{
    return m_Dbd_agent_queue_size;
}

void V0_0_39_stats_msg::setDbdAgentQueueSize(int32_t value)
{
    m_Dbd_agent_queue_size = value;
    m_Dbd_agent_queue_sizeIsSet = true;
}

bool V0_0_39_stats_msg::dbdAgentQueueSizeIsSet() const
{
    return m_Dbd_agent_queue_sizeIsSet;
}

void V0_0_39_stats_msg::unsetDbd_agent_queue_size()
{
    m_Dbd_agent_queue_sizeIsSet = false;
}
int32_t V0_0_39_stats_msg::getGettimeofdayLatency() const
{
    return m_Gettimeofday_latency;
}

void V0_0_39_stats_msg::setGettimeofdayLatency(int32_t value)
{
    m_Gettimeofday_latency = value;
    m_Gettimeofday_latencyIsSet = true;
}

bool V0_0_39_stats_msg::gettimeofdayLatencyIsSet() const
{
    return m_Gettimeofday_latencyIsSet;
}

void V0_0_39_stats_msg::unsetGettimeofday_latency()
{
    m_Gettimeofday_latencyIsSet = false;
}
int32_t V0_0_39_stats_msg::getScheduleCycleMax() const
{
    return m_Schedule_cycle_max;
}

void V0_0_39_stats_msg::setScheduleCycleMax(int32_t value)
{
    m_Schedule_cycle_max = value;
    m_Schedule_cycle_maxIsSet = true;
}

bool V0_0_39_stats_msg::scheduleCycleMaxIsSet() const
{
    return m_Schedule_cycle_maxIsSet;
}

void V0_0_39_stats_msg::unsetSchedule_cycle_max()
{
    m_Schedule_cycle_maxIsSet = false;
}
int32_t V0_0_39_stats_msg::getScheduleCycleLast() const
{
    return m_Schedule_cycle_last;
}

void V0_0_39_stats_msg::setScheduleCycleLast(int32_t value)
{
    m_Schedule_cycle_last = value;
    m_Schedule_cycle_lastIsSet = true;
}

bool V0_0_39_stats_msg::scheduleCycleLastIsSet() const
{
    return m_Schedule_cycle_lastIsSet;
}

void V0_0_39_stats_msg::unsetSchedule_cycle_last()
{
    m_Schedule_cycle_lastIsSet = false;
}
int32_t V0_0_39_stats_msg::getScheduleCycleTotal() const
{
    return m_Schedule_cycle_total;
}

void V0_0_39_stats_msg::setScheduleCycleTotal(int32_t value)
{
    m_Schedule_cycle_total = value;
    m_Schedule_cycle_totalIsSet = true;
}

bool V0_0_39_stats_msg::scheduleCycleTotalIsSet() const
{
    return m_Schedule_cycle_totalIsSet;
}

void V0_0_39_stats_msg::unsetSchedule_cycle_total()
{
    m_Schedule_cycle_totalIsSet = false;
}
int64_t V0_0_39_stats_msg::getScheduleCycleMean() const
{
    return m_Schedule_cycle_mean;
}

void V0_0_39_stats_msg::setScheduleCycleMean(int64_t value)
{
    m_Schedule_cycle_mean = value;
    m_Schedule_cycle_meanIsSet = true;
}

bool V0_0_39_stats_msg::scheduleCycleMeanIsSet() const
{
    return m_Schedule_cycle_meanIsSet;
}

void V0_0_39_stats_msg::unsetSchedule_cycle_mean()
{
    m_Schedule_cycle_meanIsSet = false;
}
int64_t V0_0_39_stats_msg::getScheduleCycleMeanDepth() const
{
    return m_Schedule_cycle_mean_depth;
}

void V0_0_39_stats_msg::setScheduleCycleMeanDepth(int64_t value)
{
    m_Schedule_cycle_mean_depth = value;
    m_Schedule_cycle_mean_depthIsSet = true;
}

bool V0_0_39_stats_msg::scheduleCycleMeanDepthIsSet() const
{
    return m_Schedule_cycle_mean_depthIsSet;
}

void V0_0_39_stats_msg::unsetSchedule_cycle_mean_depth()
{
    m_Schedule_cycle_mean_depthIsSet = false;
}
int64_t V0_0_39_stats_msg::getScheduleCyclePerMinute() const
{
    return m_Schedule_cycle_per_minute;
}

void V0_0_39_stats_msg::setScheduleCyclePerMinute(int64_t value)
{
    m_Schedule_cycle_per_minute = value;
    m_Schedule_cycle_per_minuteIsSet = true;
}

bool V0_0_39_stats_msg::scheduleCyclePerMinuteIsSet() const
{
    return m_Schedule_cycle_per_minuteIsSet;
}

void V0_0_39_stats_msg::unsetSchedule_cycle_per_minute()
{
    m_Schedule_cycle_per_minuteIsSet = false;
}
int32_t V0_0_39_stats_msg::getScheduleQueueLength() const
{
    return m_Schedule_queue_length;
}

void V0_0_39_stats_msg::setScheduleQueueLength(int32_t value)
{
    m_Schedule_queue_length = value;
    m_Schedule_queue_lengthIsSet = true;
}

bool V0_0_39_stats_msg::scheduleQueueLengthIsSet() const
{
    return m_Schedule_queue_lengthIsSet;
}

void V0_0_39_stats_msg::unsetSchedule_queue_length()
{
    m_Schedule_queue_lengthIsSet = false;
}
int32_t V0_0_39_stats_msg::getJobsSubmitted() const
{
    return m_Jobs_submitted;
}

void V0_0_39_stats_msg::setJobsSubmitted(int32_t value)
{
    m_Jobs_submitted = value;
    m_Jobs_submittedIsSet = true;
}

bool V0_0_39_stats_msg::jobsSubmittedIsSet() const
{
    return m_Jobs_submittedIsSet;
}

void V0_0_39_stats_msg::unsetJobs_submitted()
{
    m_Jobs_submittedIsSet = false;
}
int32_t V0_0_39_stats_msg::getJobsStarted() const
{
    return m_Jobs_started;
}

void V0_0_39_stats_msg::setJobsStarted(int32_t value)
{
    m_Jobs_started = value;
    m_Jobs_startedIsSet = true;
}

bool V0_0_39_stats_msg::jobsStartedIsSet() const
{
    return m_Jobs_startedIsSet;
}

void V0_0_39_stats_msg::unsetJobs_started()
{
    m_Jobs_startedIsSet = false;
}
int32_t V0_0_39_stats_msg::getJobsCompleted() const
{
    return m_Jobs_completed;
}

void V0_0_39_stats_msg::setJobsCompleted(int32_t value)
{
    m_Jobs_completed = value;
    m_Jobs_completedIsSet = true;
}

bool V0_0_39_stats_msg::jobsCompletedIsSet() const
{
    return m_Jobs_completedIsSet;
}

void V0_0_39_stats_msg::unsetJobs_completed()
{
    m_Jobs_completedIsSet = false;
}
int32_t V0_0_39_stats_msg::getJobsCanceled() const
{
    return m_Jobs_canceled;
}

void V0_0_39_stats_msg::setJobsCanceled(int32_t value)
{
    m_Jobs_canceled = value;
    m_Jobs_canceledIsSet = true;
}

bool V0_0_39_stats_msg::jobsCanceledIsSet() const
{
    return m_Jobs_canceledIsSet;
}

void V0_0_39_stats_msg::unsetJobs_canceled()
{
    m_Jobs_canceledIsSet = false;
}
int32_t V0_0_39_stats_msg::getJobsFailed() const
{
    return m_Jobs_failed;
}

void V0_0_39_stats_msg::setJobsFailed(int32_t value)
{
    m_Jobs_failed = value;
    m_Jobs_failedIsSet = true;
}

bool V0_0_39_stats_msg::jobsFailedIsSet() const
{
    return m_Jobs_failedIsSet;
}

void V0_0_39_stats_msg::unsetJobs_failed()
{
    m_Jobs_failedIsSet = false;
}
int32_t V0_0_39_stats_msg::getJobsPending() const
{
    return m_Jobs_pending;
}

void V0_0_39_stats_msg::setJobsPending(int32_t value)
{
    m_Jobs_pending = value;
    m_Jobs_pendingIsSet = true;
}

bool V0_0_39_stats_msg::jobsPendingIsSet() const
{
    return m_Jobs_pendingIsSet;
}

void V0_0_39_stats_msg::unsetJobs_pending()
{
    m_Jobs_pendingIsSet = false;
}
int32_t V0_0_39_stats_msg::getJobsRunning() const
{
    return m_Jobs_running;
}

void V0_0_39_stats_msg::setJobsRunning(int32_t value)
{
    m_Jobs_running = value;
    m_Jobs_runningIsSet = true;
}

bool V0_0_39_stats_msg::jobsRunningIsSet() const
{
    return m_Jobs_runningIsSet;
}

void V0_0_39_stats_msg::unsetJobs_running()
{
    m_Jobs_runningIsSet = false;
}
int64_t V0_0_39_stats_msg::getJobStatesTs() const
{
    return m_Job_states_ts;
}

void V0_0_39_stats_msg::setJobStatesTs(int64_t value)
{
    m_Job_states_ts = value;
    m_Job_states_tsIsSet = true;
}

bool V0_0_39_stats_msg::jobStatesTsIsSet() const
{
    return m_Job_states_tsIsSet;
}

void V0_0_39_stats_msg::unsetJob_states_ts()
{
    m_Job_states_tsIsSet = false;
}
int32_t V0_0_39_stats_msg::getBfBackfilledJobs() const
{
    return m_Bf_backfilled_jobs;
}

void V0_0_39_stats_msg::setBfBackfilledJobs(int32_t value)
{
    m_Bf_backfilled_jobs = value;
    m_Bf_backfilled_jobsIsSet = true;
}

bool V0_0_39_stats_msg::bfBackfilledJobsIsSet() const
{
    return m_Bf_backfilled_jobsIsSet;
}

void V0_0_39_stats_msg::unsetBf_backfilled_jobs()
{
    m_Bf_backfilled_jobsIsSet = false;
}
int32_t V0_0_39_stats_msg::getBfLastBackfilledJobs() const
{
    return m_Bf_last_backfilled_jobs;
}

void V0_0_39_stats_msg::setBfLastBackfilledJobs(int32_t value)
{
    m_Bf_last_backfilled_jobs = value;
    m_Bf_last_backfilled_jobsIsSet = true;
}

bool V0_0_39_stats_msg::bfLastBackfilledJobsIsSet() const
{
    return m_Bf_last_backfilled_jobsIsSet;
}

void V0_0_39_stats_msg::unsetBf_last_backfilled_jobs()
{
    m_Bf_last_backfilled_jobsIsSet = false;
}
int32_t V0_0_39_stats_msg::getBfBackfilledHetJobs() const
{
    return m_Bf_backfilled_het_jobs;
}

void V0_0_39_stats_msg::setBfBackfilledHetJobs(int32_t value)
{
    m_Bf_backfilled_het_jobs = value;
    m_Bf_backfilled_het_jobsIsSet = true;
}

bool V0_0_39_stats_msg::bfBackfilledHetJobsIsSet() const
{
    return m_Bf_backfilled_het_jobsIsSet;
}

void V0_0_39_stats_msg::unsetBf_backfilled_het_jobs()
{
    m_Bf_backfilled_het_jobsIsSet = false;
}
int32_t V0_0_39_stats_msg::getBfCycleCounter() const
{
    return m_Bf_cycle_counter;
}

void V0_0_39_stats_msg::setBfCycleCounter(int32_t value)
{
    m_Bf_cycle_counter = value;
    m_Bf_cycle_counterIsSet = true;
}

bool V0_0_39_stats_msg::bfCycleCounterIsSet() const
{
    return m_Bf_cycle_counterIsSet;
}

void V0_0_39_stats_msg::unsetBf_cycle_counter()
{
    m_Bf_cycle_counterIsSet = false;
}
int64_t V0_0_39_stats_msg::getBfCycleMean() const
{
    return m_Bf_cycle_mean;
}

void V0_0_39_stats_msg::setBfCycleMean(int64_t value)
{
    m_Bf_cycle_mean = value;
    m_Bf_cycle_meanIsSet = true;
}

bool V0_0_39_stats_msg::bfCycleMeanIsSet() const
{
    return m_Bf_cycle_meanIsSet;
}

void V0_0_39_stats_msg::unsetBf_cycle_mean()
{
    m_Bf_cycle_meanIsSet = false;
}
int64_t V0_0_39_stats_msg::getBfDepthMean() const
{
    return m_Bf_depth_mean;
}

void V0_0_39_stats_msg::setBfDepthMean(int64_t value)
{
    m_Bf_depth_mean = value;
    m_Bf_depth_meanIsSet = true;
}

bool V0_0_39_stats_msg::bfDepthMeanIsSet() const
{
    return m_Bf_depth_meanIsSet;
}

void V0_0_39_stats_msg::unsetBf_depth_mean()
{
    m_Bf_depth_meanIsSet = false;
}
int64_t V0_0_39_stats_msg::getBfDepthMeanTry() const
{
    return m_Bf_depth_mean_try;
}

void V0_0_39_stats_msg::setBfDepthMeanTry(int64_t value)
{
    m_Bf_depth_mean_try = value;
    m_Bf_depth_mean_tryIsSet = true;
}

bool V0_0_39_stats_msg::bfDepthMeanTryIsSet() const
{
    return m_Bf_depth_mean_tryIsSet;
}

void V0_0_39_stats_msg::unsetBf_depth_mean_try()
{
    m_Bf_depth_mean_tryIsSet = false;
}
int64_t V0_0_39_stats_msg::getBfCycleSum() const
{
    return m_Bf_cycle_sum;
}

void V0_0_39_stats_msg::setBfCycleSum(int64_t value)
{
    m_Bf_cycle_sum = value;
    m_Bf_cycle_sumIsSet = true;
}

bool V0_0_39_stats_msg::bfCycleSumIsSet() const
{
    return m_Bf_cycle_sumIsSet;
}

void V0_0_39_stats_msg::unsetBf_cycle_sum()
{
    m_Bf_cycle_sumIsSet = false;
}
int32_t V0_0_39_stats_msg::getBfCycleLast() const
{
    return m_Bf_cycle_last;
}

void V0_0_39_stats_msg::setBfCycleLast(int32_t value)
{
    m_Bf_cycle_last = value;
    m_Bf_cycle_lastIsSet = true;
}

bool V0_0_39_stats_msg::bfCycleLastIsSet() const
{
    return m_Bf_cycle_lastIsSet;
}

void V0_0_39_stats_msg::unsetBf_cycle_last()
{
    m_Bf_cycle_lastIsSet = false;
}
int32_t V0_0_39_stats_msg::getBfLastDepth() const
{
    return m_Bf_last_depth;
}

void V0_0_39_stats_msg::setBfLastDepth(int32_t value)
{
    m_Bf_last_depth = value;
    m_Bf_last_depthIsSet = true;
}

bool V0_0_39_stats_msg::bfLastDepthIsSet() const
{
    return m_Bf_last_depthIsSet;
}

void V0_0_39_stats_msg::unsetBf_last_depth()
{
    m_Bf_last_depthIsSet = false;
}
int32_t V0_0_39_stats_msg::getBfLastDepthTry() const
{
    return m_Bf_last_depth_try;
}

void V0_0_39_stats_msg::setBfLastDepthTry(int32_t value)
{
    m_Bf_last_depth_try = value;
    m_Bf_last_depth_tryIsSet = true;
}

bool V0_0_39_stats_msg::bfLastDepthTryIsSet() const
{
    return m_Bf_last_depth_tryIsSet;
}

void V0_0_39_stats_msg::unsetBf_last_depth_try()
{
    m_Bf_last_depth_tryIsSet = false;
}
int32_t V0_0_39_stats_msg::getBfDepthSum() const
{
    return m_Bf_depth_sum;
}

void V0_0_39_stats_msg::setBfDepthSum(int32_t value)
{
    m_Bf_depth_sum = value;
    m_Bf_depth_sumIsSet = true;
}

bool V0_0_39_stats_msg::bfDepthSumIsSet() const
{
    return m_Bf_depth_sumIsSet;
}

void V0_0_39_stats_msg::unsetBf_depth_sum()
{
    m_Bf_depth_sumIsSet = false;
}
int32_t V0_0_39_stats_msg::getBfDepthTrySum() const
{
    return m_Bf_depth_try_sum;
}

void V0_0_39_stats_msg::setBfDepthTrySum(int32_t value)
{
    m_Bf_depth_try_sum = value;
    m_Bf_depth_try_sumIsSet = true;
}

bool V0_0_39_stats_msg::bfDepthTrySumIsSet() const
{
    return m_Bf_depth_try_sumIsSet;
}

void V0_0_39_stats_msg::unsetBf_depth_try_sum()
{
    m_Bf_depth_try_sumIsSet = false;
}
int32_t V0_0_39_stats_msg::getBfQueueLen() const
{
    return m_Bf_queue_len;
}

void V0_0_39_stats_msg::setBfQueueLen(int32_t value)
{
    m_Bf_queue_len = value;
    m_Bf_queue_lenIsSet = true;
}

bool V0_0_39_stats_msg::bfQueueLenIsSet() const
{
    return m_Bf_queue_lenIsSet;
}

void V0_0_39_stats_msg::unsetBf_queue_len()
{
    m_Bf_queue_lenIsSet = false;
}
int64_t V0_0_39_stats_msg::getBfQueueLenMean() const
{
    return m_Bf_queue_len_mean;
}

void V0_0_39_stats_msg::setBfQueueLenMean(int64_t value)
{
    m_Bf_queue_len_mean = value;
    m_Bf_queue_len_meanIsSet = true;
}

bool V0_0_39_stats_msg::bfQueueLenMeanIsSet() const
{
    return m_Bf_queue_len_meanIsSet;
}

void V0_0_39_stats_msg::unsetBf_queue_len_mean()
{
    m_Bf_queue_len_meanIsSet = false;
}
int32_t V0_0_39_stats_msg::getBfQueueLenSum() const
{
    return m_Bf_queue_len_sum;
}

void V0_0_39_stats_msg::setBfQueueLenSum(int32_t value)
{
    m_Bf_queue_len_sum = value;
    m_Bf_queue_len_sumIsSet = true;
}

bool V0_0_39_stats_msg::bfQueueLenSumIsSet() const
{
    return m_Bf_queue_len_sumIsSet;
}

void V0_0_39_stats_msg::unsetBf_queue_len_sum()
{
    m_Bf_queue_len_sumIsSet = false;
}
int32_t V0_0_39_stats_msg::getBfTableSize() const
{
    return m_Bf_table_size;
}

void V0_0_39_stats_msg::setBfTableSize(int32_t value)
{
    m_Bf_table_size = value;
    m_Bf_table_sizeIsSet = true;
}

bool V0_0_39_stats_msg::bfTableSizeIsSet() const
{
    return m_Bf_table_sizeIsSet;
}

void V0_0_39_stats_msg::unsetBf_table_size()
{
    m_Bf_table_sizeIsSet = false;
}
int64_t V0_0_39_stats_msg::getBfTableSizeMean() const
{
    return m_Bf_table_size_mean;
}

void V0_0_39_stats_msg::setBfTableSizeMean(int64_t value)
{
    m_Bf_table_size_mean = value;
    m_Bf_table_size_meanIsSet = true;
}

bool V0_0_39_stats_msg::bfTableSizeMeanIsSet() const
{
    return m_Bf_table_size_meanIsSet;
}

void V0_0_39_stats_msg::unsetBf_table_size_mean()
{
    m_Bf_table_size_meanIsSet = false;
}
int64_t V0_0_39_stats_msg::getBfWhenLastCycle() const
{
    return m_Bf_when_last_cycle;
}

void V0_0_39_stats_msg::setBfWhenLastCycle(int64_t value)
{
    m_Bf_when_last_cycle = value;
    m_Bf_when_last_cycleIsSet = true;
}

bool V0_0_39_stats_msg::bfWhenLastCycleIsSet() const
{
    return m_Bf_when_last_cycleIsSet;
}

void V0_0_39_stats_msg::unsetBf_when_last_cycle()
{
    m_Bf_when_last_cycleIsSet = false;
}
bool V0_0_39_stats_msg::isBfActive() const
{
    return m_Bf_active;
}

void V0_0_39_stats_msg::setBfActive(bool value)
{
    m_Bf_active = value;
    m_Bf_activeIsSet = true;
}

bool V0_0_39_stats_msg::bfActiveIsSet() const
{
    return m_Bf_activeIsSet;
}

void V0_0_39_stats_msg::unsetBf_active()
{
    m_Bf_activeIsSet = false;
}
std::vector<std::shared_ptr<V0_0_39_stats_msg_rpcs_by_type_inner>>& V0_0_39_stats_msg::getRpcsByMessageType()
{
    return m_Rpcs_by_message_type;
}

void V0_0_39_stats_msg::setRpcsByMessageType(const std::vector<std::shared_ptr<V0_0_39_stats_msg_rpcs_by_type_inner>>& value)
{
    m_Rpcs_by_message_type = value;
    m_Rpcs_by_message_typeIsSet = true;
}

bool V0_0_39_stats_msg::rpcsByMessageTypeIsSet() const
{
    return m_Rpcs_by_message_typeIsSet;
}

void V0_0_39_stats_msg::unsetRpcs_by_message_type()
{
    m_Rpcs_by_message_typeIsSet = false;
}
std::vector<std::shared_ptr<V0_0_39_stats_msg_rpcs_by_user_inner>>& V0_0_39_stats_msg::getRpcsByUser()
{
    return m_Rpcs_by_user;
}

void V0_0_39_stats_msg::setRpcsByUser(const std::vector<std::shared_ptr<V0_0_39_stats_msg_rpcs_by_user_inner>>& value)
{
    m_Rpcs_by_user = value;
    m_Rpcs_by_userIsSet = true;
}

bool V0_0_39_stats_msg::rpcsByUserIsSet() const
{
    return m_Rpcs_by_userIsSet;
}

void V0_0_39_stats_msg::unsetRpcs_by_user()
{
    m_Rpcs_by_userIsSet = false;
}
}
