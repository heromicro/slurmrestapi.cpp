...
void V0_0_38_node::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_38_node::toJson() const
{
...
bool V0_0_38_node::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_38_node::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_38_node::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_38_node::getArchitecture() const
{
    return m_Architecture;
}

void V0_0_38_node::setArchitecture(const utility::string_t& value)
{
    m_Architecture = value;
    m_ArchitectureIsSet = true;
}

bool V0_0_38_node::architectureIsSet() const
{
    return m_ArchitectureIsSet;
}

void V0_0_38_node::unsetArchitecture()
{
    m_ArchitectureIsSet = false;
}
utility::string_t V0_0_38_node::getBurstbufferNetworkAddress() const
{
    return m_Burstbuffer_network_address;
}

void V0_0_38_node::setBurstbufferNetworkAddress(const utility::string_t& value)
{
    m_Burstbuffer_network_address = value;
    m_Burstbuffer_network_addressIsSet = true;
}

bool V0_0_38_node::burstbufferNetworkAddressIsSet() const
{
    return m_Burstbuffer_network_addressIsSet;
}

void V0_0_38_node::unsetBurstbuffer_network_address()
{
    m_Burstbuffer_network_addressIsSet = false;
}
int32_t V0_0_38_node::getBoards() const
{
    return m_Boards;
}

void V0_0_38_node::setBoards(int32_t value)
{
    m_Boards = value;
    m_BoardsIsSet = true;
}

bool V0_0_38_node::boardsIsSet() const
{
    return m_BoardsIsSet;
}

void V0_0_38_node::unsetBoards()
{
    m_BoardsIsSet = false;
}
int64_t V0_0_38_node::getBootTime() const
{
    return m_Boot_time;
}

void V0_0_38_node::setBootTime(int64_t value)
{
    m_Boot_time = value;
    m_Boot_timeIsSet = true;
}

bool V0_0_38_node::bootTimeIsSet() const
{
    return m_Boot_timeIsSet;
}

void V0_0_38_node::unsetBoot_time()
{
    m_Boot_timeIsSet = false;
}
int32_t V0_0_38_node::getCores() const
{
    return m_Cores;
}

void V0_0_38_node::setCores(int32_t value)
{
    m_Cores = value;
    m_CoresIsSet = true;
}

bool V0_0_38_node::coresIsSet() const
{
    return m_CoresIsSet;
}

void V0_0_38_node::unsetCores()
{
    m_CoresIsSet = false;
}
int32_t V0_0_38_node::getCpuBinding() const
{
    return m_Cpu_binding;
}

void V0_0_38_node::setCpuBinding(int32_t value)
{
    m_Cpu_binding = value;
    m_Cpu_bindingIsSet = true;
}

bool V0_0_38_node::cpuBindingIsSet() const
{
    return m_Cpu_bindingIsSet;
}

void V0_0_38_node::unsetCpu_binding()
{
    m_Cpu_bindingIsSet = false;
}
int64_t V0_0_38_node::getCpuLoad() const
{
    return m_Cpu_load;
}

void V0_0_38_node::setCpuLoad(int64_t value)
{
    m_Cpu_load = value;
    m_Cpu_loadIsSet = true;
}

bool V0_0_38_node::cpuLoadIsSet() const
{
    return m_Cpu_loadIsSet;
}

void V0_0_38_node::unsetCpu_load()
{
    m_Cpu_loadIsSet = false;
}
int32_t V0_0_38_node::getFreeMemory() const
{
    return m_Free_memory;
}

void V0_0_38_node::setFreeMemory(int32_t value)
{
    m_Free_memory = value;
    m_Free_memoryIsSet = true;
}

bool V0_0_38_node::freeMemoryIsSet() const
{
    return m_Free_memoryIsSet;
}

void V0_0_38_node::unsetFree_memory()
{
    m_Free_memoryIsSet = false;
}
int32_t V0_0_38_node::getCpus() const
{
    return m_Cpus;
}

void V0_0_38_node::setCpus(int32_t value)
{
    m_Cpus = value;
    m_CpusIsSet = true;
}

bool V0_0_38_node::cpusIsSet() const
{
    return m_CpusIsSet;
}

void V0_0_38_node::unsetCpus()
{
    m_CpusIsSet = false;
}
utility::string_t V0_0_38_node::getFeatures() const
{
    return m_Features;
}

void V0_0_38_node::setFeatures(const utility::string_t& value)
{
    m_Features = value;
    m_FeaturesIsSet = true;
}

bool V0_0_38_node::featuresIsSet() const
{
    return m_FeaturesIsSet;
}

void V0_0_38_node::unsetFeatures()
{
    m_FeaturesIsSet = false;
}
utility::string_t V0_0_38_node::getActiveFeatures() const
{
    return m_Active_features;
}

void V0_0_38_node::setActiveFeatures(const utility::string_t& value)
{
    m_Active_features = value;
    m_Active_featuresIsSet = true;
}

bool V0_0_38_node::activeFeaturesIsSet() const
{
    return m_Active_featuresIsSet;
}

void V0_0_38_node::unsetActive_features()
{
    m_Active_featuresIsSet = false;
}
utility::string_t V0_0_38_node::getGres() const
{
    return m_Gres;
}

void V0_0_38_node::setGres(const utility::string_t& value)
{
    m_Gres = value;
    m_GresIsSet = true;
}

bool V0_0_38_node::gresIsSet() const
{
    return m_GresIsSet;
}

void V0_0_38_node::unsetGres()
{
    m_GresIsSet = false;
}
utility::string_t V0_0_38_node::getGresDrained() const
{
    return m_Gres_drained;
}

void V0_0_38_node::setGresDrained(const utility::string_t& value)
{
    m_Gres_drained = value;
    m_Gres_drainedIsSet = true;
}

bool V0_0_38_node::gresDrainedIsSet() const
{
    return m_Gres_drainedIsSet;
}

void V0_0_38_node::unsetGres_drained()
{
    m_Gres_drainedIsSet = false;
}
utility::string_t V0_0_38_node::getGresUsed() const
{
    return m_Gres_used;
}

void V0_0_38_node::setGresUsed(const utility::string_t& value)
{
    m_Gres_used = value;
    m_Gres_usedIsSet = true;
}

bool V0_0_38_node::gresUsedIsSet() const
{
    return m_Gres_usedIsSet;
}

void V0_0_38_node::unsetGres_used()
{
    m_Gres_usedIsSet = false;
}
utility::string_t V0_0_38_node::getMcsLabel() const
{
    return m_Mcs_label;
}

void V0_0_38_node::setMcsLabel(const utility::string_t& value)
{
    m_Mcs_label = value;
    m_Mcs_labelIsSet = true;
}

bool V0_0_38_node::mcsLabelIsSet() const
{
    return m_Mcs_labelIsSet;
}

void V0_0_38_node::unsetMcs_label()
{
    m_Mcs_labelIsSet = false;
}
utility::string_t V0_0_38_node::getName() const
{
    return m_Name;
}

void V0_0_38_node::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_38_node::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_38_node::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t V0_0_38_node::getNextStateAfterReboot() const
{
    return m_Next_state_after_reboot;
}

void V0_0_38_node::setNextStateAfterReboot(const utility::string_t& value)
{
    m_Next_state_after_reboot = value;
    m_Next_state_after_rebootIsSet = true;
}

bool V0_0_38_node::nextStateAfterRebootIsSet() const
{
    return m_Next_state_after_rebootIsSet;
}

void V0_0_38_node::unsetNext_state_after_reboot()
{
    m_Next_state_after_rebootIsSet = false;
}
std::vector<utility::string_t>& V0_0_38_node::getNextStateAfterRebootFlags()
{
    return m_Next_state_after_reboot_flags;
}

void V0_0_38_node::setNextStateAfterRebootFlags(const std::vector<utility::string_t>& value)
{
    m_Next_state_after_reboot_flags = value;
    m_Next_state_after_reboot_flagsIsSet = true;
}

bool V0_0_38_node::nextStateAfterRebootFlagsIsSet() const
{
    return m_Next_state_after_reboot_flagsIsSet;
}

void V0_0_38_node::unsetNext_state_after_reboot_flags()
{
    m_Next_state_after_reboot_flagsIsSet = false;
}
utility::string_t V0_0_38_node::getAddress() const
{
    return m_Address;
}

void V0_0_38_node::setAddress(const utility::string_t& value)
{
    m_Address = value;
    m_AddressIsSet = true;
}

bool V0_0_38_node::addressIsSet() const
{
    return m_AddressIsSet;
}

void V0_0_38_node::unsetAddress()
{
    m_AddressIsSet = false;
}
utility::string_t V0_0_38_node::getHostname() const
{
    return m_Hostname;
}

void V0_0_38_node::setHostname(const utility::string_t& value)
{
    m_Hostname = value;
    m_HostnameIsSet = true;
}

bool V0_0_38_node::hostnameIsSet() const
{
    return m_HostnameIsSet;
}

void V0_0_38_node::unsetHostname()
{
    m_HostnameIsSet = false;
}
utility::string_t V0_0_38_node::getState() const
{
    return m_State;
}

void V0_0_38_node::setState(const utility::string_t& value)
{
    m_State = value;
    m_StateIsSet = true;
}

bool V0_0_38_node::stateIsSet() const
{
    return m_StateIsSet;
}

void V0_0_38_node::unsetState()
{
    m_StateIsSet = false;
}
std::vector<utility::string_t>& V0_0_38_node::getStateFlags()
{
    return m_State_flags;
}

void V0_0_38_node::setStateFlags(const std::vector<utility::string_t>& value)
{
    m_State_flags = value;
    m_State_flagsIsSet = true;
}

bool V0_0_38_node::stateFlagsIsSet() const
{
    return m_State_flagsIsSet;
}

void V0_0_38_node::unsetState_flags()
{
    m_State_flagsIsSet = false;
}
utility::string_t V0_0_38_node::getOperatingSystem() const
{
    return m_Operating_system;
}

void V0_0_38_node::setOperatingSystem(const utility::string_t& value)
{
    m_Operating_system = value;
    m_Operating_systemIsSet = true;
}

bool V0_0_38_node::operatingSystemIsSet() const
{
    return m_Operating_systemIsSet;
}

void V0_0_38_node::unsetOperating_system()
{
    m_Operating_systemIsSet = false;
}
utility::string_t V0_0_38_node::getOwner() const
{
    return m_Owner;
}

void V0_0_38_node::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool V0_0_38_node::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void V0_0_38_node::unsetOwner()
{
    m_OwnerIsSet = false;
}
std::vector<utility::string_t>& V0_0_38_node::getPartitions()
{
    return m_Partitions;
}

void V0_0_38_node::setPartitions(const std::vector<utility::string_t>& value)
{
    m_Partitions = value;
    m_PartitionsIsSet = true;
}

bool V0_0_38_node::partitionsIsSet() const
{
    return m_PartitionsIsSet;
}

void V0_0_38_node::unsetPartitions()
{
    m_PartitionsIsSet = false;
}
int32_t V0_0_38_node::getPort() const
{
    return m_Port;
}

void V0_0_38_node::setPort(int32_t value)
{
    m_Port = value;
    m_PortIsSet = true;
}

bool V0_0_38_node::portIsSet() const
{
    return m_PortIsSet;
}

void V0_0_38_node::unsetPort()
{
    m_PortIsSet = false;
}
int32_t V0_0_38_node::getRealMemory() const
{
    return m_Real_memory;
}

void V0_0_38_node::setRealMemory(int32_t value)
{
    m_Real_memory = value;
    m_Real_memoryIsSet = true;
}

bool V0_0_38_node::realMemoryIsSet() const
{
    return m_Real_memoryIsSet;
}

void V0_0_38_node::unsetReal_memory()
{
    m_Real_memoryIsSet = false;
}
utility::string_t V0_0_38_node::getReason() const
{
    return m_Reason;
}

void V0_0_38_node::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool V0_0_38_node::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void V0_0_38_node::unsetReason()
{
    m_ReasonIsSet = false;
}
int32_t V0_0_38_node::getReasonChangedAt() const
{
    return m_Reason_changed_at;
}

void V0_0_38_node::setReasonChangedAt(int32_t value)
{
    m_Reason_changed_at = value;
    m_Reason_changed_atIsSet = true;
}

bool V0_0_38_node::reasonChangedAtIsSet() const
{
    return m_Reason_changed_atIsSet;
}

void V0_0_38_node::unsetReason_changed_at()
{
    m_Reason_changed_atIsSet = false;
}
utility::string_t V0_0_38_node::getReasonSetByUser() const
{
    return m_Reason_set_by_user;
}

void V0_0_38_node::setReasonSetByUser(const utility::string_t& value)
{
    m_Reason_set_by_user = value;
    m_Reason_set_by_userIsSet = true;
}

bool V0_0_38_node::reasonSetByUserIsSet() const
{
    return m_Reason_set_by_userIsSet;
}

void V0_0_38_node::unsetReason_set_by_user()
{
    m_Reason_set_by_userIsSet = false;
}
int64_t V0_0_38_node::getSlurmdStartTime() const
{
    return m_Slurmd_start_time;
}

void V0_0_38_node::setSlurmdStartTime(int64_t value)
{
    m_Slurmd_start_time = value;
    m_Slurmd_start_timeIsSet = true;
}

bool V0_0_38_node::slurmdStartTimeIsSet() const
{
    return m_Slurmd_start_timeIsSet;
}

void V0_0_38_node::unsetSlurmd_start_time()
{
    m_Slurmd_start_timeIsSet = false;
}
int32_t V0_0_38_node::getSockets() const
{
    return m_Sockets;
}

void V0_0_38_node::setSockets(int32_t value)
{
    m_Sockets = value;
    m_SocketsIsSet = true;
}

bool V0_0_38_node::socketsIsSet() const
{
    return m_SocketsIsSet;
}

void V0_0_38_node::unsetSockets()
{
    m_SocketsIsSet = false;
}
int32_t V0_0_38_node::getThreads() const
{
    return m_Threads;
}

void V0_0_38_node::setThreads(int32_t value)
{
    m_Threads = value;
    m_ThreadsIsSet = true;
}

bool V0_0_38_node::threadsIsSet() const
{
    return m_ThreadsIsSet;
}

void V0_0_38_node::unsetThreads()
{
    m_ThreadsIsSet = false;
}
int32_t V0_0_38_node::getTemporaryDisk() const
{
    return m_Temporary_disk;
}

void V0_0_38_node::setTemporaryDisk(int32_t value)
{
    m_Temporary_disk = value;
    m_Temporary_diskIsSet = true;
}

bool V0_0_38_node::temporaryDiskIsSet() const
{
    return m_Temporary_diskIsSet;
}

void V0_0_38_node::unsetTemporary_disk()
{
    m_Temporary_diskIsSet = false;
}
int32_t V0_0_38_node::getWeight() const
{
    return m_Weight;
}

void V0_0_38_node::setWeight(int32_t value)
{
    m_Weight = value;
    m_WeightIsSet = true;
}

bool V0_0_38_node::weightIsSet() const
{
    return m_WeightIsSet;
}

void V0_0_38_node::unsetWeight()
{
    m_WeightIsSet = false;
}
utility::string_t V0_0_38_node::getTres() const
{
    return m_Tres;
}

void V0_0_38_node::setTres(const utility::string_t& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool V0_0_38_node::tresIsSet() const
{
    return m_TresIsSet;
}

void V0_0_38_node::unsetTres()
{
    m_TresIsSet = false;
}
utility::string_t V0_0_38_node::getTresUsed() const
{
    return m_Tres_used;
}

void V0_0_38_node::setTresUsed(const utility::string_t& value)
{
    m_Tres_used = value;
    m_Tres_usedIsSet = true;
}

bool V0_0_38_node::tresUsedIsSet() const
{
    return m_Tres_usedIsSet;
}

void V0_0_38_node::unsetTres_used()
{
    m_Tres_usedIsSet = false;
}
double V0_0_38_node::getTresWeighted() const
{
    return m_Tres_weighted;
}

void V0_0_38_node::setTresWeighted(double value)
{
    m_Tres_weighted = value;
    m_Tres_weightedIsSet = true;
}

bool V0_0_38_node::tresWeightedIsSet() const
{
    return m_Tres_weightedIsSet;
}

void V0_0_38_node::unsetTres_weighted()
{
    m_Tres_weightedIsSet = false;
}
utility::string_t V0_0_38_node::getSlurmdVersion() const
{
    return m_Slurmd_version;
}

void V0_0_38_node::setSlurmdVersion(const utility::string_t& value)
{
    m_Slurmd_version = value;
    m_Slurmd_versionIsSet = true;
}

bool V0_0_38_node::slurmdVersionIsSet() const
{
    return m_Slurmd_versionIsSet;
}

void V0_0_38_node::unsetSlurmd_version()
{
    m_Slurmd_versionIsSet = false;
}
int64_t V0_0_38_node::getAllocCpus() const
{
    return m_Alloc_cpus;
}

void V0_0_38_node::setAllocCpus(int64_t value)
{
    m_Alloc_cpus = value;
    m_Alloc_cpusIsSet = true;
}

bool V0_0_38_node::allocCpusIsSet() const
{
    return m_Alloc_cpusIsSet;
}

void V0_0_38_node::unsetAlloc_cpus()
{
    m_Alloc_cpusIsSet = false;
}
int64_t V0_0_38_node::getIdleCpus() const
{
    return m_Idle_cpus;
}

void V0_0_38_node::setIdleCpus(int64_t value)
{
    m_Idle_cpus = value;
    m_Idle_cpusIsSet = true;
}

bool V0_0_38_node::idleCpusIsSet() const
{
    return m_Idle_cpusIsSet;
}

void V0_0_38_node::unsetIdle_cpus()
{
    m_Idle_cpusIsSet = false;
}
int64_t V0_0_38_node::getAllocMemory() const
{
    return m_Alloc_memory;
}

void V0_0_38_node::setAllocMemory(int64_t value)
{
    m_Alloc_memory = value;
    m_Alloc_memoryIsSet = true;
}

bool V0_0_38_node::allocMemoryIsSet() const
{
    return m_Alloc_memoryIsSet;
}

void V0_0_38_node::unsetAlloc_memory()
{
    m_Alloc_memoryIsSet = false;
}
}
