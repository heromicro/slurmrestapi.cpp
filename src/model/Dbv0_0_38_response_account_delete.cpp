...
Dbv0_0_38_response_account_delete::Dbv0_0_38_response_account_delete()
{
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
}
...
void Dbv0_0_38_response_account_delete::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_response_account_delete::toJson() const
{
...
bool Dbv0_0_38_response_account_delete::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_38_response_account_delete::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_response_account_delete::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_38_meta> Dbv0_0_38_response_account_delete::getMeta() const
{
    return m_Meta;
}

void Dbv0_0_38_response_account_delete::setMeta(const std::shared_ptr<Dbv0_0_38_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool Dbv0_0_38_response_account_delete::metaIsSet() const
{
    return m_MetaIsSet;
}

void Dbv0_0_38_response_account_delete::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_error>>& Dbv0_0_38_response_account_delete::getErrors()
{
    return m_Errors;
}

void Dbv0_0_38_response_account_delete::setErrors(const std::vector<std::shared_ptr<Dbv0_0_38_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool Dbv0_0_38_response_account_delete::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void Dbv0_0_38_response_account_delete::unsetErrors()
{
    m_ErrorsIsSet = false;
}
}
