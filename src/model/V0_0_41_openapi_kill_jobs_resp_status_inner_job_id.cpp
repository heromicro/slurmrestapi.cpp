...
V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::V0_0_41_openapi_kill_jobs_resp_status_inner_job_id()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::toJson() const
{
...
bool V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int32_t V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_kill_jobs_resp_status_inner_job_id::unsetnumber()
{
    m_numberIsSet = false;
}
}
