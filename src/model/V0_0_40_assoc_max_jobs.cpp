...
V0_0_40_assoc_max_jobs::V0_0_40_assoc_max_jobs()
{
    m_PerIsSet = false;
    m_ActiveIsSet = false;
...
void V0_0_40_assoc_max_jobs::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_assoc_max_jobs::toJson() const
{
...
bool V0_0_40_assoc_max_jobs::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("per"))))
    {
        ...
        {
            std::shared_ptr<V0_0_40_assoc_max_jobs_per> refVal_setPer;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("active"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint32_no_val> refVal_setActive;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("total"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint32_no_val> refVal_setTotal;
...
void V0_0_40_assoc_max_jobs::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_assoc_max_jobs::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_40_assoc_max_jobs_per> V0_0_40_assoc_max_jobs::getPer() const
{
    return m_Per;
}

void V0_0_40_assoc_max_jobs::setPer(const std::shared_ptr<V0_0_40_assoc_max_jobs_per>& value)
{
    m_Per = value;
    m_PerIsSet = true;
}

bool V0_0_40_assoc_max_jobs::perIsSet() const
{
    return m_PerIsSet;
}

void V0_0_40_assoc_max_jobs::unsetPer()
{
    m_PerIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_assoc_max_jobs::getActive() const
{
    return m_Active;
}

void V0_0_40_assoc_max_jobs::setActive(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Active = value;
    m_ActiveIsSet = true;
}

bool V0_0_40_assoc_max_jobs::activeIsSet() const
{
    return m_ActiveIsSet;
}

void V0_0_40_assoc_max_jobs::unsetActive()
{
    m_ActiveIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_assoc_max_jobs::getAccruing() const
{
    return m_Accruing;
}

void V0_0_40_assoc_max_jobs::setAccruing(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Accruing = value;
    m_AccruingIsSet = true;
}

bool V0_0_40_assoc_max_jobs::accruingIsSet() const
{
    return m_AccruingIsSet;
}

void V0_0_40_assoc_max_jobs::unsetAccruing()
{
    m_AccruingIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_assoc_max_jobs::getTotal() const
{
    return m_Total;
}

void V0_0_40_assoc_max_jobs::setTotal(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool V0_0_40_assoc_max_jobs::totalIsSet() const
{
    return m_TotalIsSet;
}

void V0_0_40_assoc_max_jobs::unsetTotal()
{
    m_TotalIsSet = false;
}
}
