...
Dbv0_0_39_wckey_info::Dbv0_0_39_wckey_info()
{
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
    m_WckeysIsSet = false;
...
void Dbv0_0_39_wckey_info::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_39_wckey_info::toJson() const
{
...
bool Dbv0_0_39_wckey_info::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_39_wckey_info::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_39_wckey_info::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_39_meta> Dbv0_0_39_wckey_info::getMeta() const
{
    return m_Meta;
}

void Dbv0_0_39_wckey_info::setMeta(const std::shared_ptr<Dbv0_0_39_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool Dbv0_0_39_wckey_info::metaIsSet() const
{
    return m_MetaIsSet;
}

void Dbv0_0_39_wckey_info::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_39_error>>& Dbv0_0_39_wckey_info::getErrors()
{
    return m_Errors;
}

void Dbv0_0_39_wckey_info::setErrors(const std::vector<std::shared_ptr<Dbv0_0_39_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool Dbv0_0_39_wckey_info::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void Dbv0_0_39_wckey_info::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_39_wckey>>& Dbv0_0_39_wckey_info::getWckeys()
{
    return m_Wckeys;
}

void Dbv0_0_39_wckey_info::setWckeys(const std::vector<std::shared_ptr<V0_0_39_wckey>>& value)
{
    m_Wckeys = value;
    m_WckeysIsSet = true;
}

bool Dbv0_0_39_wckey_info::wckeysIsSet() const
{
    return m_WckeysIsSet;
}

void Dbv0_0_39_wckey_info::unsetWckeys()
{
    m_WckeysIsSet = false;
}
}
