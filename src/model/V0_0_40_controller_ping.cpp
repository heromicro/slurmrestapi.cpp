...
#include "slurmrestapi/model/V0_0_40_controller_ping.h"
...
V0_0_40_controller_ping::V0_0_40_controller_ping()
{
...
void V0_0_40_controller_ping::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_controller_ping::toJson() const
{
...
bool V0_0_40_controller_ping::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_controller_ping::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_controller_ping::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_controller_ping::getHostname() const
{
    return m_Hostname;
}

void V0_0_40_controller_ping::setHostname(const utility::string_t& value)
{
    m_Hostname = value;
    m_HostnameIsSet = true;
}

bool V0_0_40_controller_ping::hostnameIsSet() const
{
    return m_HostnameIsSet;
}

void V0_0_40_controller_ping::unsetHostname()
{
    m_HostnameIsSet = false;
}
utility::string_t V0_0_40_controller_ping::getPinged() const
{
    return m_Pinged;
}

void V0_0_40_controller_ping::setPinged(const utility::string_t& value)
{
    m_Pinged = value;
    m_PingedIsSet = true;
}

bool V0_0_40_controller_ping::pingedIsSet() const
{
    return m_PingedIsSet;
}

void V0_0_40_controller_ping::unsetPinged()
{
    m_PingedIsSet = false;
}
int64_t V0_0_40_controller_ping::getLatency() const
{
    return m_Latency;
}

void V0_0_40_controller_ping::setLatency(int64_t value)
{
    m_Latency = value;
    m_LatencyIsSet = true;
}

bool V0_0_40_controller_ping::latencyIsSet() const
{
    return m_LatencyIsSet;
}

void V0_0_40_controller_ping::unsetLatency()
{
    m_LatencyIsSet = false;
}
utility::string_t V0_0_40_controller_ping::getMode() const
{
    return m_Mode;
}

void V0_0_40_controller_ping::setMode(const utility::string_t& value)
{
    m_Mode = value;
    m_ModeIsSet = true;
}

bool V0_0_40_controller_ping::modeIsSet() const
{
    return m_ModeIsSet;
}

void V0_0_40_controller_ping::unsetMode()
{
    m_ModeIsSet = false;
}
}
