...
#include "slurmrestapi/model/V0_0_40_qos_preempt.h"
...
V0_0_40_qos_preempt::V0_0_40_qos_preempt()
{
    m_ListIsSet = false;
    m_ModeIsSet = false;
...
void V0_0_40_qos_preempt::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_qos_preempt::toJson() const
{
...
bool V0_0_40_qos_preempt::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("exempt_time"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint32_no_val> refVal_setExemptTime;
...
void V0_0_40_qos_preempt::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_qos_preempt::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<utility::string_t>& V0_0_40_qos_preempt::getList()
{
    return m_List;
}

void V0_0_40_qos_preempt::setList(const std::vector<utility::string_t>& value)
{
    m_List = value;
    m_ListIsSet = true;
}

bool V0_0_40_qos_preempt::listIsSet() const
{
    return m_ListIsSet;
}

void V0_0_40_qos_preempt::unsetList()
{
    m_ListIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_qos_preempt::getMode()
{
    return m_Mode;
}

void V0_0_40_qos_preempt::setMode(const std::vector<utility::string_t>& value)
{
    m_Mode = value;
    m_ModeIsSet = true;
}

bool V0_0_40_qos_preempt::modeIsSet() const
{
    return m_ModeIsSet;
}

void V0_0_40_qos_preempt::unsetMode()
{
    m_ModeIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_qos_preempt::getExemptTime() const
{
    return m_Exempt_time;
}

void V0_0_40_qos_preempt::setExemptTime(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Exempt_time = value;
    m_Exempt_timeIsSet = true;
}

bool V0_0_40_qos_preempt::exemptTimeIsSet() const
{
    return m_Exempt_timeIsSet;
}

void V0_0_40_qos_preempt::unsetExempt_time()
{
    m_Exempt_timeIsSet = false;
}
}
