...
void V0_0_39_error::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_error::toJson() const
{
...
bool V0_0_39_error::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_39_error::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_error::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_39_error::getErrorNumber() const
{
    return m_Error_number;
}

void V0_0_39_error::setErrorNumber(int32_t value)
{
    m_Error_number = value;
    m_Error_numberIsSet = true;
}

bool V0_0_39_error::errorNumberIsSet() const
{
    return m_Error_numberIsSet;
}

void V0_0_39_error::unsetError_number()
{
    m_Error_numberIsSet = false;
}
utility::string_t V0_0_39_error::getError() const
{
    return m_Error;
}

void V0_0_39_error::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool V0_0_39_error::errorIsSet() const
{
    return m_ErrorIsSet;
}

void V0_0_39_error::unsetError()
{
    m_ErrorIsSet = false;
}
utility::string_t V0_0_39_error::getSource() const
{
    return m_Source;
}

void V0_0_39_error::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool V0_0_39_error::sourceIsSet() const
{
    return m_SourceIsSet;
}

void V0_0_39_error::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t V0_0_39_error::getDescription() const
{
    return m_Description;
}

void V0_0_39_error::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool V0_0_39_error::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void V0_0_39_error::unsetDescription()
{
    m_DescriptionIsSet = false;
}
}
