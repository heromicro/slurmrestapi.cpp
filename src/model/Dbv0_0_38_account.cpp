...
Dbv0_0_38_account::Dbv0_0_38_account()
{
...
void Dbv0_0_38_account::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_account::toJson() const
{
...
bool Dbv0_0_38_account::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_38_account::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_account::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<Dbv0_0_38_association_short_info>>& Dbv0_0_38_account::getAssociations()
{
    return m_Associations;
}

void Dbv0_0_38_account::setAssociations(const std::vector<std::shared_ptr<Dbv0_0_38_association_short_info>>& value)
{
    m_Associations = value;
    m_AssociationsIsSet = true;
}

bool Dbv0_0_38_account::associationsIsSet() const
{
    return m_AssociationsIsSet;
}

void Dbv0_0_38_account::unsetAssociations()
{
    m_AssociationsIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_coordinator_info>>& Dbv0_0_38_account::getCoordinators()
{
    return m_Coordinators;
}

void Dbv0_0_38_account::setCoordinators(const std::vector<std::shared_ptr<Dbv0_0_38_coordinator_info>>& value)
{
    m_Coordinators = value;
    m_CoordinatorsIsSet = true;
}

bool Dbv0_0_38_account::coordinatorsIsSet() const
{
    return m_CoordinatorsIsSet;
}

void Dbv0_0_38_account::unsetCoordinators()
{
    m_CoordinatorsIsSet = false;
}
utility::string_t Dbv0_0_38_account::getDescription() const
{
    return m_Description;
}

void Dbv0_0_38_account::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool Dbv0_0_38_account::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void Dbv0_0_38_account::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t Dbv0_0_38_account::getName() const
{
    return m_Name;
}

void Dbv0_0_38_account::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Dbv0_0_38_account::nameIsSet() const
{
    return m_NameIsSet;
}

void Dbv0_0_38_account::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Dbv0_0_38_account::getOrganization() const
{
    return m_Organization;
}

void Dbv0_0_38_account::setOrganization(const utility::string_t& value)
{
    m_Organization = value;
    m_OrganizationIsSet = true;
}

bool Dbv0_0_38_account::organizationIsSet() const
{
    return m_OrganizationIsSet;
}

void Dbv0_0_38_account::unsetOrganization()
{
    m_OrganizationIsSet = false;
}
std::vector<utility::string_t>& Dbv0_0_38_account::getFlags()
{
    return m_Flags;
}

void Dbv0_0_38_account::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool Dbv0_0_38_account::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void Dbv0_0_38_account::unsetFlags()
{
    m_FlagsIsSet = false;
}
}
