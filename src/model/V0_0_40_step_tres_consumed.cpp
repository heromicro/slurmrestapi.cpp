...
#include "slurmrestapi/model/V0_0_40_step_tres_consumed.h"
...
V0_0_40_step_tres_consumed::V0_0_40_step_tres_consumed()
{
    m_MaxIsSet = false;
    m_MinIsSet = false;
...
void V0_0_40_step_tres_consumed::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_step_tres_consumed::toJson() const
{
...
bool V0_0_40_step_tres_consumed::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_step_tres_consumed::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_step_tres_consumed::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_step_tres_consumed::getMax()
{
    return m_Max;
}

void V0_0_40_step_tres_consumed::setMax(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Max = value;
    m_MaxIsSet = true;
}

bool V0_0_40_step_tres_consumed::maxIsSet() const
{
    return m_MaxIsSet;
}

void V0_0_40_step_tres_consumed::unsetMax()
{
    m_MaxIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_step_tres_consumed::getMin()
{
    return m_Min;
}

void V0_0_40_step_tres_consumed::setMin(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Min = value;
    m_MinIsSet = true;
}

bool V0_0_40_step_tres_consumed::minIsSet() const
{
    return m_MinIsSet;
}

void V0_0_40_step_tres_consumed::unsetMin()
{
    m_MinIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_step_tres_consumed::getAverage()
{
    return m_Average;
}

void V0_0_40_step_tres_consumed::setAverage(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Average = value;
    m_AverageIsSet = true;
}

bool V0_0_40_step_tres_consumed::averageIsSet() const
{
    return m_AverageIsSet;
}

void V0_0_40_step_tres_consumed::unsetAverage()
{
    m_AverageIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_step_tres_consumed::getTotal()
{
    return m_Total;
}

void V0_0_40_step_tres_consumed::setTotal(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool V0_0_40_step_tres_consumed::totalIsSet() const
{
    return m_TotalIsSet;
}

void V0_0_40_step_tres_consumed::unsetTotal()
{
    m_TotalIsSet = false;
}
}
