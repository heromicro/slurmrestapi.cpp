...
V0_0_39_qos_limits_max_tres_per::V0_0_39_qos_limits_max_tres_per()
{
...
void V0_0_39_qos_limits_max_tres_per::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_qos_limits_max_tres_per::toJson() const
{
...
bool V0_0_39_qos_limits_max_tres_per::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("node"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_39_tres>> refVal_setNode;
...
void V0_0_39_qos_limits_max_tres_per::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_qos_limits_max_tres_per::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_39_tres>>& V0_0_39_qos_limits_max_tres_per::getAccount()
{
    return m_Account;
}

void V0_0_39_qos_limits_max_tres_per::setAccount(const std::vector<std::shared_ptr<V0_0_39_tres>>& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool V0_0_39_qos_limits_max_tres_per::accountIsSet() const
{
    return m_AccountIsSet;
}

void V0_0_39_qos_limits_max_tres_per::unsetAccount()
{
    m_AccountIsSet = false;
}
std::vector<std::shared_ptr<V0_0_39_tres>>& V0_0_39_qos_limits_max_tres_per::getJob()
{
    return m_Job;
}

void V0_0_39_qos_limits_max_tres_per::setJob(const std::vector<std::shared_ptr<V0_0_39_tres>>& value)
{
    m_Job = value;
    m_JobIsSet = true;
}

bool V0_0_39_qos_limits_max_tres_per::jobIsSet() const
{
    return m_JobIsSet;
}

void V0_0_39_qos_limits_max_tres_per::unsetJob()
{
    m_JobIsSet = false;
}
std::vector<std::shared_ptr<V0_0_39_tres>>& V0_0_39_qos_limits_max_tres_per::getNode()
{
    return m_Node;
}

void V0_0_39_qos_limits_max_tres_per::setNode(const std::vector<std::shared_ptr<V0_0_39_tres>>& value)
{
    m_Node = value;
    m_NodeIsSet = true;
}

bool V0_0_39_qos_limits_max_tres_per::nodeIsSet() const
{
    return m_NodeIsSet;
}

void V0_0_39_qos_limits_max_tres_per::unsetNode()
{
    m_NodeIsSet = false;
}
std::vector<std::shared_ptr<V0_0_39_tres>>& V0_0_39_qos_limits_max_tres_per::getUser()
{
    return m_User;
}

void V0_0_39_qos_limits_max_tres_per::setUser(const std::vector<std::shared_ptr<V0_0_39_tres>>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool V0_0_39_qos_limits_max_tres_per::userIsSet() const
{
    return m_UserIsSet;
}

void V0_0_39_qos_limits_max_tres_per::unsetUser()
{
    m_UserIsSet = false;
}
}
