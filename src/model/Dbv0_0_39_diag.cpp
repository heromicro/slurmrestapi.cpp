...
void Dbv0_0_39_diag::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_39_diag::toJson() const
{
...
bool Dbv0_0_39_diag::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("statistics"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_stats_rec> refVal_setStatistics;
...
void Dbv0_0_39_diag::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_39_diag::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_39_meta> Dbv0_0_39_diag::getMeta() const
{
    return m_Meta;
}

void Dbv0_0_39_diag::setMeta(const std::shared_ptr<Dbv0_0_39_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool Dbv0_0_39_diag::metaIsSet() const
{
    return m_MetaIsSet;
}

void Dbv0_0_39_diag::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_39_error>>& Dbv0_0_39_diag::getErrors()
{
    return m_Errors;
}

void Dbv0_0_39_diag::setErrors(const std::vector<std::shared_ptr<Dbv0_0_39_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool Dbv0_0_39_diag::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void Dbv0_0_39_diag::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_39_warning>>& Dbv0_0_39_diag::getWarnings()
{
    return m_Warnings;
}

void Dbv0_0_39_diag::setWarnings(const std::vector<std::shared_ptr<Dbv0_0_39_warning>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool Dbv0_0_39_diag::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void Dbv0_0_39_diag::unsetWarnings()
{
    m_WarningsIsSet = false;
}
std::shared_ptr<V0_0_39_stats_rec> Dbv0_0_39_diag::getStatistics() const
{
    return m_Statistics;
}

void Dbv0_0_39_diag::setStatistics(const std::shared_ptr<V0_0_39_stats_rec>& value)
{
    m_Statistics = value;
    m_StatisticsIsSet = true;
}

bool Dbv0_0_39_diag::statisticsIsSet() const
{
    return m_StatisticsIsSet;
}

void Dbv0_0_39_diag::unsetStatistics()
{
    m_StatisticsIsSet = false;
}
}
