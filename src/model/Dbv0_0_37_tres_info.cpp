...
Dbv0_0_37_tres_info::Dbv0_0_37_tres_info()
{
    m_ErrorsIsSet = false;
    m_TresIsSet = false;
}
...
void Dbv0_0_37_tres_info::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_tres_info::toJson() const
{
...
bool Dbv0_0_37_tres_info::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_37_tres_info::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_tres_info::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<Dbv0_0_37_error>>& Dbv0_0_37_tres_info::getErrors()
{
    return m_Errors;
}

void Dbv0_0_37_tres_info::setErrors(const std::vector<std::shared_ptr<Dbv0_0_37_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool Dbv0_0_37_tres_info::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void Dbv0_0_37_tres_info::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<std::vector>>& Dbv0_0_37_tres_info::getTres()
{
    return m_Tres;
}

void Dbv0_0_37_tres_info::setTres(const std::vector<std::shared_ptr<std::vector>>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool Dbv0_0_37_tres_info::tresIsSet() const
{
    return m_TresIsSet;
}

void Dbv0_0_37_tres_info::unsetTres()
{
    m_TresIsSet = false;
}
}
