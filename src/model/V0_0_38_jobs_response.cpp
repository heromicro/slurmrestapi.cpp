...
V0_0_38_jobs_response::V0_0_38_jobs_response()
{
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
    m_JobsIsSet = false;
...
void V0_0_38_jobs_response::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_38_jobs_response::toJson() const
{
...
bool V0_0_38_jobs_response::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("jobs"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_38_job_response_properties>> refVal_setJobs;
...
void V0_0_38_jobs_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_38_jobs_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_38_meta> V0_0_38_jobs_response::getMeta() const
{
    return m_Meta;
}

void V0_0_38_jobs_response::setMeta(const std::shared_ptr<V0_0_38_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_38_jobs_response::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_38_jobs_response::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_38_error>>& V0_0_38_jobs_response::getErrors()
{
    return m_Errors;
}

void V0_0_38_jobs_response::setErrors(const std::vector<std::shared_ptr<V0_0_38_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_38_jobs_response::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_38_jobs_response::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_38_job_response_properties>>& V0_0_38_jobs_response::getJobs()
{
    return m_Jobs;
}

void V0_0_38_jobs_response::setJobs(const std::vector<std::shared_ptr<V0_0_38_job_response_properties>>& value)
{
    m_Jobs = value;
    m_JobsIsSet = true;
}

bool V0_0_38_jobs_response::jobsIsSet() const
{
    return m_JobsIsSet;
}

void V0_0_38_jobs_response::unsetJobs()
{
    m_JobsIsSet = false;
}
}
