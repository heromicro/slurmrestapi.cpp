...
V0_0_39_step_task::V0_0_39_step_task()
{
...
void V0_0_39_step_task::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_step_task::toJson() const
{
...
bool V0_0_39_step_task::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_39_step_task::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_step_task::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_39_step_task::getDistribution() const
{
    return m_Distribution;
}

void V0_0_39_step_task::setDistribution(const utility::string_t& value)
{
    m_Distribution = value;
    m_DistributionIsSet = true;
}

bool V0_0_39_step_task::distributionIsSet() const
{
    return m_DistributionIsSet;
}

void V0_0_39_step_task::unsetDistribution()
{
    m_DistributionIsSet = false;
}
}
