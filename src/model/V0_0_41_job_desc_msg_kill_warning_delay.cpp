...
V0_0_41_job_desc_msg_kill_warning_delay::V0_0_41_job_desc_msg_kill_warning_delay()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_job_desc_msg_kill_warning_delay::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_job_desc_msg_kill_warning_delay::toJson() const
{
...
bool V0_0_41_job_desc_msg_kill_warning_delay::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_job_desc_msg_kill_warning_delay::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_job_desc_msg_kill_warning_delay::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_job_desc_msg_kill_warning_delay::isSet() const
{
    return m_set;
}

void V0_0_41_job_desc_msg_kill_warning_delay::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_job_desc_msg_kill_warning_delay::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_job_desc_msg_kill_warning_delay::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_job_desc_msg_kill_warning_delay::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_job_desc_msg_kill_warning_delay::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_job_desc_msg_kill_warning_delay::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_job_desc_msg_kill_warning_delay::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int32_t V0_0_41_job_desc_msg_kill_warning_delay::getNumber() const
{
    return m_number;
}

void V0_0_41_job_desc_msg_kill_warning_delay::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_job_desc_msg_kill_warning_delay::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_job_desc_msg_kill_warning_delay::unsetnumber()
{
    m_numberIsSet = false;
}
}
