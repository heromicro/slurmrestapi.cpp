...
V0_0_41_openapi_reservation_resp::V0_0_41_openapi_reservation_resp()
{
...
void V0_0_41_openapi_reservation_resp::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_reservation_resp::toJson() const
{
...
bool V0_0_41_openapi_reservation_resp::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("reservations"))))
    {
        ...
        {
            std::vector<std::shared_ptr<V0_0_41_openapi_reservation_resp_reservations_inner>> refVal_setReservations;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("last_update"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_41_openapi_reservation_resp_last_update> refVal_setLastUpdate;
...
void V0_0_41_openapi_reservation_resp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_reservation_resp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_41_openapi_reservation_resp_reservations_inner>>& V0_0_41_openapi_reservation_resp::getReservations()
{
    return m_Reservations;
}

void V0_0_41_openapi_reservation_resp::setReservations(const std::vector<std::shared_ptr<V0_0_41_openapi_reservation_resp_reservations_inner>>& value)
{
    m_Reservations = value;
    m_ReservationsIsSet = true;
}

bool V0_0_41_openapi_reservation_resp::reservationsIsSet() const
{
    return m_ReservationsIsSet;
}

void V0_0_41_openapi_reservation_resp::unsetReservations()
{
    m_ReservationsIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_reservation_resp_last_update> V0_0_41_openapi_reservation_resp::getLastUpdate() const
{
    return m_Last_update;
}

void V0_0_41_openapi_reservation_resp::setLastUpdate(const std::shared_ptr<V0_0_41_openapi_reservation_resp_last_update>& value)
{
    m_Last_update = value;
    m_Last_updateIsSet = true;
}

bool V0_0_41_openapi_reservation_resp::lastUpdateIsSet() const
{
    return m_Last_updateIsSet;
}

void V0_0_41_openapi_reservation_resp::unsetLast_update()
{
    m_Last_updateIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_shares_resp_meta> V0_0_41_openapi_reservation_resp::getMeta() const
{
    return m_Meta;
}

void V0_0_41_openapi_reservation_resp::setMeta(const std::shared_ptr<V0_0_41_openapi_shares_resp_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_41_openapi_reservation_resp::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_41_openapi_reservation_resp::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_errors_inner>>& V0_0_41_openapi_reservation_resp::getErrors()
{
    return m_Errors;
}

void V0_0_41_openapi_reservation_resp::setErrors(const std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_errors_inner>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_41_openapi_reservation_resp::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_41_openapi_reservation_resp::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_warnings_inner>>& V0_0_41_openapi_reservation_resp::getWarnings()
{
    return m_Warnings;
}

void V0_0_41_openapi_reservation_resp::setWarnings(const std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_warnings_inner>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool V0_0_41_openapi_reservation_resp::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void V0_0_41_openapi_reservation_resp::unsetWarnings()
{
    m_WarningsIsSet = false;
}
}
