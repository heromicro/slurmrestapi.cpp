...
#include "slurmrestapi/model/V0_0_40_job.h"
...
void V0_0_40_job::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_job::toJson() const
{
...
bool V0_0_40_job::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("array"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_job_array> refVal_setArray;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("association"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_assoc_short> refVal_setAssociation;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("time"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_job_time> refVal_setTime;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("het"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_job_het> refVal_setHet;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("required"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_job_required> refVal_setRequired;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("steps"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_40_step>> refVal_setSteps;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tres"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_job_tres> refVal_setTres;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("wckey"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_wckey_tag_struct> refVal_setWckey;
...
void V0_0_40_job::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_job::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_job::getAccount() const
{
    return m_Account;
}

void V0_0_40_job::setAccount(const utility::string_t& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool V0_0_40_job::accountIsSet() const
{
    return m_AccountIsSet;
}

void V0_0_40_job::unsetAccount()
{
    m_AccountIsSet = false;
}
std::shared_ptr<V0_0_40_job_comment> V0_0_40_job::getComment() const
{
    return m_Comment;
}

void V0_0_40_job::setComment(const std::shared_ptr<V0_0_40_job_comment>& value)
{
    m_Comment = value;
    m_CommentIsSet = true;
}

bool V0_0_40_job::commentIsSet() const
{
    return m_CommentIsSet;
}

void V0_0_40_job::unsetComment()
{
    m_CommentIsSet = false;
}
int32_t V0_0_40_job::getAllocationNodes() const
{
    return m_Allocation_nodes;
}

void V0_0_40_job::setAllocationNodes(int32_t value)
{
    m_Allocation_nodes = value;
    m_Allocation_nodesIsSet = true;
}

bool V0_0_40_job::allocationNodesIsSet() const
{
    return m_Allocation_nodesIsSet;
}

void V0_0_40_job::unsetAllocation_nodes()
{
    m_Allocation_nodesIsSet = false;
}
std::shared_ptr<V0_0_40_job_array> V0_0_40_job::getArray() const
{
    return m_array;
}

void V0_0_40_job::setArray(const std::shared_ptr<V0_0_40_job_array>& value)
{
    m_array = value;
    m_arrayIsSet = true;
}

bool V0_0_40_job::arrayIsSet() const
{
    return m_arrayIsSet;
}

void V0_0_40_job::unsetarray()
{
    m_arrayIsSet = false;
}
std::shared_ptr<V0_0_40_assoc_short> V0_0_40_job::getAssociation() const
{
    return m_Association;
}

void V0_0_40_job::setAssociation(const std::shared_ptr<V0_0_40_assoc_short>& value)
{
    m_Association = value;
    m_AssociationIsSet = true;
}

bool V0_0_40_job::associationIsSet() const
{
    return m_AssociationIsSet;
}

void V0_0_40_job::unsetAssociation()
{
    m_AssociationIsSet = false;
}
utility::string_t V0_0_40_job::getBlock() const
{
    return m_Block;
}

void V0_0_40_job::setBlock(const utility::string_t& value)
{
    m_Block = value;
    m_BlockIsSet = true;
}

bool V0_0_40_job::blockIsSet() const
{
    return m_BlockIsSet;
}

void V0_0_40_job::unsetBlock()
{
    m_BlockIsSet = false;
}
utility::string_t V0_0_40_job::getCluster() const
{
    return m_Cluster;
}

void V0_0_40_job::setCluster(const utility::string_t& value)
{
    m_Cluster = value;
    m_ClusterIsSet = true;
}

bool V0_0_40_job::clusterIsSet() const
{
    return m_ClusterIsSet;
}

void V0_0_40_job::unsetCluster()
{
    m_ClusterIsSet = false;
}
utility::string_t V0_0_40_job::getConstraints() const
{
    return m_Constraints;
}

void V0_0_40_job::setConstraints(const utility::string_t& value)
{
    m_Constraints = value;
    m_ConstraintsIsSet = true;
}

bool V0_0_40_job::constraintsIsSet() const
{
    return m_ConstraintsIsSet;
}

void V0_0_40_job::unsetConstraints()
{
    m_ConstraintsIsSet = false;
}
utility::string_t V0_0_40_job::getContainer() const
{
    return m_Container;
}

void V0_0_40_job::setContainer(const utility::string_t& value)
{
    m_Container = value;
    m_ContainerIsSet = true;
}

bool V0_0_40_job::containerIsSet() const
{
    return m_ContainerIsSet;
}

void V0_0_40_job::unsetContainer()
{
    m_ContainerIsSet = false;
}
std::shared_ptr<V0_0_40_process_exit_code_verbose> V0_0_40_job::getDerivedExitCode() const
{
    return m_Derived_exit_code;
}

void V0_0_40_job::setDerivedExitCode(const std::shared_ptr<V0_0_40_process_exit_code_verbose>& value)
{
    m_Derived_exit_code = value;
    m_Derived_exit_codeIsSet = true;
}

bool V0_0_40_job::derivedExitCodeIsSet() const
{
    return m_Derived_exit_codeIsSet;
}

void V0_0_40_job::unsetDerived_exit_code()
{
    m_Derived_exit_codeIsSet = false;
}
std::shared_ptr<V0_0_40_job_time> V0_0_40_job::getTime() const
{
    return m_Time;
}

void V0_0_40_job::setTime(const std::shared_ptr<V0_0_40_job_time>& value)
{
    m_Time = value;
    m_TimeIsSet = true;
}

bool V0_0_40_job::timeIsSet() const
{
    return m_TimeIsSet;
}

void V0_0_40_job::unsetTime()
{
    m_TimeIsSet = false;
}
std::shared_ptr<V0_0_40_process_exit_code_verbose> V0_0_40_job::getExitCode() const
{
    return m_Exit_code;
}

void V0_0_40_job::setExitCode(const std::shared_ptr<V0_0_40_process_exit_code_verbose>& value)
{
    m_Exit_code = value;
    m_Exit_codeIsSet = true;
}

bool V0_0_40_job::exitCodeIsSet() const
{
    return m_Exit_codeIsSet;
}

void V0_0_40_job::unsetExit_code()
{
    m_Exit_codeIsSet = false;
}
utility::string_t V0_0_40_job::getExtra() const
{
    return m_Extra;
}

void V0_0_40_job::setExtra(const utility::string_t& value)
{
    m_Extra = value;
    m_ExtraIsSet = true;
}

bool V0_0_40_job::extraIsSet() const
{
    return m_ExtraIsSet;
}

void V0_0_40_job::unsetExtra()
{
    m_ExtraIsSet = false;
}
utility::string_t V0_0_40_job::getFailedNode() const
{
    return m_Failed_node;
}

void V0_0_40_job::setFailedNode(const utility::string_t& value)
{
    m_Failed_node = value;
    m_Failed_nodeIsSet = true;
}

bool V0_0_40_job::failedNodeIsSet() const
{
    return m_Failed_nodeIsSet;
}

void V0_0_40_job::unsetFailed_node()
{
    m_Failed_nodeIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job::getFlags()
{
    return m_Flags;
}

void V0_0_40_job::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool V0_0_40_job::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void V0_0_40_job::unsetFlags()
{
    m_FlagsIsSet = false;
}
utility::string_t V0_0_40_job::getGroup() const
{
    return m_Group;
}

void V0_0_40_job::setGroup(const utility::string_t& value)
{
    m_Group = value;
    m_GroupIsSet = true;
}

bool V0_0_40_job::groupIsSet() const
{
    return m_GroupIsSet;
}

void V0_0_40_job::unsetGroup()
{
    m_GroupIsSet = false;
}
std::shared_ptr<V0_0_40_job_het> V0_0_40_job::getHet() const
{
    return m_Het;
}

void V0_0_40_job::setHet(const std::shared_ptr<V0_0_40_job_het>& value)
{
    m_Het = value;
    m_HetIsSet = true;
}

bool V0_0_40_job::hetIsSet() const
{
    return m_HetIsSet;
}

void V0_0_40_job::unsetHet()
{
    m_HetIsSet = false;
}
int32_t V0_0_40_job::getJobId() const
{
    return m_Job_id;
}

void V0_0_40_job::setJobId(int32_t value)
{
    m_Job_id = value;
    m_Job_idIsSet = true;
}

bool V0_0_40_job::jobIdIsSet() const
{
    return m_Job_idIsSet;
}

void V0_0_40_job::unsetJob_id()
{
    m_Job_idIsSet = false;
}
utility::string_t V0_0_40_job::getName() const
{
    return m_Name;
}

void V0_0_40_job::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_40_job::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_40_job::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t V0_0_40_job::getLicenses() const
{
    return m_Licenses;
}

void V0_0_40_job::setLicenses(const utility::string_t& value)
{
    m_Licenses = value;
    m_LicensesIsSet = true;
}

bool V0_0_40_job::licensesIsSet() const
{
    return m_LicensesIsSet;
}

void V0_0_40_job::unsetLicenses()
{
    m_LicensesIsSet = false;
}
std::shared_ptr<V0_0_40_job_mcs> V0_0_40_job::getMcs() const
{
    return m_Mcs;
}

void V0_0_40_job::setMcs(const std::shared_ptr<V0_0_40_job_mcs>& value)
{
    m_Mcs = value;
    m_McsIsSet = true;
}

bool V0_0_40_job::mcsIsSet() const
{
    return m_McsIsSet;
}

void V0_0_40_job::unsetMcs()
{
    m_McsIsSet = false;
}
utility::string_t V0_0_40_job::getNodes() const
{
    return m_Nodes;
}

void V0_0_40_job::setNodes(const utility::string_t& value)
{
    m_Nodes = value;
    m_NodesIsSet = true;
}

bool V0_0_40_job::nodesIsSet() const
{
    return m_NodesIsSet;
}

void V0_0_40_job::unsetNodes()
{
    m_NodesIsSet = false;
}
utility::string_t V0_0_40_job::getPartition() const
{
    return m_Partition;
}

void V0_0_40_job::setPartition(const utility::string_t& value)
{
    m_Partition = value;
    m_PartitionIsSet = true;
}

bool V0_0_40_job::partitionIsSet() const
{
    return m_PartitionIsSet;
}

void V0_0_40_job::unsetPartition()
{
    m_PartitionIsSet = false;
}
bool V0_0_40_job::isHold() const
{
    return m_Hold;
}

void V0_0_40_job::setHold(bool value)
{
    m_Hold = value;
    m_HoldIsSet = true;
}

bool V0_0_40_job::holdIsSet() const
{
    return m_HoldIsSet;
}

void V0_0_40_job::unsetHold()
{
    m_HoldIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_job::getPriority() const
{
    return m_Priority;
}

void V0_0_40_job::setPriority(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Priority = value;
    m_PriorityIsSet = true;
}

bool V0_0_40_job::priorityIsSet() const
{
    return m_PriorityIsSet;
}

void V0_0_40_job::unsetPriority()
{
    m_PriorityIsSet = false;
}
utility::string_t V0_0_40_job::getQos() const
{
    return m_Qos;
}

void V0_0_40_job::setQos(const utility::string_t& value)
{
    m_Qos = value;
    m_QosIsSet = true;
}

bool V0_0_40_job::qosIsSet() const
{
    return m_QosIsSet;
}

void V0_0_40_job::unsetQos()
{
    m_QosIsSet = false;
}
std::shared_ptr<V0_0_40_job_required> V0_0_40_job::getRequired() const
{
    return m_Required;
}

void V0_0_40_job::setRequired(const std::shared_ptr<V0_0_40_job_required>& value)
{
    m_Required = value;
    m_RequiredIsSet = true;
}

bool V0_0_40_job::requiredIsSet() const
{
    return m_RequiredIsSet;
}

void V0_0_40_job::unsetRequired()
{
    m_RequiredIsSet = false;
}
utility::string_t V0_0_40_job::getKillRequestUser() const
{
    return m_Kill_request_user;
}

void V0_0_40_job::setKillRequestUser(const utility::string_t& value)
{
    m_Kill_request_user = value;
    m_Kill_request_userIsSet = true;
}

bool V0_0_40_job::killRequestUserIsSet() const
{
    return m_Kill_request_userIsSet;
}

void V0_0_40_job::unsetKill_request_user()
{
    m_Kill_request_userIsSet = false;
}
std::shared_ptr<V0_0_40_job_reservation> V0_0_40_job::getReservation() const
{
    return m_Reservation;
}

void V0_0_40_job::setReservation(const std::shared_ptr<V0_0_40_job_reservation>& value)
{
    m_Reservation = value;
    m_ReservationIsSet = true;
}

bool V0_0_40_job::reservationIsSet() const
{
    return m_ReservationIsSet;
}

void V0_0_40_job::unsetReservation()
{
    m_ReservationIsSet = false;
}
utility::string_t V0_0_40_job::getScript() const
{
    return m_Script;
}

void V0_0_40_job::setScript(const utility::string_t& value)
{
    m_Script = value;
    m_ScriptIsSet = true;
}

bool V0_0_40_job::scriptIsSet() const
{
    return m_ScriptIsSet;
}

void V0_0_40_job::unsetScript()
{
    m_ScriptIsSet = false;
}
std::shared_ptr<V0_0_40_job_state> V0_0_40_job::getState() const
{
    return m_State;
}

void V0_0_40_job::setState(const std::shared_ptr<V0_0_40_job_state>& value)
{
    m_State = value;
    m_StateIsSet = true;
}

bool V0_0_40_job::stateIsSet() const
{
    return m_StateIsSet;
}

void V0_0_40_job::unsetState()
{
    m_StateIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_step>>& V0_0_40_job::getSteps()
{
    return m_Steps;
}

void V0_0_40_job::setSteps(const std::vector<std::shared_ptr<V0_0_40_step>>& value)
{
    m_Steps = value;
    m_StepsIsSet = true;
}

bool V0_0_40_job::stepsIsSet() const
{
    return m_StepsIsSet;
}

void V0_0_40_job::unsetSteps()
{
    m_StepsIsSet = false;
}
utility::string_t V0_0_40_job::getSubmitLine() const
{
    return m_Submit_line;
}

void V0_0_40_job::setSubmitLine(const utility::string_t& value)
{
    m_Submit_line = value;
    m_Submit_lineIsSet = true;
}

bool V0_0_40_job::submitLineIsSet() const
{
    return m_Submit_lineIsSet;
}

void V0_0_40_job::unsetSubmit_line()
{
    m_Submit_lineIsSet = false;
}
std::shared_ptr<V0_0_40_job_tres> V0_0_40_job::getTres() const
{
    return m_Tres;
}

void V0_0_40_job::setTres(const std::shared_ptr<V0_0_40_job_tres>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool V0_0_40_job::tresIsSet() const
{
    return m_TresIsSet;
}

void V0_0_40_job::unsetTres()
{
    m_TresIsSet = false;
}
utility::string_t V0_0_40_job::getUsedGres() const
{
    return m_Used_gres;
}

void V0_0_40_job::setUsedGres(const utility::string_t& value)
{
    m_Used_gres = value;
    m_Used_gresIsSet = true;
}

bool V0_0_40_job::usedGresIsSet() const
{
    return m_Used_gresIsSet;
}

void V0_0_40_job::unsetUsed_gres()
{
    m_Used_gresIsSet = false;
}
utility::string_t V0_0_40_job::getUser() const
{
    return m_User;
}

void V0_0_40_job::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool V0_0_40_job::userIsSet() const
{
    return m_UserIsSet;
}

void V0_0_40_job::unsetUser()
{
    m_UserIsSet = false;
}
std::shared_ptr<V0_0_40_wckey_tag_struct> V0_0_40_job::getWckey() const
{
    return m_Wckey;
}

void V0_0_40_job::setWckey(const std::shared_ptr<V0_0_40_wckey_tag_struct>& value)
{
    m_Wckey = value;
    m_WckeyIsSet = true;
}

bool V0_0_40_job::wckeyIsSet() const
{
    return m_WckeyIsSet;
}

void V0_0_40_job::unsetWckey()
{
    m_WckeyIsSet = false;
}
utility::string_t V0_0_40_job::getWorkingDirectory() const
{
    return m_Working_directory;
}

void V0_0_40_job::setWorkingDirectory(const utility::string_t& value)
{
    m_Working_directory = value;
    m_Working_directoryIsSet = true;
}

bool V0_0_40_job::workingDirectoryIsSet() const
{
    return m_Working_directoryIsSet;
}

void V0_0_40_job::unsetWorking_directory()
{
    m_Working_directoryIsSet = false;
}
}
