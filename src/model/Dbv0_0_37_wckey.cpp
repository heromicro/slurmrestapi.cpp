...
Dbv0_0_37_wckey::Dbv0_0_37_wckey()
{
...
void Dbv0_0_37_wckey::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_wckey::toJson() const
{
...
bool Dbv0_0_37_wckey::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_37_wckey::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_wckey::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<utility::string_t>& Dbv0_0_37_wckey::getAccounts()
{
    return m_Accounts;
}

void Dbv0_0_37_wckey::setAccounts(const std::vector<utility::string_t>& value)
{
    m_Accounts = value;
    m_AccountsIsSet = true;
}

bool Dbv0_0_37_wckey::accountsIsSet() const
{
    return m_AccountsIsSet;
}

void Dbv0_0_37_wckey::unsetAccounts()
{
    m_AccountsIsSet = false;
}
utility::string_t Dbv0_0_37_wckey::getCluster() const
{
    return m_Cluster;
}

void Dbv0_0_37_wckey::setCluster(const utility::string_t& value)
{
    m_Cluster = value;
    m_ClusterIsSet = true;
}

bool Dbv0_0_37_wckey::clusterIsSet() const
{
    return m_ClusterIsSet;
}

void Dbv0_0_37_wckey::unsetCluster()
{
    m_ClusterIsSet = false;
}
int32_t Dbv0_0_37_wckey::getId() const
{
    return m_Id;
}

void Dbv0_0_37_wckey::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Dbv0_0_37_wckey::idIsSet() const
{
    return m_IdIsSet;
}

void Dbv0_0_37_wckey::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t Dbv0_0_37_wckey::getName() const
{
    return m_Name;
}

void Dbv0_0_37_wckey::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Dbv0_0_37_wckey::nameIsSet() const
{
    return m_NameIsSet;
}

void Dbv0_0_37_wckey::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Dbv0_0_37_wckey::getUser() const
{
    return m_User;
}

void Dbv0_0_37_wckey::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Dbv0_0_37_wckey::userIsSet() const
{
    return m_UserIsSet;
}

void Dbv0_0_37_wckey::unsetUser()
{
    m_UserIsSet = false;
}
std::vector<utility::string_t>& Dbv0_0_37_wckey::getFlags()
{
    return m_Flags;
}

void Dbv0_0_37_wckey::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool Dbv0_0_37_wckey::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void Dbv0_0_37_wckey::unsetFlags()
{
    m_FlagsIsSet = false;
}
}
