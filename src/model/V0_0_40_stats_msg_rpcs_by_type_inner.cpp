...
V0_0_40_stats_msg_rpcs_by_type_inner::V0_0_40_stats_msg_rpcs_by_type_inner()
{
...
void V0_0_40_stats_msg_rpcs_by_type_inner::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_stats_msg_rpcs_by_type_inner::toJson() const
{
...
bool V0_0_40_stats_msg_rpcs_by_type_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_stats_msg_rpcs_by_type_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_stats_msg_rpcs_by_type_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_stats_msg_rpcs_by_type_inner::getMessageType() const
{
    return m_Message_type;
}

void V0_0_40_stats_msg_rpcs_by_type_inner::setMessageType(const utility::string_t& value)
{
    m_Message_type = value;
    m_Message_typeIsSet = true;
}

bool V0_0_40_stats_msg_rpcs_by_type_inner::messageTypeIsSet() const
{
    return m_Message_typeIsSet;
}

void V0_0_40_stats_msg_rpcs_by_type_inner::unsetMessage_type()
{
    m_Message_typeIsSet = false;
}
int32_t V0_0_40_stats_msg_rpcs_by_type_inner::getTypeId() const
{
    return m_Type_id;
}

void V0_0_40_stats_msg_rpcs_by_type_inner::setTypeId(int32_t value)
{
    m_Type_id = value;
    m_Type_idIsSet = true;
}

bool V0_0_40_stats_msg_rpcs_by_type_inner::r_typeIdIsSet() const
{
    return m_Type_idIsSet;
}

void V0_0_40_stats_msg_rpcs_by_type_inner::unsetType_id()
{
    m_Type_idIsSet = false;
}
int64_t V0_0_40_stats_msg_rpcs_by_type_inner::getCount() const
{
    return m_Count;
}

void V0_0_40_stats_msg_rpcs_by_type_inner::setCount(int64_t value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool V0_0_40_stats_msg_rpcs_by_type_inner::countIsSet() const
{
    return m_CountIsSet;
}

void V0_0_40_stats_msg_rpcs_by_type_inner::unsetCount()
{
    m_CountIsSet = false;
}
int64_t V0_0_40_stats_msg_rpcs_by_type_inner::getAverageTime() const
{
    return m_Average_time;
}

void V0_0_40_stats_msg_rpcs_by_type_inner::setAverageTime(int64_t value)
{
    m_Average_time = value;
    m_Average_timeIsSet = true;
}

bool V0_0_40_stats_msg_rpcs_by_type_inner::averageTimeIsSet() const
{
    return m_Average_timeIsSet;
}

void V0_0_40_stats_msg_rpcs_by_type_inner::unsetAverage_time()
{
    m_Average_timeIsSet = false;
}
int64_t V0_0_40_stats_msg_rpcs_by_type_inner::getTotalTime() const
{
    return m_Total_time;
}

void V0_0_40_stats_msg_rpcs_by_type_inner::setTotalTime(int64_t value)
{
    m_Total_time = value;
    m_Total_timeIsSet = true;
}

bool V0_0_40_stats_msg_rpcs_by_type_inner::totalTimeIsSet() const
{
    return m_Total_timeIsSet;
}

void V0_0_40_stats_msg_rpcs_by_type_inner::unsetTotal_time()
{
    m_Total_timeIsSet = false;
}
}
