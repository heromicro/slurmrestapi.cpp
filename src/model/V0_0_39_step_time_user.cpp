...
#include "slurmrestapi/model/V0_0_39_step_time_user.h"
...
V0_0_39_step_time_user::V0_0_39_step_time_user()
{
    m_Microseconds = 0;
...
void V0_0_39_step_time_user::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_step_time_user::toJson() const
{
...
bool V0_0_39_step_time_user::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_39_step_time_user::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_step_time_user::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_39_step_time_user::getMicroseconds() const
{
    return m_Microseconds;
}

void V0_0_39_step_time_user::setMicroseconds(int32_t value)
{
    m_Microseconds = value;
    m_MicrosecondsIsSet = true;
}

bool V0_0_39_step_time_user::microsecondsIsSet() const
{
    return m_MicrosecondsIsSet;
}

void V0_0_39_step_time_user::unsetMicroseconds()
{
    m_MicrosecondsIsSet = false;
}
}
