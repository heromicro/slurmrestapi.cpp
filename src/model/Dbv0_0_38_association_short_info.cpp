...
Dbv0_0_38_association_short_info::Dbv0_0_38_association_short_info()
{
...
void Dbv0_0_38_association_short_info::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_association_short_info::toJson() const
{
...
bool Dbv0_0_38_association_short_info::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_38_association_short_info::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_association_short_info::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Dbv0_0_38_association_short_info::getAccount() const
{
    return m_Account;
}

void Dbv0_0_38_association_short_info::setAccount(const utility::string_t& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool Dbv0_0_38_association_short_info::accountIsSet() const
{
    return m_AccountIsSet;
}

void Dbv0_0_38_association_short_info::unsetAccount()
{
    m_AccountIsSet = false;
}
utility::string_t Dbv0_0_38_association_short_info::getCluster() const
{
    return m_Cluster;
}

void Dbv0_0_38_association_short_info::setCluster(const utility::string_t& value)
{
    m_Cluster = value;
    m_ClusterIsSet = true;
}

bool Dbv0_0_38_association_short_info::clusterIsSet() const
{
    return m_ClusterIsSet;
}

void Dbv0_0_38_association_short_info::unsetCluster()
{
    m_ClusterIsSet = false;
}
utility::string_t Dbv0_0_38_association_short_info::getPartition() const
{
    return m_Partition;
}

void Dbv0_0_38_association_short_info::setPartition(const utility::string_t& value)
{
    m_Partition = value;
    m_PartitionIsSet = true;
}

bool Dbv0_0_38_association_short_info::partitionIsSet() const
{
    return m_PartitionIsSet;
}

void Dbv0_0_38_association_short_info::unsetPartition()
{
    m_PartitionIsSet = false;
}
utility::string_t Dbv0_0_38_association_short_info::getUser() const
{
    return m_User;
}

void Dbv0_0_38_association_short_info::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Dbv0_0_38_association_short_info::userIsSet() const
{
    return m_UserIsSet;
}

void Dbv0_0_38_association_short_info::unsetUser()
{
    m_UserIsSet = false;
}
}
