...
Dbv0_0_38_diag_statistics_users_inner_time::Dbv0_0_38_diag_statistics_users_inner_time()
{
    m_Average = 0;
...
void Dbv0_0_38_diag_statistics_users_inner_time::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_diag_statistics_users_inner_time::toJson() const
{
...
bool Dbv0_0_38_diag_statistics_users_inner_time::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_38_diag_statistics_users_inner_time::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_diag_statistics_users_inner_time::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t Dbv0_0_38_diag_statistics_users_inner_time::getAverage() const
{
    return m_Average;
}

void Dbv0_0_38_diag_statistics_users_inner_time::setAverage(int32_t value)
{
    m_Average = value;
    m_AverageIsSet = true;
}

bool Dbv0_0_38_diag_statistics_users_inner_time::averageIsSet() const
{
    return m_AverageIsSet;
}

void Dbv0_0_38_diag_statistics_users_inner_time::unsetAverage()
{
    m_AverageIsSet = false;
}
int32_t Dbv0_0_38_diag_statistics_users_inner_time::getTotal() const
{
    return m_Total;
}

void Dbv0_0_38_diag_statistics_users_inner_time::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool Dbv0_0_38_diag_statistics_users_inner_time::totalIsSet() const
{
    return m_TotalIsSet;
}

void Dbv0_0_38_diag_statistics_users_inner_time::unsetTotal()
{
    m_TotalIsSet = false;
}
}
