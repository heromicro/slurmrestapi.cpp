...
#include "slurmrestapi/model/Dbv0_0_37_qos.h"
...
void Dbv0_0_37_qos::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_qos::toJson() const
{
...
bool Dbv0_0_37_qos::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("limits"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_qos_limits> refVal_setLimits;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("preempt"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_qos_preempt> refVal_setPreempt;
...
void Dbv0_0_37_qos::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_qos::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Dbv0_0_37_qos::getDescription() const
{
    return m_Description;
}

void Dbv0_0_37_qos::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool Dbv0_0_37_qos::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void Dbv0_0_37_qos::unsetDescription()
{
    m_DescriptionIsSet = false;
}
std::vector<utility::string_t>& Dbv0_0_37_qos::getFlags()
{
    return m_Flags;
}

void Dbv0_0_37_qos::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool Dbv0_0_37_qos::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void Dbv0_0_37_qos::unsetFlags()
{
    m_FlagsIsSet = false;
}
utility::string_t Dbv0_0_37_qos::getId() const
{
    return m_Id;
}

void Dbv0_0_37_qos::setId(const utility::string_t& value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool Dbv0_0_37_qos::idIsSet() const
{
    return m_IdIsSet;
}

void Dbv0_0_37_qos::unsetId()
{
    m_IdIsSet = false;
}
std::shared_ptr<Dbv0_0_37_qos_limits> Dbv0_0_37_qos::getLimits() const
{
    return m_Limits;
}

void Dbv0_0_37_qos::setLimits(const std::shared_ptr<Dbv0_0_37_qos_limits>& value)
{
    m_Limits = value;
    m_LimitsIsSet = true;
}

bool Dbv0_0_37_qos::limitsIsSet() const
{
    return m_LimitsIsSet;
}

void Dbv0_0_37_qos::unsetLimits()
{
    m_LimitsIsSet = false;
}
std::shared_ptr<Dbv0_0_37_qos_preempt> Dbv0_0_37_qos::getPreempt() const
{
    return m_Preempt;
}

void Dbv0_0_37_qos::setPreempt(const std::shared_ptr<Dbv0_0_37_qos_preempt>& value)
{
    m_Preempt = value;
    m_PreemptIsSet = true;
}

bool Dbv0_0_37_qos::preemptIsSet() const
{
    return m_PreemptIsSet;
}

void Dbv0_0_37_qos::unsetPreempt()
{
    m_PreemptIsSet = false;
}
int32_t Dbv0_0_37_qos::getPriority() const
{
    return m_Priority;
}

void Dbv0_0_37_qos::setPriority(int32_t value)
{
    m_Priority = value;
    m_PriorityIsSet = true;
}

bool Dbv0_0_37_qos::priorityIsSet() const
{
    return m_PriorityIsSet;
}

void Dbv0_0_37_qos::unsetPriority()
{
    m_PriorityIsSet = false;
}
double Dbv0_0_37_qos::getUsageFactor() const
{
    return m_Usage_factor;
}

void Dbv0_0_37_qos::setUsageFactor(double value)
{
    m_Usage_factor = value;
    m_Usage_factorIsSet = true;
}

bool Dbv0_0_37_qos::usageFactorIsSet() const
{
    return m_Usage_factorIsSet;
}

void Dbv0_0_37_qos::unsetUsage_factor()
{
    m_Usage_factorIsSet = false;
}
double Dbv0_0_37_qos::getUsageThreshold() const
{
    return m_Usage_threshold;
}

void Dbv0_0_37_qos::setUsageThreshold(double value)
{
    m_Usage_threshold = value;
    m_Usage_thresholdIsSet = true;
}

bool Dbv0_0_37_qos::usageThresholdIsSet() const
{
    return m_Usage_thresholdIsSet;
}

void Dbv0_0_37_qos::unsetUsage_threshold()
{
    m_Usage_thresholdIsSet = false;
}
}
