...
V0_0_39_job_mcs::V0_0_39_job_mcs()
{
...
void V0_0_39_job_mcs::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_job_mcs::toJson() const
{
...
bool V0_0_39_job_mcs::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_39_job_mcs::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_job_mcs::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_39_job_mcs::getLabel() const
{
    return m_Label;
}

void V0_0_39_job_mcs::setLabel(const utility::string_t& value)
{
    m_Label = value;
    m_LabelIsSet = true;
}

bool V0_0_39_job_mcs::labelIsSet() const
{
    return m_LabelIsSet;
}

void V0_0_39_job_mcs::unsetLabel()
{
    m_LabelIsSet = false;
}
}
