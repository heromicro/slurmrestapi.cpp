...
bool V0_0_39_step_CPU::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("requested_frequency"))))
    {
        ...
        {
            std::shared_ptr<V0_0_39_step_CPU_requested_frequency> refVal_setRequestedFrequency;
...
std::shared_ptr<V0_0_39_step_CPU_requested_frequency> V0_0_39_step_CPU::getRequestedFrequency() const
{
    return m_Requested_frequency;
}

void V0_0_39_step_CPU::setRequestedFrequency(const std::shared_ptr<V0_0_39_step_CPU_requested_frequency>& value)
{
    m_Requested_frequency = value;
    m_Requested_frequencyIsSet = true;
}

bool V0_0_39_step_CPU::requestedFrequencyIsSet() const
{
    return m_Requested_frequencyIsSet;
}

void V0_0_39_step_CPU::unsetRequested_frequency()
{
    m_Requested_frequencyIsSet = false;
}
