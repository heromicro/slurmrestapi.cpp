...
#include "slurmrestapi/model/Dbv0_0_37_diag_statistics_users_inner.h"
...
Dbv0_0_37_diag_statistics_users_inner::Dbv0_0_37_diag_statistics_users_inner()
{
...
void Dbv0_0_37_diag_statistics_users_inner::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_diag_statistics_users_inner::toJson() const
{
...
bool Dbv0_0_37_diag_statistics_users_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("time"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_diag_statistics_users_inner_time> refVal_setTime;
...
void Dbv0_0_37_diag_statistics_users_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_diag_statistics_users_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Dbv0_0_37_diag_statistics_users_inner::getUser() const
{
    return m_User;
}

void Dbv0_0_37_diag_statistics_users_inner::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Dbv0_0_37_diag_statistics_users_inner::userIsSet() const
{
    return m_UserIsSet;
}

void Dbv0_0_37_diag_statistics_users_inner::unsetUser()
{
    m_UserIsSet = false;
}
int32_t Dbv0_0_37_diag_statistics_users_inner::getCount() const
{
    return m_Count;
}

void Dbv0_0_37_diag_statistics_users_inner::setCount(int32_t value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool Dbv0_0_37_diag_statistics_users_inner::countIsSet() const
{
    return m_CountIsSet;
}

void Dbv0_0_37_diag_statistics_users_inner::unsetCount()
{
    m_CountIsSet = false;
}
std::shared_ptr<Dbv0_0_37_diag_statistics_users_inner_time> Dbv0_0_37_diag_statistics_users_inner::getTime() const
{
    return m_Time;
}

void Dbv0_0_37_diag_statistics_users_inner::setTime(const std::shared_ptr<Dbv0_0_37_diag_statistics_users_inner_time>& value)
{
    m_Time = value;
    m_TimeIsSet = true;
}

bool Dbv0_0_37_diag_statistics_users_inner::timeIsSet() const
{
    return m_TimeIsSet;
}

void Dbv0_0_37_diag_statistics_users_inner::unsetTime()
{
    m_TimeIsSet = false;
}
}
