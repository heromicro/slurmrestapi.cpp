...
V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::toJson() const
{
...
bool V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int32_t V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes::unsetnumber()
{
    m_numberIsSet = false;
}
}
