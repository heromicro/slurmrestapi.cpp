...
V0_0_41_job_desc_msg_rlimits_stack::V0_0_41_job_desc_msg_rlimits_stack()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_job_desc_msg_rlimits_stack::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_job_desc_msg_rlimits_stack::toJson() const
{
...
bool V0_0_41_job_desc_msg_rlimits_stack::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_job_desc_msg_rlimits_stack::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_job_desc_msg_rlimits_stack::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_job_desc_msg_rlimits_stack::isSet() const
{
    return m_set;
}

void V0_0_41_job_desc_msg_rlimits_stack::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_job_desc_msg_rlimits_stack::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_job_desc_msg_rlimits_stack::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_job_desc_msg_rlimits_stack::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_job_desc_msg_rlimits_stack::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_job_desc_msg_rlimits_stack::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_job_desc_msg_rlimits_stack::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int64_t V0_0_41_job_desc_msg_rlimits_stack::getNumber() const
{
    return m_number;
}

void V0_0_41_job_desc_msg_rlimits_stack::setNumber(int64_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_job_desc_msg_rlimits_stack::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_job_desc_msg_rlimits_stack::unsetnumber()
{
    m_numberIsSet = false;
}
}
