...
std::shared_ptr<V0_0_39_uint32_no_val> V0_0_39_qos_limits_min::getPriorityThreshold() const
{
    return m_Priority_threshold;
}

void V0_0_39_qos_limits_min::setPriorityThreshold(const std::shared_ptr<V0_0_39_uint32_no_val>& value)
{
    m_Priority_threshold = value;
    m_Priority_thresholdIsSet = true;
}

bool V0_0_39_qos_limits_min::priorityThresholdIsSet() const
{
    return m_Priority_thresholdIsSet;
}

void V0_0_39_qos_limits_min::unsetPriority_threshold()
{
    m_Priority_thresholdIsSet = false;
}
