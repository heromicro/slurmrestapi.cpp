...
Dbv0_0_37_job_wckey::Dbv0_0_37_job_wckey()
{
...
void Dbv0_0_37_job_wckey::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_job_wckey::toJson() const
{
...
bool Dbv0_0_37_job_wckey::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_37_job_wckey::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_job_wckey::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Dbv0_0_37_job_wckey::getWckey() const
{
    return m_Wckey;
}

void Dbv0_0_37_job_wckey::setWckey(const utility::string_t& value)
{
    m_Wckey = value;
    m_WckeyIsSet = true;
}

bool Dbv0_0_37_job_wckey::wckeyIsSet() const
{
    return m_WckeyIsSet;
}

void Dbv0_0_37_job_wckey::unsetWckey()
{
    m_WckeyIsSet = false;
}
std::vector<utility::string_t>& Dbv0_0_37_job_wckey::getFlags()
{
    return m_Flags;
}

void Dbv0_0_37_job_wckey::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool Dbv0_0_37_job_wckey::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void Dbv0_0_37_job_wckey::unsetFlags()
{
    m_FlagsIsSet = false;
}
}
