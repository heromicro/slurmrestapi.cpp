...
V0_0_41_job_desc_msg_segment_size::V0_0_41_job_desc_msg_segment_size()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_job_desc_msg_segment_size::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_job_desc_msg_segment_size::toJson() const
{
...
bool V0_0_41_job_desc_msg_segment_size::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_job_desc_msg_segment_size::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_job_desc_msg_segment_size::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_job_desc_msg_segment_size::isSet() const
{
    return m_set;
}

void V0_0_41_job_desc_msg_segment_size::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_job_desc_msg_segment_size::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_job_desc_msg_segment_size::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_job_desc_msg_segment_size::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_job_desc_msg_segment_size::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_job_desc_msg_segment_size::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_job_desc_msg_segment_size::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int32_t V0_0_41_job_desc_msg_segment_size::getNumber() const
{
    return m_number;
}

void V0_0_41_job_desc_msg_segment_size::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_job_desc_msg_segment_size::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_job_desc_msg_segment_size::unsetnumber()
{
    m_numberIsSet = false;
}
}
