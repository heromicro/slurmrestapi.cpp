...
V0_0_39_partition_info_cpus::V0_0_39_partition_info_cpus()
{
    m_Task_binding = 0;
...
void V0_0_39_partition_info_cpus::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_partition_info_cpus::toJson() const
{
...
bool V0_0_39_partition_info_cpus::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_39_partition_info_cpus::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_partition_info_cpus::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_39_partition_info_cpus::getTaskBinding() const
{
    return m_Task_binding;
}

void V0_0_39_partition_info_cpus::setTaskBinding(int32_t value)
{
    m_Task_binding = value;
    m_Task_bindingIsSet = true;
}

bool V0_0_39_partition_info_cpus::taskBindingIsSet() const
{
    return m_Task_bindingIsSet;
}

void V0_0_39_partition_info_cpus::unsetTask_binding()
{
    m_Task_bindingIsSet = false;
}
int32_t V0_0_39_partition_info_cpus::getTotal() const
{
    return m_Total;
}

void V0_0_39_partition_info_cpus::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool V0_0_39_partition_info_cpus::totalIsSet() const
{
    return m_TotalIsSet;
}

void V0_0_39_partition_info_cpus::unsetTotal()
{
    m_TotalIsSet = false;
}
}
