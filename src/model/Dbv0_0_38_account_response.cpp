...
Dbv0_0_38_account_response::Dbv0_0_38_account_response()
{
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
}
...
void Dbv0_0_38_account_response::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_account_response::toJson() const
{
...
bool Dbv0_0_38_account_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_38_account_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_account_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_38_meta> Dbv0_0_38_account_response::getMeta() const
{
    return m_Meta;
}

void Dbv0_0_38_account_response::setMeta(const std::shared_ptr<Dbv0_0_38_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool Dbv0_0_38_account_response::metaIsSet() const
{
    return m_MetaIsSet;
}

void Dbv0_0_38_account_response::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_error>>& Dbv0_0_38_account_response::getErrors()
{
    return m_Errors;
}

void Dbv0_0_38_account_response::setErrors(const std::vector<std::shared_ptr<Dbv0_0_38_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool Dbv0_0_38_account_response::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void Dbv0_0_38_account_response::unsetErrors()
{
    m_ErrorsIsSet = false;
}
}
