...
V0_0_37_partition::V0_0_37_partition()
{
    m_FlagsIsSet = false;
...
void V0_0_37_partition::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_37_partition::toJson() const
{
...
bool V0_0_37_partition::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_37_partition::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_37_partition::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<utility::string_t>& V0_0_37_partition::getFlags()
{
    return m_Flags;
}

void V0_0_37_partition::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool V0_0_37_partition::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void V0_0_37_partition::unsetFlags()
{
    m_FlagsIsSet = false;
}
std::vector<utility::string_t>& V0_0_37_partition::getPreemptionMode()
{
    return m_Preemption_mode;
}

void V0_0_37_partition::setPreemptionMode(const std::vector<utility::string_t>& value)
{
    m_Preemption_mode = value;
    m_Preemption_modeIsSet = true;
}

bool V0_0_37_partition::preemptionModeIsSet() const
{
    return m_Preemption_modeIsSet;
}

void V0_0_37_partition::unsetPreemption_mode()
{
    m_Preemption_modeIsSet = false;
}
utility::string_t V0_0_37_partition::getAllowedAllocationNodes() const
{
    return m_Allowed_allocation_nodes;
}

void V0_0_37_partition::setAllowedAllocationNodes(const utility::string_t& value)
{
    m_Allowed_allocation_nodes = value;
    m_Allowed_allocation_nodesIsSet = true;
}

bool V0_0_37_partition::allowedAllocationNodesIsSet() const
{
    return m_Allowed_allocation_nodesIsSet;
}

void V0_0_37_partition::unsetAllowed_allocation_nodes()
{
    m_Allowed_allocation_nodesIsSet = false;
}
utility::string_t V0_0_37_partition::getAllowedAccounts() const
{
    return m_Allowed_accounts;
}

void V0_0_37_partition::setAllowedAccounts(const utility::string_t& value)
{
    m_Allowed_accounts = value;
    m_Allowed_accountsIsSet = true;
}

bool V0_0_37_partition::allowedAccountsIsSet() const
{
    return m_Allowed_accountsIsSet;
}

void V0_0_37_partition::unsetAllowed_accounts()
{
    m_Allowed_accountsIsSet = false;
}
utility::string_t V0_0_37_partition::getAllowedGroups() const
{
    return m_Allowed_groups;
}

void V0_0_37_partition::setAllowedGroups(const utility::string_t& value)
{
    m_Allowed_groups = value;
    m_Allowed_groupsIsSet = true;
}

bool V0_0_37_partition::allowedGroupsIsSet() const
{
    return m_Allowed_groupsIsSet;
}

void V0_0_37_partition::unsetAllowed_groups()
{
    m_Allowed_groupsIsSet = false;
}
utility::string_t V0_0_37_partition::getAllowedQos() const
{
    return m_Allowed_qos;
}

void V0_0_37_partition::setAllowedQos(const utility::string_t& value)
{
    m_Allowed_qos = value;
    m_Allowed_qosIsSet = true;
}

bool V0_0_37_partition::allowedQosIsSet() const
{
    return m_Allowed_qosIsSet;
}

void V0_0_37_partition::unsetAllowed_qos()
{
    m_Allowed_qosIsSet = false;
}
utility::string_t V0_0_37_partition::getAlternative() const
{
    return m_Alternative;
}

void V0_0_37_partition::setAlternative(const utility::string_t& value)
{
    m_Alternative = value;
    m_AlternativeIsSet = true;
}

bool V0_0_37_partition::alternativeIsSet() const
{
    return m_AlternativeIsSet;
}

void V0_0_37_partition::unsetAlternative()
{
    m_AlternativeIsSet = false;
}
utility::string_t V0_0_37_partition::getBillingWeights() const
{
    return m_Billing_weights;
}

void V0_0_37_partition::setBillingWeights(const utility::string_t& value)
{
    m_Billing_weights = value;
    m_Billing_weightsIsSet = true;
}

bool V0_0_37_partition::billingWeightsIsSet() const
{
    return m_Billing_weightsIsSet;
}

void V0_0_37_partition::unsetBilling_weights()
{
    m_Billing_weightsIsSet = false;
}
int64_t V0_0_37_partition::getDefaultMemoryPerCpu() const
{
    return m_Default_memory_per_cpu;
}

void V0_0_37_partition::setDefaultMemoryPerCpu(int64_t value)
{
    m_Default_memory_per_cpu = value;
    m_Default_memory_per_cpuIsSet = true;
}

bool V0_0_37_partition::defaultMemoryPerCpuIsSet() const
{
    return m_Default_memory_per_cpuIsSet;
}

void V0_0_37_partition::unsetDefault_memory_per_cpu()
{
    m_Default_memory_per_cpuIsSet = false;
}
int64_t V0_0_37_partition::getDefaultTimeLimit() const
{
    return m_Default_time_limit;
}

void V0_0_37_partition::setDefaultTimeLimit(int64_t value)
{
    m_Default_time_limit = value;
    m_Default_time_limitIsSet = true;
}

bool V0_0_37_partition::defaultTimeLimitIsSet() const
{
    return m_Default_time_limitIsSet;
}

void V0_0_37_partition::unsetDefault_time_limit()
{
    m_Default_time_limitIsSet = false;
}
utility::string_t V0_0_37_partition::getDeniedAccounts() const
{
    return m_Denied_accounts;
}

void V0_0_37_partition::setDeniedAccounts(const utility::string_t& value)
{
    m_Denied_accounts = value;
    m_Denied_accountsIsSet = true;
}

bool V0_0_37_partition::deniedAccountsIsSet() const
{
    return m_Denied_accountsIsSet;
}

void V0_0_37_partition::unsetDenied_accounts()
{
    m_Denied_accountsIsSet = false;
}
utility::string_t V0_0_37_partition::getDeniedQos() const
{
    return m_Denied_qos;
}

void V0_0_37_partition::setDeniedQos(const utility::string_t& value)
{
    m_Denied_qos = value;
    m_Denied_qosIsSet = true;
}

bool V0_0_37_partition::deniedQosIsSet() const
{
    return m_Denied_qosIsSet;
}

void V0_0_37_partition::unsetDenied_qos()
{
    m_Denied_qosIsSet = false;
}
int64_t V0_0_37_partition::getPreemptionGraceTime() const
{
    return m_Preemption_grace_time;
}

void V0_0_37_partition::setPreemptionGraceTime(int64_t value)
{
    m_Preemption_grace_time = value;
    m_Preemption_grace_timeIsSet = true;
}

bool V0_0_37_partition::preemptionGraceTimeIsSet() const
{
    return m_Preemption_grace_timeIsSet;
}

void V0_0_37_partition::unsetPreemption_grace_time()
{
    m_Preemption_grace_timeIsSet = false;
}
int32_t V0_0_37_partition::getMaximumCpusPerNode() const
{
    return m_Maximum_cpus_per_node;
}

void V0_0_37_partition::setMaximumCpusPerNode(int32_t value)
{
    m_Maximum_cpus_per_node = value;
    m_Maximum_cpus_per_nodeIsSet = true;
}

bool V0_0_37_partition::maximumCpusPerNodeIsSet() const
{
    return m_Maximum_cpus_per_nodeIsSet;
}

void V0_0_37_partition::unsetMaximum_cpus_per_node()
{
    m_Maximum_cpus_per_nodeIsSet = false;
}
int64_t V0_0_37_partition::getMaximumMemoryPerNode() const
{
    return m_Maximum_memory_per_node;
}

void V0_0_37_partition::setMaximumMemoryPerNode(int64_t value)
{
    m_Maximum_memory_per_node = value;
    m_Maximum_memory_per_nodeIsSet = true;
}

bool V0_0_37_partition::maximumMemoryPerNodeIsSet() const
{
    return m_Maximum_memory_per_nodeIsSet;
}

void V0_0_37_partition::unsetMaximum_memory_per_node()
{
    m_Maximum_memory_per_nodeIsSet = false;
}
int32_t V0_0_37_partition::getMaximumNodesPerJob() const
{
    return m_Maximum_nodes_per_job;
}

void V0_0_37_partition::setMaximumNodesPerJob(int32_t value)
{
    m_Maximum_nodes_per_job = value;
    m_Maximum_nodes_per_jobIsSet = true;
}

bool V0_0_37_partition::maximumNodesPerJobIsSet() const
{
    return m_Maximum_nodes_per_jobIsSet;
}

void V0_0_37_partition::unsetMaximum_nodes_per_job()
{
    m_Maximum_nodes_per_jobIsSet = false;
}
int64_t V0_0_37_partition::getMaxTimeLimit() const
{
    return m_Max_time_limit;
}

void V0_0_37_partition::setMaxTimeLimit(int64_t value)
{
    m_Max_time_limit = value;
    m_Max_time_limitIsSet = true;
}

bool V0_0_37_partition::maxTimeLimitIsSet() const
{
    return m_Max_time_limitIsSet;
}

void V0_0_37_partition::unsetMax_time_limit()
{
    m_Max_time_limitIsSet = false;
}
int32_t V0_0_37_partition::getMinNodesPerJob() const
{
    return m_Min_nodes_per_job;
}

void V0_0_37_partition::setMinNodesPerJob(int32_t value)
{
    m_Min_nodes_per_job = value;
    m_Min_nodes_per_jobIsSet = true;
}

bool V0_0_37_partition::minNodesPerJobIsSet() const
{
    return m_Min_nodes_per_jobIsSet;
}

void V0_0_37_partition::unsetMin_nodes_per_job()
{
    m_Min_nodes_per_jobIsSet = false;
}
utility::string_t V0_0_37_partition::getName() const
{
    return m_Name;
}

void V0_0_37_partition::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_37_partition::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_37_partition::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t V0_0_37_partition::getNodes() const
{
    return m_Nodes;
}

void V0_0_37_partition::setNodes(const utility::string_t& value)
{
    m_Nodes = value;
    m_NodesIsSet = true;
}

bool V0_0_37_partition::nodesIsSet() const
{
    return m_NodesIsSet;
}

void V0_0_37_partition::unsetNodes()
{
    m_NodesIsSet = false;
}
int32_t V0_0_37_partition::getOverTimeLimit() const
{
    return m_Over_time_limit;
}

void V0_0_37_partition::setOverTimeLimit(int32_t value)
{
    m_Over_time_limit = value;
    m_Over_time_limitIsSet = true;
}

bool V0_0_37_partition::overTimeLimitIsSet() const
{
    return m_Over_time_limitIsSet;
}

void V0_0_37_partition::unsetOver_time_limit()
{
    m_Over_time_limitIsSet = false;
}
int32_t V0_0_37_partition::getPriorityJobFactor() const
{
    return m_Priority_job_factor;
}

void V0_0_37_partition::setPriorityJobFactor(int32_t value)
{
    m_Priority_job_factor = value;
    m_Priority_job_factorIsSet = true;
}

bool V0_0_37_partition::priorityJobFactorIsSet() const
{
    return m_Priority_job_factorIsSet;
}

void V0_0_37_partition::unsetPriority_job_factor()
{
    m_Priority_job_factorIsSet = false;
}
int32_t V0_0_37_partition::getPriorityTier() const
{
    return m_Priority_tier;
}

void V0_0_37_partition::setPriorityTier(int32_t value)
{
    m_Priority_tier = value;
    m_Priority_tierIsSet = true;
}

bool V0_0_37_partition::priorityTierIsSet() const
{
    return m_Priority_tierIsSet;
}

void V0_0_37_partition::unsetPriority_tier()
{
    m_Priority_tierIsSet = false;
}
utility::string_t V0_0_37_partition::getQos() const
{
    return m_Qos;
}

void V0_0_37_partition::setQos(const utility::string_t& value)
{
    m_Qos = value;
    m_QosIsSet = true;
}

bool V0_0_37_partition::qosIsSet() const
{
    return m_QosIsSet;
}

void V0_0_37_partition::unsetQos()
{
    m_QosIsSet = false;
}
utility::string_t V0_0_37_partition::getState() const
{
    return m_State;
}

void V0_0_37_partition::setState(const utility::string_t& value)
{
    m_State = value;
    m_StateIsSet = true;
}

bool V0_0_37_partition::stateIsSet() const
{
    return m_StateIsSet;
}

void V0_0_37_partition::unsetState()
{
    m_StateIsSet = false;
}
int32_t V0_0_37_partition::getTotalCpus() const
{
    return m_Total_cpus;
}

void V0_0_37_partition::setTotalCpus(int32_t value)
{
    m_Total_cpus = value;
    m_Total_cpusIsSet = true;
}

bool V0_0_37_partition::totalCpusIsSet() const
{
    return m_Total_cpusIsSet;
}

void V0_0_37_partition::unsetTotal_cpus()
{
    m_Total_cpusIsSet = false;
}
int32_t V0_0_37_partition::getTotalNodes() const
{
    return m_Total_nodes;
}

void V0_0_37_partition::setTotalNodes(int32_t value)
{
    m_Total_nodes = value;
    m_Total_nodesIsSet = true;
}

bool V0_0_37_partition::totalNodesIsSet() const
{
    return m_Total_nodesIsSet;
}

void V0_0_37_partition::unsetTotal_nodes()
{
    m_Total_nodesIsSet = false;
}
utility::string_t V0_0_37_partition::getTres() const
{
    return m_Tres;
}

void V0_0_37_partition::setTres(const utility::string_t& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool V0_0_37_partition::tresIsSet() const
{
    return m_TresIsSet;
}

void V0_0_37_partition::unsetTres()
{
    m_TresIsSet = false;
}
}
