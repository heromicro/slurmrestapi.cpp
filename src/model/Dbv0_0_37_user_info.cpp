...
Dbv0_0_37_user_info::Dbv0_0_37_user_info()
{
    m_ErrorsIsSet = false;
    m_UsersIsSet = false;
}
...
void Dbv0_0_37_user_info::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_user_info::toJson() const
{
...
bool Dbv0_0_37_user_info::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_37_user_info::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_user_info::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<Dbv0_0_37_error>>& Dbv0_0_37_user_info::getErrors()
{
    return m_Errors;
}

void Dbv0_0_37_user_info::setErrors(const std::vector<std::shared_ptr<Dbv0_0_37_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool Dbv0_0_37_user_info::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void Dbv0_0_37_user_info::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_37_user>>& Dbv0_0_37_user_info::getUsers()
{
    return m_Users;
}

void Dbv0_0_37_user_info::setUsers(const std::vector<std::shared_ptr<Dbv0_0_37_user>>& value)
{
    m_Users = value;
    m_UsersIsSet = true;
}

bool Dbv0_0_37_user_info::usersIsSet() const
{
    return m_UsersIsSet;
}

void Dbv0_0_37_user_info::unsetUsers()
{
    m_UsersIsSet = false;
}
}
