...
#include "slurmrestapi/model/Dbv0_0_38_diag_statistics.h"
...
Dbv0_0_38_diag_statistics::Dbv0_0_38_diag_statistics()
{
    m_Time_start = 0;
...
void Dbv0_0_38_diag_statistics::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_diag_statistics::toJson() const
{
...
bool Dbv0_0_38_diag_statistics::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("rollups"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Dbv0_0_38_diag_statistics_rollups_inner>> refVal_setRollups;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("RPCs"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Dbv0_0_38_diag_statistics_RPCs_inner>> refVal_setRPCs;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("users"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Dbv0_0_38_diag_statistics_users_inner>> refVal_setUsers;
...
void Dbv0_0_38_diag_statistics::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_diag_statistics::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t Dbv0_0_38_diag_statistics::getTimeStart() const
{
    return m_Time_start;
}

void Dbv0_0_38_diag_statistics::setTimeStart(int32_t value)
{
    m_Time_start = value;
    m_Time_startIsSet = true;
}

bool Dbv0_0_38_diag_statistics::timeStartIsSet() const
{
    return m_Time_startIsSet;
}

void Dbv0_0_38_diag_statistics::unsetTime_start()
{
    m_Time_startIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_diag_statistics_rollups_inner>>& Dbv0_0_38_diag_statistics::getRollups()
{
    return m_Rollups;
}

void Dbv0_0_38_diag_statistics::setRollups(const std::vector<std::shared_ptr<Dbv0_0_38_diag_statistics_rollups_inner>>& value)
{
    m_Rollups = value;
    m_RollupsIsSet = true;
}

bool Dbv0_0_38_diag_statistics::rollupsIsSet() const
{
    return m_RollupsIsSet;
}

void Dbv0_0_38_diag_statistics::unsetRollups()
{
    m_RollupsIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_diag_statistics_RPCs_inner>>& Dbv0_0_38_diag_statistics::getRPCs()
{
    return m_RPCs;
}

void Dbv0_0_38_diag_statistics::setRPCs(const std::vector<std::shared_ptr<Dbv0_0_38_diag_statistics_RPCs_inner>>& value)
{
    m_RPCs = value;
    m_RPCsIsSet = true;
}

bool Dbv0_0_38_diag_statistics::rPCsIsSet() const
{
    return m_RPCsIsSet;
}

void Dbv0_0_38_diag_statistics::unsetRPCs()
{
    m_RPCsIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_diag_statistics_users_inner>>& Dbv0_0_38_diag_statistics::getUsers()
{
    return m_Users;
}

void Dbv0_0_38_diag_statistics::setUsers(const std::vector<std::shared_ptr<Dbv0_0_38_diag_statistics_users_inner>>& value)
{
    m_Users = value;
    m_UsersIsSet = true;
}

bool Dbv0_0_38_diag_statistics::usersIsSet() const
{
    return m_UsersIsSet;
}

void Dbv0_0_38_diag_statistics::unsetUsers()
{
    m_UsersIsSet = false;
}
}
