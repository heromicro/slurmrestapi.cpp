...
V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner()
{
    m_Type_id = 0;
...
void V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::toJson() const
{
...
bool V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::getTypeId() const
{
    return m_Type_id;
}

void V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::setTypeId(int32_t value)
{
    m_Type_id = value;
    m_Type_idIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::r_typeIdIsSet() const
{
    return m_Type_idIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::unsetType_id()
{
    m_Type_idIsSet = false;
}
utility::string_t V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::getMessageType() const
{
    return m_Message_type;
}

void V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::setMessageType(const utility::string_t& value)
{
    m_Message_type = value;
    m_Message_typeIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::messageTypeIsSet() const
{
    return m_Message_typeIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::unsetMessage_type()
{
    m_Message_typeIsSet = false;
}
int32_t V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::getCount() const
{
    return m_Count;
}

void V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::setCount(int32_t value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::countIsSet() const
{
    return m_CountIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_pending_rpcs_inner::unsetCount()
{
    m_CountIsSet = false;
}
}
