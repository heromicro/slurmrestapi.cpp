...
V0_0_39_job_exit_code::V0_0_39_job_exit_code()
{
...
void V0_0_39_job_exit_code::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_job_exit_code::toJson() const
{
...
bool V0_0_39_job_exit_code::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("signal"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_job_exit_code_signal> refVal_setSignal;
...
void V0_0_39_job_exit_code::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_job_exit_code::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_39_job_exit_code::getStatus() const
{
    return m_Status;
}

void V0_0_39_job_exit_code::setStatus(const utility::string_t& value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool V0_0_39_job_exit_code::statusIsSet() const
{
    return m_StatusIsSet;
}

void V0_0_39_job_exit_code::unsetStatus()
{
    m_StatusIsSet = false;
}
int32_t V0_0_39_job_exit_code::getReturnCode() const
{
    return m_Return_code;
}

void V0_0_39_job_exit_code::setReturnCode(int32_t value)
{
    m_Return_code = value;
    m_Return_codeIsSet = true;
}

bool V0_0_39_job_exit_code::returnCodeIsSet() const
{
    return m_Return_codeIsSet;
}

void V0_0_39_job_exit_code::unsetReturn_code()
{
    m_Return_codeIsSet = false;
}
std::shared_ptr<V0_0_39_job_exit_code_signal> V0_0_39_job_exit_code::getSignal() const
{
    return m_Signal;
}

void V0_0_39_job_exit_code::setSignal(const std::shared_ptr<V0_0_39_job_exit_code_signal>& value)
{
    m_Signal = value;
    m_SignalIsSet = true;
}

bool V0_0_39_job_exit_code::signalIsSet() const
{
    return m_SignalIsSet;
}

void V0_0_39_job_exit_code::unsetSignal()
{
    m_SignalIsSet = false;
}
}
