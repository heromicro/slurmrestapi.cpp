...
V0_0_38_diag_statistics::V0_0_38_diag_statistics()
{
    m_Parts_packed = 0;
...
void V0_0_38_diag_statistics::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_38_diag_statistics::toJson() const
{
...
bool V0_0_38_diag_statistics::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("bf_table_size_mean"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            int32_t refVal_setBfTableSizeMean;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("rpcs_by_message_type"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_38_diag_rpcm>> refVal_setRpcsByMessageType;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("rpcs_by_user"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_38_diag_rpcu>> refVal_setRpcsByUser;
...
void V0_0_38_diag_statistics::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_38_diag_statistics::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_38_diag_statistics::getPartsPacked() const
{
    return m_Parts_packed;
}

void V0_0_38_diag_statistics::setPartsPacked(int32_t value)
{
    m_Parts_packed = value;
    m_Parts_packedIsSet = true;
}

bool V0_0_38_diag_statistics::partsPackedIsSet() const
{
    return m_Parts_packedIsSet;
}

void V0_0_38_diag_statistics::unsetParts_packed()
{
    m_Parts_packedIsSet = false;
}
int32_t V0_0_38_diag_statistics::getReqTime() const
{
    return m_Req_time;
}

void V0_0_38_diag_statistics::setReqTime(int32_t value)
{
    m_Req_time = value;
    m_Req_timeIsSet = true;
}

bool V0_0_38_diag_statistics::reqTimeIsSet() const
{
    return m_Req_timeIsSet;
}

void V0_0_38_diag_statistics::unsetReq_time()
{
    m_Req_timeIsSet = false;
}
int32_t V0_0_38_diag_statistics::getReqTimeStart() const
{
    return m_Req_time_start;
}

void V0_0_38_diag_statistics::setReqTimeStart(int32_t value)
{
    m_Req_time_start = value;
    m_Req_time_startIsSet = true;
}

bool V0_0_38_diag_statistics::reqTimeStartIsSet() const
{
    return m_Req_time_startIsSet;
}

void V0_0_38_diag_statistics::unsetReq_time_start()
{
    m_Req_time_startIsSet = false;
}
int32_t V0_0_38_diag_statistics::getServerThreadCount() const
{
    return m_Server_thread_count;
}

void V0_0_38_diag_statistics::setServerThreadCount(int32_t value)
{
    m_Server_thread_count = value;
    m_Server_thread_countIsSet = true;
}

bool V0_0_38_diag_statistics::serverThreadCountIsSet() const
{
    return m_Server_thread_countIsSet;
}

void V0_0_38_diag_statistics::unsetServer_thread_count()
{
    m_Server_thread_countIsSet = false;
}
int32_t V0_0_38_diag_statistics::getAgentQueueSize() const
{
    return m_Agent_queue_size;
}

void V0_0_38_diag_statistics::setAgentQueueSize(int32_t value)
{
    m_Agent_queue_size = value;
    m_Agent_queue_sizeIsSet = true;
}

bool V0_0_38_diag_statistics::agentQueueSizeIsSet() const
{
    return m_Agent_queue_sizeIsSet;
}

void V0_0_38_diag_statistics::unsetAgent_queue_size()
{
    m_Agent_queue_sizeIsSet = false;
}
int32_t V0_0_38_diag_statistics::getAgentCount() const
{
    return m_Agent_count;
}

void V0_0_38_diag_statistics::setAgentCount(int32_t value)
{
    m_Agent_count = value;
    m_Agent_countIsSet = true;
}

bool V0_0_38_diag_statistics::agentCountIsSet() const
{
    return m_Agent_countIsSet;
}

void V0_0_38_diag_statistics::unsetAgent_count()
{
    m_Agent_countIsSet = false;
}
int32_t V0_0_38_diag_statistics::getAgentThreadCount() const
{
    return m_Agent_thread_count;
}

void V0_0_38_diag_statistics::setAgentThreadCount(int32_t value)
{
    m_Agent_thread_count = value;
    m_Agent_thread_countIsSet = true;
}

bool V0_0_38_diag_statistics::agentThreadCountIsSet() const
{
    return m_Agent_thread_countIsSet;
}

void V0_0_38_diag_statistics::unsetAgent_thread_count()
{
    m_Agent_thread_countIsSet = false;
}
int32_t V0_0_38_diag_statistics::getDbdAgentQueueSize() const
{
    return m_Dbd_agent_queue_size;
}

void V0_0_38_diag_statistics::setDbdAgentQueueSize(int32_t value)
{
    m_Dbd_agent_queue_size = value;
    m_Dbd_agent_queue_sizeIsSet = true;
}

bool V0_0_38_diag_statistics::dbdAgentQueueSizeIsSet() const
{
    return m_Dbd_agent_queue_sizeIsSet;
}

void V0_0_38_diag_statistics::unsetDbd_agent_queue_size()
{
    m_Dbd_agent_queue_sizeIsSet = false;
}
int32_t V0_0_38_diag_statistics::getGettimeofdayLatency() const
{
    return m_Gettimeofday_latency;
}

void V0_0_38_diag_statistics::setGettimeofdayLatency(int32_t value)
{
    m_Gettimeofday_latency = value;
    m_Gettimeofday_latencyIsSet = true;
}

bool V0_0_38_diag_statistics::gettimeofdayLatencyIsSet() const
{
    return m_Gettimeofday_latencyIsSet;
}

void V0_0_38_diag_statistics::unsetGettimeofday_latency()
{
    m_Gettimeofday_latencyIsSet = false;
}
int32_t V0_0_38_diag_statistics::getScheduleCycleMax() const
{
    return m_Schedule_cycle_max;
}

void V0_0_38_diag_statistics::setScheduleCycleMax(int32_t value)
{
    m_Schedule_cycle_max = value;
    m_Schedule_cycle_maxIsSet = true;
}

bool V0_0_38_diag_statistics::scheduleCycleMaxIsSet() const
{
    return m_Schedule_cycle_maxIsSet;
}

void V0_0_38_diag_statistics::unsetSchedule_cycle_max()
{
    m_Schedule_cycle_maxIsSet = false;
}
int32_t V0_0_38_diag_statistics::getScheduleCycleLast() const
{
    return m_Schedule_cycle_last;
}

void V0_0_38_diag_statistics::setScheduleCycleLast(int32_t value)
{
    m_Schedule_cycle_last = value;
    m_Schedule_cycle_lastIsSet = true;
}

bool V0_0_38_diag_statistics::scheduleCycleLastIsSet() const
{
    return m_Schedule_cycle_lastIsSet;
}

void V0_0_38_diag_statistics::unsetSchedule_cycle_last()
{
    m_Schedule_cycle_lastIsSet = false;
}
int32_t V0_0_38_diag_statistics::getScheduleCycleTotal() const
{
    return m_Schedule_cycle_total;
}

void V0_0_38_diag_statistics::setScheduleCycleTotal(int32_t value)
{
    m_Schedule_cycle_total = value;
    m_Schedule_cycle_totalIsSet = true;
}

bool V0_0_38_diag_statistics::scheduleCycleTotalIsSet() const
{
    return m_Schedule_cycle_totalIsSet;
}

void V0_0_38_diag_statistics::unsetSchedule_cycle_total()
{
    m_Schedule_cycle_totalIsSet = false;
}
int32_t V0_0_38_diag_statistics::getScheduleCycleMean() const
{
    return m_Schedule_cycle_mean;
}

void V0_0_38_diag_statistics::setScheduleCycleMean(int32_t value)
{
    m_Schedule_cycle_mean = value;
    m_Schedule_cycle_meanIsSet = true;
}

bool V0_0_38_diag_statistics::scheduleCycleMeanIsSet() const
{
    return m_Schedule_cycle_meanIsSet;
}

void V0_0_38_diag_statistics::unsetSchedule_cycle_mean()
{
    m_Schedule_cycle_meanIsSet = false;
}
int32_t V0_0_38_diag_statistics::getScheduleCycleMeanDepth() const
{
    return m_Schedule_cycle_mean_depth;
}

void V0_0_38_diag_statistics::setScheduleCycleMeanDepth(int32_t value)
{
    m_Schedule_cycle_mean_depth = value;
    m_Schedule_cycle_mean_depthIsSet = true;
}

bool V0_0_38_diag_statistics::scheduleCycleMeanDepthIsSet() const
{
    return m_Schedule_cycle_mean_depthIsSet;
}

void V0_0_38_diag_statistics::unsetSchedule_cycle_mean_depth()
{
    m_Schedule_cycle_mean_depthIsSet = false;
}
int32_t V0_0_38_diag_statistics::getScheduleCyclePerMinute() const
{
    return m_Schedule_cycle_per_minute;
}

void V0_0_38_diag_statistics::setScheduleCyclePerMinute(int32_t value)
{
    m_Schedule_cycle_per_minute = value;
    m_Schedule_cycle_per_minuteIsSet = true;
}

bool V0_0_38_diag_statistics::scheduleCyclePerMinuteIsSet() const
{
    return m_Schedule_cycle_per_minuteIsSet;
}

void V0_0_38_diag_statistics::unsetSchedule_cycle_per_minute()
{
    m_Schedule_cycle_per_minuteIsSet = false;
}
int32_t V0_0_38_diag_statistics::getScheduleQueueLength() const
{
    return m_Schedule_queue_length;
}

void V0_0_38_diag_statistics::setScheduleQueueLength(int32_t value)
{
    m_Schedule_queue_length = value;
    m_Schedule_queue_lengthIsSet = true;
}

bool V0_0_38_diag_statistics::scheduleQueueLengthIsSet() const
{
    return m_Schedule_queue_lengthIsSet;
}

void V0_0_38_diag_statistics::unsetSchedule_queue_length()
{
    m_Schedule_queue_lengthIsSet = false;
}
int32_t V0_0_38_diag_statistics::getJobsSubmitted() const
{
    return m_Jobs_submitted;
}

void V0_0_38_diag_statistics::setJobsSubmitted(int32_t value)
{
    m_Jobs_submitted = value;
    m_Jobs_submittedIsSet = true;
}

bool V0_0_38_diag_statistics::jobsSubmittedIsSet() const
{
    return m_Jobs_submittedIsSet;
}

void V0_0_38_diag_statistics::unsetJobs_submitted()
{
    m_Jobs_submittedIsSet = false;
}
int32_t V0_0_38_diag_statistics::getJobsStarted() const
{
    return m_Jobs_started;
}

void V0_0_38_diag_statistics::setJobsStarted(int32_t value)
{
    m_Jobs_started = value;
    m_Jobs_startedIsSet = true;
}

bool V0_0_38_diag_statistics::jobsStartedIsSet() const
{
    return m_Jobs_startedIsSet;
}

void V0_0_38_diag_statistics::unsetJobs_started()
{
    m_Jobs_startedIsSet = false;
}
int32_t V0_0_38_diag_statistics::getJobsCompleted() const
{
    return m_Jobs_completed;
}

void V0_0_38_diag_statistics::setJobsCompleted(int32_t value)
{
    m_Jobs_completed = value;
    m_Jobs_completedIsSet = true;
}

bool V0_0_38_diag_statistics::jobsCompletedIsSet() const
{
    return m_Jobs_completedIsSet;
}

void V0_0_38_diag_statistics::unsetJobs_completed()
{
    m_Jobs_completedIsSet = false;
}
int32_t V0_0_38_diag_statistics::getJobsCanceled() const
{
    return m_Jobs_canceled;
}

void V0_0_38_diag_statistics::setJobsCanceled(int32_t value)
{
    m_Jobs_canceled = value;
    m_Jobs_canceledIsSet = true;
}

bool V0_0_38_diag_statistics::jobsCanceledIsSet() const
{
    return m_Jobs_canceledIsSet;
}

void V0_0_38_diag_statistics::unsetJobs_canceled()
{
    m_Jobs_canceledIsSet = false;
}
int32_t V0_0_38_diag_statistics::getJobsFailed() const
{
    return m_Jobs_failed;
}

void V0_0_38_diag_statistics::setJobsFailed(int32_t value)
{
    m_Jobs_failed = value;
    m_Jobs_failedIsSet = true;
}

bool V0_0_38_diag_statistics::jobsFailedIsSet() const
{
    return m_Jobs_failedIsSet;
}

void V0_0_38_diag_statistics::unsetJobs_failed()
{
    m_Jobs_failedIsSet = false;
}
int32_t V0_0_38_diag_statistics::getJobsPending() const
{
    return m_Jobs_pending;
}

void V0_0_38_diag_statistics::setJobsPending(int32_t value)
{
    m_Jobs_pending = value;
    m_Jobs_pendingIsSet = true;
}

bool V0_0_38_diag_statistics::jobsPendingIsSet() const
{
    return m_Jobs_pendingIsSet;
}

void V0_0_38_diag_statistics::unsetJobs_pending()
{
    m_Jobs_pendingIsSet = false;
}
int32_t V0_0_38_diag_statistics::getJobsRunning() const
{
    return m_Jobs_running;
}

void V0_0_38_diag_statistics::setJobsRunning(int32_t value)
{
    m_Jobs_running = value;
    m_Jobs_runningIsSet = true;
}

bool V0_0_38_diag_statistics::jobsRunningIsSet() const
{
    return m_Jobs_runningIsSet;
}

void V0_0_38_diag_statistics::unsetJobs_running()
{
    m_Jobs_runningIsSet = false;
}
int32_t V0_0_38_diag_statistics::getJobStatesTs() const
{
    return m_Job_states_ts;
}

void V0_0_38_diag_statistics::setJobStatesTs(int32_t value)
{
    m_Job_states_ts = value;
    m_Job_states_tsIsSet = true;
}

bool V0_0_38_diag_statistics::jobStatesTsIsSet() const
{
    return m_Job_states_tsIsSet;
}

void V0_0_38_diag_statistics::unsetJob_states_ts()
{
    m_Job_states_tsIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfBackfilledJobs() const
{
    return m_Bf_backfilled_jobs;
}

void V0_0_38_diag_statistics::setBfBackfilledJobs(int32_t value)
{
    m_Bf_backfilled_jobs = value;
    m_Bf_backfilled_jobsIsSet = true;
}

bool V0_0_38_diag_statistics::bfBackfilledJobsIsSet() const
{
    return m_Bf_backfilled_jobsIsSet;
}

void V0_0_38_diag_statistics::unsetBf_backfilled_jobs()
{
    m_Bf_backfilled_jobsIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfLastBackfilledJobs() const
{
    return m_Bf_last_backfilled_jobs;
}

void V0_0_38_diag_statistics::setBfLastBackfilledJobs(int32_t value)
{
    m_Bf_last_backfilled_jobs = value;
    m_Bf_last_backfilled_jobsIsSet = true;
}

bool V0_0_38_diag_statistics::bfLastBackfilledJobsIsSet() const
{
    return m_Bf_last_backfilled_jobsIsSet;
}

void V0_0_38_diag_statistics::unsetBf_last_backfilled_jobs()
{
    m_Bf_last_backfilled_jobsIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfBackfilledHetJobs() const
{
    return m_Bf_backfilled_het_jobs;
}

void V0_0_38_diag_statistics::setBfBackfilledHetJobs(int32_t value)
{
    m_Bf_backfilled_het_jobs = value;
    m_Bf_backfilled_het_jobsIsSet = true;
}

bool V0_0_38_diag_statistics::bfBackfilledHetJobsIsSet() const
{
    return m_Bf_backfilled_het_jobsIsSet;
}

void V0_0_38_diag_statistics::unsetBf_backfilled_het_jobs()
{
    m_Bf_backfilled_het_jobsIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfCycleCounter() const
{
    return m_Bf_cycle_counter;
}

void V0_0_38_diag_statistics::setBfCycleCounter(int32_t value)
{
    m_Bf_cycle_counter = value;
    m_Bf_cycle_counterIsSet = true;
}

bool V0_0_38_diag_statistics::bfCycleCounterIsSet() const
{
    return m_Bf_cycle_counterIsSet;
}

void V0_0_38_diag_statistics::unsetBf_cycle_counter()
{
    m_Bf_cycle_counterIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfCycleMean() const
{
    return m_Bf_cycle_mean;
}

void V0_0_38_diag_statistics::setBfCycleMean(int32_t value)
{
    m_Bf_cycle_mean = value;
    m_Bf_cycle_meanIsSet = true;
}

bool V0_0_38_diag_statistics::bfCycleMeanIsSet() const
{
    return m_Bf_cycle_meanIsSet;
}

void V0_0_38_diag_statistics::unsetBf_cycle_mean()
{
    m_Bf_cycle_meanIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfCycleMax() const
{
    return m_Bf_cycle_max;
}

void V0_0_38_diag_statistics::setBfCycleMax(int32_t value)
{
    m_Bf_cycle_max = value;
    m_Bf_cycle_maxIsSet = true;
}

bool V0_0_38_diag_statistics::bfCycleMaxIsSet() const
{
    return m_Bf_cycle_maxIsSet;
}

void V0_0_38_diag_statistics::unsetBf_cycle_max()
{
    m_Bf_cycle_maxIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfLastDepth() const
{
    return m_Bf_last_depth;
}

void V0_0_38_diag_statistics::setBfLastDepth(int32_t value)
{
    m_Bf_last_depth = value;
    m_Bf_last_depthIsSet = true;
}

bool V0_0_38_diag_statistics::bfLastDepthIsSet() const
{
    return m_Bf_last_depthIsSet;
}

void V0_0_38_diag_statistics::unsetBf_last_depth()
{
    m_Bf_last_depthIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfLastDepthTry() const
{
    return m_Bf_last_depth_try;
}

void V0_0_38_diag_statistics::setBfLastDepthTry(int32_t value)
{
    m_Bf_last_depth_try = value;
    m_Bf_last_depth_tryIsSet = true;
}

bool V0_0_38_diag_statistics::bfLastDepthTryIsSet() const
{
    return m_Bf_last_depth_tryIsSet;
}

void V0_0_38_diag_statistics::unsetBf_last_depth_try()
{
    m_Bf_last_depth_tryIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfDepthMean() const
{
    return m_Bf_depth_mean;
}

void V0_0_38_diag_statistics::setBfDepthMean(int32_t value)
{
    m_Bf_depth_mean = value;
    m_Bf_depth_meanIsSet = true;
}

bool V0_0_38_diag_statistics::bfDepthMeanIsSet() const
{
    return m_Bf_depth_meanIsSet;
}

void V0_0_38_diag_statistics::unsetBf_depth_mean()
{
    m_Bf_depth_meanIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfDepthMeanTry() const
{
    return m_Bf_depth_mean_try;
}

void V0_0_38_diag_statistics::setBfDepthMeanTry(int32_t value)
{
    m_Bf_depth_mean_try = value;
    m_Bf_depth_mean_tryIsSet = true;
}

bool V0_0_38_diag_statistics::bfDepthMeanTryIsSet() const
{
    return m_Bf_depth_mean_tryIsSet;
}

void V0_0_38_diag_statistics::unsetBf_depth_mean_try()
{
    m_Bf_depth_mean_tryIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfCycleLast() const
{
    return m_Bf_cycle_last;
}

void V0_0_38_diag_statistics::setBfCycleLast(int32_t value)
{
    m_Bf_cycle_last = value;
    m_Bf_cycle_lastIsSet = true;
}

bool V0_0_38_diag_statistics::bfCycleLastIsSet() const
{
    return m_Bf_cycle_lastIsSet;
}

void V0_0_38_diag_statistics::unsetBf_cycle_last()
{
    m_Bf_cycle_lastIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfQueueLen() const
{
    return m_Bf_queue_len;
}

void V0_0_38_diag_statistics::setBfQueueLen(int32_t value)
{
    m_Bf_queue_len = value;
    m_Bf_queue_lenIsSet = true;
}

bool V0_0_38_diag_statistics::bfQueueLenIsSet() const
{
    return m_Bf_queue_lenIsSet;
}

void V0_0_38_diag_statistics::unsetBf_queue_len()
{
    m_Bf_queue_lenIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfQueueLenMean() const
{
    return m_Bf_queue_len_mean;
}

void V0_0_38_diag_statistics::setBfQueueLenMean(int32_t value)
{
    m_Bf_queue_len_mean = value;
    m_Bf_queue_len_meanIsSet = true;
}

bool V0_0_38_diag_statistics::bfQueueLenMeanIsSet() const
{
    return m_Bf_queue_len_meanIsSet;
}

void V0_0_38_diag_statistics::unsetBf_queue_len_mean()
{
    m_Bf_queue_len_meanIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfTableSize() const
{
    return m_Bf_table_size;
}

void V0_0_38_diag_statistics::setBfTableSize(int32_t value)
{
    m_Bf_table_size = value;
    m_Bf_table_sizeIsSet = true;
}

bool V0_0_38_diag_statistics::bfTableSizeIsSet() const
{
    return m_Bf_table_sizeIsSet;
}

void V0_0_38_diag_statistics::unsetBf_table_size()
{
    m_Bf_table_sizeIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfTableSizeMean() const
{
    return m_Bf_table_size_mean;
}

void V0_0_38_diag_statistics::setBfTableSizeMean(int32_t value)
{
    m_Bf_table_size_mean = value;
    m_Bf_table_size_meanIsSet = true;
}

bool V0_0_38_diag_statistics::bfTableSizeMeanIsSet() const
{
    return m_Bf_table_size_meanIsSet;
}

void V0_0_38_diag_statistics::unsetBf_table_size_mean()
{
    m_Bf_table_size_meanIsSet = false;
}
int32_t V0_0_38_diag_statistics::getBfWhenLastCycle() const
{
    return m_Bf_when_last_cycle;
}

void V0_0_38_diag_statistics::setBfWhenLastCycle(int32_t value)
{
    m_Bf_when_last_cycle = value;
    m_Bf_when_last_cycleIsSet = true;
}

bool V0_0_38_diag_statistics::bfWhenLastCycleIsSet() const
{
    return m_Bf_when_last_cycleIsSet;
}

void V0_0_38_diag_statistics::unsetBf_when_last_cycle()
{
    m_Bf_when_last_cycleIsSet = false;
}
bool V0_0_38_diag_statistics::isBfActive() const
{
    return m_Bf_active;
}

void V0_0_38_diag_statistics::setBfActive(bool value)
{
    m_Bf_active = value;
    m_Bf_activeIsSet = true;
}

bool V0_0_38_diag_statistics::bfActiveIsSet() const
{
    return m_Bf_activeIsSet;
}

void V0_0_38_diag_statistics::unsetBf_active()
{
    m_Bf_activeIsSet = false;
}
std::vector<std::shared_ptr<V0_0_38_diag_rpcm>>& V0_0_38_diag_statistics::getRpcsByMessageType()
{
    return m_Rpcs_by_message_type;
}

void V0_0_38_diag_statistics::setRpcsByMessageType(const std::vector<std::shared_ptr<V0_0_38_diag_rpcm>>& value)
{
    m_Rpcs_by_message_type = value;
    m_Rpcs_by_message_typeIsSet = true;
}

bool V0_0_38_diag_statistics::rpcsByMessageTypeIsSet() const
{
    return m_Rpcs_by_message_typeIsSet;
}

void V0_0_38_diag_statistics::unsetRpcs_by_message_type()
{
    m_Rpcs_by_message_typeIsSet = false;
}
std::vector<std::shared_ptr<V0_0_38_diag_rpcu>>& V0_0_38_diag_statistics::getRpcsByUser()
{
    return m_Rpcs_by_user;
}

void V0_0_38_diag_statistics::setRpcsByUser(const std::vector<std::shared_ptr<V0_0_38_diag_rpcu>>& value)
{
    m_Rpcs_by_user = value;
    m_Rpcs_by_userIsSet = true;
}

bool V0_0_38_diag_statistics::rpcsByUserIsSet() const
{
    return m_Rpcs_by_userIsSet;
}

void V0_0_38_diag_statistics::unsetRpcs_by_user()
{
    m_Rpcs_by_userIsSet = false;
}
}
