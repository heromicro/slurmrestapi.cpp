...
void V0_0_40_user::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_user::toJson() const
{
...
bool V0_0_40_user::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_user::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_user::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<utility::string_t>& V0_0_40_user::getAdministratorLevel()
{
    return m_Administrator_level;
}

void V0_0_40_user::setAdministratorLevel(const std::vector<utility::string_t>& value)
{
    m_Administrator_level = value;
    m_Administrator_levelIsSet = true;
}

bool V0_0_40_user::administratorLevelIsSet() const
{
    return m_Administrator_levelIsSet;
}

void V0_0_40_user::unsetAdministrator_level()
{
    m_Administrator_levelIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_assoc_short>>& V0_0_40_user::getAssociations()
{
    return m_Associations;
}

void V0_0_40_user::setAssociations(const std::vector<std::shared_ptr<V0_0_40_assoc_short>>& value)
{
    m_Associations = value;
    m_AssociationsIsSet = true;
}

bool V0_0_40_user::associationsIsSet() const
{
    return m_AssociationsIsSet;
}

void V0_0_40_user::unsetAssociations()
{
    m_AssociationsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_coord>>& V0_0_40_user::getCoordinators()
{
    return m_Coordinators;
}

void V0_0_40_user::setCoordinators(const std::vector<std::shared_ptr<V0_0_40_coord>>& value)
{
    m_Coordinators = value;
    m_CoordinatorsIsSet = true;
}

bool V0_0_40_user::coordinatorsIsSet() const
{
    return m_CoordinatorsIsSet;
}

void V0_0_40_user::unsetCoordinators()
{
    m_CoordinatorsIsSet = false;
}
std::shared_ptr<V0_0_40_user_default> V0_0_40_user::getRDefault() const
{
    return m_r_default;
}

void V0_0_40_user::setRDefault(const std::shared_ptr<V0_0_40_user_default>& value)
{
    m_r_default = value;
    m_r_defaultIsSet = true;
}

bool V0_0_40_user::rDefaultIsSet() const
{
    return m_r_defaultIsSet;
}

void V0_0_40_user::unsetr_default()
{
    m_r_defaultIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_user::getFlags()
{
    return m_Flags;
}

void V0_0_40_user::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool V0_0_40_user::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void V0_0_40_user::unsetFlags()
{
    m_FlagsIsSet = false;
}
utility::string_t V0_0_40_user::getName() const
{
    return m_Name;
}

void V0_0_40_user::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_40_user::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_40_user::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t V0_0_40_user::getOldName() const
{
    return m_Old_name;
}

void V0_0_40_user::setOldName(const utility::string_t& value)
{
    m_Old_name = value;
    m_Old_nameIsSet = true;
}

bool V0_0_40_user::oldNameIsSet() const
{
    return m_Old_nameIsSet;
}

void V0_0_40_user::unsetOld_name()
{
    m_Old_nameIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_wckey>>& V0_0_40_user::getWckeys()
{
    return m_Wckeys;
}

void V0_0_40_user::setWckeys(const std::vector<std::shared_ptr<V0_0_40_wckey>>& value)
{
    m_Wckeys = value;
    m_WckeysIsSet = true;
}

bool V0_0_40_user::wckeysIsSet() const
{
    return m_WckeysIsSet;
}

void V0_0_40_user::unsetWckeys()
{
    m_WckeysIsSet = false;
}
}
