...
void V0_0_40_qos::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_qos::toJson() const
{
...
bool V0_0_40_qos::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("limits"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_qos_limits> refVal_setLimits;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("preempt"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_qos_preempt> refVal_setPreempt;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("usage_factor"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_float64_no_val> refVal_setUsageFactor;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("usage_threshold"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_float64_no_val> refVal_setUsageThreshold;
...
void V0_0_40_qos::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_qos::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_qos::getDescription() const
{
    return m_Description;
}

void V0_0_40_qos::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool V0_0_40_qos::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void V0_0_40_qos::unsetDescription()
{
    m_DescriptionIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_qos::getFlags()
{
    return m_Flags;
}

void V0_0_40_qos::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool V0_0_40_qos::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void V0_0_40_qos::unsetFlags()
{
    m_FlagsIsSet = false;
}
int32_t V0_0_40_qos::getId() const
{
    return m_Id;
}

void V0_0_40_qos::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool V0_0_40_qos::idIsSet() const
{
    return m_IdIsSet;
}

void V0_0_40_qos::unsetId()
{
    m_IdIsSet = false;
}
std::shared_ptr<V0_0_40_qos_limits> V0_0_40_qos::getLimits() const
{
    return m_Limits;
}

void V0_0_40_qos::setLimits(const std::shared_ptr<V0_0_40_qos_limits>& value)
{
    m_Limits = value;
    m_LimitsIsSet = true;
}

bool V0_0_40_qos::limitsIsSet() const
{
    return m_LimitsIsSet;
}

void V0_0_40_qos::unsetLimits()
{
    m_LimitsIsSet = false;
}
utility::string_t V0_0_40_qos::getName() const
{
    return m_Name;
}

void V0_0_40_qos::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_40_qos::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_40_qos::unsetName()
{
    m_NameIsSet = false;
}
std::shared_ptr<V0_0_40_qos_preempt> V0_0_40_qos::getPreempt() const
{
    return m_Preempt;
}

void V0_0_40_qos::setPreempt(const std::shared_ptr<V0_0_40_qos_preempt>& value)
{
    m_Preempt = value;
    m_PreemptIsSet = true;
}

bool V0_0_40_qos::preemptIsSet() const
{
    return m_PreemptIsSet;
}

void V0_0_40_qos::unsetPreempt()
{
    m_PreemptIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_qos::getPriority() const
{
    return m_Priority;
}

void V0_0_40_qos::setPriority(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Priority = value;
    m_PriorityIsSet = true;
}

bool V0_0_40_qos::priorityIsSet() const
{
    return m_PriorityIsSet;
}

void V0_0_40_qos::unsetPriority()
{
    m_PriorityIsSet = false;
}
std::shared_ptr<V0_0_40_float64_no_val> V0_0_40_qos::getUsageFactor() const
{
    return m_Usage_factor;
}

void V0_0_40_qos::setUsageFactor(const std::shared_ptr<V0_0_40_float64_no_val>& value)
{
    m_Usage_factor = value;
    m_Usage_factorIsSet = true;
}

bool V0_0_40_qos::usageFactorIsSet() const
{
    return m_Usage_factorIsSet;
}

void V0_0_40_qos::unsetUsage_factor()
{
    m_Usage_factorIsSet = false;
}
std::shared_ptr<V0_0_40_float64_no_val> V0_0_40_qos::getUsageThreshold() const
{
    return m_Usage_threshold;
}

void V0_0_40_qos::setUsageThreshold(const std::shared_ptr<V0_0_40_float64_no_val>& value)
{
    m_Usage_threshold = value;
    m_Usage_thresholdIsSet = true;
}

bool V0_0_40_qos::usageThresholdIsSet() const
{
    return m_Usage_thresholdIsSet;
}

void V0_0_40_qos::unsetUsage_threshold()
{
    m_Usage_thresholdIsSet = false;
}
}
