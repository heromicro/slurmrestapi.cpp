...
std::shared_ptr<Dbv0_0_39_meta> Status::getMeta() const
{
    return m_Meta;
}

void Status::setMeta(const std::shared_ptr<Dbv0_0_39_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}
...
std::vector<std::shared_ptr<Dbv0_0_39_error>>& Status::getErrors()
{
    return m_Errors;
}

void Status::setErrors(const std::vector<std::shared_ptr<Dbv0_0_39_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}
...
std::vector<std::shared_ptr<Dbv0_0_39_warning>>& Status::getWarnings()
{
    return m_Warnings;
}

void Status::setWarnings(const std::vector<std::shared_ptr<Dbv0_0_39_warning>>& value)
{
    m_Warnings = value;
