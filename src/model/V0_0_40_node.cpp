...
void V0_0_40_node::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_node::toJson() const
{
...
bool V0_0_40_node::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("boot_time"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint64_no_val> refVal_setBootTime;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("free_mem"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint64_no_val> refVal_setFreeMem;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("energy"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_acct_gather_energy> refVal_setEnergy;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("last_busy"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint64_no_val> refVal_setLastBusy;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("reason_changed_at"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint64_no_val> refVal_setReasonChangedAt;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("resume_after"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint64_no_val> refVal_setResumeAfter;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("slurmd_start_time"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint64_no_val> refVal_setSlurmdStartTime;
...
void V0_0_40_node::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_node::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_node::getArchitecture() const
{
    return m_Architecture;
}

void V0_0_40_node::setArchitecture(const utility::string_t& value)
{
    m_Architecture = value;
    m_ArchitectureIsSet = true;
}

bool V0_0_40_node::architectureIsSet() const
{
    return m_ArchitectureIsSet;
}

void V0_0_40_node::unsetArchitecture()
{
    m_ArchitectureIsSet = false;
}
utility::string_t V0_0_40_node::getBurstbufferNetworkAddress() const
{
    return m_Burstbuffer_network_address;
}

void V0_0_40_node::setBurstbufferNetworkAddress(const utility::string_t& value)
{
    m_Burstbuffer_network_address = value;
    m_Burstbuffer_network_addressIsSet = true;
}

bool V0_0_40_node::burstbufferNetworkAddressIsSet() const
{
    return m_Burstbuffer_network_addressIsSet;
}

void V0_0_40_node::unsetBurstbuffer_network_address()
{
    m_Burstbuffer_network_addressIsSet = false;
}
int32_t V0_0_40_node::getBoards() const
{
    return m_Boards;
}

void V0_0_40_node::setBoards(int32_t value)
{
    m_Boards = value;
    m_BoardsIsSet = true;
}

bool V0_0_40_node::boardsIsSet() const
{
    return m_BoardsIsSet;
}

void V0_0_40_node::unsetBoards()
{
    m_BoardsIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_node::getBootTime() const
{
    return m_Boot_time;
}

void V0_0_40_node::setBootTime(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Boot_time = value;
    m_Boot_timeIsSet = true;
}

bool V0_0_40_node::bootTimeIsSet() const
{
    return m_Boot_timeIsSet;
}

void V0_0_40_node::unsetBoot_time()
{
    m_Boot_timeIsSet = false;
}
utility::string_t V0_0_40_node::getClusterName() const
{
    return m_Cluster_name;
}

void V0_0_40_node::setClusterName(const utility::string_t& value)
{
    m_Cluster_name = value;
    m_Cluster_nameIsSet = true;
}

bool V0_0_40_node::clusterNameIsSet() const
{
    return m_Cluster_nameIsSet;
}

void V0_0_40_node::unsetCluster_name()
{
    m_Cluster_nameIsSet = false;
}
int32_t V0_0_40_node::getCores() const
{
    return m_Cores;
}

void V0_0_40_node::setCores(int32_t value)
{
    m_Cores = value;
    m_CoresIsSet = true;
}

bool V0_0_40_node::coresIsSet() const
{
    return m_CoresIsSet;
}

void V0_0_40_node::unsetCores()
{
    m_CoresIsSet = false;
}
int32_t V0_0_40_node::getSpecializedCores() const
{
    return m_Specialized_cores;
}

void V0_0_40_node::setSpecializedCores(int32_t value)
{
    m_Specialized_cores = value;
    m_Specialized_coresIsSet = true;
}

bool V0_0_40_node::specializedCoresIsSet() const
{
    return m_Specialized_coresIsSet;
}

void V0_0_40_node::unsetSpecialized_cores()
{
    m_Specialized_coresIsSet = false;
}
int32_t V0_0_40_node::getCpuBinding() const
{
    return m_Cpu_binding;
}

void V0_0_40_node::setCpuBinding(int32_t value)
{
    m_Cpu_binding = value;
    m_Cpu_bindingIsSet = true;
}

bool V0_0_40_node::cpuBindingIsSet() const
{
    return m_Cpu_bindingIsSet;
}

void V0_0_40_node::unsetCpu_binding()
{
    m_Cpu_bindingIsSet = false;
}
int32_t V0_0_40_node::getCpuLoad() const
{
    return m_Cpu_load;
}

void V0_0_40_node::setCpuLoad(int32_t value)
{
    m_Cpu_load = value;
    m_Cpu_loadIsSet = true;
}

bool V0_0_40_node::cpuLoadIsSet() const
{
    return m_Cpu_loadIsSet;
}

void V0_0_40_node::unsetCpu_load()
{
    m_Cpu_loadIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_node::getFreeMem() const
{
    return m_Free_mem;
}

void V0_0_40_node::setFreeMem(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Free_mem = value;
    m_Free_memIsSet = true;
}

bool V0_0_40_node::freeMemIsSet() const
{
    return m_Free_memIsSet;
}

void V0_0_40_node::unsetFree_mem()
{
    m_Free_memIsSet = false;
}
int32_t V0_0_40_node::getCpus() const
{
    return m_Cpus;
}

void V0_0_40_node::setCpus(int32_t value)
{
    m_Cpus = value;
    m_CpusIsSet = true;
}

bool V0_0_40_node::cpusIsSet() const
{
    return m_CpusIsSet;
}

void V0_0_40_node::unsetCpus()
{
    m_CpusIsSet = false;
}
int32_t V0_0_40_node::getEffectiveCpus() const
{
    return m_Effective_cpus;
}

void V0_0_40_node::setEffectiveCpus(int32_t value)
{
    m_Effective_cpus = value;
    m_Effective_cpusIsSet = true;
}

bool V0_0_40_node::effectiveCpusIsSet() const
{
    return m_Effective_cpusIsSet;
}

void V0_0_40_node::unsetEffective_cpus()
{
    m_Effective_cpusIsSet = false;
}
utility::string_t V0_0_40_node::getSpecializedCpus() const
{
    return m_Specialized_cpus;
}

void V0_0_40_node::setSpecializedCpus(const utility::string_t& value)
{
    m_Specialized_cpus = value;
    m_Specialized_cpusIsSet = true;
}

bool V0_0_40_node::specializedCpusIsSet() const
{
    return m_Specialized_cpusIsSet;
}

void V0_0_40_node::unsetSpecialized_cpus()
{
    m_Specialized_cpusIsSet = false;
}
std::shared_ptr<V0_0_40_acct_gather_energy> V0_0_40_node::getEnergy() const
{
    return m_Energy;
}

void V0_0_40_node::setEnergy(const std::shared_ptr<V0_0_40_acct_gather_energy>& value)
{
    m_Energy = value;
    m_EnergyIsSet = true;
}

bool V0_0_40_node::energyIsSet() const
{
    return m_EnergyIsSet;
}

void V0_0_40_node::unsetEnergy()
{
    m_EnergyIsSet = false;
}
std::shared_ptr<Object> V0_0_40_node::getExternalSensors() const
{
    return m_External_sensors;
}

void V0_0_40_node::setExternalSensors(const std::shared_ptr<Object>& value)
{
    m_External_sensors = value;
    m_External_sensorsIsSet = true;
}

bool V0_0_40_node::externalSensorsIsSet() const
{
    return m_External_sensorsIsSet;
}

void V0_0_40_node::unsetExternal_sensors()
{
    m_External_sensorsIsSet = false;
}
utility::string_t V0_0_40_node::getExtra() const
{
    return m_Extra;
}

void V0_0_40_node::setExtra(const utility::string_t& value)
{
    m_Extra = value;
    m_ExtraIsSet = true;
}

bool V0_0_40_node::extraIsSet() const
{
    return m_ExtraIsSet;
}

void V0_0_40_node::unsetExtra()
{
    m_ExtraIsSet = false;
}
std::shared_ptr<Object> V0_0_40_node::getPower() const
{
    return m_Power;
}

void V0_0_40_node::setPower(const std::shared_ptr<Object>& value)
{
    m_Power = value;
    m_PowerIsSet = true;
}

bool V0_0_40_node::powerIsSet() const
{
    return m_PowerIsSet;
}

void V0_0_40_node::unsetPower()
{
    m_PowerIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_node::getFeatures()
{
    return m_Features;
}

void V0_0_40_node::setFeatures(const std::vector<utility::string_t>& value)
{
    m_Features = value;
    m_FeaturesIsSet = true;
}

bool V0_0_40_node::featuresIsSet() const
{
    return m_FeaturesIsSet;
}

void V0_0_40_node::unsetFeatures()
{
    m_FeaturesIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_node::getActiveFeatures()
{
    return m_Active_features;
}

void V0_0_40_node::setActiveFeatures(const std::vector<utility::string_t>& value)
{
    m_Active_features = value;
    m_Active_featuresIsSet = true;
}

bool V0_0_40_node::activeFeaturesIsSet() const
{
    return m_Active_featuresIsSet;
}

void V0_0_40_node::unsetActive_features()
{
    m_Active_featuresIsSet = false;
}
utility::string_t V0_0_40_node::getGres() const
{
    return m_Gres;
}

void V0_0_40_node::setGres(const utility::string_t& value)
{
    m_Gres = value;
    m_GresIsSet = true;
}

bool V0_0_40_node::gresIsSet() const
{
    return m_GresIsSet;
}

void V0_0_40_node::unsetGres()
{
    m_GresIsSet = false;
}
utility::string_t V0_0_40_node::getGresDrained() const
{
    return m_Gres_drained;
}

void V0_0_40_node::setGresDrained(const utility::string_t& value)
{
    m_Gres_drained = value;
    m_Gres_drainedIsSet = true;
}

bool V0_0_40_node::gresDrainedIsSet() const
{
    return m_Gres_drainedIsSet;
}

void V0_0_40_node::unsetGres_drained()
{
    m_Gres_drainedIsSet = false;
}
utility::string_t V0_0_40_node::getGresUsed() const
{
    return m_Gres_used;
}

void V0_0_40_node::setGresUsed(const utility::string_t& value)
{
    m_Gres_used = value;
    m_Gres_usedIsSet = true;
}

bool V0_0_40_node::gresUsedIsSet() const
{
    return m_Gres_usedIsSet;
}

void V0_0_40_node::unsetGres_used()
{
    m_Gres_usedIsSet = false;
}
utility::string_t V0_0_40_node::getInstanceId() const
{
    return m_Instance_id;
}

void V0_0_40_node::setInstanceId(const utility::string_t& value)
{
    m_Instance_id = value;
    m_Instance_idIsSet = true;
}

bool V0_0_40_node::instanceIdIsSet() const
{
    return m_Instance_idIsSet;
}

void V0_0_40_node::unsetInstance_id()
{
    m_Instance_idIsSet = false;
}
utility::string_t V0_0_40_node::getInstanceType() const
{
    return m_Instance_type;
}

void V0_0_40_node::setInstanceType(const utility::string_t& value)
{
    m_Instance_type = value;
    m_Instance_typeIsSet = true;
}

bool V0_0_40_node::instanceTypeIsSet() const
{
    return m_Instance_typeIsSet;
}

void V0_0_40_node::unsetInstance_type()
{
    m_Instance_typeIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_node::getLastBusy() const
{
    return m_Last_busy;
}

void V0_0_40_node::setLastBusy(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Last_busy = value;
    m_Last_busyIsSet = true;
}

bool V0_0_40_node::lastBusyIsSet() const
{
    return m_Last_busyIsSet;
}

void V0_0_40_node::unsetLast_busy()
{
    m_Last_busyIsSet = false;
}
utility::string_t V0_0_40_node::getMcsLabel() const
{
    return m_Mcs_label;
}

void V0_0_40_node::setMcsLabel(const utility::string_t& value)
{
    m_Mcs_label = value;
    m_Mcs_labelIsSet = true;
}

bool V0_0_40_node::mcsLabelIsSet() const
{
    return m_Mcs_labelIsSet;
}

void V0_0_40_node::unsetMcs_label()
{
    m_Mcs_labelIsSet = false;
}
int64_t V0_0_40_node::getSpecializedMemory() const
{
    return m_Specialized_memory;
}

void V0_0_40_node::setSpecializedMemory(int64_t value)
{
    m_Specialized_memory = value;
    m_Specialized_memoryIsSet = true;
}

bool V0_0_40_node::specializedMemoryIsSet() const
{
    return m_Specialized_memoryIsSet;
}

void V0_0_40_node::unsetSpecialized_memory()
{
    m_Specialized_memoryIsSet = false;
}
utility::string_t V0_0_40_node::getName() const
{
    return m_Name;
}

void V0_0_40_node::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_40_node::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_40_node::unsetName()
{
    m_NameIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_node::getNextStateAfterReboot()
{
    return m_Next_state_after_reboot;
}

void V0_0_40_node::setNextStateAfterReboot(const std::vector<utility::string_t>& value)
{
    m_Next_state_after_reboot = value;
    m_Next_state_after_rebootIsSet = true;
}

bool V0_0_40_node::nextStateAfterRebootIsSet() const
{
    return m_Next_state_after_rebootIsSet;
}

void V0_0_40_node::unsetNext_state_after_reboot()
{
    m_Next_state_after_rebootIsSet = false;
}
utility::string_t V0_0_40_node::getAddress() const
{
    return m_Address;
}

void V0_0_40_node::setAddress(const utility::string_t& value)
{
    m_Address = value;
    m_AddressIsSet = true;
}

bool V0_0_40_node::addressIsSet() const
{
    return m_AddressIsSet;
}

void V0_0_40_node::unsetAddress()
{
    m_AddressIsSet = false;
}
utility::string_t V0_0_40_node::getHostname() const
{
    return m_Hostname;
}

void V0_0_40_node::setHostname(const utility::string_t& value)
{
    m_Hostname = value;
    m_HostnameIsSet = true;
}

bool V0_0_40_node::hostnameIsSet() const
{
    return m_HostnameIsSet;
}

void V0_0_40_node::unsetHostname()
{
    m_HostnameIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_node::getState()
{
    return m_State;
}

void V0_0_40_node::setState(const std::vector<utility::string_t>& value)
{
    m_State = value;
    m_StateIsSet = true;
}

bool V0_0_40_node::stateIsSet() const
{
    return m_StateIsSet;
}

void V0_0_40_node::unsetState()
{
    m_StateIsSet = false;
}
utility::string_t V0_0_40_node::getOperatingSystem() const
{
    return m_Operating_system;
}

void V0_0_40_node::setOperatingSystem(const utility::string_t& value)
{
    m_Operating_system = value;
    m_Operating_systemIsSet = true;
}

bool V0_0_40_node::operatingSystemIsSet() const
{
    return m_Operating_systemIsSet;
}

void V0_0_40_node::unsetOperating_system()
{
    m_Operating_systemIsSet = false;
}
utility::string_t V0_0_40_node::getOwner() const
{
    return m_Owner;
}

void V0_0_40_node::setOwner(const utility::string_t& value)
{
    m_Owner = value;
    m_OwnerIsSet = true;
}

bool V0_0_40_node::ownerIsSet() const
{
    return m_OwnerIsSet;
}

void V0_0_40_node::unsetOwner()
{
    m_OwnerIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_node::getPartitions()
{
    return m_Partitions;
}

void V0_0_40_node::setPartitions(const std::vector<utility::string_t>& value)
{
    m_Partitions = value;
    m_PartitionsIsSet = true;
}

bool V0_0_40_node::partitionsIsSet() const
{
    return m_PartitionsIsSet;
}

void V0_0_40_node::unsetPartitions()
{
    m_PartitionsIsSet = false;
}
int32_t V0_0_40_node::getPort() const
{
    return m_Port;
}

void V0_0_40_node::setPort(int32_t value)
{
    m_Port = value;
    m_PortIsSet = true;
}

bool V0_0_40_node::portIsSet() const
{
    return m_PortIsSet;
}

void V0_0_40_node::unsetPort()
{
    m_PortIsSet = false;
}
int64_t V0_0_40_node::getRealMemory() const
{
    return m_Real_memory;
}

void V0_0_40_node::setRealMemory(int64_t value)
{
    m_Real_memory = value;
    m_Real_memoryIsSet = true;
}

bool V0_0_40_node::realMemoryIsSet() const
{
    return m_Real_memoryIsSet;
}

void V0_0_40_node::unsetReal_memory()
{
    m_Real_memoryIsSet = false;
}
utility::string_t V0_0_40_node::getComment() const
{
    return m_Comment;
}

void V0_0_40_node::setComment(const utility::string_t& value)
{
    m_Comment = value;
    m_CommentIsSet = true;
}

bool V0_0_40_node::commentIsSet() const
{
    return m_CommentIsSet;
}

void V0_0_40_node::unsetComment()
{
    m_CommentIsSet = false;
}
utility::string_t V0_0_40_node::getReason() const
{
    return m_Reason;
}

void V0_0_40_node::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool V0_0_40_node::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void V0_0_40_node::unsetReason()
{
    m_ReasonIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_node::getReasonChangedAt() const
{
    return m_Reason_changed_at;
}

void V0_0_40_node::setReasonChangedAt(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Reason_changed_at = value;
    m_Reason_changed_atIsSet = true;
}

bool V0_0_40_node::reasonChangedAtIsSet() const
{
    return m_Reason_changed_atIsSet;
}

void V0_0_40_node::unsetReason_changed_at()
{
    m_Reason_changed_atIsSet = false;
}
utility::string_t V0_0_40_node::getReasonSetByUser() const
{
    return m_Reason_set_by_user;
}

void V0_0_40_node::setReasonSetByUser(const utility::string_t& value)
{
    m_Reason_set_by_user = value;
    m_Reason_set_by_userIsSet = true;
}

bool V0_0_40_node::reasonSetByUserIsSet() const
{
    return m_Reason_set_by_userIsSet;
}

void V0_0_40_node::unsetReason_set_by_user()
{
    m_Reason_set_by_userIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_node::getResumeAfter() const
{
    return m_Resume_after;
}

void V0_0_40_node::setResumeAfter(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Resume_after = value;
    m_Resume_afterIsSet = true;
}

bool V0_0_40_node::resumeAfterIsSet() const
{
    return m_Resume_afterIsSet;
}

void V0_0_40_node::unsetResume_after()
{
    m_Resume_afterIsSet = false;
}
utility::string_t V0_0_40_node::getReservation() const
{
    return m_Reservation;
}

void V0_0_40_node::setReservation(const utility::string_t& value)
{
    m_Reservation = value;
    m_ReservationIsSet = true;
}

bool V0_0_40_node::reservationIsSet() const
{
    return m_ReservationIsSet;
}

void V0_0_40_node::unsetReservation()
{
    m_ReservationIsSet = false;
}
int64_t V0_0_40_node::getAllocMemory() const
{
    return m_Alloc_memory;
}

void V0_0_40_node::setAllocMemory(int64_t value)
{
    m_Alloc_memory = value;
    m_Alloc_memoryIsSet = true;
}

bool V0_0_40_node::allocMemoryIsSet() const
{
    return m_Alloc_memoryIsSet;
}

void V0_0_40_node::unsetAlloc_memory()
{
    m_Alloc_memoryIsSet = false;
}
int32_t V0_0_40_node::getAllocCpus() const
{
    return m_Alloc_cpus;
}

void V0_0_40_node::setAllocCpus(int32_t value)
{
    m_Alloc_cpus = value;
    m_Alloc_cpusIsSet = true;
}

bool V0_0_40_node::allocCpusIsSet() const
{
    return m_Alloc_cpusIsSet;
}

void V0_0_40_node::unsetAlloc_cpus()
{
    m_Alloc_cpusIsSet = false;
}
int32_t V0_0_40_node::getAllocIdleCpus() const
{
    return m_Alloc_idle_cpus;
}

void V0_0_40_node::setAllocIdleCpus(int32_t value)
{
    m_Alloc_idle_cpus = value;
    m_Alloc_idle_cpusIsSet = true;
}

bool V0_0_40_node::allocIdleCpusIsSet() const
{
    return m_Alloc_idle_cpusIsSet;
}

void V0_0_40_node::unsetAlloc_idle_cpus()
{
    m_Alloc_idle_cpusIsSet = false;
}
utility::string_t V0_0_40_node::getTresUsed() const
{
    return m_Tres_used;
}

void V0_0_40_node::setTresUsed(const utility::string_t& value)
{
    m_Tres_used = value;
    m_Tres_usedIsSet = true;
}

bool V0_0_40_node::tresUsedIsSet() const
{
    return m_Tres_usedIsSet;
}

void V0_0_40_node::unsetTres_used()
{
    m_Tres_usedIsSet = false;
}
double V0_0_40_node::getTresWeighted() const
{
    return m_Tres_weighted;
}

void V0_0_40_node::setTresWeighted(double value)
{
    m_Tres_weighted = value;
    m_Tres_weightedIsSet = true;
}

bool V0_0_40_node::tresWeightedIsSet() const
{
    return m_Tres_weightedIsSet;
}

void V0_0_40_node::unsetTres_weighted()
{
    m_Tres_weightedIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_node::getSlurmdStartTime() const
{
    return m_Slurmd_start_time;
}

void V0_0_40_node::setSlurmdStartTime(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Slurmd_start_time = value;
    m_Slurmd_start_timeIsSet = true;
}

bool V0_0_40_node::slurmdStartTimeIsSet() const
{
    return m_Slurmd_start_timeIsSet;
}

void V0_0_40_node::unsetSlurmd_start_time()
{
    m_Slurmd_start_timeIsSet = false;
}
int32_t V0_0_40_node::getSockets() const
{
    return m_Sockets;
}

void V0_0_40_node::setSockets(int32_t value)
{
    m_Sockets = value;
    m_SocketsIsSet = true;
}

bool V0_0_40_node::socketsIsSet() const
{
    return m_SocketsIsSet;
}

void V0_0_40_node::unsetSockets()
{
    m_SocketsIsSet = false;
}
int32_t V0_0_40_node::getThreads() const
{
    return m_Threads;
}

void V0_0_40_node::setThreads(int32_t value)
{
    m_Threads = value;
    m_ThreadsIsSet = true;
}

bool V0_0_40_node::threadsIsSet() const
{
    return m_ThreadsIsSet;
}

void V0_0_40_node::unsetThreads()
{
    m_ThreadsIsSet = false;
}
int32_t V0_0_40_node::getTemporaryDisk() const
{
    return m_Temporary_disk;
}

void V0_0_40_node::setTemporaryDisk(int32_t value)
{
    m_Temporary_disk = value;
    m_Temporary_diskIsSet = true;
}

bool V0_0_40_node::temporaryDiskIsSet() const
{
    return m_Temporary_diskIsSet;
}

void V0_0_40_node::unsetTemporary_disk()
{
    m_Temporary_diskIsSet = false;
}
int32_t V0_0_40_node::getWeight() const
{
    return m_Weight;
}

void V0_0_40_node::setWeight(int32_t value)
{
    m_Weight = value;
    m_WeightIsSet = true;
}

bool V0_0_40_node::weightIsSet() const
{
    return m_WeightIsSet;
}

void V0_0_40_node::unsetWeight()
{
    m_WeightIsSet = false;
}
utility::string_t V0_0_40_node::getTres() const
{
    return m_Tres;
}

void V0_0_40_node::setTres(const utility::string_t& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool V0_0_40_node::tresIsSet() const
{
    return m_TresIsSet;
}

void V0_0_40_node::unsetTres()
{
    m_TresIsSet = false;
}
utility::string_t V0_0_40_node::getVersion() const
{
    return m_Version;
}

void V0_0_40_node::setVersion(const utility::string_t& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool V0_0_40_node::versionIsSet() const
{
    return m_VersionIsSet;
}

void V0_0_40_node::unsetVersion()
{
    m_VersionIsSet = false;
}
}
