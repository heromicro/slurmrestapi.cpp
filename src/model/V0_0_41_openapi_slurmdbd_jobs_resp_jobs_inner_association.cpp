...
V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association()
{
...
void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::toJson() const
{
...
bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::getAccount() const
{
    return m_Account;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::setAccount(const utility::string_t& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::accountIsSet() const
{
    return m_AccountIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::unsetAccount()
{
    m_AccountIsSet = false;
}
utility::string_t V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::getCluster() const
{
    return m_Cluster;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::setCluster(const utility::string_t& value)
{
    m_Cluster = value;
    m_ClusterIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::clusterIsSet() const
{
    return m_ClusterIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::unsetCluster()
{
    m_ClusterIsSet = false;
}
utility::string_t V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::getPartition() const
{
    return m_Partition;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::setPartition(const utility::string_t& value)
{
    m_Partition = value;
    m_PartitionIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::partitionIsSet() const
{
    return m_PartitionIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::unsetPartition()
{
    m_PartitionIsSet = false;
}
utility::string_t V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::getUser() const
{
    return m_User;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::userIsSet() const
{
    return m_UserIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::unsetUser()
{
    m_UserIsSet = false;
}
int32_t V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::getId() const
{
    return m_Id;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::idIsSet() const
{
    return m_IdIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_association::unsetId()
{
    m_IdIsSet = false;
}
}
