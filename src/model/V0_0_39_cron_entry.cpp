...
V0_0_39_cron_entry::V0_0_39_cron_entry()
{
    m_FlagsIsSet = false;
...
void V0_0_39_cron_entry::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_cron_entry::toJson() const
{
...
bool V0_0_39_cron_entry::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("line"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_cron_entry_line> refVal_setLine;
...
void V0_0_39_cron_entry::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_cron_entry::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<utility::string_t>& V0_0_39_cron_entry::getFlags()
{
    return m_Flags;
}

void V0_0_39_cron_entry::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool V0_0_39_cron_entry::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void V0_0_39_cron_entry::unsetFlags()
{
    m_FlagsIsSet = false;
}
utility::string_t V0_0_39_cron_entry::getMinute() const
{
    return m_Minute;
}

void V0_0_39_cron_entry::setMinute(const utility::string_t& value)
{
    m_Minute = value;
    m_MinuteIsSet = true;
}

bool V0_0_39_cron_entry::minuteIsSet() const
{
    return m_MinuteIsSet;
}

void V0_0_39_cron_entry::unsetMinute()
{
    m_MinuteIsSet = false;
}
utility::string_t V0_0_39_cron_entry::getHour() const
{
    return m_Hour;
}

void V0_0_39_cron_entry::setHour(const utility::string_t& value)
{
    m_Hour = value;
    m_HourIsSet = true;
}

bool V0_0_39_cron_entry::hourIsSet() const
{
    return m_HourIsSet;
}

void V0_0_39_cron_entry::unsetHour()
{
    m_HourIsSet = false;
}
utility::string_t V0_0_39_cron_entry::getDayOfMonth() const
{
    return m_Day_of_month;
}

void V0_0_39_cron_entry::setDayOfMonth(const utility::string_t& value)
{
    m_Day_of_month = value;
    m_Day_of_monthIsSet = true;
}

bool V0_0_39_cron_entry::dayOfMonthIsSet() const
{
    return m_Day_of_monthIsSet;
}

void V0_0_39_cron_entry::unsetDay_of_month()
{
    m_Day_of_monthIsSet = false;
}
utility::string_t V0_0_39_cron_entry::getMonth() const
{
    return m_Month;
}

void V0_0_39_cron_entry::setMonth(const utility::string_t& value)
{
    m_Month = value;
    m_MonthIsSet = true;
}

bool V0_0_39_cron_entry::monthIsSet() const
{
    return m_MonthIsSet;
}

void V0_0_39_cron_entry::unsetMonth()
{
    m_MonthIsSet = false;
}
utility::string_t V0_0_39_cron_entry::getDayOfWeek() const
{
    return m_Day_of_week;
}

void V0_0_39_cron_entry::setDayOfWeek(const utility::string_t& value)
{
    m_Day_of_week = value;
    m_Day_of_weekIsSet = true;
}

bool V0_0_39_cron_entry::dayOfWeekIsSet() const
{
    return m_Day_of_weekIsSet;
}

void V0_0_39_cron_entry::unsetDay_of_week()
{
    m_Day_of_weekIsSet = false;
}
utility::string_t V0_0_39_cron_entry::getSpecification() const
{
    return m_Specification;
}

void V0_0_39_cron_entry::setSpecification(const utility::string_t& value)
{
    m_Specification = value;
    m_SpecificationIsSet = true;
}

bool V0_0_39_cron_entry::specificationIsSet() const
{
    return m_SpecificationIsSet;
}

void V0_0_39_cron_entry::unsetSpecification()
{
    m_SpecificationIsSet = false;
}
utility::string_t V0_0_39_cron_entry::getCommand() const
{
    return m_Command;
}

void V0_0_39_cron_entry::setCommand(const utility::string_t& value)
{
    m_Command = value;
    m_CommandIsSet = true;
}

bool V0_0_39_cron_entry::commandIsSet() const
{
    return m_CommandIsSet;
}

void V0_0_39_cron_entry::unsetCommand()
{
    m_CommandIsSet = false;
}
std::shared_ptr<V0_0_39_cron_entry_line> V0_0_39_cron_entry::getLine() const
{
    return m_Line;
}

void V0_0_39_cron_entry::setLine(const std::shared_ptr<V0_0_39_cron_entry_line>& value)
{
    m_Line = value;
    m_LineIsSet = true;
}

bool V0_0_39_cron_entry::lineIsSet() const
{
    return m_LineIsSet;
}

void V0_0_39_cron_entry::unsetLine()
{
    m_LineIsSet = false;
}
}
