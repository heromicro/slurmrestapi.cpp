...
V0_0_40_assoc_short::V0_0_40_assoc_short()
{
...
void V0_0_40_assoc_short::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_assoc_short::toJson() const
{
...
bool V0_0_40_assoc_short::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_assoc_short::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_assoc_short::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_assoc_short::getAccount() const
{
    return m_Account;
}

void V0_0_40_assoc_short::setAccount(const utility::string_t& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool V0_0_40_assoc_short::accountIsSet() const
{
    return m_AccountIsSet;
}

void V0_0_40_assoc_short::unsetAccount()
{
    m_AccountIsSet = false;
}
utility::string_t V0_0_40_assoc_short::getCluster() const
{
    return m_Cluster;
}

void V0_0_40_assoc_short::setCluster(const utility::string_t& value)
{
    m_Cluster = value;
    m_ClusterIsSet = true;
}

bool V0_0_40_assoc_short::clusterIsSet() const
{
    return m_ClusterIsSet;
}

void V0_0_40_assoc_short::unsetCluster()
{
    m_ClusterIsSet = false;
}
utility::string_t V0_0_40_assoc_short::getPartition() const
{
    return m_Partition;
}

void V0_0_40_assoc_short::setPartition(const utility::string_t& value)
{
    m_Partition = value;
    m_PartitionIsSet = true;
}

bool V0_0_40_assoc_short::partitionIsSet() const
{
    return m_PartitionIsSet;
}

void V0_0_40_assoc_short::unsetPartition()
{
    m_PartitionIsSet = false;
}
utility::string_t V0_0_40_assoc_short::getUser() const
{
    return m_User;
}

void V0_0_40_assoc_short::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool V0_0_40_assoc_short::userIsSet() const
{
    return m_UserIsSet;
}

void V0_0_40_assoc_short::unsetUser()
{
    m_UserIsSet = false;
}
int32_t V0_0_40_assoc_short::getId() const
{
    return m_Id;
}

void V0_0_40_assoc_short::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool V0_0_40_assoc_short::idIsSet() const
{
    return m_IdIsSet;
}

void V0_0_40_assoc_short::unsetId()
{
    m_IdIsSet = false;
}
}
