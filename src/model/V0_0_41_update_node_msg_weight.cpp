...
V0_0_41_update_node_msg_weight::V0_0_41_update_node_msg_weight()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_update_node_msg_weight::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_update_node_msg_weight::toJson() const
{
...
bool V0_0_41_update_node_msg_weight::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_update_node_msg_weight::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_update_node_msg_weight::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_update_node_msg_weight::isSet() const
{
    return m_set;
}

void V0_0_41_update_node_msg_weight::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_update_node_msg_weight::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_update_node_msg_weight::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_update_node_msg_weight::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_update_node_msg_weight::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_update_node_msg_weight::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_update_node_msg_weight::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int32_t V0_0_41_update_node_msg_weight::getNumber() const
{
    return m_number;
}

void V0_0_41_update_node_msg_weight::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_update_node_msg_weight::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_update_node_msg_weight::unsetnumber()
{
    m_numberIsSet = false;
}
}
