...
Dbv0_0_38_association::Dbv0_0_38_association()
{
...
void Dbv0_0_38_association::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_association::toJson() const
{
...
bool Dbv0_0_38_association::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("default"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_association_default> refVal_setRDefault;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("max"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_association_max> refVal_setMax;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("min"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_association_min> refVal_setMin;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("usage"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_association_usage> refVal_setUsage;
...
void Dbv0_0_38_association::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_association::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Dbv0_0_38_association::getAccount() const
{
    return m_Account;
}

void Dbv0_0_38_association::setAccount(const utility::string_t& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool Dbv0_0_38_association::accountIsSet() const
{
    return m_AccountIsSet;
}

void Dbv0_0_38_association::unsetAccount()
{
    m_AccountIsSet = false;
}
utility::string_t Dbv0_0_38_association::getCluster() const
{
    return m_Cluster;
}

void Dbv0_0_38_association::setCluster(const utility::string_t& value)
{
    m_Cluster = value;
    m_ClusterIsSet = true;
}

bool Dbv0_0_38_association::clusterIsSet() const
{
    return m_ClusterIsSet;
}

void Dbv0_0_38_association::unsetCluster()
{
    m_ClusterIsSet = false;
}
std::shared_ptr<Dbv0_0_38_association_default> Dbv0_0_38_association::getRDefault() const
{
    return m_r_default;
}

void Dbv0_0_38_association::setRDefault(const std::shared_ptr<Dbv0_0_38_association_default>& value)
{
    m_r_default = value;
    m_r_defaultIsSet = true;
}

bool Dbv0_0_38_association::rDefaultIsSet() const
{
    return m_r_defaultIsSet;
}

void Dbv0_0_38_association::unsetr_default()
{
    m_r_defaultIsSet = false;
}
std::vector<utility::string_t>& Dbv0_0_38_association::getFlags()
{
    return m_Flags;
}

void Dbv0_0_38_association::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool Dbv0_0_38_association::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void Dbv0_0_38_association::unsetFlags()
{
    m_FlagsIsSet = false;
}
std::shared_ptr<Dbv0_0_38_association_max> Dbv0_0_38_association::getMax() const
{
    return m_Max;
}

void Dbv0_0_38_association::setMax(const std::shared_ptr<Dbv0_0_38_association_max>& value)
{
    m_Max = value;
    m_MaxIsSet = true;
}

bool Dbv0_0_38_association::maxIsSet() const
{
    return m_MaxIsSet;
}

void Dbv0_0_38_association::unsetMax()
{
    m_MaxIsSet = false;
}
std::shared_ptr<Dbv0_0_38_association_min> Dbv0_0_38_association::getMin() const
{
    return m_Min;
}

void Dbv0_0_38_association::setMin(const std::shared_ptr<Dbv0_0_38_association_min>& value)
{
    m_Min = value;
    m_MinIsSet = true;
}

bool Dbv0_0_38_association::minIsSet() const
{
    return m_MinIsSet;
}

void Dbv0_0_38_association::unsetMin()
{
    m_MinIsSet = false;
}
utility::string_t Dbv0_0_38_association::getParentAccount() const
{
    return m_Parent_account;
}

void Dbv0_0_38_association::setParentAccount(const utility::string_t& value)
{
    m_Parent_account = value;
    m_Parent_accountIsSet = true;
}

bool Dbv0_0_38_association::parentAccountIsSet() const
{
    return m_Parent_accountIsSet;
}

void Dbv0_0_38_association::unsetParent_account()
{
    m_Parent_accountIsSet = false;
}
utility::string_t Dbv0_0_38_association::getPartition() const
{
    return m_Partition;
}

void Dbv0_0_38_association::setPartition(const utility::string_t& value)
{
    m_Partition = value;
    m_PartitionIsSet = true;
}

bool Dbv0_0_38_association::partitionIsSet() const
{
    return m_PartitionIsSet;
}

void Dbv0_0_38_association::unsetPartition()
{
    m_PartitionIsSet = false;
}
int32_t Dbv0_0_38_association::getPriority() const
{
    return m_Priority;
}

void Dbv0_0_38_association::setPriority(int32_t value)
{
    m_Priority = value;
    m_PriorityIsSet = true;
}

bool Dbv0_0_38_association::priorityIsSet() const
{
    return m_PriorityIsSet;
}

void Dbv0_0_38_association::unsetPriority()
{
    m_PriorityIsSet = false;
}
int32_t Dbv0_0_38_association::getSharesRaw() const
{
    return m_Shares_raw;
}

void Dbv0_0_38_association::setSharesRaw(int32_t value)
{
    m_Shares_raw = value;
    m_Shares_rawIsSet = true;
}

bool Dbv0_0_38_association::sharesRawIsSet() const
{
    return m_Shares_rawIsSet;
}

void Dbv0_0_38_association::unsetShares_raw()
{
    m_Shares_rawIsSet = false;
}
std::shared_ptr<Dbv0_0_38_association_usage> Dbv0_0_38_association::getUsage() const
{
    return m_Usage;
}

void Dbv0_0_38_association::setUsage(const std::shared_ptr<Dbv0_0_38_association_usage>& value)
{
    m_Usage = value;
    m_UsageIsSet = true;
}

bool Dbv0_0_38_association::usageIsSet() const
{
    return m_UsageIsSet;
}

void Dbv0_0_38_association::unsetUsage()
{
    m_UsageIsSet = false;
}
utility::string_t Dbv0_0_38_association::getUser() const
{
    return m_User;
}

void Dbv0_0_38_association::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Dbv0_0_38_association::userIsSet() const
{
    return m_UserIsSet;
}

void Dbv0_0_38_association::unsetUser()
{
    m_UserIsSet = false;
}
std::vector<utility::string_t>& Dbv0_0_38_association::getQOS()
{
    return m_QOS;
}

void Dbv0_0_38_association::setQOS(const std::vector<utility::string_t>& value)
{
    m_QOS = value;
    m_QOSIsSet = true;
}

bool Dbv0_0_38_association::qOSIsSet() const
{
    return m_QOSIsSet;
}

void Dbv0_0_38_association::unsetQOS()
{
    m_QOSIsSet = false;
}
}
