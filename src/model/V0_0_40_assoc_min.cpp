...
V0_0_40_assoc_min::V0_0_40_assoc_min()
{
...
void V0_0_40_assoc_min::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_assoc_min::toJson() const
{
...
bool V0_0_40_assoc_min::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_assoc_min::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_assoc_min::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_assoc_min::getPriorityThreshold() const
{
    return m_Priority_threshold;
}

void V0_0_40_assoc_min::setPriorityThreshold(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Priority_threshold = value;
    m_Priority_thresholdIsSet = true;
}

bool V0_0_40_assoc_min::priorityThresholdIsSet() const
{
    return m_Priority_thresholdIsSet;
}

void V0_0_40_assoc_min::unsetPriority_threshold()
{
    m_Priority_thresholdIsSet = false;
}
}
