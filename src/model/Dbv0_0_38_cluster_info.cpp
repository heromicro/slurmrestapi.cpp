...
Dbv0_0_38_cluster_info::Dbv0_0_38_cluster_info()
{
...
void Dbv0_0_38_cluster_info::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_cluster_info::toJson() const
{
...
bool Dbv0_0_38_cluster_info::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("controller"))))
    {
        ...
        {
            std::shared_ptr<Dbv0_0_38_cluster_info_controller> refVal_setController;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("associations"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_cluster_info_associations> refVal_setAssociations;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tres"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Dbv0_0_38_response_tres>> refVal_setTres;
...
void Dbv0_0_38_cluster_info::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_cluster_info::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_38_cluster_info_controller> Dbv0_0_38_cluster_info::getController() const
{
    return m_Controller;
}

void Dbv0_0_38_cluster_info::setController(const std::shared_ptr<Dbv0_0_38_cluster_info_controller>& value)
{
    m_Controller = value;
    m_ControllerIsSet = true;
}

bool Dbv0_0_38_cluster_info::controllerIsSet() const
{
    return m_ControllerIsSet;
}

void Dbv0_0_38_cluster_info::unsetController()
{
    m_ControllerIsSet = false;
}
std::vector<utility::string_t>& Dbv0_0_38_cluster_info::getFlags()
{
    return m_Flags;
}

void Dbv0_0_38_cluster_info::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool Dbv0_0_38_cluster_info::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void Dbv0_0_38_cluster_info::unsetFlags()
{
    m_FlagsIsSet = false;
}
utility::string_t Dbv0_0_38_cluster_info::getName() const
{
    return m_Name;
}

void Dbv0_0_38_cluster_info::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Dbv0_0_38_cluster_info::nameIsSet() const
{
    return m_NameIsSet;
}

void Dbv0_0_38_cluster_info::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t Dbv0_0_38_cluster_info::getNodes() const
{
    return m_Nodes;
}

void Dbv0_0_38_cluster_info::setNodes(const utility::string_t& value)
{
    m_Nodes = value;
    m_NodesIsSet = true;
}

bool Dbv0_0_38_cluster_info::nodesIsSet() const
{
    return m_NodesIsSet;
}

void Dbv0_0_38_cluster_info::unsetNodes()
{
    m_NodesIsSet = false;
}
utility::string_t Dbv0_0_38_cluster_info::getSelectPlugin() const
{
    return m_Select_plugin;
}

void Dbv0_0_38_cluster_info::setSelectPlugin(const utility::string_t& value)
{
    m_Select_plugin = value;
    m_Select_pluginIsSet = true;
}

bool Dbv0_0_38_cluster_info::selectPluginIsSet() const
{
    return m_Select_pluginIsSet;
}

void Dbv0_0_38_cluster_info::unsetSelect_plugin()
{
    m_Select_pluginIsSet = false;
}
std::shared_ptr<Dbv0_0_38_cluster_info_associations> Dbv0_0_38_cluster_info::getAssociations() const
{
    return m_Associations;
}

void Dbv0_0_38_cluster_info::setAssociations(const std::shared_ptr<Dbv0_0_38_cluster_info_associations>& value)
{
    m_Associations = value;
    m_AssociationsIsSet = true;
}

bool Dbv0_0_38_cluster_info::associationsIsSet() const
{
    return m_AssociationsIsSet;
}

void Dbv0_0_38_cluster_info::unsetAssociations()
{
    m_AssociationsIsSet = false;
}
int32_t Dbv0_0_38_cluster_info::getRpcVersion() const
{
    return m_Rpc_version;
}

void Dbv0_0_38_cluster_info::setRpcVersion(int32_t value)
{
    m_Rpc_version = value;
    m_Rpc_versionIsSet = true;
}

bool Dbv0_0_38_cluster_info::rpcVersionIsSet() const
{
    return m_Rpc_versionIsSet;
}

void Dbv0_0_38_cluster_info::unsetRpc_version()
{
    m_Rpc_versionIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_response_tres>>& Dbv0_0_38_cluster_info::getTres()
{
    return m_Tres;
}

void Dbv0_0_38_cluster_info::setTres(const std::vector<std::shared_ptr<Dbv0_0_38_response_tres>>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool Dbv0_0_38_cluster_info::tresIsSet() const
{
    return m_TresIsSet;
}

void Dbv0_0_38_cluster_info::unsetTres()
{
    m_TresIsSet = false;
}
}
