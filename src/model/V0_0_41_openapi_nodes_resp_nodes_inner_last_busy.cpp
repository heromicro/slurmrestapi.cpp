...
V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::V0_0_41_openapi_nodes_resp_nodes_inner_last_busy()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::toJson() const
{
...
bool V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int64_t V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::setNumber(int64_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_last_busy::unsetnumber()
{
    m_numberIsSet = false;
}
}
