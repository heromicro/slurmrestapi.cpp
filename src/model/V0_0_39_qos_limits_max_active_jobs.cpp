...
V0_0_39_qos_limits_max_active_jobs::V0_0_39_qos_limits_max_active_jobs()
{
...
void V0_0_39_qos_limits_max_active_jobs::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_qos_limits_max_active_jobs::toJson() const
{
...
bool V0_0_39_qos_limits_max_active_jobs::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_39_qos_limits_max_active_jobs::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_qos_limits_max_active_jobs::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_39_uint32_no_val> V0_0_39_qos_limits_max_active_jobs::getAccruing() const
{
    return m_Accruing;
}

void V0_0_39_qos_limits_max_active_jobs::setAccruing(const std::shared_ptr<V0_0_39_uint32_no_val>& value)
{
    m_Accruing = value;
    m_AccruingIsSet = true;
}

bool V0_0_39_qos_limits_max_active_jobs::accruingIsSet() const
{
    return m_AccruingIsSet;
}

void V0_0_39_qos_limits_max_active_jobs::unsetAccruing()
{
    m_AccruingIsSet = false;
}
std::shared_ptr<V0_0_39_uint32_no_val> V0_0_39_qos_limits_max_active_jobs::getCount() const
{
    return m_Count;
}

void V0_0_39_qos_limits_max_active_jobs::setCount(const std::shared_ptr<V0_0_39_uint32_no_val>& value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool V0_0_39_qos_limits_max_active_jobs::countIsSet() const
{
    return m_CountIsSet;
}

void V0_0_39_qos_limits_max_active_jobs::unsetCount()
{
    m_CountIsSet = false;
}
}
