...
#include "slurmrestapi/model/V0_0_41_openapi_licenses_resp_last_update.h"
...
V0_0_41_openapi_licenses_resp_last_update::V0_0_41_openapi_licenses_resp_last_update()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_licenses_resp_last_update::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_licenses_resp_last_update::toJson() const
{
...
bool V0_0_41_openapi_licenses_resp_last_update::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_licenses_resp_last_update::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_licenses_resp_last_update::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_licenses_resp_last_update::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_licenses_resp_last_update::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_licenses_resp_last_update::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_licenses_resp_last_update::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_licenses_resp_last_update::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_licenses_resp_last_update::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_licenses_resp_last_update::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_licenses_resp_last_update::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int64_t V0_0_41_openapi_licenses_resp_last_update::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_licenses_resp_last_update::setNumber(int64_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_licenses_resp_last_update::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_licenses_resp_last_update::unsetnumber()
{
    m_numberIsSet = false;
}
}
