...
V0_0_40_partition_info_defaults::V0_0_40_partition_info_defaults()
{
    m_Memory_per_cpu = 0L;
...
void V0_0_40_partition_info_defaults::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_partition_info_defaults::toJson() const
{
...
bool V0_0_40_partition_info_defaults::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_partition_info_defaults::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_partition_info_defaults::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int64_t V0_0_40_partition_info_defaults::getMemoryPerCpu() const
{
    return m_Memory_per_cpu;
}

void V0_0_40_partition_info_defaults::setMemoryPerCpu(int64_t value)
{
    m_Memory_per_cpu = value;
    m_Memory_per_cpuIsSet = true;
}

bool V0_0_40_partition_info_defaults::memoryPerCpuIsSet() const
{
    return m_Memory_per_cpuIsSet;
}

void V0_0_40_partition_info_defaults::unsetMemory_per_cpu()
{
    m_Memory_per_cpuIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_partition_info_defaults::getPartitionMemoryPerCpu() const
{
    return m_Partition_memory_per_cpu;
}

void V0_0_40_partition_info_defaults::setPartitionMemoryPerCpu(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Partition_memory_per_cpu = value;
    m_Partition_memory_per_cpuIsSet = true;
}

bool V0_0_40_partition_info_defaults::partitionMemoryPerCpuIsSet() const
{
    return m_Partition_memory_per_cpuIsSet;
}

void V0_0_40_partition_info_defaults::unsetPartition_memory_per_cpu()
{
    m_Partition_memory_per_cpuIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_partition_info_defaults::getPartitionMemoryPerNode() const
{
    return m_Partition_memory_per_node;
}

void V0_0_40_partition_info_defaults::setPartitionMemoryPerNode(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Partition_memory_per_node = value;
    m_Partition_memory_per_nodeIsSet = true;
}

bool V0_0_40_partition_info_defaults::partitionMemoryPerNodeIsSet() const
{
    return m_Partition_memory_per_nodeIsSet;
}

void V0_0_40_partition_info_defaults::unsetPartition_memory_per_node()
{
    m_Partition_memory_per_nodeIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_partition_info_defaults::getTime() const
{
    return m_Time;
}

void V0_0_40_partition_info_defaults::setTime(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Time = value;
    m_TimeIsSet = true;
}

bool V0_0_40_partition_info_defaults::timeIsSet() const
{
    return m_TimeIsSet;
}

void V0_0_40_partition_info_defaults::unsetTime()
{
    m_TimeIsSet = false;
}
utility::string_t V0_0_40_partition_info_defaults::getJob() const
{
    return m_Job;
}

void V0_0_40_partition_info_defaults::setJob(const utility::string_t& value)
{
    m_Job = value;
    m_JobIsSet = true;
}

bool V0_0_40_partition_info_defaults::jobIsSet() const
{
    return m_JobIsSet;
}

void V0_0_40_partition_info_defaults::unsetJob()
{
    m_JobIsSet = false;
}
}
