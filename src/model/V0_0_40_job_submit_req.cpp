...
V0_0_40_job_submit_req::V0_0_40_job_submit_req()
{
...
void V0_0_40_job_submit_req::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_job_submit_req::toJson() const
{
...
bool V0_0_40_job_submit_req::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("jobs"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_40_job_desc_msg>> refVal_setJobs;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("job"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_job_desc_msg> refVal_setJob;
...
void V0_0_40_job_submit_req::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_job_submit_req::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_job_submit_req::getScript() const
{
    return m_Script;
}

void V0_0_40_job_submit_req::setScript(const utility::string_t& value)
{
    m_Script = value;
    m_ScriptIsSet = true;
}

bool V0_0_40_job_submit_req::scriptIsSet() const
{
    return m_ScriptIsSet;
}

void V0_0_40_job_submit_req::unsetScript()
{
    m_ScriptIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_job_desc_msg>>& V0_0_40_job_submit_req::getJobs()
{
    return m_Jobs;
}

void V0_0_40_job_submit_req::setJobs(const std::vector<std::shared_ptr<V0_0_40_job_desc_msg>>& value)
{
    m_Jobs = value;
    m_JobsIsSet = true;
}

bool V0_0_40_job_submit_req::jobsIsSet() const
{
    return m_JobsIsSet;
}

void V0_0_40_job_submit_req::unsetJobs()
{
    m_JobsIsSet = false;
}
std::shared_ptr<V0_0_40_job_desc_msg> V0_0_40_job_submit_req::getJob() const
{
    return m_Job;
}

void V0_0_40_job_submit_req::setJob(const std::shared_ptr<V0_0_40_job_desc_msg>& value)
{
    m_Job = value;
    m_JobIsSet = true;
}

bool V0_0_40_job_submit_req::jobIsSet() const
{
    return m_JobIsSet;
}

void V0_0_40_job_submit_req::unsetJob()
{
    m_JobIsSet = false;
}
}
