...
Dbv0_0_37_association_min::Dbv0_0_37_association_min()
{
...
void Dbv0_0_37_association_min::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_association_min::toJson() const
{
...
bool Dbv0_0_37_association_min::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_37_association_min::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_association_min::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t Dbv0_0_37_association_min::getPriorityThreshold() const
{
    return m_Priority_threshold;
}

void Dbv0_0_37_association_min::setPriorityThreshold(int32_t value)
{
    m_Priority_threshold = value;
    m_Priority_thresholdIsSet = true;
}

bool Dbv0_0_37_association_min::priorityThresholdIsSet() const
{
    return m_Priority_thresholdIsSet;
}

void Dbv0_0_37_association_min::unsetPriority_threshold()
{
    m_Priority_thresholdIsSet = false;
}
}
