...
utility::string_t V0_0_39_cluster_rec_controller::getHost() const
{
    return m_Host;
}

void V0_0_39_cluster_rec_controller::setHost(const utility::string_t& value)
{
    m_Host = value;
    m_HostIsSet = true;
}

bool V0_0_39_cluster_rec_controller::hostIsSet() const
{
    return m_HostIsSet;
}

void V0_0_39_cluster_rec_controller::unsetHost()
{
    m_HostIsSet = false;
}
