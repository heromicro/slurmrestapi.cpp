...
V0_0_37_job_properties::V0_0_37_job_properties()
{
...
void V0_0_37_job_properties::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_37_job_properties::toJson() const
{
...
bool V0_0_37_job_properties::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_37_job_properties::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_37_job_properties::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_37_job_properties::getAccount() const
{
    return m_Account;
}

void V0_0_37_job_properties::setAccount(const utility::string_t& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool V0_0_37_job_properties::accountIsSet() const
{
    return m_AccountIsSet;
}

void V0_0_37_job_properties::unsetAccount()
{
    m_AccountIsSet = false;
}
utility::string_t V0_0_37_job_properties::getAccountGatherFrequency() const
{
    return m_Account_gather_frequency;
}

void V0_0_37_job_properties::setAccountGatherFrequency(const utility::string_t& value)
{
    m_Account_gather_frequency = value;
    m_Account_gather_frequencyIsSet = true;
}

bool V0_0_37_job_properties::accountGatherFrequencyIsSet() const
{
    return m_Account_gather_frequencyIsSet;
}

void V0_0_37_job_properties::unsetAccount_gather_frequency()
{
    m_Account_gather_frequencyIsSet = false;
}
std::vector<utility::string_t>& V0_0_37_job_properties::getArgv()
{
    return m_Argv;
}

void V0_0_37_job_properties::setArgv(const std::vector<utility::string_t>& value)
{
    m_Argv = value;
    m_ArgvIsSet = true;
}

bool V0_0_37_job_properties::argvIsSet() const
{
    return m_ArgvIsSet;
}

void V0_0_37_job_properties::unsetArgv()
{
    m_ArgvIsSet = false;
}
utility::string_t V0_0_37_job_properties::getArray() const
{
    return m_array;
}

void V0_0_37_job_properties::setArray(const utility::string_t& value)
{
    m_array = value;
    m_arrayIsSet = true;
}

bool V0_0_37_job_properties::arrayIsSet() const
{
    return m_arrayIsSet;
}

void V0_0_37_job_properties::unsetarray()
{
    m_arrayIsSet = false;
}
utility::string_t V0_0_37_job_properties::getBatchFeatures() const
{
    return m_Batch_features;
}

void V0_0_37_job_properties::setBatchFeatures(const utility::string_t& value)
{
    m_Batch_features = value;
    m_Batch_featuresIsSet = true;
}

bool V0_0_37_job_properties::batchFeaturesIsSet() const
{
    return m_Batch_featuresIsSet;
}

void V0_0_37_job_properties::unsetBatch_features()
{
    m_Batch_featuresIsSet = false;
}
int64_t V0_0_37_job_properties::getBeginTime() const
{
    return m_Begin_time;
}

void V0_0_37_job_properties::setBeginTime(int64_t value)
{
    m_Begin_time = value;
    m_Begin_timeIsSet = true;
}

bool V0_0_37_job_properties::beginTimeIsSet() const
{
    return m_Begin_timeIsSet;
}

void V0_0_37_job_properties::unsetBegin_time()
{
    m_Begin_timeIsSet = false;
}
utility::string_t V0_0_37_job_properties::getBurstBuffer() const
{
    return m_Burst_buffer;
}

void V0_0_37_job_properties::setBurstBuffer(const utility::string_t& value)
{
    m_Burst_buffer = value;
    m_Burst_bufferIsSet = true;
}

bool V0_0_37_job_properties::burstBufferIsSet() const
{
    return m_Burst_bufferIsSet;
}

void V0_0_37_job_properties::unsetBurst_buffer()
{
    m_Burst_bufferIsSet = false;
}
utility::string_t V0_0_37_job_properties::getClusterConstraint() const
{
    return m_Cluster_constraint;
}

void V0_0_37_job_properties::setClusterConstraint(const utility::string_t& value)
{
    m_Cluster_constraint = value;
    m_Cluster_constraintIsSet = true;
}

bool V0_0_37_job_properties::clusterConstraintIsSet() const
{
    return m_Cluster_constraintIsSet;
}

void V0_0_37_job_properties::unsetCluster_constraint()
{
    m_Cluster_constraintIsSet = false;
}
utility::string_t V0_0_37_job_properties::getComment() const
{
    return m_Comment;
}

void V0_0_37_job_properties::setComment(const utility::string_t& value)
{
    m_Comment = value;
    m_CommentIsSet = true;
}

bool V0_0_37_job_properties::commentIsSet() const
{
    return m_CommentIsSet;
}

void V0_0_37_job_properties::unsetComment()
{
    m_CommentIsSet = false;
}
utility::string_t V0_0_37_job_properties::getConstraints() const
{
    return m_Constraints;
}

void V0_0_37_job_properties::setConstraints(const utility::string_t& value)
{
    m_Constraints = value;
    m_ConstraintsIsSet = true;
}

bool V0_0_37_job_properties::constraintsIsSet() const
{
    return m_ConstraintsIsSet;
}

void V0_0_37_job_properties::unsetConstraints()
{
    m_ConstraintsIsSet = false;
}
int32_t V0_0_37_job_properties::getCoreSpecification() const
{
    return m_Core_specification;
}

void V0_0_37_job_properties::setCoreSpecification(int32_t value)
{
    m_Core_specification = value;
    m_Core_specificationIsSet = true;
}

bool V0_0_37_job_properties::coreSpecificationIsSet() const
{
    return m_Core_specificationIsSet;
}

void V0_0_37_job_properties::unsetCore_specification()
{
    m_Core_specificationIsSet = false;
}
int32_t V0_0_37_job_properties::getCoresPerSocket() const
{
    return m_Cores_per_socket;
}

void V0_0_37_job_properties::setCoresPerSocket(int32_t value)
{
    m_Cores_per_socket = value;
    m_Cores_per_socketIsSet = true;
}

bool V0_0_37_job_properties::coresPerSocketIsSet() const
{
    return m_Cores_per_socketIsSet;
}

void V0_0_37_job_properties::unsetCores_per_socket()
{
    m_Cores_per_socketIsSet = false;
}
utility::string_t V0_0_37_job_properties::getCpuBinding() const
{
    return m_Cpu_binding;
}

void V0_0_37_job_properties::setCpuBinding(const utility::string_t& value)
{
    m_Cpu_binding = value;
    m_Cpu_bindingIsSet = true;
}

bool V0_0_37_job_properties::cpuBindingIsSet() const
{
    return m_Cpu_bindingIsSet;
}

void V0_0_37_job_properties::unsetCpu_binding()
{
    m_Cpu_bindingIsSet = false;
}
utility::string_t V0_0_37_job_properties::getCpuBindingHint() const
{
    return m_Cpu_binding_hint;
}

void V0_0_37_job_properties::setCpuBindingHint(const utility::string_t& value)
{
    m_Cpu_binding_hint = value;
    m_Cpu_binding_hintIsSet = true;
}

bool V0_0_37_job_properties::cpuBindingHintIsSet() const
{
    return m_Cpu_binding_hintIsSet;
}

void V0_0_37_job_properties::unsetCpu_binding_hint()
{
    m_Cpu_binding_hintIsSet = false;
}
utility::string_t V0_0_37_job_properties::getCpuFrequency() const
{
    return m_Cpu_frequency;
}

void V0_0_37_job_properties::setCpuFrequency(const utility::string_t& value)
{
    m_Cpu_frequency = value;
    m_Cpu_frequencyIsSet = true;
}

bool V0_0_37_job_properties::cpuFrequencyIsSet() const
{
    return m_Cpu_frequencyIsSet;
}

void V0_0_37_job_properties::unsetCpu_frequency()
{
    m_Cpu_frequencyIsSet = false;
}
utility::string_t V0_0_37_job_properties::getCpusPerGpu() const
{
    return m_Cpus_per_gpu;
}

void V0_0_37_job_properties::setCpusPerGpu(const utility::string_t& value)
{
    m_Cpus_per_gpu = value;
    m_Cpus_per_gpuIsSet = true;
}

bool V0_0_37_job_properties::cpusPerGpuIsSet() const
{
    return m_Cpus_per_gpuIsSet;
}

void V0_0_37_job_properties::unsetCpus_per_gpu()
{
    m_Cpus_per_gpuIsSet = false;
}
int32_t V0_0_37_job_properties::getCpusPerTask() const
{
    return m_Cpus_per_task;
}

void V0_0_37_job_properties::setCpusPerTask(int32_t value)
{
    m_Cpus_per_task = value;
    m_Cpus_per_taskIsSet = true;
}

bool V0_0_37_job_properties::cpusPerTaskIsSet() const
{
    return m_Cpus_per_taskIsSet;
}

void V0_0_37_job_properties::unsetCpus_per_task()
{
    m_Cpus_per_taskIsSet = false;
}
utility::string_t V0_0_37_job_properties::getCurrentWorkingDirectory() const
{
    return m_Current_working_directory;
}

void V0_0_37_job_properties::setCurrentWorkingDirectory(const utility::string_t& value)
{
    m_Current_working_directory = value;
    m_Current_working_directoryIsSet = true;
}

bool V0_0_37_job_properties::currentWorkingDirectoryIsSet() const
{
    return m_Current_working_directoryIsSet;
}

void V0_0_37_job_properties::unsetCurrent_working_directory()
{
    m_Current_working_directoryIsSet = false;
}
utility::string_t V0_0_37_job_properties::getDeadline() const
{
    return m_Deadline;
}

void V0_0_37_job_properties::setDeadline(const utility::string_t& value)
{
    m_Deadline = value;
    m_DeadlineIsSet = true;
}

bool V0_0_37_job_properties::deadlineIsSet() const
{
    return m_DeadlineIsSet;
}

void V0_0_37_job_properties::unsetDeadline()
{
    m_DeadlineIsSet = false;
}
int32_t V0_0_37_job_properties::getDelayBoot() const
{
    return m_Delay_boot;
}

void V0_0_37_job_properties::setDelayBoot(int32_t value)
{
    m_Delay_boot = value;
    m_Delay_bootIsSet = true;
}

bool V0_0_37_job_properties::delayBootIsSet() const
{
    return m_Delay_bootIsSet;
}

void V0_0_37_job_properties::unsetDelay_boot()
{
    m_Delay_bootIsSet = false;
}
utility::string_t V0_0_37_job_properties::getDependency() const
{
    return m_Dependency;
}

void V0_0_37_job_properties::setDependency(const utility::string_t& value)
{
    m_Dependency = value;
    m_DependencyIsSet = true;
}

bool V0_0_37_job_properties::dependencyIsSet() const
{
    return m_DependencyIsSet;
}

void V0_0_37_job_properties::unsetDependency()
{
    m_DependencyIsSet = false;
}
utility::string_t V0_0_37_job_properties::getDistribution() const
{
    return m_Distribution;
}

void V0_0_37_job_properties::setDistribution(const utility::string_t& value)
{
    m_Distribution = value;
    m_DistributionIsSet = true;
}

bool V0_0_37_job_properties::distributionIsSet() const
{
    return m_DistributionIsSet;
}

void V0_0_37_job_properties::unsetDistribution()
{
    m_DistributionIsSet = false;
}
std::shared_ptr<Object> V0_0_37_job_properties::getEnvironment() const
{
    return m_Environment;
}

void V0_0_37_job_properties::setEnvironment(const std::shared_ptr<Object>& value)
{
    m_Environment = value;
    m_EnvironmentIsSet = true;
}

bool V0_0_37_job_properties::environmentIsSet() const
{
    return m_EnvironmentIsSet;
}

void V0_0_37_job_properties::unsetEnvironment()
{
    m_EnvironmentIsSet = false;
}
utility::string_t V0_0_37_job_properties::getExclusive() const
{
    return m_Exclusive;
}

void V0_0_37_job_properties::setExclusive(const utility::string_t& value)
{
    m_Exclusive = value;
    m_ExclusiveIsSet = true;
}

bool V0_0_37_job_properties::exclusiveIsSet() const
{
    return m_ExclusiveIsSet;
}

void V0_0_37_job_properties::unsetExclusive()
{
    m_ExclusiveIsSet = false;
}
bool V0_0_37_job_properties::isGetUserEnvironment() const
{
    return m_Get_user_environment;
}

void V0_0_37_job_properties::setGetUserEnvironment(bool value)
{
    m_Get_user_environment = value;
    m_Get_user_environmentIsSet = true;
}

bool V0_0_37_job_properties::getUserEnvironmentIsSet() const
{
    return m_Get_user_environmentIsSet;
}

void V0_0_37_job_properties::unsetGet_user_environment()
{
    m_Get_user_environmentIsSet = false;
}
utility::string_t V0_0_37_job_properties::getGres() const
{
    return m_Gres;
}

void V0_0_37_job_properties::setGres(const utility::string_t& value)
{
    m_Gres = value;
    m_GresIsSet = true;
}

bool V0_0_37_job_properties::gresIsSet() const
{
    return m_GresIsSet;
}

void V0_0_37_job_properties::unsetGres()
{
    m_GresIsSet = false;
}
utility::string_t V0_0_37_job_properties::getGresFlags() const
{
    return m_Gres_flags;
}

void V0_0_37_job_properties::setGresFlags(const utility::string_t& value)
{
    m_Gres_flags = value;
    m_Gres_flagsIsSet = true;
}

bool V0_0_37_job_properties::gresFlagsIsSet() const
{
    return m_Gres_flagsIsSet;
}

void V0_0_37_job_properties::unsetGres_flags()
{
    m_Gres_flagsIsSet = false;
}
utility::string_t V0_0_37_job_properties::getGpuBinding() const
{
    return m_Gpu_binding;
}

void V0_0_37_job_properties::setGpuBinding(const utility::string_t& value)
{
    m_Gpu_binding = value;
    m_Gpu_bindingIsSet = true;
}

bool V0_0_37_job_properties::gpuBindingIsSet() const
{
    return m_Gpu_bindingIsSet;
}

void V0_0_37_job_properties::unsetGpu_binding()
{
    m_Gpu_bindingIsSet = false;
}
utility::string_t V0_0_37_job_properties::getGpuFrequency() const
{
    return m_Gpu_frequency;
}

void V0_0_37_job_properties::setGpuFrequency(const utility::string_t& value)
{
    m_Gpu_frequency = value;
    m_Gpu_frequencyIsSet = true;
}

bool V0_0_37_job_properties::gpuFrequencyIsSet() const
{
    return m_Gpu_frequencyIsSet;
}

void V0_0_37_job_properties::unsetGpu_frequency()
{
    m_Gpu_frequencyIsSet = false;
}
utility::string_t V0_0_37_job_properties::getGpus() const
{
    return m_Gpus;
}

void V0_0_37_job_properties::setGpus(const utility::string_t& value)
{
    m_Gpus = value;
    m_GpusIsSet = true;
}

bool V0_0_37_job_properties::gpusIsSet() const
{
    return m_GpusIsSet;
}

void V0_0_37_job_properties::unsetGpus()
{
    m_GpusIsSet = false;
}
utility::string_t V0_0_37_job_properties::getGpusPerNode() const
{
    return m_Gpus_per_node;
}

void V0_0_37_job_properties::setGpusPerNode(const utility::string_t& value)
{
    m_Gpus_per_node = value;
    m_Gpus_per_nodeIsSet = true;
}

bool V0_0_37_job_properties::gpusPerNodeIsSet() const
{
    return m_Gpus_per_nodeIsSet;
}

void V0_0_37_job_properties::unsetGpus_per_node()
{
    m_Gpus_per_nodeIsSet = false;
}
utility::string_t V0_0_37_job_properties::getGpusPerSocket() const
{
    return m_Gpus_per_socket;
}

void V0_0_37_job_properties::setGpusPerSocket(const utility::string_t& value)
{
    m_Gpus_per_socket = value;
    m_Gpus_per_socketIsSet = true;
}

bool V0_0_37_job_properties::gpusPerSocketIsSet() const
{
    return m_Gpus_per_socketIsSet;
}

void V0_0_37_job_properties::unsetGpus_per_socket()
{
    m_Gpus_per_socketIsSet = false;
}
utility::string_t V0_0_37_job_properties::getGpusPerTask() const
{
    return m_Gpus_per_task;
}

void V0_0_37_job_properties::setGpusPerTask(const utility::string_t& value)
{
    m_Gpus_per_task = value;
    m_Gpus_per_taskIsSet = true;
}

bool V0_0_37_job_properties::gpusPerTaskIsSet() const
{
    return m_Gpus_per_taskIsSet;
}

void V0_0_37_job_properties::unsetGpus_per_task()
{
    m_Gpus_per_taskIsSet = false;
}
bool V0_0_37_job_properties::isHold() const
{
    return m_Hold;
}

void V0_0_37_job_properties::setHold(bool value)
{
    m_Hold = value;
    m_HoldIsSet = true;
}

bool V0_0_37_job_properties::holdIsSet() const
{
    return m_HoldIsSet;
}

void V0_0_37_job_properties::unsetHold()
{
    m_HoldIsSet = false;
}
bool V0_0_37_job_properties::isKillOnInvalidDependency() const
{
    return m_Kill_on_invalid_dependency;
}

void V0_0_37_job_properties::setKillOnInvalidDependency(bool value)
{
    m_Kill_on_invalid_dependency = value;
    m_Kill_on_invalid_dependencyIsSet = true;
}

bool V0_0_37_job_properties::killOnInvalidDependencyIsSet() const
{
    return m_Kill_on_invalid_dependencyIsSet;
}

void V0_0_37_job_properties::unsetKill_on_invalid_dependency()
{
    m_Kill_on_invalid_dependencyIsSet = false;
}
utility::string_t V0_0_37_job_properties::getLicenses() const
{
    return m_Licenses;
}

void V0_0_37_job_properties::setLicenses(const utility::string_t& value)
{
    m_Licenses = value;
    m_LicensesIsSet = true;
}

bool V0_0_37_job_properties::licensesIsSet() const
{
    return m_LicensesIsSet;
}

void V0_0_37_job_properties::unsetLicenses()
{
    m_LicensesIsSet = false;
}
utility::string_t V0_0_37_job_properties::getMailType() const
{
    return m_Mail_type;
}

void V0_0_37_job_properties::setMailType(const utility::string_t& value)
{
    m_Mail_type = value;
    m_Mail_typeIsSet = true;
}

bool V0_0_37_job_properties::mailTypeIsSet() const
{
    return m_Mail_typeIsSet;
}

void V0_0_37_job_properties::unsetMail_type()
{
    m_Mail_typeIsSet = false;
}
utility::string_t V0_0_37_job_properties::getMailUser() const
{
    return m_Mail_user;
}

void V0_0_37_job_properties::setMailUser(const utility::string_t& value)
{
    m_Mail_user = value;
    m_Mail_userIsSet = true;
}

bool V0_0_37_job_properties::mailUserIsSet() const
{
    return m_Mail_userIsSet;
}

void V0_0_37_job_properties::unsetMail_user()
{
    m_Mail_userIsSet = false;
}
utility::string_t V0_0_37_job_properties::getMcsLabel() const
{
    return m_Mcs_label;
}

void V0_0_37_job_properties::setMcsLabel(const utility::string_t& value)
{
    m_Mcs_label = value;
    m_Mcs_labelIsSet = true;
}

bool V0_0_37_job_properties::mcsLabelIsSet() const
{
    return m_Mcs_labelIsSet;
}

void V0_0_37_job_properties::unsetMcs_label()
{
    m_Mcs_labelIsSet = false;
}
utility::string_t V0_0_37_job_properties::getMemoryBinding() const
{
    return m_Memory_binding;
}

void V0_0_37_job_properties::setMemoryBinding(const utility::string_t& value)
{
    m_Memory_binding = value;
    m_Memory_bindingIsSet = true;
}

bool V0_0_37_job_properties::memoryBindingIsSet() const
{
    return m_Memory_bindingIsSet;
}

void V0_0_37_job_properties::unsetMemory_binding()
{
    m_Memory_bindingIsSet = false;
}
int32_t V0_0_37_job_properties::getMemoryPerCpu() const
{
    return m_Memory_per_cpu;
}

void V0_0_37_job_properties::setMemoryPerCpu(int32_t value)
{
    m_Memory_per_cpu = value;
    m_Memory_per_cpuIsSet = true;
}

bool V0_0_37_job_properties::memoryPerCpuIsSet() const
{
    return m_Memory_per_cpuIsSet;
}

void V0_0_37_job_properties::unsetMemory_per_cpu()
{
    m_Memory_per_cpuIsSet = false;
}
int32_t V0_0_37_job_properties::getMemoryPerGpu() const
{
    return m_Memory_per_gpu;
}

void V0_0_37_job_properties::setMemoryPerGpu(int32_t value)
{
    m_Memory_per_gpu = value;
    m_Memory_per_gpuIsSet = true;
}

bool V0_0_37_job_properties::memoryPerGpuIsSet() const
{
    return m_Memory_per_gpuIsSet;
}

void V0_0_37_job_properties::unsetMemory_per_gpu()
{
    m_Memory_per_gpuIsSet = false;
}
int32_t V0_0_37_job_properties::getMemoryPerNode() const
{
    return m_Memory_per_node;
}

void V0_0_37_job_properties::setMemoryPerNode(int32_t value)
{
    m_Memory_per_node = value;
    m_Memory_per_nodeIsSet = true;
}

bool V0_0_37_job_properties::memoryPerNodeIsSet() const
{
    return m_Memory_per_nodeIsSet;
}

void V0_0_37_job_properties::unsetMemory_per_node()
{
    m_Memory_per_nodeIsSet = false;
}
int32_t V0_0_37_job_properties::getMinimumCpusPerNode() const
{
    return m_Minimum_cpus_per_node;
}

void V0_0_37_job_properties::setMinimumCpusPerNode(int32_t value)
{
    m_Minimum_cpus_per_node = value;
    m_Minimum_cpus_per_nodeIsSet = true;
}

bool V0_0_37_job_properties::minimumCpusPerNodeIsSet() const
{
    return m_Minimum_cpus_per_nodeIsSet;
}

void V0_0_37_job_properties::unsetMinimum_cpus_per_node()
{
    m_Minimum_cpus_per_nodeIsSet = false;
}
bool V0_0_37_job_properties::isMinimumNodes() const
{
    return m_Minimum_nodes;
}

void V0_0_37_job_properties::setMinimumNodes(bool value)
{
    m_Minimum_nodes = value;
    m_Minimum_nodesIsSet = true;
}

bool V0_0_37_job_properties::minimumNodesIsSet() const
{
    return m_Minimum_nodesIsSet;
}

void V0_0_37_job_properties::unsetMinimum_nodes()
{
    m_Minimum_nodesIsSet = false;
}
utility::string_t V0_0_37_job_properties::getName() const
{
    return m_Name;
}

void V0_0_37_job_properties::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_37_job_properties::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_37_job_properties::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t V0_0_37_job_properties::getNice() const
{
    return m_Nice;
}

void V0_0_37_job_properties::setNice(const utility::string_t& value)
{
    m_Nice = value;
    m_NiceIsSet = true;
}

bool V0_0_37_job_properties::niceIsSet() const
{
    return m_NiceIsSet;
}

void V0_0_37_job_properties::unsetNice()
{
    m_NiceIsSet = false;
}
bool V0_0_37_job_properties::isNoKill() const
{
    return m_No_kill;
}

void V0_0_37_job_properties::setNoKill(bool value)
{
    m_No_kill = value;
    m_No_killIsSet = true;
}

bool V0_0_37_job_properties::noKillIsSet() const
{
    return m_No_killIsSet;
}

void V0_0_37_job_properties::unsetNo_kill()
{
    m_No_killIsSet = false;
}
std::vector<int32_t>& V0_0_37_job_properties::getNodes()
{
    return m_Nodes;
}

void V0_0_37_job_properties::setNodes(std::vector<int32_t> value)
{
    m_Nodes = value;
    m_NodesIsSet = true;
}

bool V0_0_37_job_properties::nodesIsSet() const
{
    return m_NodesIsSet;
}

void V0_0_37_job_properties::unsetNodes()
{
    m_NodesIsSet = false;
}
utility::string_t V0_0_37_job_properties::getOpenMode() const
{
    return m_Open_mode;
}

void V0_0_37_job_properties::setOpenMode(const utility::string_t& value)
{
    m_Open_mode = value;
    m_Open_modeIsSet = true;
}

bool V0_0_37_job_properties::openModeIsSet() const
{
    return m_Open_modeIsSet;
}

void V0_0_37_job_properties::unsetOpen_mode()
{
    m_Open_modeIsSet = false;
}
utility::string_t V0_0_37_job_properties::getPartition() const
{
    return m_Partition;
}

void V0_0_37_job_properties::setPartition(const utility::string_t& value)
{
    m_Partition = value;
    m_PartitionIsSet = true;
}

bool V0_0_37_job_properties::partitionIsSet() const
{
    return m_PartitionIsSet;
}

void V0_0_37_job_properties::unsetPartition()
{
    m_PartitionIsSet = false;
}
utility::string_t V0_0_37_job_properties::getPriority() const
{
    return m_Priority;
}

void V0_0_37_job_properties::setPriority(const utility::string_t& value)
{
    m_Priority = value;
    m_PriorityIsSet = true;
}

bool V0_0_37_job_properties::priorityIsSet() const
{
    return m_PriorityIsSet;
}

void V0_0_37_job_properties::unsetPriority()
{
    m_PriorityIsSet = false;
}
utility::string_t V0_0_37_job_properties::getQos() const
{
    return m_Qos;
}

void V0_0_37_job_properties::setQos(const utility::string_t& value)
{
    m_Qos = value;
    m_QosIsSet = true;
}

bool V0_0_37_job_properties::qosIsSet() const
{
    return m_QosIsSet;
}

void V0_0_37_job_properties::unsetQos()
{
    m_QosIsSet = false;
}
bool V0_0_37_job_properties::isRequeue() const
{
    return m_Requeue;
}

void V0_0_37_job_properties::setRequeue(bool value)
{
    m_Requeue = value;
    m_RequeueIsSet = true;
}

bool V0_0_37_job_properties::requeueIsSet() const
{
    return m_RequeueIsSet;
}

void V0_0_37_job_properties::unsetRequeue()
{
    m_RequeueIsSet = false;
}
utility::string_t V0_0_37_job_properties::getReservation() const
{
    return m_Reservation;
}

void V0_0_37_job_properties::setReservation(const utility::string_t& value)
{
    m_Reservation = value;
    m_ReservationIsSet = true;
}

bool V0_0_37_job_properties::reservationIsSet() const
{
    return m_ReservationIsSet;
}

void V0_0_37_job_properties::unsetReservation()
{
    m_ReservationIsSet = false;
}
utility::string_t V0_0_37_job_properties::getSignal() const
{
    return m_Signal;
}

void V0_0_37_job_properties::setSignal(const utility::string_t& value)
{
    m_Signal = value;
    m_SignalIsSet = true;
}

bool V0_0_37_job_properties::signalIsSet() const
{
    return m_SignalIsSet;
}

void V0_0_37_job_properties::unsetSignal()
{
    m_SignalIsSet = false;
}
int32_t V0_0_37_job_properties::getSocketsPerNode() const
{
    return m_Sockets_per_node;
}

void V0_0_37_job_properties::setSocketsPerNode(int32_t value)
{
    m_Sockets_per_node = value;
    m_Sockets_per_nodeIsSet = true;
}

bool V0_0_37_job_properties::socketsPerNodeIsSet() const
{
    return m_Sockets_per_nodeIsSet;
}

void V0_0_37_job_properties::unsetSockets_per_node()
{
    m_Sockets_per_nodeIsSet = false;
}
bool V0_0_37_job_properties::isSpreadJob() const
{
    return m_Spread_job;
}

void V0_0_37_job_properties::setSpreadJob(bool value)
{
    m_Spread_job = value;
    m_Spread_jobIsSet = true;
}

bool V0_0_37_job_properties::spreadJobIsSet() const
{
    return m_Spread_jobIsSet;
}

void V0_0_37_job_properties::unsetSpread_job()
{
    m_Spread_jobIsSet = false;
}
utility::string_t V0_0_37_job_properties::getStandardError() const
{
    return m_Standard_error;
}

void V0_0_37_job_properties::setStandardError(const utility::string_t& value)
{
    m_Standard_error = value;
    m_Standard_errorIsSet = true;
}

bool V0_0_37_job_properties::standardErrorIsSet() const
{
    return m_Standard_errorIsSet;
}

void V0_0_37_job_properties::unsetStandard_error()
{
    m_Standard_errorIsSet = false;
}
utility::string_t V0_0_37_job_properties::getStandardInput() const
{
    return m_Standard_input;
}

void V0_0_37_job_properties::setStandardInput(const utility::string_t& value)
{
    m_Standard_input = value;
    m_Standard_inputIsSet = true;
}

bool V0_0_37_job_properties::standardInputIsSet() const
{
    return m_Standard_inputIsSet;
}

void V0_0_37_job_properties::unsetStandard_input()
{
    m_Standard_inputIsSet = false;
}
utility::string_t V0_0_37_job_properties::getStandardOutput() const
{
    return m_Standard_output;
}

void V0_0_37_job_properties::setStandardOutput(const utility::string_t& value)
{
    m_Standard_output = value;
    m_Standard_outputIsSet = true;
}

bool V0_0_37_job_properties::standardOutputIsSet() const
{
    return m_Standard_outputIsSet;
}

void V0_0_37_job_properties::unsetStandard_output()
{
    m_Standard_outputIsSet = false;
}
int32_t V0_0_37_job_properties::getTasks() const
{
    return m_Tasks;
}

void V0_0_37_job_properties::setTasks(int32_t value)
{
    m_Tasks = value;
    m_TasksIsSet = true;
}

bool V0_0_37_job_properties::tasksIsSet() const
{
    return m_TasksIsSet;
}

void V0_0_37_job_properties::unsetTasks()
{
    m_TasksIsSet = false;
}
int32_t V0_0_37_job_properties::getTasksPerCore() const
{
    return m_Tasks_per_core;
}

void V0_0_37_job_properties::setTasksPerCore(int32_t value)
{
    m_Tasks_per_core = value;
    m_Tasks_per_coreIsSet = true;
}

bool V0_0_37_job_properties::tasksPerCoreIsSet() const
{
    return m_Tasks_per_coreIsSet;
}

void V0_0_37_job_properties::unsetTasks_per_core()
{
    m_Tasks_per_coreIsSet = false;
}
int32_t V0_0_37_job_properties::getTasksPerNode() const
{
    return m_Tasks_per_node;
}

void V0_0_37_job_properties::setTasksPerNode(int32_t value)
{
    m_Tasks_per_node = value;
    m_Tasks_per_nodeIsSet = true;
}

bool V0_0_37_job_properties::tasksPerNodeIsSet() const
{
    return m_Tasks_per_nodeIsSet;
}

void V0_0_37_job_properties::unsetTasks_per_node()
{
    m_Tasks_per_nodeIsSet = false;
}
int32_t V0_0_37_job_properties::getTasksPerSocket() const
{
    return m_Tasks_per_socket;
}

void V0_0_37_job_properties::setTasksPerSocket(int32_t value)
{
    m_Tasks_per_socket = value;
    m_Tasks_per_socketIsSet = true;
}

bool V0_0_37_job_properties::tasksPerSocketIsSet() const
{
    return m_Tasks_per_socketIsSet;
}

void V0_0_37_job_properties::unsetTasks_per_socket()
{
    m_Tasks_per_socketIsSet = false;
}
int32_t V0_0_37_job_properties::getThreadSpecification() const
{
    return m_Thread_specification;
}

void V0_0_37_job_properties::setThreadSpecification(int32_t value)
{
    m_Thread_specification = value;
    m_Thread_specificationIsSet = true;
}

bool V0_0_37_job_properties::threadSpecificationIsSet() const
{
    return m_Thread_specificationIsSet;
}

void V0_0_37_job_properties::unsetThread_specification()
{
    m_Thread_specificationIsSet = false;
}
int32_t V0_0_37_job_properties::getThreadsPerCore() const
{
    return m_Threads_per_core;
}

void V0_0_37_job_properties::setThreadsPerCore(int32_t value)
{
    m_Threads_per_core = value;
    m_Threads_per_coreIsSet = true;
}

bool V0_0_37_job_properties::threadsPerCoreIsSet() const
{
    return m_Threads_per_coreIsSet;
}

void V0_0_37_job_properties::unsetThreads_per_core()
{
    m_Threads_per_coreIsSet = false;
}
int32_t V0_0_37_job_properties::getTimeLimit() const
{
    return m_Time_limit;
}

void V0_0_37_job_properties::setTimeLimit(int32_t value)
{
    m_Time_limit = value;
    m_Time_limitIsSet = true;
}

bool V0_0_37_job_properties::timeLimitIsSet() const
{
    return m_Time_limitIsSet;
}

void V0_0_37_job_properties::unsetTime_limit()
{
    m_Time_limitIsSet = false;
}
int32_t V0_0_37_job_properties::getTimeMinimum() const
{
    return m_Time_minimum;
}

void V0_0_37_job_properties::setTimeMinimum(int32_t value)
{
    m_Time_minimum = value;
    m_Time_minimumIsSet = true;
}

bool V0_0_37_job_properties::timeMinimumIsSet() const
{
    return m_Time_minimumIsSet;
}

void V0_0_37_job_properties::unsetTime_minimum()
{
    m_Time_minimumIsSet = false;
}
bool V0_0_37_job_properties::isWaitAllNodes() const
{
    return m_Wait_all_nodes;
}

void V0_0_37_job_properties::setWaitAllNodes(bool value)
{
    m_Wait_all_nodes = value;
    m_Wait_all_nodesIsSet = true;
}

bool V0_0_37_job_properties::waitAllNodesIsSet() const
{
    return m_Wait_all_nodesIsSet;
}

void V0_0_37_job_properties::unsetWait_all_nodes()
{
    m_Wait_all_nodesIsSet = false;
}
utility::string_t V0_0_37_job_properties::getWckey() const
{
    return m_Wckey;
}

void V0_0_37_job_properties::setWckey(const utility::string_t& value)
{
    m_Wckey = value;
    m_WckeyIsSet = true;
}

bool V0_0_37_job_properties::wckeyIsSet() const
{
    return m_WckeyIsSet;
}

void V0_0_37_job_properties::unsetWckey()
{
    m_WckeyIsSet = false;
}
}
