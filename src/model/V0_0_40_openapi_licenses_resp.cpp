...
V0_0_40_openapi_licenses_resp::V0_0_40_openapi_licenses_resp()
{
...
void V0_0_40_openapi_licenses_resp::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_openapi_licenses_resp::toJson() const
{
...
bool V0_0_40_openapi_licenses_resp::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("licenses"))))
    {
        ...
        {
            std::vector<std::shared_ptr<V0_0_40_license>> refVal_setLicenses;
...
void V0_0_40_openapi_licenses_resp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_openapi_licenses_resp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_40_license>>& V0_0_40_openapi_licenses_resp::getLicenses()
{
    return m_Licenses;
}

void V0_0_40_openapi_licenses_resp::setLicenses(const std::vector<std::shared_ptr<V0_0_40_license>>& value)
{
    m_Licenses = value;
    m_LicensesIsSet = true;
}

bool V0_0_40_openapi_licenses_resp::licensesIsSet() const
{
    return m_LicensesIsSet;
}

void V0_0_40_openapi_licenses_resp::unsetLicenses()
{
    m_LicensesIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_openapi_licenses_resp::getLastUpdate() const
{
    return m_Last_update;
}

void V0_0_40_openapi_licenses_resp::setLastUpdate(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Last_update = value;
    m_Last_updateIsSet = true;
}

bool V0_0_40_openapi_licenses_resp::lastUpdateIsSet() const
{
    return m_Last_updateIsSet;
}

void V0_0_40_openapi_licenses_resp::unsetLast_update()
{
    m_Last_updateIsSet = false;
}
std::shared_ptr<V0_0_40_openapi_meta> V0_0_40_openapi_licenses_resp::getMeta() const
{
    return m_Meta;
}

void V0_0_40_openapi_licenses_resp::setMeta(const std::shared_ptr<V0_0_40_openapi_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_40_openapi_licenses_resp::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_40_openapi_licenses_resp::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_openapi_error>>& V0_0_40_openapi_licenses_resp::getErrors()
{
    return m_Errors;
}

void V0_0_40_openapi_licenses_resp::setErrors(const std::vector<std::shared_ptr<V0_0_40_openapi_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_40_openapi_licenses_resp::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_40_openapi_licenses_resp::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_openapi_warning>>& V0_0_40_openapi_licenses_resp::getWarnings()
{
    return m_Warnings;
}

void V0_0_40_openapi_licenses_resp::setWarnings(const std::vector<std::shared_ptr<V0_0_40_openapi_warning>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool V0_0_40_openapi_licenses_resp::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void V0_0_40_openapi_licenses_resp::unsetWarnings()
{
    m_WarningsIsSet = false;
}
}
