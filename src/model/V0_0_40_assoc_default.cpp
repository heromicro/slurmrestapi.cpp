...
V0_0_40_assoc_default::V0_0_40_assoc_default()
{
...
void V0_0_40_assoc_default::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_assoc_default::toJson() const
{
...
bool V0_0_40_assoc_default::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_assoc_default::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_assoc_default::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_assoc_default::getQos() const
{
    return m_Qos;
}

void V0_0_40_assoc_default::setQos(const utility::string_t& value)
{
    m_Qos = value;
    m_QosIsSet = true;
}

bool V0_0_40_assoc_default::qosIsSet() const
{
    return m_QosIsSet;
}

void V0_0_40_assoc_default::unsetQos()
{
    m_QosIsSet = false;
}
}
