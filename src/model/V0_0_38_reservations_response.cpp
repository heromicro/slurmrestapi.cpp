...
V0_0_38_reservations_response::V0_0_38_reservations_response()
{
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
...
void V0_0_38_reservations_response::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_38_reservations_response::toJson() const
{
...
bool V0_0_38_reservations_response::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("reservations"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_38_reservation>> refVal_setReservations;
...
void V0_0_38_reservations_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_38_reservations_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_38_meta> V0_0_38_reservations_response::getMeta() const
{
    return m_Meta;
}

void V0_0_38_reservations_response::setMeta(const std::shared_ptr<V0_0_38_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_38_reservations_response::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_38_reservations_response::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_38_error>>& V0_0_38_reservations_response::getErrors()
{
    return m_Errors;
}

void V0_0_38_reservations_response::setErrors(const std::vector<std::shared_ptr<V0_0_38_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_38_reservations_response::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_38_reservations_response::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_38_reservation>>& V0_0_38_reservations_response::getReservations()
{
    return m_Reservations;
}

void V0_0_38_reservations_response::setReservations(const std::vector<std::shared_ptr<V0_0_38_reservation>>& value)
{
    m_Reservations = value;
    m_ReservationsIsSet = true;
}

bool V0_0_38_reservations_response::reservationsIsSet() const
{
    return m_ReservationsIsSet;
}

void V0_0_38_reservations_response::unsetReservations()
{
    m_ReservationsIsSet = false;
}
}
