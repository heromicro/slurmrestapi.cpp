...
V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::toJson() const
{
...
bool V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int32_t V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_job_info_resp_jobs_inner_tasks_per_node::unsetnumber()
{
    m_numberIsSet = false;
}
}
