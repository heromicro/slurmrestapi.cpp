...
V0_0_41_job_desc_msg_rlimits_cpu::V0_0_41_job_desc_msg_rlimits_cpu()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_job_desc_msg_rlimits_cpu::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_job_desc_msg_rlimits_cpu::toJson() const
{
...
bool V0_0_41_job_desc_msg_rlimits_cpu::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_job_desc_msg_rlimits_cpu::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_job_desc_msg_rlimits_cpu::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_job_desc_msg_rlimits_cpu::isSet() const
{
    return m_set;
}

void V0_0_41_job_desc_msg_rlimits_cpu::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_job_desc_msg_rlimits_cpu::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_job_desc_msg_rlimits_cpu::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_job_desc_msg_rlimits_cpu::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_job_desc_msg_rlimits_cpu::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_job_desc_msg_rlimits_cpu::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_job_desc_msg_rlimits_cpu::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int64_t V0_0_41_job_desc_msg_rlimits_cpu::getNumber() const
{
    return m_number;
}

void V0_0_41_job_desc_msg_rlimits_cpu::setNumber(int64_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_job_desc_msg_rlimits_cpu::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_job_desc_msg_rlimits_cpu::unsetnumber()
{
    m_numberIsSet = false;
}
}
