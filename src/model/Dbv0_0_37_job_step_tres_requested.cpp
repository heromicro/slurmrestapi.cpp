...
Dbv0_0_37_job_step_tres_requested::Dbv0_0_37_job_step_tres_requested()
{
...
void Dbv0_0_37_job_step_tres_requested::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_job_step_tres_requested::toJson() const
{
...
bool Dbv0_0_37_job_step_tres_requested::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("average"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>> refVal_setAverage;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("max"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>> refVal_setMax;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("min"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>> refVal_setMin;
...
void Dbv0_0_37_job_step_tres_requested::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_job_step_tres_requested::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& Dbv0_0_37_job_step_tres_requested::getAverage()
{
    return m_Average;
}

void Dbv0_0_37_job_step_tres_requested::setAverage(const std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& value)
{
    m_Average = value;
    m_AverageIsSet = true;
}

bool Dbv0_0_37_job_step_tres_requested::averageIsSet() const
{
    return m_AverageIsSet;
}

void Dbv0_0_37_job_step_tres_requested::unsetAverage()
{
    m_AverageIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& Dbv0_0_37_job_step_tres_requested::getMax()
{
    return m_Max;
}

void Dbv0_0_37_job_step_tres_requested::setMax(const std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& value)
{
    m_Max = value;
    m_MaxIsSet = true;
}

bool Dbv0_0_37_job_step_tres_requested::maxIsSet() const
{
    return m_MaxIsSet;
}

void Dbv0_0_37_job_step_tres_requested::unsetMax()
{
    m_MaxIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& Dbv0_0_37_job_step_tres_requested::getMin()
{
    return m_Min;
}

void Dbv0_0_37_job_step_tres_requested::setMin(const std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& value)
{
    m_Min = value;
    m_MinIsSet = true;
}

bool Dbv0_0_37_job_step_tres_requested::minIsSet() const
{
    return m_MinIsSet;
}

void Dbv0_0_37_job_step_tres_requested::unsetMin()
{
    m_MinIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& Dbv0_0_37_job_step_tres_requested::getTotal()
{
    return m_Total;
}

void Dbv0_0_37_job_step_tres_requested::setTotal(const std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool Dbv0_0_37_job_step_tres_requested::totalIsSet() const
{
    return m_TotalIsSet;
}

void Dbv0_0_37_job_step_tres_requested::unsetTotal()
{
    m_TotalIsSet = false;
}
}
