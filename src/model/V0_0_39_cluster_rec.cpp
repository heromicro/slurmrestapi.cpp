...
V0_0_39_cluster_rec::V0_0_39_cluster_rec()
{
...
void V0_0_39_cluster_rec::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_cluster_rec::toJson() const
{
...
bool V0_0_39_cluster_rec::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("controller"))))
    {
        ...
        {
            std::shared_ptr<V0_0_39_cluster_rec_controller> refVal_setController;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("associations"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_cluster_rec_associations> refVal_setAssociations;
...
void V0_0_39_cluster_rec::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_cluster_rec::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_39_cluster_rec_controller> V0_0_39_cluster_rec::getController() const
{
    return m_Controller;
}

void V0_0_39_cluster_rec::setController(const std::shared_ptr<V0_0_39_cluster_rec_controller>& value)
{
    m_Controller = value;
    m_ControllerIsSet = true;
}

bool V0_0_39_cluster_rec::controllerIsSet() const
{
    return m_ControllerIsSet;
}

void V0_0_39_cluster_rec::unsetController()
{
    m_ControllerIsSet = false;
}
std::vector<utility::string_t>& V0_0_39_cluster_rec::getFlags()
{
    return m_Flags;
}

void V0_0_39_cluster_rec::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool V0_0_39_cluster_rec::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void V0_0_39_cluster_rec::unsetFlags()
{
    m_FlagsIsSet = false;
}
utility::string_t V0_0_39_cluster_rec::getName() const
{
    return m_Name;
}

void V0_0_39_cluster_rec::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_39_cluster_rec::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_39_cluster_rec::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t V0_0_39_cluster_rec::getNodes() const
{
    return m_Nodes;
}

void V0_0_39_cluster_rec::setNodes(const utility::string_t& value)
{
    m_Nodes = value;
    m_NodesIsSet = true;
}

bool V0_0_39_cluster_rec::nodesIsSet() const
{
    return m_NodesIsSet;
}

void V0_0_39_cluster_rec::unsetNodes()
{
    m_NodesIsSet = false;
}
utility::string_t V0_0_39_cluster_rec::getSelectPlugin() const
{
    return m_Select_plugin;
}

void V0_0_39_cluster_rec::setSelectPlugin(const utility::string_t& value)
{
    m_Select_plugin = value;
    m_Select_pluginIsSet = true;
}

bool V0_0_39_cluster_rec::selectPluginIsSet() const
{
    return m_Select_pluginIsSet;
}

void V0_0_39_cluster_rec::unsetSelect_plugin()
{
    m_Select_pluginIsSet = false;
}
std::shared_ptr<V0_0_39_cluster_rec_associations> V0_0_39_cluster_rec::getAssociations() const
{
    return m_Associations;
}

void V0_0_39_cluster_rec::setAssociations(const std::shared_ptr<V0_0_39_cluster_rec_associations>& value)
{
    m_Associations = value;
    m_AssociationsIsSet = true;
}

bool V0_0_39_cluster_rec::associationsIsSet() const
{
    return m_AssociationsIsSet;
}

void V0_0_39_cluster_rec::unsetAssociations()
{
    m_AssociationsIsSet = false;
}
int32_t V0_0_39_cluster_rec::getRpcVersion() const
{
    return m_Rpc_version;
}

void V0_0_39_cluster_rec::setRpcVersion(int32_t value)
{
    m_Rpc_version = value;
    m_Rpc_versionIsSet = true;
}

bool V0_0_39_cluster_rec::rpcVersionIsSet() const
{
    return m_Rpc_versionIsSet;
}

void V0_0_39_cluster_rec::unsetRpc_version()
{
    m_Rpc_versionIsSet = false;
}
std::vector<std::shared_ptr<V0_0_39_tres>>& V0_0_39_cluster_rec::getTres()
{
    return m_Tres;
}

void V0_0_39_cluster_rec::setTres(const std::vector<std::shared_ptr<V0_0_39_tres>>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool V0_0_39_cluster_rec::tresIsSet() const
{
    return m_TresIsSet;
}

void V0_0_39_cluster_rec::unsetTres()
{
    m_TresIsSet = false;
}
}
