...
V0_0_41_job_desc_msg_time_limit::V0_0_41_job_desc_msg_time_limit()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_job_desc_msg_time_limit::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_job_desc_msg_time_limit::toJson() const
{
...
bool V0_0_41_job_desc_msg_time_limit::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_job_desc_msg_time_limit::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_job_desc_msg_time_limit::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_job_desc_msg_time_limit::isSet() const
{
    return m_set;
}

void V0_0_41_job_desc_msg_time_limit::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_job_desc_msg_time_limit::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_job_desc_msg_time_limit::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_job_desc_msg_time_limit::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_job_desc_msg_time_limit::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_job_desc_msg_time_limit::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_job_desc_msg_time_limit::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int32_t V0_0_41_job_desc_msg_time_limit::getNumber() const
{
    return m_number;
}

void V0_0_41_job_desc_msg_time_limit::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_job_desc_msg_time_limit::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_job_desc_msg_time_limit::unsetnumber()
{
    m_numberIsSet = false;
}
}
