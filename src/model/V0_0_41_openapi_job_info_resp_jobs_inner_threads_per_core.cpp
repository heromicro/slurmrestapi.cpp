...
V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::toJson() const
{
...
bool V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int32_t V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_job_info_resp_jobs_inner_threads_per_core::unsetnumber()
{
    m_numberIsSet = false;
}
}
