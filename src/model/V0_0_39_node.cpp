...
bool V0_0_39_node::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("external_sensors"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_ext_sensors_data> refVal_setExternalSensors;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("power"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_power_mgmt_data> refVal_setPower;
...
std::shared_ptr<V0_0_39_ext_sensors_data> V0_0_39_node::getExternalSensors() const
{
    return m_External_sensors;
}

void V0_0_39_node::setExternalSensors(const std::shared_ptr<V0_0_39_ext_sensors_data>& value)
{
...
std::shared_ptr<V0_0_39_power_mgmt_data> V0_0_39_node::getPower() const
{
    return m_Power;
}

void V0_0_39_node::setPower(const std::shared_ptr<V0_0_39_power_mgmt_data>& value)
{
    m_Power = value;
    m_PowerIsSet = true;
}
