...
void V0_0_40_wckey::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_wckey::toJson() const
{
...
bool V0_0_40_wckey::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_wckey::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_wckey::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_40_accounting>>& V0_0_40_wckey::getAccounting()
{
    return m_Accounting;
}

void V0_0_40_wckey::setAccounting(const std::vector<std::shared_ptr<V0_0_40_accounting>>& value)
{
    m_Accounting = value;
    m_AccountingIsSet = true;
}

bool V0_0_40_wckey::accountingIsSet() const
{
    return m_AccountingIsSet;
}

void V0_0_40_wckey::unsetAccounting()
{
    m_AccountingIsSet = false;
}
utility::string_t V0_0_40_wckey::getCluster() const
{
    return m_Cluster;
}

void V0_0_40_wckey::setCluster(const utility::string_t& value)
{
    m_Cluster = value;
    m_ClusterIsSet = true;
}

bool V0_0_40_wckey::clusterIsSet() const
{
    return m_ClusterIsSet;
}

void V0_0_40_wckey::unsetCluster()
{
    m_ClusterIsSet = false;
}
int32_t V0_0_40_wckey::getId() const
{
    return m_Id;
}

void V0_0_40_wckey::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool V0_0_40_wckey::idIsSet() const
{
    return m_IdIsSet;
}

void V0_0_40_wckey::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t V0_0_40_wckey::getName() const
{
    return m_Name;
}

void V0_0_40_wckey::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_40_wckey::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_40_wckey::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t V0_0_40_wckey::getUser() const
{
    return m_User;
}

void V0_0_40_wckey::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool V0_0_40_wckey::userIsSet() const
{
    return m_UserIsSet;
}

void V0_0_40_wckey::unsetUser()
{
    m_UserIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_wckey::getFlags()
{
    return m_Flags;
}

void V0_0_40_wckey::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool V0_0_40_wckey::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void V0_0_40_wckey::unsetFlags()
{
    m_FlagsIsSet = false;
}
}
