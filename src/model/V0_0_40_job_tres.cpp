...
V0_0_40_job_tres::V0_0_40_job_tres()
{
...
void V0_0_40_job_tres::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_job_tres::toJson() const
{
...
bool V0_0_40_job_tres::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("requested"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_40_tres>> refVal_setRequested;
...
void V0_0_40_job_tres::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_job_tres::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_job_tres::getAllocated()
{
    return m_Allocated;
}

void V0_0_40_job_tres::setAllocated(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Allocated = value;
    m_AllocatedIsSet = true;
}

bool V0_0_40_job_tres::allocatedIsSet() const
{
    return m_AllocatedIsSet;
}

void V0_0_40_job_tres::unsetAllocated()
{
    m_AllocatedIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_job_tres::getRequested()
{
    return m_Requested;
}

void V0_0_40_job_tres::setRequested(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Requested = value;
    m_RequestedIsSet = true;
}

bool V0_0_40_job_tres::requestedIsSet() const
{
    return m_RequestedIsSet;
}

void V0_0_40_job_tres::unsetRequested()
{
    m_RequestedIsSet = false;
}
}
