...
V0_0_41_openapi_diag_resp::V0_0_41_openapi_diag_resp()
{
...
void V0_0_41_openapi_diag_resp::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_diag_resp::toJson() const
{
...
bool V0_0_41_openapi_diag_resp::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("statistics"))))
    {
        ...
        {
            std::shared_ptr<V0_0_41_openapi_diag_resp_statistics> refVal_setStatistics;
...
void V0_0_41_openapi_diag_resp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_diag_resp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_41_openapi_diag_resp_statistics> V0_0_41_openapi_diag_resp::getStatistics() const
{
    return m_Statistics;
}

void V0_0_41_openapi_diag_resp::setStatistics(const std::shared_ptr<V0_0_41_openapi_diag_resp_statistics>& value)
{
    m_Statistics = value;
    m_StatisticsIsSet = true;
}

bool V0_0_41_openapi_diag_resp::statisticsIsSet() const
{
    return m_StatisticsIsSet;
}

void V0_0_41_openapi_diag_resp::unsetStatistics()
{
    m_StatisticsIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_shares_resp_meta> V0_0_41_openapi_diag_resp::getMeta() const
{
    return m_Meta;
}

void V0_0_41_openapi_diag_resp::setMeta(const std::shared_ptr<V0_0_41_openapi_shares_resp_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_41_openapi_diag_resp::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_41_openapi_diag_resp::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_errors_inner>>& V0_0_41_openapi_diag_resp::getErrors()
{
    return m_Errors;
}

void V0_0_41_openapi_diag_resp::setErrors(const std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_errors_inner>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_41_openapi_diag_resp::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_41_openapi_diag_resp::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_warnings_inner>>& V0_0_41_openapi_diag_resp::getWarnings()
{
    return m_Warnings;
}

void V0_0_41_openapi_diag_resp::setWarnings(const std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_warnings_inner>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool V0_0_41_openapi_diag_resp::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void V0_0_41_openapi_diag_resp::unsetWarnings()
{
    m_WarningsIsSet = false;
}
}
