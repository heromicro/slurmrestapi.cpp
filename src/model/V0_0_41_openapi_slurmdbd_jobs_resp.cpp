...
V0_0_41_openapi_slurmdbd_jobs_resp::V0_0_41_openapi_slurmdbd_jobs_resp()
{
    m_JobsIsSet = false;
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
...
void V0_0_41_openapi_slurmdbd_jobs_resp::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_slurmdbd_jobs_resp::toJson() const
{
...
bool V0_0_41_openapi_slurmdbd_jobs_resp::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("jobs"))))
    {
        ...
        {
            std::vector<std::shared_ptr<V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner>> refVal_setJobs;
...
void V0_0_41_openapi_slurmdbd_jobs_resp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_slurmdbd_jobs_resp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner>>& V0_0_41_openapi_slurmdbd_jobs_resp::getJobs()
{
    return m_Jobs;
}

void V0_0_41_openapi_slurmdbd_jobs_resp::setJobs(const std::vector<std::shared_ptr<V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner>>& value)
{
    m_Jobs = value;
    m_JobsIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp::jobsIsSet() const
{
    return m_JobsIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp::unsetJobs()
{
    m_JobsIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_shares_resp_meta> V0_0_41_openapi_slurmdbd_jobs_resp::getMeta() const
{
    return m_Meta;
}

void V0_0_41_openapi_slurmdbd_jobs_resp::setMeta(const std::shared_ptr<V0_0_41_openapi_shares_resp_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_errors_inner>>& V0_0_41_openapi_slurmdbd_jobs_resp::getErrors()
{
    return m_Errors;
}

void V0_0_41_openapi_slurmdbd_jobs_resp::setErrors(const std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_errors_inner>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_warnings_inner>>& V0_0_41_openapi_slurmdbd_jobs_resp::getWarnings()
{
    return m_Warnings;
}

void V0_0_41_openapi_slurmdbd_jobs_resp::setWarnings(const std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_warnings_inner>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp::unsetWarnings()
{
    m_WarningsIsSet = false;
}
}
