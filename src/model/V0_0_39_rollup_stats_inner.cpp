...
#include "slurmrestapi/model/V0_0_39_rollup_stats_inner.h"
...
V0_0_39_rollup_stats_inner::V0_0_39_rollup_stats_inner()
{
...
void V0_0_39_rollup_stats_inner::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_rollup_stats_inner::toJson() const
{
...
bool V0_0_39_rollup_stats_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_39_rollup_stats_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_rollup_stats_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_39_rollup_stats_inner::getType() const
{
    return m_Type;
}

void V0_0_39_rollup_stats_inner::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool V0_0_39_rollup_stats_inner::typeIsSet() const
{
    return m_TypeIsSet;
}

void V0_0_39_rollup_stats_inner::unsetType()
{
    m_TypeIsSet = false;
}
int32_t V0_0_39_rollup_stats_inner::getLastRun() const
{
    return m_Last_run;
}

void V0_0_39_rollup_stats_inner::setLastRun(int32_t value)
{
    m_Last_run = value;
    m_Last_runIsSet = true;
}

bool V0_0_39_rollup_stats_inner::lastRunIsSet() const
{
    return m_Last_runIsSet;
}

void V0_0_39_rollup_stats_inner::unsetLast_run()
{
    m_Last_runIsSet = false;
}
int64_t V0_0_39_rollup_stats_inner::getMaxCycle() const
{
    return m_Max_cycle;
}

void V0_0_39_rollup_stats_inner::setMaxCycle(int64_t value)
{
    m_Max_cycle = value;
    m_Max_cycleIsSet = true;
}

bool V0_0_39_rollup_stats_inner::maxCycleIsSet() const
{
    return m_Max_cycleIsSet;
}

void V0_0_39_rollup_stats_inner::unsetMax_cycle()
{
    m_Max_cycleIsSet = false;
}
int64_t V0_0_39_rollup_stats_inner::getTotalTime() const
{
    return m_Total_time;
}

void V0_0_39_rollup_stats_inner::setTotalTime(int64_t value)
{
    m_Total_time = value;
    m_Total_timeIsSet = true;
}

bool V0_0_39_rollup_stats_inner::totalTimeIsSet() const
{
    return m_Total_timeIsSet;
}

void V0_0_39_rollup_stats_inner::unsetTotal_time()
{
    m_Total_timeIsSet = false;
}
int64_t V0_0_39_rollup_stats_inner::getTotalCycles() const
{
    return m_Total_cycles;
}

void V0_0_39_rollup_stats_inner::setTotalCycles(int64_t value)
{
    m_Total_cycles = value;
    m_Total_cyclesIsSet = true;
}

bool V0_0_39_rollup_stats_inner::totalCyclesIsSet() const
{
    return m_Total_cyclesIsSet;
}

void V0_0_39_rollup_stats_inner::unsetTotal_cycles()
{
    m_Total_cyclesIsSet = false;
}
int64_t V0_0_39_rollup_stats_inner::getMeanCycles() const
{
    return m_Mean_cycles;
}

void V0_0_39_rollup_stats_inner::setMeanCycles(int64_t value)
{
    m_Mean_cycles = value;
    m_Mean_cyclesIsSet = true;
}

bool V0_0_39_rollup_stats_inner::meanCyclesIsSet() const
{
    return m_Mean_cyclesIsSet;
}

void V0_0_39_rollup_stats_inner::unsetMean_cycles()
{
    m_Mean_cyclesIsSet = false;
}
}
