...
V0_0_40_accounting_allocated::V0_0_40_accounting_allocated()
{
    m_Seconds = 0L;
...
void V0_0_40_accounting_allocated::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_accounting_allocated::toJson() const
{
...
bool V0_0_40_accounting_allocated::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_accounting_allocated::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_accounting_allocated::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int64_t V0_0_40_accounting_allocated::getSeconds() const
{
    return m_Seconds;
}

void V0_0_40_accounting_allocated::setSeconds(int64_t value)
{
    m_Seconds = value;
    m_SecondsIsSet = true;
}

bool V0_0_40_accounting_allocated::secondsIsSet() const
{
    return m_SecondsIsSet;
}

void V0_0_40_accounting_allocated::unsetSeconds()
{
    m_SecondsIsSet = false;
}
}
