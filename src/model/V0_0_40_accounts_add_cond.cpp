...
V0_0_40_accounts_add_cond::V0_0_40_accounts_add_cond()
{
...
void V0_0_40_accounts_add_cond::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_accounts_add_cond::toJson() const
{
...
bool V0_0_40_accounts_add_cond::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_accounts_add_cond::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_accounts_add_cond::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<utility::string_t>& V0_0_40_accounts_add_cond::getAccounts()
{
    return m_Accounts;
}

void V0_0_40_accounts_add_cond::setAccounts(const std::vector<utility::string_t>& value)
{
    m_Accounts = value;
    m_AccountsIsSet = true;
}

bool V0_0_40_accounts_add_cond::accountsIsSet() const
{
    return m_AccountsIsSet;
}

void V0_0_40_accounts_add_cond::unsetAccounts()
{
    m_AccountsIsSet = false;
}
std::shared_ptr<V0_0_40_assoc_rec_set> V0_0_40_accounts_add_cond::getAssociation() const
{
    return m_Association;
}

void V0_0_40_accounts_add_cond::setAssociation(const std::shared_ptr<V0_0_40_assoc_rec_set>& value)
{
    m_Association = value;
    m_AssociationIsSet = true;
}

bool V0_0_40_accounts_add_cond::associationIsSet() const
{
    return m_AssociationIsSet;
}

void V0_0_40_accounts_add_cond::unsetAssociation()
{
    m_AssociationIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_accounts_add_cond::getClusters()
{
    return m_Clusters;
}

void V0_0_40_accounts_add_cond::setClusters(const std::vector<utility::string_t>& value)
{
    m_Clusters = value;
    m_ClustersIsSet = true;
}

bool V0_0_40_accounts_add_cond::clustersIsSet() const
{
    return m_ClustersIsSet;
}

void V0_0_40_accounts_add_cond::unsetClusters()
{
    m_ClustersIsSet = false;
}
}
