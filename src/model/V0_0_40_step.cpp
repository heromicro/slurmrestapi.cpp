...
#include "slurmrestapi/model/V0_0_40_step.h"
...
void V0_0_40_step::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_step::toJson() const
{
...
bool V0_0_40_step::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("time"))))
    {
        ...
        {
            std::shared_ptr<V0_0_40_step_time> refVal_setTime;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("nodes"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_step_nodes> refVal_setNodes;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("CPU"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_step_CPU> refVal_setCPU;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("statistics"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_step_statistics> refVal_setStatistics;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("step"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_step_step> refVal_setStep;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tres"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_step_tres> refVal_setTres;
...
void V0_0_40_step::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_step::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_40_step_time> V0_0_40_step::getTime() const
{
    return m_Time;
}

void V0_0_40_step::setTime(const std::shared_ptr<V0_0_40_step_time>& value)
{
    m_Time = value;
    m_TimeIsSet = true;
}

bool V0_0_40_step::timeIsSet() const
{
    return m_TimeIsSet;
}

void V0_0_40_step::unsetTime()
{
    m_TimeIsSet = false;
}
std::shared_ptr<V0_0_40_process_exit_code_verbose> V0_0_40_step::getExitCode() const
{
    return m_Exit_code;
}

void V0_0_40_step::setExitCode(const std::shared_ptr<V0_0_40_process_exit_code_verbose>& value)
{
    m_Exit_code = value;
    m_Exit_codeIsSet = true;
}

bool V0_0_40_step::exitCodeIsSet() const
{
    return m_Exit_codeIsSet;
}

void V0_0_40_step::unsetExit_code()
{
    m_Exit_codeIsSet = false;
}
std::shared_ptr<V0_0_40_step_nodes> V0_0_40_step::getNodes() const
{
    return m_Nodes;
}

void V0_0_40_step::setNodes(const std::shared_ptr<V0_0_40_step_nodes>& value)
{
    m_Nodes = value;
    m_NodesIsSet = true;
}

bool V0_0_40_step::nodesIsSet() const
{
    return m_NodesIsSet;
}

void V0_0_40_step::unsetNodes()
{
    m_NodesIsSet = false;
}
std::shared_ptr<V0_0_40_step_tasks> V0_0_40_step::getTasks() const
{
    return m_Tasks;
}

void V0_0_40_step::setTasks(const std::shared_ptr<V0_0_40_step_tasks>& value)
{
    m_Tasks = value;
    m_TasksIsSet = true;
}

bool V0_0_40_step::tasksIsSet() const
{
    return m_TasksIsSet;
}

void V0_0_40_step::unsetTasks()
{
    m_TasksIsSet = false;
}
utility::string_t V0_0_40_step::getPid() const
{
    return m_Pid;
}

void V0_0_40_step::setPid(const utility::string_t& value)
{
    m_Pid = value;
    m_PidIsSet = true;
}

bool V0_0_40_step::pidIsSet() const
{
    return m_PidIsSet;
}

void V0_0_40_step::unsetPid()
{
    m_PidIsSet = false;
}
std::shared_ptr<V0_0_40_step_CPU> V0_0_40_step::getCPU() const
{
    return m_CPU;
}

void V0_0_40_step::setCPU(const std::shared_ptr<V0_0_40_step_CPU>& value)
{
    m_CPU = value;
    m_CPUIsSet = true;
}

bool V0_0_40_step::cPUIsSet() const
{
    return m_CPUIsSet;
}

void V0_0_40_step::unsetCPU()
{
    m_CPUIsSet = false;
}
utility::string_t V0_0_40_step::getKillRequestUser() const
{
    return m_Kill_request_user;
}

void V0_0_40_step::setKillRequestUser(const utility::string_t& value)
{
    m_Kill_request_user = value;
    m_Kill_request_userIsSet = true;
}

bool V0_0_40_step::killRequestUserIsSet() const
{
    return m_Kill_request_userIsSet;
}

void V0_0_40_step::unsetKill_request_user()
{
    m_Kill_request_userIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_step::getState()
{
    return m_State;
}

void V0_0_40_step::setState(const std::vector<utility::string_t>& value)
{
    m_State = value;
    m_StateIsSet = true;
}

bool V0_0_40_step::stateIsSet() const
{
    return m_StateIsSet;
}

void V0_0_40_step::unsetState()
{
    m_StateIsSet = false;
}
std::shared_ptr<V0_0_40_step_statistics> V0_0_40_step::getStatistics() const
{
    return m_Statistics;
}

void V0_0_40_step::setStatistics(const std::shared_ptr<V0_0_40_step_statistics>& value)
{
    m_Statistics = value;
    m_StatisticsIsSet = true;
}

bool V0_0_40_step::statisticsIsSet() const
{
    return m_StatisticsIsSet;
}

void V0_0_40_step::unsetStatistics()
{
    m_StatisticsIsSet = false;
}
std::shared_ptr<V0_0_40_step_step> V0_0_40_step::getStep() const
{
    return m_Step;
}

void V0_0_40_step::setStep(const std::shared_ptr<V0_0_40_step_step>& value)
{
    m_Step = value;
    m_StepIsSet = true;
}

bool V0_0_40_step::stepIsSet() const
{
    return m_StepIsSet;
}

void V0_0_40_step::unsetStep()
{
    m_StepIsSet = false;
}
std::shared_ptr<V0_0_40_step_task> V0_0_40_step::getTask() const
{
    return m_Task;
}

void V0_0_40_step::setTask(const std::shared_ptr<V0_0_40_step_task>& value)
{
    m_Task = value;
    m_TaskIsSet = true;
}

bool V0_0_40_step::taskIsSet() const
{
    return m_TaskIsSet;
}

void V0_0_40_step::unsetTask()
{
    m_TaskIsSet = false;
}
std::shared_ptr<V0_0_40_step_tres> V0_0_40_step::getTres() const
{
    return m_Tres;
}

void V0_0_40_step::setTres(const std::shared_ptr<V0_0_40_step_tres>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool V0_0_40_step::tresIsSet() const
{
    return m_TresIsSet;
}

void V0_0_40_step::unsetTres()
{
    m_TresIsSet = false;
}
}
