...
V0_0_38_job_resources::V0_0_38_job_resources()
{
...
void V0_0_38_job_resources::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_38_job_resources::toJson() const
{
...
bool V0_0_38_job_resources::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("allocated_nodes"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_38_node_allocation>> refVal_setAllocatedNodes;
...
void V0_0_38_job_resources::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_38_job_resources::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_38_job_resources::getNodes() const
{
    return m_Nodes;
}

void V0_0_38_job_resources::setNodes(const utility::string_t& value)
{
    m_Nodes = value;
    m_NodesIsSet = true;
}

bool V0_0_38_job_resources::nodesIsSet() const
{
    return m_NodesIsSet;
}

void V0_0_38_job_resources::unsetNodes()
{
    m_NodesIsSet = false;
}
int32_t V0_0_38_job_resources::getAllocatedCpus() const
{
    return m_Allocated_cpus;
}

void V0_0_38_job_resources::setAllocatedCpus(int32_t value)
{
    m_Allocated_cpus = value;
    m_Allocated_cpusIsSet = true;
}

bool V0_0_38_job_resources::allocatedCpusIsSet() const
{
    return m_Allocated_cpusIsSet;
}

void V0_0_38_job_resources::unsetAllocated_cpus()
{
    m_Allocated_cpusIsSet = false;
}
int32_t V0_0_38_job_resources::getAllocatedHosts() const
{
    return m_Allocated_hosts;
}

void V0_0_38_job_resources::setAllocatedHosts(int32_t value)
{
    m_Allocated_hosts = value;
    m_Allocated_hostsIsSet = true;
}

bool V0_0_38_job_resources::allocatedHostsIsSet() const
{
    return m_Allocated_hostsIsSet;
}

void V0_0_38_job_resources::unsetAllocated_hosts()
{
    m_Allocated_hostsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_38_node_allocation>>& V0_0_38_job_resources::getAllocatedNodes()
{
    return m_Allocated_nodes;
}

void V0_0_38_job_resources::setAllocatedNodes(const std::vector<std::shared_ptr<V0_0_38_node_allocation>>& value)
{
    m_Allocated_nodes = value;
    m_Allocated_nodesIsSet = true;
}

bool V0_0_38_job_resources::allocatedNodesIsSet() const
{
    return m_Allocated_nodesIsSet;
}

void V0_0_38_job_resources::unsetAllocated_nodes()
{
    m_Allocated_nodesIsSet = false;
}
}
