...
V0_0_39_job_time::V0_0_39_job_time()
{
    m_Elapsed = 0;
...
void V0_0_39_job_time::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_job_time::toJson() const
{
...
bool V0_0_39_job_time::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("system"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_job_time_system> refVal_setSystem;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("limit"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_uint32_no_val> refVal_setLimit;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("total"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_job_time_system> refVal_setTotal;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("user"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_job_time_system> refVal_setUser;
...
void V0_0_39_job_time::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_job_time::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_39_job_time::getElapsed() const
{
    return m_Elapsed;
}

void V0_0_39_job_time::setElapsed(int32_t value)
{
    m_Elapsed = value;
    m_ElapsedIsSet = true;
}

bool V0_0_39_job_time::elapsedIsSet() const
{
    return m_ElapsedIsSet;
}

void V0_0_39_job_time::unsetElapsed()
{
    m_ElapsedIsSet = false;
}
int64_t V0_0_39_job_time::getEligible() const
{
    return m_Eligible;
}

void V0_0_39_job_time::setEligible(int64_t value)
{
    m_Eligible = value;
    m_EligibleIsSet = true;
}

bool V0_0_39_job_time::eligibleIsSet() const
{
    return m_EligibleIsSet;
}

void V0_0_39_job_time::unsetEligible()
{
    m_EligibleIsSet = false;
}
int64_t V0_0_39_job_time::getEnd() const
{
    return m_End;
}

void V0_0_39_job_time::setEnd(int64_t value)
{
    m_End = value;
    m_EndIsSet = true;
}

bool V0_0_39_job_time::endIsSet() const
{
    return m_EndIsSet;
}

void V0_0_39_job_time::unsetEnd()
{
    m_EndIsSet = false;
}
int64_t V0_0_39_job_time::getStart() const
{
    return m_Start;
}

void V0_0_39_job_time::setStart(int64_t value)
{
    m_Start = value;
    m_StartIsSet = true;
}

bool V0_0_39_job_time::startIsSet() const
{
    return m_StartIsSet;
}

void V0_0_39_job_time::unsetStart()
{
    m_StartIsSet = false;
}
int64_t V0_0_39_job_time::getSubmission() const
{
    return m_Submission;
}

void V0_0_39_job_time::setSubmission(int64_t value)
{
    m_Submission = value;
    m_SubmissionIsSet = true;
}

bool V0_0_39_job_time::submissionIsSet() const
{
    return m_SubmissionIsSet;
}

void V0_0_39_job_time::unsetSubmission()
{
    m_SubmissionIsSet = false;
}
int32_t V0_0_39_job_time::getSuspended() const
{
    return m_Suspended;
}

void V0_0_39_job_time::setSuspended(int32_t value)
{
    m_Suspended = value;
    m_SuspendedIsSet = true;
}

bool V0_0_39_job_time::suspendedIsSet() const
{
    return m_SuspendedIsSet;
}

void V0_0_39_job_time::unsetSuspended()
{
    m_SuspendedIsSet = false;
}
std::shared_ptr<V0_0_39_job_time_system> V0_0_39_job_time::getSystem() const
{
    return m_System;
}

void V0_0_39_job_time::setSystem(const std::shared_ptr<V0_0_39_job_time_system>& value)
{
    m_System = value;
    m_SystemIsSet = true;
}

bool V0_0_39_job_time::systemIsSet() const
{
    return m_SystemIsSet;
}

void V0_0_39_job_time::unsetSystem()
{
    m_SystemIsSet = false;
}
std::shared_ptr<V0_0_39_uint32_no_val> V0_0_39_job_time::getLimit() const
{
    return m_Limit;
}

void V0_0_39_job_time::setLimit(const std::shared_ptr<V0_0_39_uint32_no_val>& value)
{
    m_Limit = value;
    m_LimitIsSet = true;
}

bool V0_0_39_job_time::limitIsSet() const
{
    return m_LimitIsSet;
}

void V0_0_39_job_time::unsetLimit()
{
    m_LimitIsSet = false;
}
std::shared_ptr<V0_0_39_job_time_system> V0_0_39_job_time::getTotal() const
{
    return m_Total;
}

void V0_0_39_job_time::setTotal(const std::shared_ptr<V0_0_39_job_time_system>& value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool V0_0_39_job_time::totalIsSet() const
{
    return m_TotalIsSet;
}

void V0_0_39_job_time::unsetTotal()
{
    m_TotalIsSet = false;
}
std::shared_ptr<V0_0_39_job_time_system> V0_0_39_job_time::getUser() const
{
    return m_User;
}

void V0_0_39_job_time::setUser(const std::shared_ptr<V0_0_39_job_time_system>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool V0_0_39_job_time::userIsSet() const
{
    return m_UserIsSet;
}

void V0_0_39_job_time::unsetUser()
{
    m_UserIsSet = false;
}
}
