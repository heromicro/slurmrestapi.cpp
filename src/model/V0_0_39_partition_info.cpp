...
bool V0_0_39_partition_info::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("cpus"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_partition_info_cpus> refVal_setCpus;
...
std::shared_ptr<V0_0_39_partition_info_cpus> V0_0_39_partition_info::getCpus() const
{
    return m_Cpus;
}

void V0_0_39_partition_info::setCpus(const std::shared_ptr<V0_0_39_partition_info_cpus>& value)
{
    m_Cpus = value;
    m_CpusIsSet = true;
}
