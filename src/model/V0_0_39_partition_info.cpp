...
V0_0_39_partition_info::V0_0_39_partition_info()
{
    m_NodesIsSet = false;
...
void V0_0_39_partition_info::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_partition_info::toJson() const
{
...
bool V0_0_39_partition_info::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("nodes"))))
    {
        ...
        {
            std::shared_ptr<V0_0_39_partition_info_nodes> refVal_setNodes;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("accounts"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_partition_info_accounts> refVal_setAccounts;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("groups"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_partition_info_groups> refVal_setGroups;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("qos"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_partition_info_qos> refVal_setQos;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tres"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_partition_info_tres> refVal_setTres;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("cpus"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_partition_info_nodes> refVal_setCpus;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("defaults"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_partition_info_defaults> refVal_setDefaults;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("maximums"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_partition_info_maximums> refVal_setMaximums;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("minimums"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_partition_info_minimums> refVal_setMinimums;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("priority"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_partition_info_priority> refVal_setPriority;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("timeouts"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_partition_info_timeouts> refVal_setTimeouts;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("suspend_time"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_uint32_no_val> refVal_setSuspendTime;
...
void V0_0_39_partition_info::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_partition_info::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_39_partition_info_nodes> V0_0_39_partition_info::getNodes() const
{
    return m_Nodes;
}

void V0_0_39_partition_info::setNodes(const std::shared_ptr<V0_0_39_partition_info_nodes>& value)
{
    m_Nodes = value;
    m_NodesIsSet = true;
}

bool V0_0_39_partition_info::nodesIsSet() const
{
    return m_NodesIsSet;
}

void V0_0_39_partition_info::unsetNodes()
{
    m_NodesIsSet = false;
}
std::shared_ptr<V0_0_39_partition_info_accounts> V0_0_39_partition_info::getAccounts() const
{
    return m_Accounts;
}

void V0_0_39_partition_info::setAccounts(const std::shared_ptr<V0_0_39_partition_info_accounts>& value)
{
    m_Accounts = value;
    m_AccountsIsSet = true;
}

bool V0_0_39_partition_info::accountsIsSet() const
{
    return m_AccountsIsSet;
}

void V0_0_39_partition_info::unsetAccounts()
{
    m_AccountsIsSet = false;
}
std::shared_ptr<V0_0_39_partition_info_groups> V0_0_39_partition_info::getGroups() const
{
    return m_Groups;
}

void V0_0_39_partition_info::setGroups(const std::shared_ptr<V0_0_39_partition_info_groups>& value)
{
    m_Groups = value;
    m_GroupsIsSet = true;
}

bool V0_0_39_partition_info::groupsIsSet() const
{
    return m_GroupsIsSet;
}

void V0_0_39_partition_info::unsetGroups()
{
    m_GroupsIsSet = false;
}
std::shared_ptr<V0_0_39_partition_info_qos> V0_0_39_partition_info::getQos() const
{
    return m_Qos;
}

void V0_0_39_partition_info::setQos(const std::shared_ptr<V0_0_39_partition_info_qos>& value)
{
    m_Qos = value;
    m_QosIsSet = true;
}

bool V0_0_39_partition_info::qosIsSet() const
{
    return m_QosIsSet;
}

void V0_0_39_partition_info::unsetQos()
{
    m_QosIsSet = false;
}
utility::string_t V0_0_39_partition_info::getAlternate() const
{
    return m_Alternate;
}

void V0_0_39_partition_info::setAlternate(const utility::string_t& value)
{
    m_Alternate = value;
    m_AlternateIsSet = true;
}

bool V0_0_39_partition_info::alternateIsSet() const
{
    return m_AlternateIsSet;
}

void V0_0_39_partition_info::unsetAlternate()
{
    m_AlternateIsSet = false;
}
std::shared_ptr<V0_0_39_partition_info_tres> V0_0_39_partition_info::getTres() const
{
    return m_Tres;
}

void V0_0_39_partition_info::setTres(const std::shared_ptr<V0_0_39_partition_info_tres>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool V0_0_39_partition_info::tresIsSet() const
{
    return m_TresIsSet;
}

void V0_0_39_partition_info::unsetTres()
{
    m_TresIsSet = false;
}
utility::string_t V0_0_39_partition_info::getCluster() const
{
    return m_Cluster;
}

void V0_0_39_partition_info::setCluster(const utility::string_t& value)
{
    m_Cluster = value;
    m_ClusterIsSet = true;
}

bool V0_0_39_partition_info::clusterIsSet() const
{
    return m_ClusterIsSet;
}

void V0_0_39_partition_info::unsetCluster()
{
    m_ClusterIsSet = false;
}
std::shared_ptr<V0_0_39_partition_info_nodes> V0_0_39_partition_info::getCpus() const
{
    return m_Cpus;
}

void V0_0_39_partition_info::setCpus(const std::shared_ptr<V0_0_39_partition_info_nodes>& value)
{
    m_Cpus = value;
    m_CpusIsSet = true;
}

bool V0_0_39_partition_info::cpusIsSet() const
{
    return m_CpusIsSet;
}

void V0_0_39_partition_info::unsetCpus()
{
    m_CpusIsSet = false;
}
std::shared_ptr<V0_0_39_partition_info_defaults> V0_0_39_partition_info::getDefaults() const
{
    return m_Defaults;
}

void V0_0_39_partition_info::setDefaults(const std::shared_ptr<V0_0_39_partition_info_defaults>& value)
{
    m_Defaults = value;
    m_DefaultsIsSet = true;
}

bool V0_0_39_partition_info::defaultsIsSet() const
{
    return m_DefaultsIsSet;
}

void V0_0_39_partition_info::unsetDefaults()
{
    m_DefaultsIsSet = false;
}
int32_t V0_0_39_partition_info::getGraceTime() const
{
    return m_Grace_time;
}

void V0_0_39_partition_info::setGraceTime(int32_t value)
{
    m_Grace_time = value;
    m_Grace_timeIsSet = true;
}

bool V0_0_39_partition_info::graceTimeIsSet() const
{
    return m_Grace_timeIsSet;
}

void V0_0_39_partition_info::unsetGrace_time()
{
    m_Grace_timeIsSet = false;
}
std::shared_ptr<V0_0_39_partition_info_maximums> V0_0_39_partition_info::getMaximums() const
{
    return m_Maximums;
}

void V0_0_39_partition_info::setMaximums(const std::shared_ptr<V0_0_39_partition_info_maximums>& value)
{
    m_Maximums = value;
    m_MaximumsIsSet = true;
}

bool V0_0_39_partition_info::maximumsIsSet() const
{
    return m_MaximumsIsSet;
}

void V0_0_39_partition_info::unsetMaximums()
{
    m_MaximumsIsSet = false;
}
std::shared_ptr<V0_0_39_partition_info_minimums> V0_0_39_partition_info::getMinimums() const
{
    return m_Minimums;
}

void V0_0_39_partition_info::setMinimums(const std::shared_ptr<V0_0_39_partition_info_minimums>& value)
{
    m_Minimums = value;
    m_MinimumsIsSet = true;
}

bool V0_0_39_partition_info::minimumsIsSet() const
{
    return m_MinimumsIsSet;
}

void V0_0_39_partition_info::unsetMinimums()
{
    m_MinimumsIsSet = false;
}
utility::string_t V0_0_39_partition_info::getName() const
{
    return m_Name;
}

void V0_0_39_partition_info::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_39_partition_info::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_39_partition_info::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t V0_0_39_partition_info::getNodeSets() const
{
    return m_Node_sets;
}

void V0_0_39_partition_info::setNodeSets(const utility::string_t& value)
{
    m_Node_sets = value;
    m_Node_setsIsSet = true;
}

bool V0_0_39_partition_info::nodeSetsIsSet() const
{
    return m_Node_setsIsSet;
}

void V0_0_39_partition_info::unsetNode_sets()
{
    m_Node_setsIsSet = false;
}
std::shared_ptr<V0_0_39_partition_info_priority> V0_0_39_partition_info::getPriority() const
{
    return m_Priority;
}

void V0_0_39_partition_info::setPriority(const std::shared_ptr<V0_0_39_partition_info_priority>& value)
{
    m_Priority = value;
    m_PriorityIsSet = true;
}

bool V0_0_39_partition_info::priorityIsSet() const
{
    return m_PriorityIsSet;
}

void V0_0_39_partition_info::unsetPriority()
{
    m_PriorityIsSet = false;
}
std::shared_ptr<V0_0_39_partition_info_timeouts> V0_0_39_partition_info::getTimeouts() const
{
    return m_Timeouts;
}

void V0_0_39_partition_info::setTimeouts(const std::shared_ptr<V0_0_39_partition_info_timeouts>& value)
{
    m_Timeouts = value;
    m_TimeoutsIsSet = true;
}

bool V0_0_39_partition_info::timeoutsIsSet() const
{
    return m_TimeoutsIsSet;
}

void V0_0_39_partition_info::unsetTimeouts()
{
    m_TimeoutsIsSet = false;
}
std::shared_ptr<V0_0_39_uint32_no_val> V0_0_39_partition_info::getSuspendTime() const
{
    return m_Suspend_time;
}

void V0_0_39_partition_info::setSuspendTime(const std::shared_ptr<V0_0_39_uint32_no_val>& value)
{
    m_Suspend_time = value;
    m_Suspend_timeIsSet = true;
}

bool V0_0_39_partition_info::suspendTimeIsSet() const
{
    return m_Suspend_timeIsSet;
}

void V0_0_39_partition_info::unsetSuspend_time()
{
    m_Suspend_timeIsSet = false;
}
}
