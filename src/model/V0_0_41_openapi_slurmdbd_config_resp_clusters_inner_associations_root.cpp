...
V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root()
{
...
void V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::toJson() const
{
...
bool V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::getAccount() const
{
    return m_Account;
}

void V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::setAccount(const utility::string_t& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::accountIsSet() const
{
    return m_AccountIsSet;
}

void V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::unsetAccount()
{
    m_AccountIsSet = false;
}
utility::string_t V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::getCluster() const
{
    return m_Cluster;
}

void V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::setCluster(const utility::string_t& value)
{
    m_Cluster = value;
    m_ClusterIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::clusterIsSet() const
{
    return m_ClusterIsSet;
}

void V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::unsetCluster()
{
    m_ClusterIsSet = false;
}
utility::string_t V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::getPartition() const
{
    return m_Partition;
}

void V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::setPartition(const utility::string_t& value)
{
    m_Partition = value;
    m_PartitionIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::partitionIsSet() const
{
    return m_PartitionIsSet;
}

void V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::unsetPartition()
{
    m_PartitionIsSet = false;
}
utility::string_t V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::getUser() const
{
    return m_User;
}

void V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::userIsSet() const
{
    return m_UserIsSet;
}

void V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::unsetUser()
{
    m_UserIsSet = false;
}
int32_t V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::getId() const
{
    return m_Id;
}

void V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::idIsSet() const
{
    return m_IdIsSet;
}

void V0_0_41_openapi_slurmdbd_config_resp_clusters_inner_associations_root::unsetId()
{
    m_IdIsSet = false;
}
}
