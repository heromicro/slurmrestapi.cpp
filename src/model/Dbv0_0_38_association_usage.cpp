...
Dbv0_0_38_association_usage::Dbv0_0_38_association_usage()
{
...
void Dbv0_0_38_association_usage::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_association_usage::toJson() const
{
...
bool Dbv0_0_38_association_usage::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_38_association_usage::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_association_usage::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t Dbv0_0_38_association_usage::getAccrueJobCount() const
{
    return m_Accrue_job_count;
}

void Dbv0_0_38_association_usage::setAccrueJobCount(int32_t value)
{
    m_Accrue_job_count = value;
    m_Accrue_job_countIsSet = true;
}

bool Dbv0_0_38_association_usage::accrueJobCountIsSet() const
{
    return m_Accrue_job_countIsSet;
}

void Dbv0_0_38_association_usage::unsetAccrue_job_count()
{
    m_Accrue_job_countIsSet = false;
}
double Dbv0_0_38_association_usage::getGroupUsedWallclock() const
{
    return m_Group_used_wallclock;
}

void Dbv0_0_38_association_usage::setGroupUsedWallclock(double value)
{
    m_Group_used_wallclock = value;
    m_Group_used_wallclockIsSet = true;
}

bool Dbv0_0_38_association_usage::groupUsedWallclockIsSet() const
{
    return m_Group_used_wallclockIsSet;
}

void Dbv0_0_38_association_usage::unsetGroup_used_wallclock()
{
    m_Group_used_wallclockIsSet = false;
}
double Dbv0_0_38_association_usage::getFairshareFactor() const
{
    return m_Fairshare_factor;
}

void Dbv0_0_38_association_usage::setFairshareFactor(double value)
{
    m_Fairshare_factor = value;
    m_Fairshare_factorIsSet = true;
}

bool Dbv0_0_38_association_usage::fairshareFactorIsSet() const
{
    return m_Fairshare_factorIsSet;
}

void Dbv0_0_38_association_usage::unsetFairshare_factor()
{
    m_Fairshare_factorIsSet = false;
}
int32_t Dbv0_0_38_association_usage::getFairshareShares() const
{
    return m_Fairshare_shares;
}

void Dbv0_0_38_association_usage::setFairshareShares(int32_t value)
{
    m_Fairshare_shares = value;
    m_Fairshare_sharesIsSet = true;
}

bool Dbv0_0_38_association_usage::fairshareSharesIsSet() const
{
    return m_Fairshare_sharesIsSet;
}

void Dbv0_0_38_association_usage::unsetFairshare_shares()
{
    m_Fairshare_sharesIsSet = false;
}
int32_t Dbv0_0_38_association_usage::getNormalizedPriority() const
{
    return m_Normalized_priority;
}

void Dbv0_0_38_association_usage::setNormalizedPriority(int32_t value)
{
    m_Normalized_priority = value;
    m_Normalized_priorityIsSet = true;
}

bool Dbv0_0_38_association_usage::normalizedPriorityIsSet() const
{
    return m_Normalized_priorityIsSet;
}

void Dbv0_0_38_association_usage::unsetNormalized_priority()
{
    m_Normalized_priorityIsSet = false;
}
double Dbv0_0_38_association_usage::getNormalizedShares() const
{
    return m_Normalized_shares;
}

void Dbv0_0_38_association_usage::setNormalizedShares(double value)
{
    m_Normalized_shares = value;
    m_Normalized_sharesIsSet = true;
}

bool Dbv0_0_38_association_usage::normalizedSharesIsSet() const
{
    return m_Normalized_sharesIsSet;
}

void Dbv0_0_38_association_usage::unsetNormalized_shares()
{
    m_Normalized_sharesIsSet = false;
}
double Dbv0_0_38_association_usage::getEffectiveNormalizedUsage() const
{
    return m_Effective_normalized_usage;
}

void Dbv0_0_38_association_usage::setEffectiveNormalizedUsage(double value)
{
    m_Effective_normalized_usage = value;
    m_Effective_normalized_usageIsSet = true;
}

bool Dbv0_0_38_association_usage::effectiveNormalizedUsageIsSet() const
{
    return m_Effective_normalized_usageIsSet;
}

void Dbv0_0_38_association_usage::unsetEffective_normalized_usage()
{
    m_Effective_normalized_usageIsSet = false;
}
int32_t Dbv0_0_38_association_usage::getRawUsage() const
{
    return m_Raw_usage;
}

void Dbv0_0_38_association_usage::setRawUsage(int32_t value)
{
    m_Raw_usage = value;
    m_Raw_usageIsSet = true;
}

bool Dbv0_0_38_association_usage::rawUsageIsSet() const
{
    return m_Raw_usageIsSet;
}

void Dbv0_0_38_association_usage::unsetRaw_usage()
{
    m_Raw_usageIsSet = false;
}
int32_t Dbv0_0_38_association_usage::getJobCount() const
{
    return m_Job_count;
}

void Dbv0_0_38_association_usage::setJobCount(int32_t value)
{
    m_Job_count = value;
    m_Job_countIsSet = true;
}

bool Dbv0_0_38_association_usage::jobCountIsSet() const
{
    return m_Job_countIsSet;
}

void Dbv0_0_38_association_usage::unsetJob_count()
{
    m_Job_countIsSet = false;
}
double Dbv0_0_38_association_usage::getFairshareLevel() const
{
    return m_Fairshare_level;
}

void Dbv0_0_38_association_usage::setFairshareLevel(double value)
{
    m_Fairshare_level = value;
    m_Fairshare_levelIsSet = true;
}

bool Dbv0_0_38_association_usage::fairshareLevelIsSet() const
{
    return m_Fairshare_levelIsSet;
}

void Dbv0_0_38_association_usage::unsetFairshare_level()
{
    m_Fairshare_levelIsSet = false;
}
}
