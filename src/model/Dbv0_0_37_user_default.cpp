...
Dbv0_0_37_user_default::Dbv0_0_37_user_default()
{
...
void Dbv0_0_37_user_default::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_user_default::toJson() const
{
...
bool Dbv0_0_37_user_default::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_37_user_default::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_user_default::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Dbv0_0_37_user_default::getAccount() const
{
    return m_Account;
}

void Dbv0_0_37_user_default::setAccount(const utility::string_t& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool Dbv0_0_37_user_default::accountIsSet() const
{
    return m_AccountIsSet;
}

void Dbv0_0_37_user_default::unsetAccount()
{
    m_AccountIsSet = false;
}
utility::string_t Dbv0_0_37_user_default::getWckey() const
{
    return m_Wckey;
}

void Dbv0_0_37_user_default::setWckey(const utility::string_t& value)
{
    m_Wckey = value;
    m_WckeyIsSet = true;
}

bool Dbv0_0_37_user_default::wckeyIsSet() const
{
    return m_WckeyIsSet;
}

void Dbv0_0_37_user_default::unsetWckey()
{
    m_WckeyIsSet = false;
}
}
