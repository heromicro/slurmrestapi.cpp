...
Dbv0_0_38_set_config::Dbv0_0_38_set_config()
{
...
void Dbv0_0_38_set_config::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_set_config::toJson() const
{
...
bool Dbv0_0_38_set_config::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("clusters"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Dbv0_0_38_clusters_properties>> refVal_setClusters;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("accounts"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Dbv0_0_38_update_account>> refVal_setAccounts;
...
void Dbv0_0_38_set_config::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_set_config::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<Dbv0_0_38_clusters_properties>>& Dbv0_0_38_set_config::getClusters()
{
    return m_Clusters;
}

void Dbv0_0_38_set_config::setClusters(const std::vector<std::shared_ptr<Dbv0_0_38_clusters_properties>>& value)
{
    m_Clusters = value;
    m_ClustersIsSet = true;
}

bool Dbv0_0_38_set_config::clustersIsSet() const
{
    return m_ClustersIsSet;
}

void Dbv0_0_38_set_config::unsetClusters()
{
    m_ClustersIsSet = false;
}
std::vector<std::shared_ptr<std::vector>>& Dbv0_0_38_set_config::getTRES()
{
    return m_TRES;
}

void Dbv0_0_38_set_config::setTRES(const std::vector<std::shared_ptr<std::vector>>& value)
{
    m_TRES = value;
    m_TRESIsSet = true;
}

bool Dbv0_0_38_set_config::tRESIsSet() const
{
    return m_TRESIsSet;
}

void Dbv0_0_38_set_config::unsetTRES()
{
    m_TRESIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_update_account>>& Dbv0_0_38_set_config::getAccounts()
{
    return m_Accounts;
}

void Dbv0_0_38_set_config::setAccounts(const std::vector<std::shared_ptr<Dbv0_0_38_update_account>>& value)
{
    m_Accounts = value;
    m_AccountsIsSet = true;
}

bool Dbv0_0_38_set_config::accountsIsSet() const
{
    return m_AccountsIsSet;
}

void Dbv0_0_38_set_config::unsetAccounts()
{
    m_AccountsIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_user>>& Dbv0_0_38_set_config::getUsers()
{
    return m_Users;
}

void Dbv0_0_38_set_config::setUsers(const std::vector<std::shared_ptr<Dbv0_0_38_user>>& value)
{
    m_Users = value;
    m_UsersIsSet = true;
}

bool Dbv0_0_38_set_config::usersIsSet() const
{
    return m_UsersIsSet;
}

void Dbv0_0_38_set_config::unsetUsers()
{
    m_UsersIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_qos>>& Dbv0_0_38_set_config::getQos()
{
    return m_Qos;
}

void Dbv0_0_38_set_config::setQos(const std::vector<std::shared_ptr<Dbv0_0_38_qos>>& value)
{
    m_Qos = value;
    m_QosIsSet = true;
}

bool Dbv0_0_38_set_config::qosIsSet() const
{
    return m_QosIsSet;
}

void Dbv0_0_38_set_config::unsetQos()
{
    m_QosIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_wckey>>& Dbv0_0_38_set_config::getWckeys()
{
    return m_Wckeys;
}

void Dbv0_0_38_set_config::setWckeys(const std::vector<std::shared_ptr<Dbv0_0_38_wckey>>& value)
{
    m_Wckeys = value;
    m_WckeysIsSet = true;
}

bool Dbv0_0_38_set_config::wckeysIsSet() const
{
    return m_WckeysIsSet;
}

void Dbv0_0_38_set_config::unsetWckeys()
{
    m_WckeysIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_association>>& Dbv0_0_38_set_config::getAssociations()
{
    return m_Associations;
}

void Dbv0_0_38_set_config::setAssociations(const std::vector<std::shared_ptr<Dbv0_0_38_association>>& value)
{
    m_Associations = value;
    m_AssociationsIsSet = true;
}

bool Dbv0_0_38_set_config::associationsIsSet() const
{
    return m_AssociationsIsSet;
}

void Dbv0_0_38_set_config::unsetAssociations()
{
    m_AssociationsIsSet = false;
}
}
