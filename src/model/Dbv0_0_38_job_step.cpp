...
#include "slurmrestapi/model/Dbv0_0_38_job_step.h"
...
Dbv0_0_38_job_step::Dbv0_0_38_job_step()
{
    m_TimeIsSet = false;
...
void Dbv0_0_38_job_step::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_job_step::toJson() const
{
...
bool Dbv0_0_38_job_step::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("time"))))
    {
        ...
        {
            std::shared_ptr<Dbv0_0_38_job_step_time> refVal_setTime;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("nodes"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_job_step_nodes> refVal_setNodes;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tasks"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_job_step_tasks> refVal_setTasks;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("CPU"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_job_step_CPU> refVal_setCPU;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("statistics"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_job_step_statistics> refVal_setStatistics;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("step"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_job_step_step> refVal_setStep;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tres"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_job_step_tres> refVal_setTres;
...
void Dbv0_0_38_job_step::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_job_step::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_38_job_step_time> Dbv0_0_38_job_step::getTime() const
{
    return m_Time;
}

void Dbv0_0_38_job_step::setTime(const std::shared_ptr<Dbv0_0_38_job_step_time>& value)
{
    m_Time = value;
    m_TimeIsSet = true;
}

bool Dbv0_0_38_job_step::timeIsSet() const
{
    return m_TimeIsSet;
}

void Dbv0_0_38_job_step::unsetTime()
{
    m_TimeIsSet = false;
}
std::shared_ptr<Dbv0_0_38_job_exit_code> Dbv0_0_38_job_step::getExitCode() const
{
    return m_Exit_code;
}

void Dbv0_0_38_job_step::setExitCode(const std::shared_ptr<Dbv0_0_38_job_exit_code>& value)
{
    m_Exit_code = value;
    m_Exit_codeIsSet = true;
}

bool Dbv0_0_38_job_step::exitCodeIsSet() const
{
    return m_Exit_codeIsSet;
}

void Dbv0_0_38_job_step::unsetExit_code()
{
    m_Exit_codeIsSet = false;
}
std::shared_ptr<Dbv0_0_38_job_step_nodes> Dbv0_0_38_job_step::getNodes() const
{
    return m_Nodes;
}

void Dbv0_0_38_job_step::setNodes(const std::shared_ptr<Dbv0_0_38_job_step_nodes>& value)
{
    m_Nodes = value;
    m_NodesIsSet = true;
}

bool Dbv0_0_38_job_step::nodesIsSet() const
{
    return m_NodesIsSet;
}

void Dbv0_0_38_job_step::unsetNodes()
{
    m_NodesIsSet = false;
}
std::shared_ptr<Dbv0_0_38_job_step_tasks> Dbv0_0_38_job_step::getTasks() const
{
    return m_Tasks;
}

void Dbv0_0_38_job_step::setTasks(const std::shared_ptr<Dbv0_0_38_job_step_tasks>& value)
{
    m_Tasks = value;
    m_TasksIsSet = true;
}

bool Dbv0_0_38_job_step::tasksIsSet() const
{
    return m_TasksIsSet;
}

void Dbv0_0_38_job_step::unsetTasks()
{
    m_TasksIsSet = false;
}
utility::string_t Dbv0_0_38_job_step::getPid() const
{
    return m_Pid;
}

void Dbv0_0_38_job_step::setPid(const utility::string_t& value)
{
    m_Pid = value;
    m_PidIsSet = true;
}

bool Dbv0_0_38_job_step::pidIsSet() const
{
    return m_PidIsSet;
}

void Dbv0_0_38_job_step::unsetPid()
{
    m_PidIsSet = false;
}
std::shared_ptr<Dbv0_0_38_job_step_CPU> Dbv0_0_38_job_step::getCPU() const
{
    return m_CPU;
}

void Dbv0_0_38_job_step::setCPU(const std::shared_ptr<Dbv0_0_38_job_step_CPU>& value)
{
    m_CPU = value;
    m_CPUIsSet = true;
}

bool Dbv0_0_38_job_step::cPUIsSet() const
{
    return m_CPUIsSet;
}

void Dbv0_0_38_job_step::unsetCPU()
{
    m_CPUIsSet = false;
}
utility::string_t Dbv0_0_38_job_step::getKillRequestUser() const
{
    return m_Kill_request_user;
}

void Dbv0_0_38_job_step::setKillRequestUser(const utility::string_t& value)
{
    m_Kill_request_user = value;
    m_Kill_request_userIsSet = true;
}

bool Dbv0_0_38_job_step::killRequestUserIsSet() const
{
    return m_Kill_request_userIsSet;
}

void Dbv0_0_38_job_step::unsetKill_request_user()
{
    m_Kill_request_userIsSet = false;
}
utility::string_t Dbv0_0_38_job_step::getState() const
{
    return m_State;
}

void Dbv0_0_38_job_step::setState(const utility::string_t& value)
{
    m_State = value;
    m_StateIsSet = true;
}

bool Dbv0_0_38_job_step::stateIsSet() const
{
    return m_StateIsSet;
}

void Dbv0_0_38_job_step::unsetState()
{
    m_StateIsSet = false;
}
std::shared_ptr<Dbv0_0_38_job_step_statistics> Dbv0_0_38_job_step::getStatistics() const
{
    return m_Statistics;
}

void Dbv0_0_38_job_step::setStatistics(const std::shared_ptr<Dbv0_0_38_job_step_statistics>& value)
{
    m_Statistics = value;
    m_StatisticsIsSet = true;
}

bool Dbv0_0_38_job_step::statisticsIsSet() const
{
    return m_StatisticsIsSet;
}

void Dbv0_0_38_job_step::unsetStatistics()
{
    m_StatisticsIsSet = false;
}
std::shared_ptr<Dbv0_0_38_job_step_step> Dbv0_0_38_job_step::getStep() const
{
    return m_Step;
}

void Dbv0_0_38_job_step::setStep(const std::shared_ptr<Dbv0_0_38_job_step_step>& value)
{
    m_Step = value;
    m_StepIsSet = true;
}

bool Dbv0_0_38_job_step::stepIsSet() const
{
    return m_StepIsSet;
}

void Dbv0_0_38_job_step::unsetStep()
{
    m_StepIsSet = false;
}
utility::string_t Dbv0_0_38_job_step::getTask() const
{
    return m_Task;
}

void Dbv0_0_38_job_step::setTask(const utility::string_t& value)
{
    m_Task = value;
    m_TaskIsSet = true;
}

bool Dbv0_0_38_job_step::taskIsSet() const
{
    return m_TaskIsSet;
}

void Dbv0_0_38_job_step::unsetTask()
{
    m_TaskIsSet = false;
}
std::shared_ptr<Dbv0_0_38_job_step_tres> Dbv0_0_38_job_step::getTres() const
{
    return m_Tres;
}

void Dbv0_0_38_job_step::setTres(const std::shared_ptr<Dbv0_0_38_job_step_tres>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool Dbv0_0_38_job_step::tresIsSet() const
{
    return m_TresIsSet;
}

void Dbv0_0_38_job_step::unsetTres()
{
    m_TresIsSet = false;
}
}
