...
#include "slurmrestapi/model/Dbv0_0_37_association_max_tres.h"
...
Dbv0_0_37_association_max_tres::Dbv0_0_37_association_max_tres()
{
    m_GroupIsSet = false;
    m_PerIsSet = false;
    m_TotalIsSet = false;
...
void Dbv0_0_37_association_max_tres::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_association_max_tres::toJson() const
{
...
bool Dbv0_0_37_association_max_tres::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("group"))))
    {
        ...
        {
            std::shared_ptr<Dbv0_0_37_association_max_tres_group> refVal_setGroup;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("per"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_association_max_tres_per> refVal_setPer;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("minutes"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_association_max_tres_minutes> refVal_setMinutes;
...
void Dbv0_0_37_association_max_tres::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_association_max_tres::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_37_association_max_tres_group> Dbv0_0_37_association_max_tres::getGroup() const
{
    return m_Group;
}

void Dbv0_0_37_association_max_tres::setGroup(const std::shared_ptr<Dbv0_0_37_association_max_tres_group>& value)
{
    m_Group = value;
    m_GroupIsSet = true;
}

bool Dbv0_0_37_association_max_tres::groupIsSet() const
{
    return m_GroupIsSet;
}

void Dbv0_0_37_association_max_tres::unsetGroup()
{
    m_GroupIsSet = false;
}
std::shared_ptr<Dbv0_0_37_association_max_tres_per> Dbv0_0_37_association_max_tres::getPer() const
{
    return m_Per;
}

void Dbv0_0_37_association_max_tres::setPer(const std::shared_ptr<Dbv0_0_37_association_max_tres_per>& value)
{
    m_Per = value;
    m_PerIsSet = true;
}

bool Dbv0_0_37_association_max_tres::perIsSet() const
{
    return m_PerIsSet;
}

void Dbv0_0_37_association_max_tres::unsetPer()
{
    m_PerIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& Dbv0_0_37_association_max_tres::getTotal()
{
    return m_Total;
}

void Dbv0_0_37_association_max_tres::setTotal(const std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool Dbv0_0_37_association_max_tres::totalIsSet() const
{
    return m_TotalIsSet;
}

void Dbv0_0_37_association_max_tres::unsetTotal()
{
    m_TotalIsSet = false;
}
std::shared_ptr<Dbv0_0_37_association_max_tres_minutes> Dbv0_0_37_association_max_tres::getMinutes() const
{
    return m_Minutes;
}

void Dbv0_0_37_association_max_tres::setMinutes(const std::shared_ptr<Dbv0_0_37_association_max_tres_minutes>& value)
{
    m_Minutes = value;
    m_MinutesIsSet = true;
}

bool Dbv0_0_37_association_max_tres::minutesIsSet() const
{
    return m_MinutesIsSet;
}

void Dbv0_0_37_association_max_tres::unsetMinutes()
{
    m_MinutesIsSet = false;
}
}
