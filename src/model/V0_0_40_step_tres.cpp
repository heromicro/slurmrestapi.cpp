...
V0_0_40_step_tres::V0_0_40_step_tres()
{
...
void V0_0_40_step_tres::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_step_tres::toJson() const
{
...
bool V0_0_40_step_tres::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("requested"))))
    {
        ...
        {
            std::shared_ptr<V0_0_40_step_tres_requested> refVal_setRequested;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("consumed"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_step_tres_consumed> refVal_setConsumed;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("allocated"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_40_tres>> refVal_setAllocated;
...
void V0_0_40_step_tres::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_step_tres::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_40_step_tres_requested> V0_0_40_step_tres::getRequested() const
{
    return m_Requested;
}

void V0_0_40_step_tres::setRequested(const std::shared_ptr<V0_0_40_step_tres_requested>& value)
{
    m_Requested = value;
    m_RequestedIsSet = true;
}

bool V0_0_40_step_tres::requestedIsSet() const
{
    return m_RequestedIsSet;
}

void V0_0_40_step_tres::unsetRequested()
{
    m_RequestedIsSet = false;
}
std::shared_ptr<V0_0_40_step_tres_consumed> V0_0_40_step_tres::getConsumed() const
{
    return m_Consumed;
}

void V0_0_40_step_tres::setConsumed(const std::shared_ptr<V0_0_40_step_tres_consumed>& value)
{
    m_Consumed = value;
    m_ConsumedIsSet = true;
}

bool V0_0_40_step_tres::consumedIsSet() const
{
    return m_ConsumedIsSet;
}

void V0_0_40_step_tres::unsetConsumed()
{
    m_ConsumedIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_step_tres::getAllocated()
{
    return m_Allocated;
}

void V0_0_40_step_tres::setAllocated(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Allocated = value;
    m_AllocatedIsSet = true;
}

bool V0_0_40_step_tres::allocatedIsSet() const
{
    return m_AllocatedIsSet;
}

void V0_0_40_step_tres::unsetAllocated()
{
    m_AllocatedIsSet = false;
}
}
