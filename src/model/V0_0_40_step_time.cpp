...
#include "slurmrestapi/model/V0_0_40_step_time.h"
...
V0_0_40_step_time::V0_0_40_step_time()
{
    m_Elapsed = 0;
...
void V0_0_40_step_time::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_step_time::toJson() const
{
...
bool V0_0_40_step_time::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("end"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint64_no_val> refVal_setEnd;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("start"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint64_no_val> refVal_setStart;
...
void V0_0_40_step_time::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_step_time::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_40_step_time::getElapsed() const
{
    return m_Elapsed;
}

void V0_0_40_step_time::setElapsed(int32_t value)
{
    m_Elapsed = value;
    m_ElapsedIsSet = true;
}

bool V0_0_40_step_time::elapsedIsSet() const
{
    return m_ElapsedIsSet;
}

void V0_0_40_step_time::unsetElapsed()
{
    m_ElapsedIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_step_time::getEnd() const
{
    return m_End;
}

void V0_0_40_step_time::setEnd(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_End = value;
    m_EndIsSet = true;
}

bool V0_0_40_step_time::endIsSet() const
{
    return m_EndIsSet;
}

void V0_0_40_step_time::unsetEnd()
{
    m_EndIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_step_time::getStart() const
{
    return m_Start;
}

void V0_0_40_step_time::setStart(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Start = value;
    m_StartIsSet = true;
}

bool V0_0_40_step_time::startIsSet() const
{
    return m_StartIsSet;
}

void V0_0_40_step_time::unsetStart()
{
    m_StartIsSet = false;
}
int32_t V0_0_40_step_time::getSuspended() const
{
    return m_Suspended;
}

void V0_0_40_step_time::setSuspended(int32_t value)
{
    m_Suspended = value;
    m_SuspendedIsSet = true;
}

bool V0_0_40_step_time::suspendedIsSet() const
{
    return m_SuspendedIsSet;
}

void V0_0_40_step_time::unsetSuspended()
{
    m_SuspendedIsSet = false;
}
std::shared_ptr<V0_0_40_step_time_system> V0_0_40_step_time::getSystem() const
{
    return m_System;
}

void V0_0_40_step_time::setSystem(const std::shared_ptr<V0_0_40_step_time_system>& value)
{
    m_System = value;
    m_SystemIsSet = true;
}

bool V0_0_40_step_time::systemIsSet() const
{
    return m_SystemIsSet;
}

void V0_0_40_step_time::unsetSystem()
{
    m_SystemIsSet = false;
}
std::shared_ptr<V0_0_40_step_time_total> V0_0_40_step_time::getTotal() const
{
    return m_Total;
}

void V0_0_40_step_time::setTotal(const std::shared_ptr<V0_0_40_step_time_total>& value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool V0_0_40_step_time::totalIsSet() const
{
    return m_TotalIsSet;
}

void V0_0_40_step_time::unsetTotal()
{
    m_TotalIsSet = false;
}
std::shared_ptr<V0_0_40_step_time_user> V0_0_40_step_time::getUser() const
{
    return m_User;
}

void V0_0_40_step_time::setUser(const std::shared_ptr<V0_0_40_step_time_user>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool V0_0_40_step_time::userIsSet() const
{
    return m_UserIsSet;
}

void V0_0_40_step_time::unsetUser()
{
    m_UserIsSet = false;
}
}
