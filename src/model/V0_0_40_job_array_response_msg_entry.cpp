...
#include "slurmrestapi/model/V0_0_40_job_array_response_msg_entry.h"
...
V0_0_40_job_array_response_msg_entry::V0_0_40_job_array_response_msg_entry()
{
    m_Job_id = 0;
    m_Job_idIsSet = false;
...
void V0_0_40_job_array_response_msg_entry::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_job_array_response_msg_entry::toJson() const
{
...
bool V0_0_40_job_array_response_msg_entry::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_job_array_response_msg_entry::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_job_array_response_msg_entry::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_40_job_array_response_msg_entry::getJobId() const
{
    return m_Job_id;
}

void V0_0_40_job_array_response_msg_entry::setJobId(int32_t value)
{
    m_Job_id = value;
    m_Job_idIsSet = true;
}

bool V0_0_40_job_array_response_msg_entry::jobIdIsSet() const
{
    return m_Job_idIsSet;
}

void V0_0_40_job_array_response_msg_entry::unsetJob_id()
{
    m_Job_idIsSet = false;
}
utility::string_t V0_0_40_job_array_response_msg_entry::getStepId() const
{
    return m_Step_id;
}

void V0_0_40_job_array_response_msg_entry::setStepId(const utility::string_t& value)
{
    m_Step_id = value;
    m_Step_idIsSet = true;
}

bool V0_0_40_job_array_response_msg_entry::stepIdIsSet() const
{
    return m_Step_idIsSet;
}

void V0_0_40_job_array_response_msg_entry::unsetStep_id()
{
    m_Step_idIsSet = false;
}
utility::string_t V0_0_40_job_array_response_msg_entry::getError() const
{
    return m_Error;
}

void V0_0_40_job_array_response_msg_entry::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool V0_0_40_job_array_response_msg_entry::errorIsSet() const
{
    return m_ErrorIsSet;
}

void V0_0_40_job_array_response_msg_entry::unsetError()
{
    m_ErrorIsSet = false;
}
int32_t V0_0_40_job_array_response_msg_entry::getErrorCode() const
{
    return m_Error_code;
}

void V0_0_40_job_array_response_msg_entry::setErrorCode(int32_t value)
{
    m_Error_code = value;
    m_Error_codeIsSet = true;
}

bool V0_0_40_job_array_response_msg_entry::errorCodeIsSet() const
{
    return m_Error_codeIsSet;
}

void V0_0_40_job_array_response_msg_entry::unsetError_code()
{
    m_Error_codeIsSet = false;
}
utility::string_t V0_0_40_job_array_response_msg_entry::getWhy() const
{
    return m_Why;
}

void V0_0_40_job_array_response_msg_entry::setWhy(const utility::string_t& value)
{
    m_Why = value;
    m_WhyIsSet = true;
}

bool V0_0_40_job_array_response_msg_entry::whyIsSet() const
{
    return m_WhyIsSet;
}

void V0_0_40_job_array_response_msg_entry::unsetWhy()
{
    m_WhyIsSet = false;
}
}
