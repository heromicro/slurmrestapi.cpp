...
V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::toJson() const
{
...
bool V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int32_t V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_timeouts_resume::unsetnumber()
{
    m_numberIsSet = false;
}
}
