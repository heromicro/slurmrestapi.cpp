...
#include "slurmrestapi/model/V0_0_40_step_tres_requested.h"
...
V0_0_40_step_tres_requested::V0_0_40_step_tres_requested()
{
    m_MaxIsSet = false;
    m_MinIsSet = false;
...
void V0_0_40_step_tres_requested::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_step_tres_requested::toJson() const
{
...
bool V0_0_40_step_tres_requested::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("max"))))
    {
        ...
        {
            std::vector<std::shared_ptr<V0_0_40_tres>> refVal_setMax;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("min"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_40_tres>> refVal_setMin;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("average"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_40_tres>> refVal_setAverage;
...
void V0_0_40_step_tres_requested::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_step_tres_requested::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_step_tres_requested::getMax()
{
    return m_Max;
}

void V0_0_40_step_tres_requested::setMax(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Max = value;
    m_MaxIsSet = true;
}

bool V0_0_40_step_tres_requested::maxIsSet() const
{
    return m_MaxIsSet;
}

void V0_0_40_step_tres_requested::unsetMax()
{
    m_MaxIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_step_tres_requested::getMin()
{
    return m_Min;
}

void V0_0_40_step_tres_requested::setMin(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Min = value;
    m_MinIsSet = true;
}

bool V0_0_40_step_tres_requested::minIsSet() const
{
    return m_MinIsSet;
}

void V0_0_40_step_tres_requested::unsetMin()
{
    m_MinIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_step_tres_requested::getAverage()
{
    return m_Average;
}

void V0_0_40_step_tres_requested::setAverage(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Average = value;
    m_AverageIsSet = true;
}

bool V0_0_40_step_tres_requested::averageIsSet() const
{
    return m_AverageIsSet;
}

void V0_0_40_step_tres_requested::unsetAverage()
{
    m_AverageIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_step_tres_requested::getTotal()
{
    return m_Total;
}

void V0_0_40_step_tres_requested::setTotal(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool V0_0_40_step_tres_requested::totalIsSet() const
{
    return m_TotalIsSet;
}

void V0_0_40_step_tres_requested::unsetTotal()
{
    m_TotalIsSet = false;
}
}
