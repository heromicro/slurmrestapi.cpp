...
V0_0_38_job_submission_response::V0_0_38_job_submission_response()
{
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
    m_Job_id = 0;
...
void V0_0_38_job_submission_response::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_38_job_submission_response::toJson() const
{
...
bool V0_0_38_job_submission_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_38_job_submission_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_38_job_submission_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_38_meta> V0_0_38_job_submission_response::getMeta() const
{
    return m_Meta;
}

void V0_0_38_job_submission_response::setMeta(const std::shared_ptr<V0_0_38_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_38_job_submission_response::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_38_job_submission_response::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_38_error>>& V0_0_38_job_submission_response::getErrors()
{
    return m_Errors;
}

void V0_0_38_job_submission_response::setErrors(const std::vector<std::shared_ptr<V0_0_38_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_38_job_submission_response::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_38_job_submission_response::unsetErrors()
{
    m_ErrorsIsSet = false;
}
int32_t V0_0_38_job_submission_response::getJobId() const
{
    return m_Job_id;
}

void V0_0_38_job_submission_response::setJobId(int32_t value)
{
    m_Job_id = value;
    m_Job_idIsSet = true;
}

bool V0_0_38_job_submission_response::jobIdIsSet() const
{
    return m_Job_idIsSet;
}

void V0_0_38_job_submission_response::unsetJob_id()
{
    m_Job_idIsSet = false;
}
utility::string_t V0_0_38_job_submission_response::getStepId() const
{
    return m_Step_id;
}

void V0_0_38_job_submission_response::setStepId(const utility::string_t& value)
{
    m_Step_id = value;
    m_Step_idIsSet = true;
}

bool V0_0_38_job_submission_response::stepIdIsSet() const
{
    return m_Step_idIsSet;
}

void V0_0_38_job_submission_response::unsetStep_id()
{
    m_Step_idIsSet = false;
}
utility::string_t V0_0_38_job_submission_response::getJobSubmitUserMsg() const
{
    return m_Job_submit_user_msg;
}

void V0_0_38_job_submission_response::setJobSubmitUserMsg(const utility::string_t& value)
{
    m_Job_submit_user_msg = value;
    m_Job_submit_user_msgIsSet = true;
}

bool V0_0_38_job_submission_response::jobSubmitUserMsgIsSet() const
{
    return m_Job_submit_user_msgIsSet;
}

void V0_0_38_job_submission_response::unsetJob_submit_user_msg()
{
    m_Job_submit_user_msgIsSet = false;
}
}
