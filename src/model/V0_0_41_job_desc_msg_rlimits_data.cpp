...
V0_0_41_job_desc_msg_rlimits_data::V0_0_41_job_desc_msg_rlimits_data()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_job_desc_msg_rlimits_data::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_job_desc_msg_rlimits_data::toJson() const
{
...
bool V0_0_41_job_desc_msg_rlimits_data::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_job_desc_msg_rlimits_data::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_job_desc_msg_rlimits_data::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_job_desc_msg_rlimits_data::isSet() const
{
    return m_set;
}

void V0_0_41_job_desc_msg_rlimits_data::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_job_desc_msg_rlimits_data::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_job_desc_msg_rlimits_data::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_job_desc_msg_rlimits_data::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_job_desc_msg_rlimits_data::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_job_desc_msg_rlimits_data::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_job_desc_msg_rlimits_data::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int64_t V0_0_41_job_desc_msg_rlimits_data::getNumber() const
{
    return m_number;
}

void V0_0_41_job_desc_msg_rlimits_data::setNumber(int64_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_job_desc_msg_rlimits_data::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_job_desc_msg_rlimits_data::unsetnumber()
{
    m_numberIsSet = false;
}
}
