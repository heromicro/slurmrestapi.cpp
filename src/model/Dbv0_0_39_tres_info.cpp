...
Dbv0_0_39_tres_info::Dbv0_0_39_tres_info()
{
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
...
void Dbv0_0_39_tres_info::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_39_tres_info::toJson() const
{
...
bool Dbv0_0_39_tres_info::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_39_tres_info::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_39_tres_info::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_39_meta> Dbv0_0_39_tres_info::getMeta() const
{
    return m_Meta;
}

void Dbv0_0_39_tres_info::setMeta(const std::shared_ptr<Dbv0_0_39_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool Dbv0_0_39_tres_info::metaIsSet() const
{
    return m_MetaIsSet;
}

void Dbv0_0_39_tres_info::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_39_error>>& Dbv0_0_39_tres_info::getErrors()
{
    return m_Errors;
}

void Dbv0_0_39_tres_info::setErrors(const std::vector<std::shared_ptr<Dbv0_0_39_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool Dbv0_0_39_tres_info::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void Dbv0_0_39_tres_info::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_39_warning>>& Dbv0_0_39_tres_info::getWarnings()
{
    return m_Warnings;
}

void Dbv0_0_39_tres_info::setWarnings(const std::vector<std::shared_ptr<Dbv0_0_39_warning>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool Dbv0_0_39_tres_info::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void Dbv0_0_39_tres_info::unsetWarnings()
{
    m_WarningsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_39_tres>>& Dbv0_0_39_tres_info::getTres()
{
    return m_Tres;
}

void Dbv0_0_39_tres_info::setTres(const std::vector<std::shared_ptr<V0_0_39_tres>>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool Dbv0_0_39_tres_info::tresIsSet() const
{
    return m_TresIsSet;
}

void Dbv0_0_39_tres_info::unsetTres()
{
    m_TresIsSet = false;
}
}
