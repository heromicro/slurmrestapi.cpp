...
V0_0_39_qos_limits_max_tres::V0_0_39_qos_limits_max_tres()
{
    m_TotalIsSet = false;
...
void V0_0_39_qos_limits_max_tres::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_qos_limits_max_tres::toJson() const
{
...
bool V0_0_39_qos_limits_max_tres::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("minutes"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_qos_limits_max_tres_minutes> refVal_setMinutes;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("per"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_qos_limits_max_tres_per> refVal_setPer;
...
void V0_0_39_qos_limits_max_tres::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_qos_limits_max_tres::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_39_tres>>& V0_0_39_qos_limits_max_tres::getTotal()
{
    return m_Total;
}

void V0_0_39_qos_limits_max_tres::setTotal(const std::vector<std::shared_ptr<V0_0_39_tres>>& value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool V0_0_39_qos_limits_max_tres::totalIsSet() const
{
    return m_TotalIsSet;
}

void V0_0_39_qos_limits_max_tres::unsetTotal()
{
    m_TotalIsSet = false;
}
std::shared_ptr<V0_0_39_qos_limits_max_tres_minutes> V0_0_39_qos_limits_max_tres::getMinutes() const
{
    return m_Minutes;
}

void V0_0_39_qos_limits_max_tres::setMinutes(const std::shared_ptr<V0_0_39_qos_limits_max_tres_minutes>& value)
{
    m_Minutes = value;
    m_MinutesIsSet = true;
}

bool V0_0_39_qos_limits_max_tres::minutesIsSet() const
{
    return m_MinutesIsSet;
}

void V0_0_39_qos_limits_max_tres::unsetMinutes()
{
    m_MinutesIsSet = false;
}
std::shared_ptr<V0_0_39_qos_limits_max_tres_per> V0_0_39_qos_limits_max_tres::getPer() const
{
    return m_Per;
}

void V0_0_39_qos_limits_max_tres::setPer(const std::shared_ptr<V0_0_39_qos_limits_max_tres_per>& value)
{
    m_Per = value;
    m_PerIsSet = true;
}

bool V0_0_39_qos_limits_max_tres::perIsSet() const
{
    return m_PerIsSet;
}

void V0_0_39_qos_limits_max_tres::unsetPer()
{
    m_PerIsSet = false;
}
}
