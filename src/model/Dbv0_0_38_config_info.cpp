...
Dbv0_0_38_config_info::Dbv0_0_38_config_info()
{
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
    m_TresIsSet = false;
...
void Dbv0_0_38_config_info::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_config_info::toJson() const
{
...
bool Dbv0_0_38_config_info::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("qos"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Dbv0_0_38_qos>> refVal_setQos;
...
void Dbv0_0_38_config_info::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_config_info::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_38_meta> Dbv0_0_38_config_info::getMeta() const
{
    return m_Meta;
}

void Dbv0_0_38_config_info::setMeta(const std::shared_ptr<Dbv0_0_38_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool Dbv0_0_38_config_info::metaIsSet() const
{
    return m_MetaIsSet;
}

void Dbv0_0_38_config_info::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_error>>& Dbv0_0_38_config_info::getErrors()
{
    return m_Errors;
}

void Dbv0_0_38_config_info::setErrors(const std::vector<std::shared_ptr<Dbv0_0_38_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool Dbv0_0_38_config_info::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void Dbv0_0_38_config_info::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<std::vector>>& Dbv0_0_38_config_info::getTres()
{
    return m_Tres;
}

void Dbv0_0_38_config_info::setTres(const std::vector<std::shared_ptr<std::vector>>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool Dbv0_0_38_config_info::tresIsSet() const
{
    return m_TresIsSet;
}

void Dbv0_0_38_config_info::unsetTres()
{
    m_TresIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_account>>& Dbv0_0_38_config_info::getAccounts()
{
    return m_Accounts;
}

void Dbv0_0_38_config_info::setAccounts(const std::vector<std::shared_ptr<Dbv0_0_38_account>>& value)
{
    m_Accounts = value;
    m_AccountsIsSet = true;
}

bool Dbv0_0_38_config_info::accountsIsSet() const
{
    return m_AccountsIsSet;
}

void Dbv0_0_38_config_info::unsetAccounts()
{
    m_AccountsIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_association>>& Dbv0_0_38_config_info::getAssociations()
{
    return m_Associations;
}

void Dbv0_0_38_config_info::setAssociations(const std::vector<std::shared_ptr<Dbv0_0_38_association>>& value)
{
    m_Associations = value;
    m_AssociationsIsSet = true;
}

bool Dbv0_0_38_config_info::associationsIsSet() const
{
    return m_AssociationsIsSet;
}

void Dbv0_0_38_config_info::unsetAssociations()
{
    m_AssociationsIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_user>>& Dbv0_0_38_config_info::getUsers()
{
    return m_Users;
}

void Dbv0_0_38_config_info::setUsers(const std::vector<std::shared_ptr<Dbv0_0_38_user>>& value)
{
    m_Users = value;
    m_UsersIsSet = true;
}

bool Dbv0_0_38_config_info::usersIsSet() const
{
    return m_UsersIsSet;
}

void Dbv0_0_38_config_info::unsetUsers()
{
    m_UsersIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_qos>>& Dbv0_0_38_config_info::getQos()
{
    return m_Qos;
}

void Dbv0_0_38_config_info::setQos(const std::vector<std::shared_ptr<Dbv0_0_38_qos>>& value)
{
    m_Qos = value;
    m_QosIsSet = true;
}

bool Dbv0_0_38_config_info::qosIsSet() const
{
    return m_QosIsSet;
}

void Dbv0_0_38_config_info::unsetQos()
{
    m_QosIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_wckey>>& Dbv0_0_38_config_info::getWckeys()
{
    return m_Wckeys;
}

void Dbv0_0_38_config_info::setWckeys(const std::vector<std::shared_ptr<Dbv0_0_38_wckey>>& value)
{
    m_Wckeys = value;
    m_WckeysIsSet = true;
}

bool Dbv0_0_38_config_info::wckeysIsSet() const
{
    return m_WckeysIsSet;
}

void Dbv0_0_38_config_info::unsetWckeys()
{
    m_WckeysIsSet = false;
}
}
