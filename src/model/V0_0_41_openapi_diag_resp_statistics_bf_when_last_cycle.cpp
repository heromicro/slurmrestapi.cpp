...
V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::toJson() const
{
...
bool V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int64_t V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::setNumber(int64_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_bf_when_last_cycle::unsetnumber()
{
    m_numberIsSet = false;
}
}
