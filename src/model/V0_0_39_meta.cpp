...
std::shared_ptr<V0_0_39_meta_plugin> V0_0_39_meta::getPlugin() const
{
    return m_Plugin;
}

void V0_0_39_meta::setPlugin(const std::shared_ptr<V0_0_39_meta_plugin>& value)
{
    m_Plugin = value;
    m_PluginIsSet = true;
}
...
std::shared_ptr<V0_0_39_meta_Slurm> V0_0_39_meta::getSlurm() const
{
    return m_Slurm;
}

void V0_0_39_meta::setSlurm(const std::shared_ptr<V0_0_39_meta_Slurm>& value)
{
    m_Slurm = value;
    m_SlurmIsSet = true;
}
