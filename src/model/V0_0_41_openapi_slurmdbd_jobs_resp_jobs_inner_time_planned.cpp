...
#include "slurmrestapi/model/V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned.h"
...
V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::toJson() const
{
...
bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int64_t V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::setNumber(int64_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_time_planned::unsetnumber()
{
    m_numberIsSet = false;
}
}
