...
V0_0_41_openapi_users_resp::V0_0_41_openapi_users_resp()
{
    m_UsersIsSet = false;
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
...
void V0_0_41_openapi_users_resp::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_users_resp::toJson() const
{
...
bool V0_0_41_openapi_users_resp::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_users_resp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_users_resp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_41_openapi_slurmdbd_config_resp_users_inner>>& V0_0_41_openapi_users_resp::getUsers()
{
    return m_Users;
}

void V0_0_41_openapi_users_resp::setUsers(const std::vector<std::shared_ptr<V0_0_41_openapi_slurmdbd_config_resp_users_inner>>& value)
{
    m_Users = value;
    m_UsersIsSet = true;
}

bool V0_0_41_openapi_users_resp::usersIsSet() const
{
    return m_UsersIsSet;
}

void V0_0_41_openapi_users_resp::unsetUsers()
{
    m_UsersIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_shares_resp_meta> V0_0_41_openapi_users_resp::getMeta() const
{
    return m_Meta;
}

void V0_0_41_openapi_users_resp::setMeta(const std::shared_ptr<V0_0_41_openapi_shares_resp_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_41_openapi_users_resp::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_41_openapi_users_resp::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_errors_inner>>& V0_0_41_openapi_users_resp::getErrors()
{
    return m_Errors;
}

void V0_0_41_openapi_users_resp::setErrors(const std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_errors_inner>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_41_openapi_users_resp::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_41_openapi_users_resp::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_warnings_inner>>& V0_0_41_openapi_users_resp::getWarnings()
{
    return m_Warnings;
}

void V0_0_41_openapi_users_resp::setWarnings(const std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_warnings_inner>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool V0_0_41_openapi_users_resp::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void V0_0_41_openapi_users_resp::unsetWarnings()
{
    m_WarningsIsSet = false;
}
}
