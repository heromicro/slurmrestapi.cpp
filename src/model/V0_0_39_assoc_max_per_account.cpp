...
V0_0_39_assoc_max_per_account::V0_0_39_assoc_max_per_account()
{
...
void V0_0_39_assoc_max_per_account::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_assoc_max_per_account::toJson() const
{
...
bool V0_0_39_assoc_max_per_account::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_39_assoc_max_per_account::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_assoc_max_per_account::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_39_uint32_no_val> V0_0_39_assoc_max_per_account::getWallClock() const
{
    return m_Wall_clock;
}

void V0_0_39_assoc_max_per_account::setWallClock(const std::shared_ptr<V0_0_39_uint32_no_val>& value)
{
    m_Wall_clock = value;
    m_Wall_clockIsSet = true;
}

bool V0_0_39_assoc_max_per_account::wallClockIsSet() const
{
    return m_Wall_clockIsSet;
}

void V0_0_39_assoc_max_per_account::unsetWall_clock()
{
    m_Wall_clockIsSet = false;
}
}
