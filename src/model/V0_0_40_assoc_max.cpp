...
V0_0_40_assoc_max::V0_0_40_assoc_max()
{
    m_JobsIsSet = false;
    m_TresIsSet = false;
    m_PerIsSet = false;
...
void V0_0_40_assoc_max::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_assoc_max::toJson() const
{
...
bool V0_0_40_assoc_max::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("jobs"))))
    {
        ...
        {
            std::shared_ptr<V0_0_40_assoc_max_jobs> refVal_setJobs;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tres"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_assoc_max_tres> refVal_setTres;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("per"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_assoc_max_per> refVal_setPer;
...
void V0_0_40_assoc_max::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_assoc_max::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_40_assoc_max_jobs> V0_0_40_assoc_max::getJobs() const
{
    return m_Jobs;
}

void V0_0_40_assoc_max::setJobs(const std::shared_ptr<V0_0_40_assoc_max_jobs>& value)
{
    m_Jobs = value;
    m_JobsIsSet = true;
}

bool V0_0_40_assoc_max::jobsIsSet() const
{
    return m_JobsIsSet;
}

void V0_0_40_assoc_max::unsetJobs()
{
    m_JobsIsSet = false;
}
std::shared_ptr<V0_0_40_assoc_max_tres> V0_0_40_assoc_max::getTres() const
{
    return m_Tres;
}

void V0_0_40_assoc_max::setTres(const std::shared_ptr<V0_0_40_assoc_max_tres>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool V0_0_40_assoc_max::tresIsSet() const
{
    return m_TresIsSet;
}

void V0_0_40_assoc_max::unsetTres()
{
    m_TresIsSet = false;
}
std::shared_ptr<V0_0_40_assoc_max_per> V0_0_40_assoc_max::getPer() const
{
    return m_Per;
}

void V0_0_40_assoc_max::setPer(const std::shared_ptr<V0_0_40_assoc_max_per>& value)
{
    m_Per = value;
    m_PerIsSet = true;
}

bool V0_0_40_assoc_max::perIsSet() const
{
    return m_PerIsSet;
}

void V0_0_40_assoc_max::unsetPer()
{
    m_PerIsSet = false;
}
}
