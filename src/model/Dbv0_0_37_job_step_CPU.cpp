...
Dbv0_0_37_job_step_CPU::Dbv0_0_37_job_step_CPU()
{
...
void Dbv0_0_37_job_step_CPU::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_job_step_CPU::toJson() const
{
...
bool Dbv0_0_37_job_step_CPU::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("requested_frequency"))))
    {
        ...
        {
            std::shared_ptr<Dbv0_0_37_job_step_CPU_requested_frequency> refVal_setRequestedFrequency;
...
void Dbv0_0_37_job_step_CPU::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_job_step_CPU::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_37_job_step_CPU_requested_frequency> Dbv0_0_37_job_step_CPU::getRequestedFrequency() const
{
    return m_Requested_frequency;
}

void Dbv0_0_37_job_step_CPU::setRequestedFrequency(const std::shared_ptr<Dbv0_0_37_job_step_CPU_requested_frequency>& value)
{
    m_Requested_frequency = value;
    m_Requested_frequencyIsSet = true;
}

bool Dbv0_0_37_job_step_CPU::requestedFrequencyIsSet() const
{
    return m_Requested_frequencyIsSet;
}

void Dbv0_0_37_job_step_CPU::unsetRequested_frequency()
{
    m_Requested_frequencyIsSet = false;
}
std::vector<utility::string_t>& Dbv0_0_37_job_step_CPU::getGovernor()
{
    return m_Governor;
}

void Dbv0_0_37_job_step_CPU::setGovernor(const std::vector<utility::string_t>& value)
{
    m_Governor = value;
    m_GovernorIsSet = true;
}

bool Dbv0_0_37_job_step_CPU::governorIsSet() const
{
    return m_GovernorIsSet;
}

void Dbv0_0_37_job_step_CPU::unsetGovernor()
{
    m_GovernorIsSet = false;
}
}
