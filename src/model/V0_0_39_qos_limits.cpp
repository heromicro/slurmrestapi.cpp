...
bool V0_0_39_qos_limits::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("grace_time"))))
    {
        ...
        {
            std::shared_ptr<V0_0_39_uint32_no_val> refVal_setGraceTime;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("max"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_qos_limits_max> refVal_setMax;
...
std::shared_ptr<V0_0_39_uint32_no_val> V0_0_39_qos_limits::getGraceTime() const
{
    return m_Grace_time;
}

void V0_0_39_qos_limits::setGraceTime(const std::shared_ptr<V0_0_39_uint32_no_val>& value)
{
    m_Grace_time = value;
    m_Grace_timeIsSet = true;
}

bool V0_0_39_qos_limits::graceTimeIsSet() const
{
    return m_Grace_timeIsSet;
}

void V0_0_39_qos_limits::unsetGrace_time()
{
    m_Grace_timeIsSet = false;
}
std::shared_ptr<V0_0_39_qos_limits_max> V0_0_39_qos_limits::getMax() const
{
    return m_Max;
}

void V0_0_39_qos_limits::setMax(const std::shared_ptr<V0_0_39_qos_limits_max>& value)
{
    m_Max = value;
    m_MaxIsSet = true;
}

bool V0_0_39_qos_limits::maxIsSet() const
{
    return m_MaxIsSet;
}

void V0_0_39_qos_limits::unsetMax()
{
    m_MaxIsSet = false;
}
double V0_0_39_qos_limits::getFactor() const
{
    return m_Factor;
}

void V0_0_39_qos_limits::setFactor(double value)
{
    m_Factor = value;
    m_FactorIsSet = true;
}

bool V0_0_39_qos_limits::factorIsSet() const
{
    return m_FactorIsSet;
}

void V0_0_39_qos_limits::unsetFactor()
{
    m_FactorIsSet = false;
}
