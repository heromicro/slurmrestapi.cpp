...
V0_0_39_step_statistics::V0_0_39_step_statistics()
{
    m_CPUIsSet = false;
    m_EnergyIsSet = false;
}
...
void V0_0_39_step_statistics::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_step_statistics::toJson() const
{
...
bool V0_0_39_step_statistics::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("CPU"))))
    {
        ...
        {
            std::shared_ptr<V0_0_39_step_statistics_CPU> refVal_setCPU;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("energy"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_step_statistics_energy> refVal_setEnergy;
...
void V0_0_39_step_statistics::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_step_statistics::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_39_step_statistics_CPU> V0_0_39_step_statistics::getCPU() const
{
    return m_CPU;
}

void V0_0_39_step_statistics::setCPU(const std::shared_ptr<V0_0_39_step_statistics_CPU>& value)
{
    m_CPU = value;
    m_CPUIsSet = true;
}

bool V0_0_39_step_statistics::cPUIsSet() const
{
    return m_CPUIsSet;
}

void V0_0_39_step_statistics::unsetCPU()
{
    m_CPUIsSet = false;
}
std::shared_ptr<V0_0_39_step_statistics_energy> V0_0_39_step_statistics::getEnergy() const
{
    return m_Energy;
}

void V0_0_39_step_statistics::setEnergy(const std::shared_ptr<V0_0_39_step_statistics_energy>& value)
{
    m_Energy = value;
    m_EnergyIsSet = true;
}

bool V0_0_39_step_statistics::energyIsSet() const
{
    return m_EnergyIsSet;
}

void V0_0_39_step_statistics::unsetEnergy()
{
    m_EnergyIsSet = false;
}
}
