...
V0_0_40_update_node_msg::V0_0_40_update_node_msg()
{
...
void V0_0_40_update_node_msg::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_update_node_msg::toJson() const
{
...
bool V0_0_40_update_node_msg::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("resume_after"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint32_no_val> refVal_setResumeAfter;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("weight"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint32_no_val> refVal_setWeight;
...
void V0_0_40_update_node_msg::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_update_node_msg::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_update_node_msg::getComment() const
{
    return m_Comment;
}

void V0_0_40_update_node_msg::setComment(const utility::string_t& value)
{
    m_Comment = value;
    m_CommentIsSet = true;
}

bool V0_0_40_update_node_msg::commentIsSet() const
{
    return m_CommentIsSet;
}

void V0_0_40_update_node_msg::unsetComment()
{
    m_CommentIsSet = false;
}
int32_t V0_0_40_update_node_msg::getCpuBind() const
{
    return m_Cpu_bind;
}

void V0_0_40_update_node_msg::setCpuBind(int32_t value)
{
    m_Cpu_bind = value;
    m_Cpu_bindIsSet = true;
}

bool V0_0_40_update_node_msg::cpuBindIsSet() const
{
    return m_Cpu_bindIsSet;
}

void V0_0_40_update_node_msg::unsetCpu_bind()
{
    m_Cpu_bindIsSet = false;
}
utility::string_t V0_0_40_update_node_msg::getExtra() const
{
    return m_Extra;
}

void V0_0_40_update_node_msg::setExtra(const utility::string_t& value)
{
    m_Extra = value;
    m_ExtraIsSet = true;
}

bool V0_0_40_update_node_msg::extraIsSet() const
{
    return m_ExtraIsSet;
}

void V0_0_40_update_node_msg::unsetExtra()
{
    m_ExtraIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_update_node_msg::getFeatures()
{
    return m_Features;
}

void V0_0_40_update_node_msg::setFeatures(const std::vector<utility::string_t>& value)
{
    m_Features = value;
    m_FeaturesIsSet = true;
}

bool V0_0_40_update_node_msg::featuresIsSet() const
{
    return m_FeaturesIsSet;
}

void V0_0_40_update_node_msg::unsetFeatures()
{
    m_FeaturesIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_update_node_msg::getFeaturesAct()
{
    return m_Features_act;
}

void V0_0_40_update_node_msg::setFeaturesAct(const std::vector<utility::string_t>& value)
{
    m_Features_act = value;
    m_Features_actIsSet = true;
}

bool V0_0_40_update_node_msg::featuresActIsSet() const
{
    return m_Features_actIsSet;
}

void V0_0_40_update_node_msg::unsetFeatures_act()
{
    m_Features_actIsSet = false;
}
utility::string_t V0_0_40_update_node_msg::getGres() const
{
    return m_Gres;
}

void V0_0_40_update_node_msg::setGres(const utility::string_t& value)
{
    m_Gres = value;
    m_GresIsSet = true;
}

bool V0_0_40_update_node_msg::gresIsSet() const
{
    return m_GresIsSet;
}

void V0_0_40_update_node_msg::unsetGres()
{
    m_GresIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_update_node_msg::getAddress()
{
    return m_Address;
}

void V0_0_40_update_node_msg::setAddress(const std::vector<utility::string_t>& value)
{
    m_Address = value;
    m_AddressIsSet = true;
}

bool V0_0_40_update_node_msg::addressIsSet() const
{
    return m_AddressIsSet;
}

void V0_0_40_update_node_msg::unsetAddress()
{
    m_AddressIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_update_node_msg::getHostname()
{
    return m_Hostname;
}

void V0_0_40_update_node_msg::setHostname(const std::vector<utility::string_t>& value)
{
    m_Hostname = value;
    m_HostnameIsSet = true;
}

bool V0_0_40_update_node_msg::hostnameIsSet() const
{
    return m_HostnameIsSet;
}

void V0_0_40_update_node_msg::unsetHostname()
{
    m_HostnameIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_update_node_msg::getName()
{
    return m_Name;
}

void V0_0_40_update_node_msg::setName(const std::vector<utility::string_t>& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_40_update_node_msg::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_40_update_node_msg::unsetName()
{
    m_NameIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_update_node_msg::getState()
{
    return m_State;
}

void V0_0_40_update_node_msg::setState(const std::vector<utility::string_t>& value)
{
    m_State = value;
    m_StateIsSet = true;
}

bool V0_0_40_update_node_msg::stateIsSet() const
{
    return m_StateIsSet;
}

void V0_0_40_update_node_msg::unsetState()
{
    m_StateIsSet = false;
}
utility::string_t V0_0_40_update_node_msg::getReason() const
{
    return m_Reason;
}

void V0_0_40_update_node_msg::setReason(const utility::string_t& value)
{
    m_Reason = value;
    m_ReasonIsSet = true;
}

bool V0_0_40_update_node_msg::reasonIsSet() const
{
    return m_ReasonIsSet;
}

void V0_0_40_update_node_msg::unsetReason()
{
    m_ReasonIsSet = false;
}
utility::string_t V0_0_40_update_node_msg::getReasonUid() const
{
    return m_Reason_uid;
}

void V0_0_40_update_node_msg::setReasonUid(const utility::string_t& value)
{
    m_Reason_uid = value;
    m_Reason_uidIsSet = true;
}

bool V0_0_40_update_node_msg::reasonUidIsSet() const
{
    return m_Reason_uidIsSet;
}

void V0_0_40_update_node_msg::unsetReason_uid()
{
    m_Reason_uidIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_update_node_msg::getResumeAfter() const
{
    return m_Resume_after;
}

void V0_0_40_update_node_msg::setResumeAfter(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Resume_after = value;
    m_Resume_afterIsSet = true;
}

bool V0_0_40_update_node_msg::resumeAfterIsSet() const
{
    return m_Resume_afterIsSet;
}

void V0_0_40_update_node_msg::unsetResume_after()
{
    m_Resume_afterIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_update_node_msg::getWeight() const
{
    return m_Weight;
}

void V0_0_40_update_node_msg::setWeight(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Weight = value;
    m_WeightIsSet = true;
}

bool V0_0_40_update_node_msg::weightIsSet() const
{
    return m_WeightIsSet;
}

void V0_0_40_update_node_msg::unsetWeight()
{
    m_WeightIsSet = false;
}
}
