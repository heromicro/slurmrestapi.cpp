...
V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::toJson() const
{
...
bool V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
double V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::setNumber(double value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_shares_resp_shares_shares_inner_shares_normalized::unsetnumber()
{
    m_numberIsSet = false;
}
}
