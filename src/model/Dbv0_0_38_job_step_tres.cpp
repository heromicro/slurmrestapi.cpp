...
Dbv0_0_38_job_step_tres::Dbv0_0_38_job_step_tres()
{
...
void Dbv0_0_38_job_step_tres::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_job_step_tres::toJson() const
{
...
bool Dbv0_0_38_job_step_tres::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("requested"))))
    {
        ...
        {
            std::shared_ptr<Dbv0_0_38_job_step_tres_requested> refVal_setRequested;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("consumed"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_job_step_tres_requested> refVal_setConsumed;
...
void Dbv0_0_38_job_step_tres::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_job_step_tres::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_38_job_step_tres_requested> Dbv0_0_38_job_step_tres::getRequested() const
{
    return m_Requested;
}

void Dbv0_0_38_job_step_tres::setRequested(const std::shared_ptr<Dbv0_0_38_job_step_tres_requested>& value)
{
    m_Requested = value;
    m_RequestedIsSet = true;
}

bool Dbv0_0_38_job_step_tres::requestedIsSet() const
{
    return m_RequestedIsSet;
}

void Dbv0_0_38_job_step_tres::unsetRequested()
{
    m_RequestedIsSet = false;
}
std::shared_ptr<Dbv0_0_38_job_step_tres_requested> Dbv0_0_38_job_step_tres::getConsumed() const
{
    return m_Consumed;
}

void Dbv0_0_38_job_step_tres::setConsumed(const std::shared_ptr<Dbv0_0_38_job_step_tres_requested>& value)
{
    m_Consumed = value;
    m_ConsumedIsSet = true;
}

bool Dbv0_0_38_job_step_tres::consumedIsSet() const
{
    return m_ConsumedIsSet;
}

void Dbv0_0_38_job_step_tres::unsetConsumed()
{
    m_ConsumedIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_tres_list_inner>>& Dbv0_0_38_job_step_tres::getAllocated()
{
    return m_Allocated;
}

void Dbv0_0_38_job_step_tres::setAllocated(const std::vector<std::shared_ptr<Dbv0_0_38_tres_list_inner>>& value)
{
    m_Allocated = value;
    m_AllocatedIsSet = true;
}

bool Dbv0_0_38_job_step_tres::allocatedIsSet() const
{
    return m_AllocatedIsSet;
}

void Dbv0_0_38_job_step_tres::unsetAllocated()
{
    m_AllocatedIsSet = false;
}
}
