...
std::vector<std::shared_ptr<AnyType>>& V0_0_39_job_desc_msg::getPowerFlags()
{
    return m_Power_flags;
}

void V0_0_39_job_desc_msg::setPowerFlags(const std::vector<std::shared_ptr<AnyType>>& value)
{
    m_Power_flags = value;
...
bool V0_0_39_job_desc_msg::isHold() const
{
    return m_Hold;
}

void V0_0_39_job_desc_msg::setHold(bool value)
{
    m_Hold = value;
    m_HoldIsSet = true;
}

bool V0_0_39_job_desc_msg::holdIsSet() const
{
    return m_HoldIsSet;
}

void V0_0_39_job_desc_msg::unsetHold()
{
    m_HoldIsSet = false;
}
std::shared_ptr<V0_0_39_uint32_no_val> V0_0_39_job_desc_msg::getPriority() const
{
    return m_Priority;
}

void V0_0_39_job_desc_msg::setPriority(const std::shared_ptr<V0_0_39_uint32_no_val>& value)
{
    m_Priority = value;
...
bool V0_0_39_job_desc_msg::isOversubscribe() const
{
    return m_Oversubscribe;
}

void V0_0_39_job_desc_msg::setOversubscribe(bool value)
{
    m_Oversubscribe = value;
    m_OversubscribeIsSet = true;
}

bool V0_0_39_job_desc_msg::oversubscribeIsSet() const
{
    return m_OversubscribeIsSet;
}

void V0_0_39_job_desc_msg::unsetOversubscribe()
{
    m_OversubscribeIsSet = false;
}
