...
V0_0_41_openapi_partition_resp::V0_0_41_openapi_partition_resp()
{
...
void V0_0_41_openapi_partition_resp::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_partition_resp::toJson() const
{
...
bool V0_0_41_openapi_partition_resp::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("partitions"))))
    {
        ...
        {
            std::vector<std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner>> refVal_setPartitions;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("last_update"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_41_openapi_partition_resp_last_update> refVal_setLastUpdate;
...
void V0_0_41_openapi_partition_resp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_partition_resp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner>>& V0_0_41_openapi_partition_resp::getPartitions()
{
    return m_Partitions;
}

void V0_0_41_openapi_partition_resp::setPartitions(const std::vector<std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner>>& value)
{
    m_Partitions = value;
    m_PartitionsIsSet = true;
}

bool V0_0_41_openapi_partition_resp::partitionsIsSet() const
{
    return m_PartitionsIsSet;
}

void V0_0_41_openapi_partition_resp::unsetPartitions()
{
    m_PartitionsIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_partition_resp_last_update> V0_0_41_openapi_partition_resp::getLastUpdate() const
{
    return m_Last_update;
}

void V0_0_41_openapi_partition_resp::setLastUpdate(const std::shared_ptr<V0_0_41_openapi_partition_resp_last_update>& value)
{
    m_Last_update = value;
    m_Last_updateIsSet = true;
}

bool V0_0_41_openapi_partition_resp::lastUpdateIsSet() const
{
    return m_Last_updateIsSet;
}

void V0_0_41_openapi_partition_resp::unsetLast_update()
{
    m_Last_updateIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_shares_resp_meta> V0_0_41_openapi_partition_resp::getMeta() const
{
    return m_Meta;
}

void V0_0_41_openapi_partition_resp::setMeta(const std::shared_ptr<V0_0_41_openapi_shares_resp_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_41_openapi_partition_resp::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_41_openapi_partition_resp::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_errors_inner>>& V0_0_41_openapi_partition_resp::getErrors()
{
    return m_Errors;
}

void V0_0_41_openapi_partition_resp::setErrors(const std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_errors_inner>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_41_openapi_partition_resp::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_41_openapi_partition_resp::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_warnings_inner>>& V0_0_41_openapi_partition_resp::getWarnings()
{
    return m_Warnings;
}

void V0_0_41_openapi_partition_resp::setWarnings(const std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_warnings_inner>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool V0_0_41_openapi_partition_resp::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void V0_0_41_openapi_partition_resp::unsetWarnings()
{
    m_WarningsIsSet = false;
}
}
