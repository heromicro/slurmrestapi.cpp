...
V0_0_41_openapi_nodes_resp_nodes_inner_energy::V0_0_41_openapi_nodes_resp_nodes_inner_energy()
{
    m_Average_watts = 0;
...
void V0_0_41_openapi_nodes_resp_nodes_inner_energy::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_nodes_resp_nodes_inner_energy::toJson() const
{
...
bool V0_0_41_openapi_nodes_resp_nodes_inner_energy::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("current_watts"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_41_openapi_nodes_resp_nodes_inner_energy_current_watts> refVal_setCurrentWatts;
...
void V0_0_41_openapi_nodes_resp_nodes_inner_energy::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_nodes_resp_nodes_inner_energy::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_41_openapi_nodes_resp_nodes_inner_energy::getAverageWatts() const
{
    return m_Average_watts;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_energy::setAverageWatts(int32_t value)
{
    m_Average_watts = value;
    m_Average_wattsIsSet = true;
}

bool V0_0_41_openapi_nodes_resp_nodes_inner_energy::averageWattsIsSet() const
{
    return m_Average_wattsIsSet;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_energy::unsetAverage_watts()
{
    m_Average_wattsIsSet = false;
}
int64_t V0_0_41_openapi_nodes_resp_nodes_inner_energy::getBaseConsumedEnergy() const
{
    return m_Base_consumed_energy;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_energy::setBaseConsumedEnergy(int64_t value)
{
    m_Base_consumed_energy = value;
    m_Base_consumed_energyIsSet = true;
}

bool V0_0_41_openapi_nodes_resp_nodes_inner_energy::baseConsumedEnergyIsSet() const
{
    return m_Base_consumed_energyIsSet;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_energy::unsetBase_consumed_energy()
{
    m_Base_consumed_energyIsSet = false;
}
int64_t V0_0_41_openapi_nodes_resp_nodes_inner_energy::getConsumedEnergy() const
{
    return m_Consumed_energy;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_energy::setConsumedEnergy(int64_t value)
{
    m_Consumed_energy = value;
    m_Consumed_energyIsSet = true;
}

bool V0_0_41_openapi_nodes_resp_nodes_inner_energy::consumedEnergyIsSet() const
{
    return m_Consumed_energyIsSet;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_energy::unsetConsumed_energy()
{
    m_Consumed_energyIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_nodes_resp_nodes_inner_energy_current_watts> V0_0_41_openapi_nodes_resp_nodes_inner_energy::getCurrentWatts() const
{
    return m_Current_watts;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_energy::setCurrentWatts(const std::shared_ptr<V0_0_41_openapi_nodes_resp_nodes_inner_energy_current_watts>& value)
{
    m_Current_watts = value;
    m_Current_wattsIsSet = true;
}

bool V0_0_41_openapi_nodes_resp_nodes_inner_energy::currentWattsIsSet() const
{
    return m_Current_wattsIsSet;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_energy::unsetCurrent_watts()
{
    m_Current_wattsIsSet = false;
}
int64_t V0_0_41_openapi_nodes_resp_nodes_inner_energy::getPreviousConsumedEnergy() const
{
    return m_Previous_consumed_energy;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_energy::setPreviousConsumedEnergy(int64_t value)
{
    m_Previous_consumed_energy = value;
    m_Previous_consumed_energyIsSet = true;
}

bool V0_0_41_openapi_nodes_resp_nodes_inner_energy::previousConsumedEnergyIsSet() const
{
    return m_Previous_consumed_energyIsSet;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_energy::unsetPrevious_consumed_energy()
{
    m_Previous_consumed_energyIsSet = false;
}
int64_t V0_0_41_openapi_nodes_resp_nodes_inner_energy::getLastCollected() const
{
    return m_Last_collected;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_energy::setLastCollected(int64_t value)
{
    m_Last_collected = value;
    m_Last_collectedIsSet = true;
}

bool V0_0_41_openapi_nodes_resp_nodes_inner_energy::lastCollectedIsSet() const
{
    return m_Last_collectedIsSet;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_energy::unsetLast_collected()
{
    m_Last_collectedIsSet = false;
}
}
