...
bool V0_0_39_assoc_max::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tres"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_assoc_max_tres> refVal_setTres;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("per"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_assoc_max_per> refVal_setPer;
...
std::shared_ptr<V0_0_39_assoc_max_tres> V0_0_39_assoc_max::getTres() const
{
    return m_Tres;
}

void V0_0_39_assoc_max::setTres(const std::shared_ptr<V0_0_39_assoc_max_tres>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool V0_0_39_assoc_max::tresIsSet() const
{
    return m_TresIsSet;
}

void V0_0_39_assoc_max::unsetTres()
{
    m_TresIsSet = false;
}
std::shared_ptr<V0_0_39_assoc_max_per> V0_0_39_assoc_max::getPer() const
{
    return m_Per;
}

void V0_0_39_assoc_max::setPer(const std::shared_ptr<V0_0_39_assoc_max_per>& value)
{
    m_Per = value;
    m_PerIsSet = true;
}

bool V0_0_39_assoc_max::perIsSet() const
{
    return m_PerIsSet;
}

void V0_0_39_assoc_max::unsetPer()
{
    m_PerIsSet = false;
}
}
