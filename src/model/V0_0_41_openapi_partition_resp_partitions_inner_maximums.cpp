...
V0_0_41_openapi_partition_resp_partitions_inner_maximums::V0_0_41_openapi_partition_resp_partitions_inner_maximums()
{
...
void V0_0_41_openapi_partition_resp_partitions_inner_maximums::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_partition_resp_partitions_inner_maximums::toJson() const
{
...
bool V0_0_41_openapi_partition_resp_partitions_inner_maximums::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("cpus_per_node"))))
    {
        ...
        {
            std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_cpus_per_node> refVal_setCpusPerNode;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("cpus_per_socket"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_cpus_per_socket> refVal_setCpusPerSocket;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("partition_memory_per_cpu"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_partition_memory_per_cpu> refVal_setPartitionMemoryPerCpu;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("partition_memory_per_node"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_partition_memory_per_node> refVal_setPartitionMemoryPerNode;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("nodes"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes> refVal_setNodes;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("time"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_time> refVal_setTime;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("over_time_limit"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_over_time_limit> refVal_setOverTimeLimit;
...
void V0_0_41_openapi_partition_resp_partitions_inner_maximums::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_partition_resp_partitions_inner_maximums::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_cpus_per_node> V0_0_41_openapi_partition_resp_partitions_inner_maximums::getCpusPerNode() const
{
    return m_Cpus_per_node;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::setCpusPerNode(const std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_cpus_per_node>& value)
{
    m_Cpus_per_node = value;
    m_Cpus_per_nodeIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_maximums::cpusPerNodeIsSet() const
{
    return m_Cpus_per_nodeIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::unsetCpus_per_node()
{
    m_Cpus_per_nodeIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_cpus_per_socket> V0_0_41_openapi_partition_resp_partitions_inner_maximums::getCpusPerSocket() const
{
    return m_Cpus_per_socket;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::setCpusPerSocket(const std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_cpus_per_socket>& value)
{
    m_Cpus_per_socket = value;
    m_Cpus_per_socketIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_maximums::cpusPerSocketIsSet() const
{
    return m_Cpus_per_socketIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::unsetCpus_per_socket()
{
    m_Cpus_per_socketIsSet = false;
}
int64_t V0_0_41_openapi_partition_resp_partitions_inner_maximums::getMemoryPerCpu() const
{
    return m_Memory_per_cpu;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::setMemoryPerCpu(int64_t value)
{
    m_Memory_per_cpu = value;
    m_Memory_per_cpuIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_maximums::memoryPerCpuIsSet() const
{
    return m_Memory_per_cpuIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::unsetMemory_per_cpu()
{
    m_Memory_per_cpuIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_partition_memory_per_cpu> V0_0_41_openapi_partition_resp_partitions_inner_maximums::getPartitionMemoryPerCpu() const
{
    return m_Partition_memory_per_cpu;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::setPartitionMemoryPerCpu(const std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_partition_memory_per_cpu>& value)
{
    m_Partition_memory_per_cpu = value;
    m_Partition_memory_per_cpuIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_maximums::partitionMemoryPerCpuIsSet() const
{
    return m_Partition_memory_per_cpuIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::unsetPartition_memory_per_cpu()
{
    m_Partition_memory_per_cpuIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_partition_memory_per_node> V0_0_41_openapi_partition_resp_partitions_inner_maximums::getPartitionMemoryPerNode() const
{
    return m_Partition_memory_per_node;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::setPartitionMemoryPerNode(const std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_partition_memory_per_node>& value)
{
    m_Partition_memory_per_node = value;
    m_Partition_memory_per_nodeIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_maximums::partitionMemoryPerNodeIsSet() const
{
    return m_Partition_memory_per_nodeIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::unsetPartition_memory_per_node()
{
    m_Partition_memory_per_nodeIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes> V0_0_41_openapi_partition_resp_partitions_inner_maximums::getNodes() const
{
    return m_Nodes;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::setNodes(const std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_nodes>& value)
{
    m_Nodes = value;
    m_NodesIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_maximums::nodesIsSet() const
{
    return m_NodesIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::unsetNodes()
{
    m_NodesIsSet = false;
}
int32_t V0_0_41_openapi_partition_resp_partitions_inner_maximums::getShares() const
{
    return m_Shares;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::setShares(int32_t value)
{
    m_Shares = value;
    m_SharesIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_maximums::sharesIsSet() const
{
    return m_SharesIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::unsetShares()
{
    m_SharesIsSet = false;
}
std::shared_ptr<V0_0_40_partition_info_maximums_oversubscribe> V0_0_41_openapi_partition_resp_partitions_inner_maximums::getOversubscribe() const
{
    return m_Oversubscribe;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::setOversubscribe(const std::shared_ptr<V0_0_40_partition_info_maximums_oversubscribe>& value)
{
    m_Oversubscribe = value;
    m_OversubscribeIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_maximums::oversubscribeIsSet() const
{
    return m_OversubscribeIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::unsetOversubscribe()
{
    m_OversubscribeIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_time> V0_0_41_openapi_partition_resp_partitions_inner_maximums::getTime() const
{
    return m_Time;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::setTime(const std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_time>& value)
{
    m_Time = value;
    m_TimeIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_maximums::timeIsSet() const
{
    return m_TimeIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::unsetTime()
{
    m_TimeIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_over_time_limit> V0_0_41_openapi_partition_resp_partitions_inner_maximums::getOverTimeLimit() const
{
    return m_Over_time_limit;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::setOverTimeLimit(const std::shared_ptr<V0_0_41_openapi_partition_resp_partitions_inner_maximums_over_time_limit>& value)
{
    m_Over_time_limit = value;
    m_Over_time_limitIsSet = true;
}

bool V0_0_41_openapi_partition_resp_partitions_inner_maximums::overTimeLimitIsSet() const
{
    return m_Over_time_limitIsSet;
}

void V0_0_41_openapi_partition_resp_partitions_inner_maximums::unsetOver_time_limit()
{
    m_Over_time_limitIsSet = false;
}
}
