...
V0_0_41_openapi_job_info_resp_last_backfill::V0_0_41_openapi_job_info_resp_last_backfill()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_job_info_resp_last_backfill::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_job_info_resp_last_backfill::toJson() const
{
...
bool V0_0_41_openapi_job_info_resp_last_backfill::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_job_info_resp_last_backfill::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_job_info_resp_last_backfill::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_job_info_resp_last_backfill::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_job_info_resp_last_backfill::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_job_info_resp_last_backfill::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_job_info_resp_last_backfill::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_job_info_resp_last_backfill::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_job_info_resp_last_backfill::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_job_info_resp_last_backfill::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_job_info_resp_last_backfill::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int64_t V0_0_41_openapi_job_info_resp_last_backfill::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_job_info_resp_last_backfill::setNumber(int64_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_job_info_resp_last_backfill::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_job_info_resp_last_backfill::unsetnumber()
{
    m_numberIsSet = false;
}
}
