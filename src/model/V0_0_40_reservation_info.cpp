...
#include "slurmrestapi/model/V0_0_40_reservation_info.h"
...
V0_0_40_reservation_info::V0_0_40_reservation_info()
{
...
void V0_0_40_reservation_info::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_reservation_info::toJson() const
{
...
bool V0_0_40_reservation_info::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("core_specializations"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_40_reservation_core_spec>> refVal_setCoreSpecializations;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("purge_completed"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_reservation_info_purge_completed> refVal_setPurgeCompleted;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("watts"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint32_no_val> refVal_setWatts;
...
void V0_0_40_reservation_info::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_reservation_info::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_reservation_info::getAccounts() const
{
    return m_Accounts;
}

void V0_0_40_reservation_info::setAccounts(const utility::string_t& value)
{
    m_Accounts = value;
    m_AccountsIsSet = true;
}

bool V0_0_40_reservation_info::accountsIsSet() const
{
    return m_AccountsIsSet;
}

void V0_0_40_reservation_info::unsetAccounts()
{
    m_AccountsIsSet = false;
}
utility::string_t V0_0_40_reservation_info::getBurstBuffer() const
{
    return m_Burst_buffer;
}

void V0_0_40_reservation_info::setBurstBuffer(const utility::string_t& value)
{
    m_Burst_buffer = value;
    m_Burst_bufferIsSet = true;
}

bool V0_0_40_reservation_info::burstBufferIsSet() const
{
    return m_Burst_bufferIsSet;
}

void V0_0_40_reservation_info::unsetBurst_buffer()
{
    m_Burst_bufferIsSet = false;
}
int32_t V0_0_40_reservation_info::getCoreCount() const
{
    return m_Core_count;
}

void V0_0_40_reservation_info::setCoreCount(int32_t value)
{
    m_Core_count = value;
    m_Core_countIsSet = true;
}

bool V0_0_40_reservation_info::coreCountIsSet() const
{
    return m_Core_countIsSet;
}

void V0_0_40_reservation_info::unsetCore_count()
{
    m_Core_countIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_reservation_core_spec>>& V0_0_40_reservation_info::getCoreSpecializations()
{
    return m_Core_specializations;
}

void V0_0_40_reservation_info::setCoreSpecializations(const std::vector<std::shared_ptr<V0_0_40_reservation_core_spec>>& value)
{
    m_Core_specializations = value;
    m_Core_specializationsIsSet = true;
}

bool V0_0_40_reservation_info::coreSpecializationsIsSet() const
{
    return m_Core_specializationsIsSet;
}

void V0_0_40_reservation_info::unsetCore_specializations()
{
    m_Core_specializationsIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_reservation_info::getEndTime() const
{
    return m_End_time;
}

void V0_0_40_reservation_info::setEndTime(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_End_time = value;
    m_End_timeIsSet = true;
}

bool V0_0_40_reservation_info::endTimeIsSet() const
{
    return m_End_timeIsSet;
}

void V0_0_40_reservation_info::unsetEnd_time()
{
    m_End_timeIsSet = false;
}
utility::string_t V0_0_40_reservation_info::getFeatures() const
{
    return m_Features;
}

void V0_0_40_reservation_info::setFeatures(const utility::string_t& value)
{
    m_Features = value;
    m_FeaturesIsSet = true;
}

bool V0_0_40_reservation_info::featuresIsSet() const
{
    return m_FeaturesIsSet;
}

void V0_0_40_reservation_info::unsetFeatures()
{
    m_FeaturesIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_reservation_info::getFlags()
{
    return m_Flags;
}

void V0_0_40_reservation_info::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool V0_0_40_reservation_info::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void V0_0_40_reservation_info::unsetFlags()
{
    m_FlagsIsSet = false;
}
utility::string_t V0_0_40_reservation_info::getGroups() const
{
    return m_Groups;
}

void V0_0_40_reservation_info::setGroups(const utility::string_t& value)
{
    m_Groups = value;
    m_GroupsIsSet = true;
}

bool V0_0_40_reservation_info::groupsIsSet() const
{
    return m_GroupsIsSet;
}

void V0_0_40_reservation_info::unsetGroups()
{
    m_GroupsIsSet = false;
}
utility::string_t V0_0_40_reservation_info::getLicenses() const
{
    return m_Licenses;
}

void V0_0_40_reservation_info::setLicenses(const utility::string_t& value)
{
    m_Licenses = value;
    m_LicensesIsSet = true;
}

bool V0_0_40_reservation_info::licensesIsSet() const
{
    return m_LicensesIsSet;
}

void V0_0_40_reservation_info::unsetLicenses()
{
    m_LicensesIsSet = false;
}
int32_t V0_0_40_reservation_info::getMaxStartDelay() const
{
    return m_Max_start_delay;
}

void V0_0_40_reservation_info::setMaxStartDelay(int32_t value)
{
    m_Max_start_delay = value;
    m_Max_start_delayIsSet = true;
}

bool V0_0_40_reservation_info::maxStartDelayIsSet() const
{
    return m_Max_start_delayIsSet;
}

void V0_0_40_reservation_info::unsetMax_start_delay()
{
    m_Max_start_delayIsSet = false;
}
utility::string_t V0_0_40_reservation_info::getName() const
{
    return m_Name;
}

void V0_0_40_reservation_info::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_40_reservation_info::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_40_reservation_info::unsetName()
{
    m_NameIsSet = false;
}
int32_t V0_0_40_reservation_info::getNodeCount() const
{
    return m_Node_count;
}

void V0_0_40_reservation_info::setNodeCount(int32_t value)
{
    m_Node_count = value;
    m_Node_countIsSet = true;
}

bool V0_0_40_reservation_info::nodeCountIsSet() const
{
    return m_Node_countIsSet;
}

void V0_0_40_reservation_info::unsetNode_count()
{
    m_Node_countIsSet = false;
}
utility::string_t V0_0_40_reservation_info::getNodeList() const
{
    return m_Node_list;
}

void V0_0_40_reservation_info::setNodeList(const utility::string_t& value)
{
    m_Node_list = value;
    m_Node_listIsSet = true;
}

bool V0_0_40_reservation_info::nodeListIsSet() const
{
    return m_Node_listIsSet;
}

void V0_0_40_reservation_info::unsetNode_list()
{
    m_Node_listIsSet = false;
}
utility::string_t V0_0_40_reservation_info::getPartition() const
{
    return m_Partition;
}

void V0_0_40_reservation_info::setPartition(const utility::string_t& value)
{
    m_Partition = value;
    m_PartitionIsSet = true;
}

bool V0_0_40_reservation_info::partitionIsSet() const
{
    return m_PartitionIsSet;
}

void V0_0_40_reservation_info::unsetPartition()
{
    m_PartitionIsSet = false;
}
std::shared_ptr<V0_0_40_reservation_info_purge_completed> V0_0_40_reservation_info::getPurgeCompleted() const
{
    return m_Purge_completed;
}

void V0_0_40_reservation_info::setPurgeCompleted(const std::shared_ptr<V0_0_40_reservation_info_purge_completed>& value)
{
    m_Purge_completed = value;
    m_Purge_completedIsSet = true;
}

bool V0_0_40_reservation_info::purgeCompletedIsSet() const
{
    return m_Purge_completedIsSet;
}

void V0_0_40_reservation_info::unsetPurge_completed()
{
    m_Purge_completedIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_reservation_info::getStartTime() const
{
    return m_Start_time;
}

void V0_0_40_reservation_info::setStartTime(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Start_time = value;
    m_Start_timeIsSet = true;
}

bool V0_0_40_reservation_info::startTimeIsSet() const
{
    return m_Start_timeIsSet;
}

void V0_0_40_reservation_info::unsetStart_time()
{
    m_Start_timeIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_reservation_info::getWatts() const
{
    return m_Watts;
}

void V0_0_40_reservation_info::setWatts(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Watts = value;
    m_WattsIsSet = true;
}

bool V0_0_40_reservation_info::wattsIsSet() const
{
    return m_WattsIsSet;
}

void V0_0_40_reservation_info::unsetWatts()
{
    m_WattsIsSet = false;
}
utility::string_t V0_0_40_reservation_info::getTres() const
{
    return m_Tres;
}

void V0_0_40_reservation_info::setTres(const utility::string_t& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool V0_0_40_reservation_info::tresIsSet() const
{
    return m_TresIsSet;
}

void V0_0_40_reservation_info::unsetTres()
{
    m_TresIsSet = false;
}
utility::string_t V0_0_40_reservation_info::getUsers() const
{
    return m_Users;
}

void V0_0_40_reservation_info::setUsers(const utility::string_t& value)
{
    m_Users = value;
    m_UsersIsSet = true;
}

bool V0_0_40_reservation_info::usersIsSet() const
{
    return m_UsersIsSet;
}

void V0_0_40_reservation_info::unsetUsers()
{
    m_UsersIsSet = false;
}
}
