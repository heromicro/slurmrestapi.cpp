...
bool V0_0_39_job_info::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("derived_exit_code"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_uint32_no_val> refVal_setDerivedExitCode;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("exit_code"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_uint32_no_val> refVal_setExitCode;
...
std::shared_ptr<V0_0_39_uint32_no_val> V0_0_39_job_info::getDerivedExitCode() const
{
    return m_Derived_exit_code;
}

void V0_0_39_job_info::setDerivedExitCode(const std::shared_ptr<V0_0_39_uint32_no_val>& value)
{
...
std::shared_ptr<V0_0_39_uint32_no_val> V0_0_39_job_info::getExitCode() const
{
    return m_Exit_code;
}

void V0_0_39_job_info::setExitCode(const std::shared_ptr<V0_0_39_uint32_no_val>& value)
{
    m_Exit_code = value;
...
bool V0_0_39_job_info::isHold() const
{
    return m_Hold;
}

void V0_0_39_job_info::setHold(bool value)
{
    m_Hold = value;
    m_HoldIsSet = true;
}

bool V0_0_39_job_info::holdIsSet() const
{
    return m_HoldIsSet;
}

void V0_0_39_job_info::unsetHold()
{
    m_HoldIsSet = false;
}
...
bool V0_0_39_job_info::isOversubscribe() const
{
    return m_Oversubscribe;
}

void V0_0_39_job_info::setOversubscribe(bool value)
{
    m_Oversubscribe = value;
    m_OversubscribeIsSet = true;
}

bool V0_0_39_job_info::oversubscribeIsSet() const
{
    return m_OversubscribeIsSet;
}

void V0_0_39_job_info::unsetOversubscribe()
{
    m_OversubscribeIsSet = false;
}
