...
V0_0_40_assoc_shares_obj_wrap::V0_0_40_assoc_shares_obj_wrap()
{
    m_Id = 0;
    m_IdIsSet = false;
...
void V0_0_40_assoc_shares_obj_wrap::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_assoc_shares_obj_wrap::toJson() const
{
...
bool V0_0_40_assoc_shares_obj_wrap::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("shares_normalized"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_float64_no_val> refVal_setSharesNormalized;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("shares"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint32_no_val> refVal_setShares;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tres"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_assoc_shares_obj_wrap_tres> refVal_setTres;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("usage_normalized"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_float64_no_val> refVal_setUsageNormalized;
...
void V0_0_40_assoc_shares_obj_wrap::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_assoc_shares_obj_wrap::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_40_assoc_shares_obj_wrap::getId() const
{
    return m_Id;
}

void V0_0_40_assoc_shares_obj_wrap::setId(int32_t value)
{
    m_Id = value;
    m_IdIsSet = true;
}

bool V0_0_40_assoc_shares_obj_wrap::idIsSet() const
{
    return m_IdIsSet;
}

void V0_0_40_assoc_shares_obj_wrap::unsetId()
{
    m_IdIsSet = false;
}
utility::string_t V0_0_40_assoc_shares_obj_wrap::getCluster() const
{
    return m_Cluster;
}

void V0_0_40_assoc_shares_obj_wrap::setCluster(const utility::string_t& value)
{
    m_Cluster = value;
    m_ClusterIsSet = true;
}

bool V0_0_40_assoc_shares_obj_wrap::clusterIsSet() const
{
    return m_ClusterIsSet;
}

void V0_0_40_assoc_shares_obj_wrap::unsetCluster()
{
    m_ClusterIsSet = false;
}
utility::string_t V0_0_40_assoc_shares_obj_wrap::getName() const
{
    return m_Name;
}

void V0_0_40_assoc_shares_obj_wrap::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_40_assoc_shares_obj_wrap::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_40_assoc_shares_obj_wrap::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t V0_0_40_assoc_shares_obj_wrap::getParent() const
{
    return m_Parent;
}

void V0_0_40_assoc_shares_obj_wrap::setParent(const utility::string_t& value)
{
    m_Parent = value;
    m_ParentIsSet = true;
}

bool V0_0_40_assoc_shares_obj_wrap::parentIsSet() const
{
    return m_ParentIsSet;
}

void V0_0_40_assoc_shares_obj_wrap::unsetParent()
{
    m_ParentIsSet = false;
}
utility::string_t V0_0_40_assoc_shares_obj_wrap::getPartition() const
{
    return m_Partition;
}

void V0_0_40_assoc_shares_obj_wrap::setPartition(const utility::string_t& value)
{
    m_Partition = value;
    m_PartitionIsSet = true;
}

bool V0_0_40_assoc_shares_obj_wrap::partitionIsSet() const
{
    return m_PartitionIsSet;
}

void V0_0_40_assoc_shares_obj_wrap::unsetPartition()
{
    m_PartitionIsSet = false;
}
std::shared_ptr<V0_0_40_float64_no_val> V0_0_40_assoc_shares_obj_wrap::getSharesNormalized() const
{
    return m_Shares_normalized;
}

void V0_0_40_assoc_shares_obj_wrap::setSharesNormalized(const std::shared_ptr<V0_0_40_float64_no_val>& value)
{
    m_Shares_normalized = value;
    m_Shares_normalizedIsSet = true;
}

bool V0_0_40_assoc_shares_obj_wrap::sharesNormalizedIsSet() const
{
    return m_Shares_normalizedIsSet;
}

void V0_0_40_assoc_shares_obj_wrap::unsetShares_normalized()
{
    m_Shares_normalizedIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_assoc_shares_obj_wrap::getShares() const
{
    return m_Shares;
}

void V0_0_40_assoc_shares_obj_wrap::setShares(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Shares = value;
    m_SharesIsSet = true;
}

bool V0_0_40_assoc_shares_obj_wrap::sharesIsSet() const
{
    return m_SharesIsSet;
}

void V0_0_40_assoc_shares_obj_wrap::unsetShares()
{
    m_SharesIsSet = false;
}
std::shared_ptr<V0_0_40_assoc_shares_obj_wrap_tres> V0_0_40_assoc_shares_obj_wrap::getTres() const
{
    return m_Tres;
}

void V0_0_40_assoc_shares_obj_wrap::setTres(const std::shared_ptr<V0_0_40_assoc_shares_obj_wrap_tres>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool V0_0_40_assoc_shares_obj_wrap::tresIsSet() const
{
    return m_TresIsSet;
}

void V0_0_40_assoc_shares_obj_wrap::unsetTres()
{
    m_TresIsSet = false;
}
double V0_0_40_assoc_shares_obj_wrap::getEffectiveUsage() const
{
    return m_Effective_usage;
}

void V0_0_40_assoc_shares_obj_wrap::setEffectiveUsage(double value)
{
    m_Effective_usage = value;
    m_Effective_usageIsSet = true;
}

bool V0_0_40_assoc_shares_obj_wrap::effectiveUsageIsSet() const
{
    return m_Effective_usageIsSet;
}

void V0_0_40_assoc_shares_obj_wrap::unsetEffective_usage()
{
    m_Effective_usageIsSet = false;
}
std::shared_ptr<V0_0_40_float64_no_val> V0_0_40_assoc_shares_obj_wrap::getUsageNormalized() const
{
    return m_Usage_normalized;
}

void V0_0_40_assoc_shares_obj_wrap::setUsageNormalized(const std::shared_ptr<V0_0_40_float64_no_val>& value)
{
    m_Usage_normalized = value;
    m_Usage_normalizedIsSet = true;
}

bool V0_0_40_assoc_shares_obj_wrap::usageNormalizedIsSet() const
{
    return m_Usage_normalizedIsSet;
}

void V0_0_40_assoc_shares_obj_wrap::unsetUsage_normalized()
{
    m_Usage_normalizedIsSet = false;
}
int64_t V0_0_40_assoc_shares_obj_wrap::getUsage() const
{
    return m_Usage;
}

void V0_0_40_assoc_shares_obj_wrap::setUsage(int64_t value)
{
    m_Usage = value;
    m_UsageIsSet = true;
}

bool V0_0_40_assoc_shares_obj_wrap::usageIsSet() const
{
    return m_UsageIsSet;
}

void V0_0_40_assoc_shares_obj_wrap::unsetUsage()
{
    m_UsageIsSet = false;
}
std::shared_ptr<V0_0_40_assoc_shares_obj_wrap_fairshare> V0_0_40_assoc_shares_obj_wrap::getFairshare() const
{
    return m_Fairshare;
}

void V0_0_40_assoc_shares_obj_wrap::setFairshare(const std::shared_ptr<V0_0_40_assoc_shares_obj_wrap_fairshare>& value)
{
    m_Fairshare = value;
    m_FairshareIsSet = true;
}

bool V0_0_40_assoc_shares_obj_wrap::fairshareIsSet() const
{
    return m_FairshareIsSet;
}

void V0_0_40_assoc_shares_obj_wrap::unsetFairshare()
{
    m_FairshareIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_assoc_shares_obj_wrap::getType()
{
    return m_Type;
}

void V0_0_40_assoc_shares_obj_wrap::setType(const std::vector<utility::string_t>& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool V0_0_40_assoc_shares_obj_wrap::typeIsSet() const
{
    return m_TypeIsSet;
}

void V0_0_40_assoc_shares_obj_wrap::unsetType()
{
    m_TypeIsSet = false;
}
}
