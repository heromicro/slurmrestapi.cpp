...
V0_0_40_assoc_max_tres_per::V0_0_40_assoc_max_tres_per()
{
    m_JobIsSet = false;
    m_NodeIsSet = false;
}
...
void V0_0_40_assoc_max_tres_per::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_assoc_max_tres_per::toJson() const
{
...
bool V0_0_40_assoc_max_tres_per::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_assoc_max_tres_per::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_assoc_max_tres_per::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_assoc_max_tres_per::getJob()
{
    return m_Job;
}

void V0_0_40_assoc_max_tres_per::setJob(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Job = value;
    m_JobIsSet = true;
}

bool V0_0_40_assoc_max_tres_per::jobIsSet() const
{
    return m_JobIsSet;
}

void V0_0_40_assoc_max_tres_per::unsetJob()
{
    m_JobIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_assoc_max_tres_per::getNode()
{
    return m_Node;
}

void V0_0_40_assoc_max_tres_per::setNode(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Node = value;
    m_NodeIsSet = true;
}

bool V0_0_40_assoc_max_tres_per::nodeIsSet() const
{
    return m_NodeIsSet;
}

void V0_0_40_assoc_max_tres_per::unsetNode()
{
    m_NodeIsSet = false;
}
}
