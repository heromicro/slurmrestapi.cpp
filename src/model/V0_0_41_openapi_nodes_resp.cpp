...
V0_0_41_openapi_nodes_resp::V0_0_41_openapi_nodes_resp()
{
    m_NodesIsSet = false;
...
void V0_0_41_openapi_nodes_resp::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_nodes_resp::toJson() const
{
...
bool V0_0_41_openapi_nodes_resp::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("nodes"))))
    {
        ...
        {
            std::vector<std::shared_ptr<V0_0_41_openapi_nodes_resp_nodes_inner>> refVal_setNodes;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("last_update"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_41_openapi_nodes_resp_last_update> refVal_setLastUpdate;
...
void V0_0_41_openapi_nodes_resp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_nodes_resp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_41_openapi_nodes_resp_nodes_inner>>& V0_0_41_openapi_nodes_resp::getNodes()
{
    return m_Nodes;
}

void V0_0_41_openapi_nodes_resp::setNodes(const std::vector<std::shared_ptr<V0_0_41_openapi_nodes_resp_nodes_inner>>& value)
{
    m_Nodes = value;
    m_NodesIsSet = true;
}

bool V0_0_41_openapi_nodes_resp::nodesIsSet() const
{
    return m_NodesIsSet;
}

void V0_0_41_openapi_nodes_resp::unsetNodes()
{
    m_NodesIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_nodes_resp_last_update> V0_0_41_openapi_nodes_resp::getLastUpdate() const
{
    return m_Last_update;
}

void V0_0_41_openapi_nodes_resp::setLastUpdate(const std::shared_ptr<V0_0_41_openapi_nodes_resp_last_update>& value)
{
    m_Last_update = value;
    m_Last_updateIsSet = true;
}

bool V0_0_41_openapi_nodes_resp::lastUpdateIsSet() const
{
    return m_Last_updateIsSet;
}

void V0_0_41_openapi_nodes_resp::unsetLast_update()
{
    m_Last_updateIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_shares_resp_meta> V0_0_41_openapi_nodes_resp::getMeta() const
{
    return m_Meta;
}

void V0_0_41_openapi_nodes_resp::setMeta(const std::shared_ptr<V0_0_41_openapi_shares_resp_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_41_openapi_nodes_resp::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_41_openapi_nodes_resp::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_errors_inner>>& V0_0_41_openapi_nodes_resp::getErrors()
{
    return m_Errors;
}

void V0_0_41_openapi_nodes_resp::setErrors(const std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_errors_inner>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_41_openapi_nodes_resp::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_41_openapi_nodes_resp::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_warnings_inner>>& V0_0_41_openapi_nodes_resp::getWarnings()
{
    return m_Warnings;
}

void V0_0_41_openapi_nodes_resp::setWarnings(const std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_warnings_inner>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool V0_0_41_openapi_nodes_resp::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void V0_0_41_openapi_nodes_resp::unsetWarnings()
{
    m_WarningsIsSet = false;
}
}
