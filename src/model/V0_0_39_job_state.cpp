...
utility::string_t V0_0_39_job_state::getCurrent() const
{
    return m_Current;
}

void V0_0_39_job_state::setCurrent(const utility::string_t& value)
{
    m_Current = value;
    m_CurrentIsSet = true;
}

bool V0_0_39_job_state::currentIsSet() const
{
    return m_CurrentIsSet;
}

void V0_0_39_job_state::unsetCurrent()
{
    m_CurrentIsSet = false;
}
