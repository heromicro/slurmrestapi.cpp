...
V0_0_40_openapi_slurmdbd_stats_resp::V0_0_40_openapi_slurmdbd_stats_resp()
{
...
void V0_0_40_openapi_slurmdbd_stats_resp::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_openapi_slurmdbd_stats_resp::toJson() const
{
...
bool V0_0_40_openapi_slurmdbd_stats_resp::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("statistics"))))
    {
        ...
        {
            std::shared_ptr<V0_0_40_stats_rec> refVal_setStatistics;
...
void V0_0_40_openapi_slurmdbd_stats_resp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_openapi_slurmdbd_stats_resp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_40_stats_rec> V0_0_40_openapi_slurmdbd_stats_resp::getStatistics() const
{
    return m_Statistics;
}

void V0_0_40_openapi_slurmdbd_stats_resp::setStatistics(const std::shared_ptr<V0_0_40_stats_rec>& value)
{
    m_Statistics = value;
    m_StatisticsIsSet = true;
}

bool V0_0_40_openapi_slurmdbd_stats_resp::statisticsIsSet() const
{
    return m_StatisticsIsSet;
}

void V0_0_40_openapi_slurmdbd_stats_resp::unsetStatistics()
{
    m_StatisticsIsSet = false;
}
std::shared_ptr<V0_0_40_openapi_meta> V0_0_40_openapi_slurmdbd_stats_resp::getMeta() const
{
    return m_Meta;
}

void V0_0_40_openapi_slurmdbd_stats_resp::setMeta(const std::shared_ptr<V0_0_40_openapi_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_40_openapi_slurmdbd_stats_resp::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_40_openapi_slurmdbd_stats_resp::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_openapi_error>>& V0_0_40_openapi_slurmdbd_stats_resp::getErrors()
{
    return m_Errors;
}

void V0_0_40_openapi_slurmdbd_stats_resp::setErrors(const std::vector<std::shared_ptr<V0_0_40_openapi_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_40_openapi_slurmdbd_stats_resp::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_40_openapi_slurmdbd_stats_resp::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_openapi_warning>>& V0_0_40_openapi_slurmdbd_stats_resp::getWarnings()
{
    return m_Warnings;
}

void V0_0_40_openapi_slurmdbd_stats_resp::setWarnings(const std::vector<std::shared_ptr<V0_0_40_openapi_warning>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool V0_0_40_openapi_slurmdbd_stats_resp::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void V0_0_40_openapi_slurmdbd_stats_resp::unsetWarnings()
{
    m_WarningsIsSet = false;
}
}
