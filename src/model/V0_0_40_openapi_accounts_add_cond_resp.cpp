...
V0_0_40_openapi_accounts_add_cond_resp::V0_0_40_openapi_accounts_add_cond_resp()
{
...
void V0_0_40_openapi_accounts_add_cond_resp::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_openapi_accounts_add_cond_resp::toJson() const
{
...
bool V0_0_40_openapi_accounts_add_cond_resp::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("association_condition"))))
    {
        ...
        {
            std::shared_ptr<V0_0_40_accounts_add_cond> refVal_setAssociationCondition;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("account"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_account_short> refVal_setAccount;
...
void V0_0_40_openapi_accounts_add_cond_resp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_openapi_accounts_add_cond_resp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_40_accounts_add_cond> V0_0_40_openapi_accounts_add_cond_resp::getAssociationCondition() const
{
    return m_Association_condition;
}

void V0_0_40_openapi_accounts_add_cond_resp::setAssociationCondition(const std::shared_ptr<V0_0_40_accounts_add_cond>& value)
{
    m_Association_condition = value;
    m_Association_conditionIsSet = true;
}

bool V0_0_40_openapi_accounts_add_cond_resp::associationConditionIsSet() const
{
    return m_Association_conditionIsSet;
}

void V0_0_40_openapi_accounts_add_cond_resp::unsetAssociation_condition()
{
    m_Association_conditionIsSet = false;
}
std::shared_ptr<V0_0_40_account_short> V0_0_40_openapi_accounts_add_cond_resp::getAccount() const
{
    return m_Account;
}

void V0_0_40_openapi_accounts_add_cond_resp::setAccount(const std::shared_ptr<V0_0_40_account_short>& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool V0_0_40_openapi_accounts_add_cond_resp::accountIsSet() const
{
    return m_AccountIsSet;
}

void V0_0_40_openapi_accounts_add_cond_resp::unsetAccount()
{
    m_AccountIsSet = false;
}
std::shared_ptr<V0_0_40_openapi_meta> V0_0_40_openapi_accounts_add_cond_resp::getMeta() const
{
    return m_Meta;
}

void V0_0_40_openapi_accounts_add_cond_resp::setMeta(const std::shared_ptr<V0_0_40_openapi_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_40_openapi_accounts_add_cond_resp::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_40_openapi_accounts_add_cond_resp::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_openapi_error>>& V0_0_40_openapi_accounts_add_cond_resp::getErrors()
{
    return m_Errors;
}

void V0_0_40_openapi_accounts_add_cond_resp::setErrors(const std::vector<std::shared_ptr<V0_0_40_openapi_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_40_openapi_accounts_add_cond_resp::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_40_openapi_accounts_add_cond_resp::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_openapi_warning>>& V0_0_40_openapi_accounts_add_cond_resp::getWarnings()
{
    return m_Warnings;
}

void V0_0_40_openapi_accounts_add_cond_resp::setWarnings(const std::vector<std::shared_ptr<V0_0_40_openapi_warning>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool V0_0_40_openapi_accounts_add_cond_resp::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void V0_0_40_openapi_accounts_add_cond_resp::unsetWarnings()
{
    m_WarningsIsSet = false;
}
}
