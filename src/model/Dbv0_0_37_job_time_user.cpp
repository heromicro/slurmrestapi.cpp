...
Dbv0_0_37_job_time_user::Dbv0_0_37_job_time_user()
{
    m_Seconds = 0;
...
void Dbv0_0_37_job_time_user::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_job_time_user::toJson() const
{
...
bool Dbv0_0_37_job_time_user::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_37_job_time_user::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_job_time_user::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t Dbv0_0_37_job_time_user::getSeconds() const
{
    return m_Seconds;
}

void Dbv0_0_37_job_time_user::setSeconds(int32_t value)
{
    m_Seconds = value;
    m_SecondsIsSet = true;
}

bool Dbv0_0_37_job_time_user::secondsIsSet() const
{
    return m_SecondsIsSet;
}

void Dbv0_0_37_job_time_user::unsetSeconds()
{
    m_SecondsIsSet = false;
}
int32_t Dbv0_0_37_job_time_user::getMicroseconds() const
{
    return m_Microseconds;
}

void Dbv0_0_37_job_time_user::setMicroseconds(int32_t value)
{
    m_Microseconds = value;
    m_MicrosecondsIsSet = true;
}

bool Dbv0_0_37_job_time_user::microsecondsIsSet() const
{
    return m_MicrosecondsIsSet;
}

void Dbv0_0_37_job_time_user::unsetMicroseconds()
{
    m_MicrosecondsIsSet = false;
}
}
