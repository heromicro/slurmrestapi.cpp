...
V0_0_40_stats_msg_rpcs_by_user_inner::V0_0_40_stats_msg_rpcs_by_user_inner()
{
...
void V0_0_40_stats_msg_rpcs_by_user_inner::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_stats_msg_rpcs_by_user_inner::toJson() const
{
...
bool V0_0_40_stats_msg_rpcs_by_user_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_stats_msg_rpcs_by_user_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_stats_msg_rpcs_by_user_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_stats_msg_rpcs_by_user_inner::getUser() const
{
    return m_User;
}

void V0_0_40_stats_msg_rpcs_by_user_inner::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool V0_0_40_stats_msg_rpcs_by_user_inner::userIsSet() const
{
    return m_UserIsSet;
}

void V0_0_40_stats_msg_rpcs_by_user_inner::unsetUser()
{
    m_UserIsSet = false;
}
int32_t V0_0_40_stats_msg_rpcs_by_user_inner::getUserId() const
{
    return m_User_id;
}

void V0_0_40_stats_msg_rpcs_by_user_inner::setUserId(int32_t value)
{
    m_User_id = value;
    m_User_idIsSet = true;
}

bool V0_0_40_stats_msg_rpcs_by_user_inner::userIdIsSet() const
{
    return m_User_idIsSet;
}

void V0_0_40_stats_msg_rpcs_by_user_inner::unsetUser_id()
{
    m_User_idIsSet = false;
}
int64_t V0_0_40_stats_msg_rpcs_by_user_inner::getCount() const
{
    return m_Count;
}

void V0_0_40_stats_msg_rpcs_by_user_inner::setCount(int64_t value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool V0_0_40_stats_msg_rpcs_by_user_inner::countIsSet() const
{
    return m_CountIsSet;
}

void V0_0_40_stats_msg_rpcs_by_user_inner::unsetCount()
{
    m_CountIsSet = false;
}
int64_t V0_0_40_stats_msg_rpcs_by_user_inner::getAverageTime() const
{
    return m_Average_time;
}

void V0_0_40_stats_msg_rpcs_by_user_inner::setAverageTime(int64_t value)
{
    m_Average_time = value;
    m_Average_timeIsSet = true;
}

bool V0_0_40_stats_msg_rpcs_by_user_inner::averageTimeIsSet() const
{
    return m_Average_timeIsSet;
}

void V0_0_40_stats_msg_rpcs_by_user_inner::unsetAverage_time()
{
    m_Average_timeIsSet = false;
}
int64_t V0_0_40_stats_msg_rpcs_by_user_inner::getTotalTime() const
{
    return m_Total_time;
}

void V0_0_40_stats_msg_rpcs_by_user_inner::setTotalTime(int64_t value)
{
    m_Total_time = value;
    m_Total_timeIsSet = true;
}

bool V0_0_40_stats_msg_rpcs_by_user_inner::totalTimeIsSet() const
{
    return m_Total_timeIsSet;
}

void V0_0_40_stats_msg_rpcs_by_user_inner::unsetTotal_time()
{
    m_Total_timeIsSet = false;
}
}
