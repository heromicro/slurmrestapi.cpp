...
V0_0_40_partition_info_accounts::V0_0_40_partition_info_accounts()
{
...
void V0_0_40_partition_info_accounts::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_partition_info_accounts::toJson() const
{
...
bool V0_0_40_partition_info_accounts::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_partition_info_accounts::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_partition_info_accounts::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_partition_info_accounts::getAllowed() const
{
    return m_Allowed;
}

void V0_0_40_partition_info_accounts::setAllowed(const utility::string_t& value)
{
    m_Allowed = value;
    m_AllowedIsSet = true;
}

bool V0_0_40_partition_info_accounts::allowedIsSet() const
{
    return m_AllowedIsSet;
}

void V0_0_40_partition_info_accounts::unsetAllowed()
{
    m_AllowedIsSet = false;
}
utility::string_t V0_0_40_partition_info_accounts::getDeny() const
{
    return m_Deny;
}

void V0_0_40_partition_info_accounts::setDeny(const utility::string_t& value)
{
    m_Deny = value;
    m_DenyIsSet = true;
}

bool V0_0_40_partition_info_accounts::denyIsSet() const
{
    return m_DenyIsSet;
}

void V0_0_40_partition_info_accounts::unsetDeny()
{
    m_DenyIsSet = false;
}
}
