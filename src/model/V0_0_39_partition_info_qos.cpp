...
utility::string_t V0_0_39_partition_info_qos::getAllowed() const
{
    return m_Allowed;
}

void V0_0_39_partition_info_qos::setAllowed(const utility::string_t& value)
{
    m_Allowed = value;
    m_AllowedIsSet = true;
}

bool V0_0_39_partition_info_qos::allowedIsSet() const
{
    return m_AllowedIsSet;
}

void V0_0_39_partition_info_qos::unsetAllowed()
{
    m_AllowedIsSet = false;
}
utility::string_t V0_0_39_partition_info_qos::getDeny() const
{
    return m_Deny;
}

void V0_0_39_partition_info_qos::setDeny(const utility::string_t& value)
{
    m_Deny = value;
    m_DenyIsSet = true;
}

bool V0_0_39_partition_info_qos::denyIsSet() const
{
    return m_DenyIsSet;
}

void V0_0_39_partition_info_qos::unsetDeny()
{
    m_DenyIsSet = false;
}
