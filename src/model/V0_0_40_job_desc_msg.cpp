...
V0_0_40_job_desc_msg::V0_0_40_job_desc_msg()
{
...
void V0_0_40_job_desc_msg::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_job_desc_msg::toJson() const
{
...
bool V0_0_40_job_desc_msg::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("begin_time"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint64_no_val> refVal_setBeginTime;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("crontab"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_cron_entry> refVal_setCrontab;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("rlimits"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_job_desc_msg_rlimits> refVal_setRlimits;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("kill_warning_delay"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint16_no_val> refVal_setKillWarningDelay;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("required_switches"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint32_no_val> refVal_setRequiredSwitches;
...
void V0_0_40_job_desc_msg::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_job_desc_msg::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_job_desc_msg::getAccount() const
{
    return m_Account;
}

void V0_0_40_job_desc_msg::setAccount(const utility::string_t& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool V0_0_40_job_desc_msg::accountIsSet() const
{
    return m_AccountIsSet;
}

void V0_0_40_job_desc_msg::unsetAccount()
{
    m_AccountIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getAccountGatherFrequency() const
{
    return m_Account_gather_frequency;
}

void V0_0_40_job_desc_msg::setAccountGatherFrequency(const utility::string_t& value)
{
    m_Account_gather_frequency = value;
    m_Account_gather_frequencyIsSet = true;
}

bool V0_0_40_job_desc_msg::accountGatherFrequencyIsSet() const
{
    return m_Account_gather_frequencyIsSet;
}

void V0_0_40_job_desc_msg::unsetAccount_gather_frequency()
{
    m_Account_gather_frequencyIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getAdminComment() const
{
    return m_Admin_comment;
}

void V0_0_40_job_desc_msg::setAdminComment(const utility::string_t& value)
{
    m_Admin_comment = value;
    m_Admin_commentIsSet = true;
}

bool V0_0_40_job_desc_msg::adminCommentIsSet() const
{
    return m_Admin_commentIsSet;
}

void V0_0_40_job_desc_msg::unsetAdmin_comment()
{
    m_Admin_commentIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getAllocationNodeList() const
{
    return m_Allocation_node_list;
}

void V0_0_40_job_desc_msg::setAllocationNodeList(const utility::string_t& value)
{
    m_Allocation_node_list = value;
    m_Allocation_node_listIsSet = true;
}

bool V0_0_40_job_desc_msg::allocationNodeListIsSet() const
{
    return m_Allocation_node_listIsSet;
}

void V0_0_40_job_desc_msg::unsetAllocation_node_list()
{
    m_Allocation_node_listIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getAllocationNodePort() const
{
    return m_Allocation_node_port;
}

void V0_0_40_job_desc_msg::setAllocationNodePort(int32_t value)
{
    m_Allocation_node_port = value;
    m_Allocation_node_portIsSet = true;
}

bool V0_0_40_job_desc_msg::allocationNodePortIsSet() const
{
    return m_Allocation_node_portIsSet;
}

void V0_0_40_job_desc_msg::unsetAllocation_node_port()
{
    m_Allocation_node_portIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getArgv()
{
    return m_Argv;
}

void V0_0_40_job_desc_msg::setArgv(const std::vector<utility::string_t>& value)
{
    m_Argv = value;
    m_ArgvIsSet = true;
}

bool V0_0_40_job_desc_msg::argvIsSet() const
{
    return m_ArgvIsSet;
}

void V0_0_40_job_desc_msg::unsetArgv()
{
    m_ArgvIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getArray() const
{
    return m_array;
}

void V0_0_40_job_desc_msg::setArray(const utility::string_t& value)
{
    m_array = value;
    m_arrayIsSet = true;
}

bool V0_0_40_job_desc_msg::arrayIsSet() const
{
    return m_arrayIsSet;
}

void V0_0_40_job_desc_msg::unsetarray()
{
    m_arrayIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getBatchFeatures() const
{
    return m_Batch_features;
}

void V0_0_40_job_desc_msg::setBatchFeatures(const utility::string_t& value)
{
    m_Batch_features = value;
    m_Batch_featuresIsSet = true;
}

bool V0_0_40_job_desc_msg::batchFeaturesIsSet() const
{
    return m_Batch_featuresIsSet;
}

void V0_0_40_job_desc_msg::unsetBatch_features()
{
    m_Batch_featuresIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_job_desc_msg::getBeginTime() const
{
    return m_Begin_time;
}

void V0_0_40_job_desc_msg::setBeginTime(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Begin_time = value;
    m_Begin_timeIsSet = true;
}

bool V0_0_40_job_desc_msg::beginTimeIsSet() const
{
    return m_Begin_timeIsSet;
}

void V0_0_40_job_desc_msg::unsetBegin_time()
{
    m_Begin_timeIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getFlags()
{
    return m_Flags;
}

void V0_0_40_job_desc_msg::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool V0_0_40_job_desc_msg::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void V0_0_40_job_desc_msg::unsetFlags()
{
    m_FlagsIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getBurstBuffer() const
{
    return m_Burst_buffer;
}

void V0_0_40_job_desc_msg::setBurstBuffer(const utility::string_t& value)
{
    m_Burst_buffer = value;
    m_Burst_bufferIsSet = true;
}

bool V0_0_40_job_desc_msg::burstBufferIsSet() const
{
    return m_Burst_bufferIsSet;
}

void V0_0_40_job_desc_msg::unsetBurst_buffer()
{
    m_Burst_bufferIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getClusters() const
{
    return m_Clusters;
}

void V0_0_40_job_desc_msg::setClusters(const utility::string_t& value)
{
    m_Clusters = value;
    m_ClustersIsSet = true;
}

bool V0_0_40_job_desc_msg::clustersIsSet() const
{
    return m_ClustersIsSet;
}

void V0_0_40_job_desc_msg::unsetClusters()
{
    m_ClustersIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getClusterConstraint() const
{
    return m_Cluster_constraint;
}

void V0_0_40_job_desc_msg::setClusterConstraint(const utility::string_t& value)
{
    m_Cluster_constraint = value;
    m_Cluster_constraintIsSet = true;
}

bool V0_0_40_job_desc_msg::clusterConstraintIsSet() const
{
    return m_Cluster_constraintIsSet;
}

void V0_0_40_job_desc_msg::unsetCluster_constraint()
{
    m_Cluster_constraintIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getComment() const
{
    return m_Comment;
}

void V0_0_40_job_desc_msg::setComment(const utility::string_t& value)
{
    m_Comment = value;
    m_CommentIsSet = true;
}

bool V0_0_40_job_desc_msg::commentIsSet() const
{
    return m_CommentIsSet;
}

void V0_0_40_job_desc_msg::unsetComment()
{
    m_CommentIsSet = false;
}
bool V0_0_40_job_desc_msg::isContiguous() const
{
    return m_Contiguous;
}

void V0_0_40_job_desc_msg::setContiguous(bool value)
{
    m_Contiguous = value;
    m_ContiguousIsSet = true;
}

bool V0_0_40_job_desc_msg::contiguousIsSet() const
{
    return m_ContiguousIsSet;
}

void V0_0_40_job_desc_msg::unsetContiguous()
{
    m_ContiguousIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getContainer() const
{
    return m_Container;
}

void V0_0_40_job_desc_msg::setContainer(const utility::string_t& value)
{
    m_Container = value;
    m_ContainerIsSet = true;
}

bool V0_0_40_job_desc_msg::containerIsSet() const
{
    return m_ContainerIsSet;
}

void V0_0_40_job_desc_msg::unsetContainer()
{
    m_ContainerIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getContainerId() const
{
    return m_Container_id;
}

void V0_0_40_job_desc_msg::setContainerId(const utility::string_t& value)
{
    m_Container_id = value;
    m_Container_idIsSet = true;
}

bool V0_0_40_job_desc_msg::containerIdIsSet() const
{
    return m_Container_idIsSet;
}

void V0_0_40_job_desc_msg::unsetContainer_id()
{
    m_Container_idIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getCoresPerSocket() const
{
    return m_Cores_per_socket;
}

void V0_0_40_job_desc_msg::setCoresPerSocket(int32_t value)
{
    m_Cores_per_socket = value;
    m_Cores_per_socketIsSet = true;
}

bool V0_0_40_job_desc_msg::coresPerSocketIsSet() const
{
    return m_Cores_per_socketIsSet;
}

void V0_0_40_job_desc_msg::unsetCores_per_socket()
{
    m_Cores_per_socketIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getCoreSpecification() const
{
    return m_Core_specification;
}

void V0_0_40_job_desc_msg::setCoreSpecification(int32_t value)
{
    m_Core_specification = value;
    m_Core_specificationIsSet = true;
}

bool V0_0_40_job_desc_msg::coreSpecificationIsSet() const
{
    return m_Core_specificationIsSet;
}

void V0_0_40_job_desc_msg::unsetCore_specification()
{
    m_Core_specificationIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getThreadSpecification() const
{
    return m_Thread_specification;
}

void V0_0_40_job_desc_msg::setThreadSpecification(int32_t value)
{
    m_Thread_specification = value;
    m_Thread_specificationIsSet = true;
}

bool V0_0_40_job_desc_msg::threadSpecificationIsSet() const
{
    return m_Thread_specificationIsSet;
}

void V0_0_40_job_desc_msg::unsetThread_specification()
{
    m_Thread_specificationIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getCpuBinding() const
{
    return m_Cpu_binding;
}

void V0_0_40_job_desc_msg::setCpuBinding(const utility::string_t& value)
{
    m_Cpu_binding = value;
    m_Cpu_bindingIsSet = true;
}

bool V0_0_40_job_desc_msg::cpuBindingIsSet() const
{
    return m_Cpu_bindingIsSet;
}

void V0_0_40_job_desc_msg::unsetCpu_binding()
{
    m_Cpu_bindingIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getCpuBindingFlags()
{
    return m_Cpu_binding_flags;
}

void V0_0_40_job_desc_msg::setCpuBindingFlags(const std::vector<utility::string_t>& value)
{
    m_Cpu_binding_flags = value;
    m_Cpu_binding_flagsIsSet = true;
}

bool V0_0_40_job_desc_msg::cpuBindingFlagsIsSet() const
{
    return m_Cpu_binding_flagsIsSet;
}

void V0_0_40_job_desc_msg::unsetCpu_binding_flags()
{
    m_Cpu_binding_flagsIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getCpuFrequency() const
{
    return m_Cpu_frequency;
}

void V0_0_40_job_desc_msg::setCpuFrequency(const utility::string_t& value)
{
    m_Cpu_frequency = value;
    m_Cpu_frequencyIsSet = true;
}

bool V0_0_40_job_desc_msg::cpuFrequencyIsSet() const
{
    return m_Cpu_frequencyIsSet;
}

void V0_0_40_job_desc_msg::unsetCpu_frequency()
{
    m_Cpu_frequencyIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getCpusPerTres() const
{
    return m_Cpus_per_tres;
}

void V0_0_40_job_desc_msg::setCpusPerTres(const utility::string_t& value)
{
    m_Cpus_per_tres = value;
    m_Cpus_per_tresIsSet = true;
}

bool V0_0_40_job_desc_msg::cpusPerTresIsSet() const
{
    return m_Cpus_per_tresIsSet;
}

void V0_0_40_job_desc_msg::unsetCpus_per_tres()
{
    m_Cpus_per_tresIsSet = false;
}
std::shared_ptr<V0_0_40_cron_entry> V0_0_40_job_desc_msg::getCrontab() const
{
    return m_Crontab;
}

void V0_0_40_job_desc_msg::setCrontab(const std::shared_ptr<V0_0_40_cron_entry>& value)
{
    m_Crontab = value;
    m_CrontabIsSet = true;
}

bool V0_0_40_job_desc_msg::crontabIsSet() const
{
    return m_CrontabIsSet;
}

void V0_0_40_job_desc_msg::unsetCrontab()
{
    m_CrontabIsSet = false;
}
int64_t V0_0_40_job_desc_msg::getDeadline() const
{
    return m_Deadline;
}

void V0_0_40_job_desc_msg::setDeadline(int64_t value)
{
    m_Deadline = value;
    m_DeadlineIsSet = true;
}

bool V0_0_40_job_desc_msg::deadlineIsSet() const
{
    return m_DeadlineIsSet;
}

void V0_0_40_job_desc_msg::unsetDeadline()
{
    m_DeadlineIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getDelayBoot() const
{
    return m_Delay_boot;
}

void V0_0_40_job_desc_msg::setDelayBoot(int32_t value)
{
    m_Delay_boot = value;
    m_Delay_bootIsSet = true;
}

bool V0_0_40_job_desc_msg::delayBootIsSet() const
{
    return m_Delay_bootIsSet;
}

void V0_0_40_job_desc_msg::unsetDelay_boot()
{
    m_Delay_bootIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getDependency() const
{
    return m_Dependency;
}

void V0_0_40_job_desc_msg::setDependency(const utility::string_t& value)
{
    m_Dependency = value;
    m_DependencyIsSet = true;
}

bool V0_0_40_job_desc_msg::dependencyIsSet() const
{
    return m_DependencyIsSet;
}

void V0_0_40_job_desc_msg::unsetDependency()
{
    m_DependencyIsSet = false;
}
int64_t V0_0_40_job_desc_msg::getEndTime() const
{
    return m_End_time;
}

void V0_0_40_job_desc_msg::setEndTime(int64_t value)
{
    m_End_time = value;
    m_End_timeIsSet = true;
}

bool V0_0_40_job_desc_msg::endTimeIsSet() const
{
    return m_End_timeIsSet;
}

void V0_0_40_job_desc_msg::unsetEnd_time()
{
    m_End_timeIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getEnvironment()
{
    return m_Environment;
}

void V0_0_40_job_desc_msg::setEnvironment(const std::vector<utility::string_t>& value)
{
    m_Environment = value;
    m_EnvironmentIsSet = true;
}

bool V0_0_40_job_desc_msg::environmentIsSet() const
{
    return m_EnvironmentIsSet;
}

void V0_0_40_job_desc_msg::unsetEnvironment()
{
    m_EnvironmentIsSet = false;
}
std::shared_ptr<V0_0_40_job_desc_msg_rlimits> V0_0_40_job_desc_msg::getRlimits() const
{
    return m_Rlimits;
}

void V0_0_40_job_desc_msg::setRlimits(const std::shared_ptr<V0_0_40_job_desc_msg_rlimits>& value)
{
    m_Rlimits = value;
    m_RlimitsIsSet = true;
}

bool V0_0_40_job_desc_msg::rlimitsIsSet() const
{
    return m_RlimitsIsSet;
}

void V0_0_40_job_desc_msg::unsetRlimits()
{
    m_RlimitsIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getExcludedNodes()
{
    return m_Excluded_nodes;
}

void V0_0_40_job_desc_msg::setExcludedNodes(const std::vector<utility::string_t>& value)
{
    m_Excluded_nodes = value;
    m_Excluded_nodesIsSet = true;
}

bool V0_0_40_job_desc_msg::excludedNodesIsSet() const
{
    return m_Excluded_nodesIsSet;
}

void V0_0_40_job_desc_msg::unsetExcluded_nodes()
{
    m_Excluded_nodesIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getExtra() const
{
    return m_Extra;
}

void V0_0_40_job_desc_msg::setExtra(const utility::string_t& value)
{
    m_Extra = value;
    m_ExtraIsSet = true;
}

bool V0_0_40_job_desc_msg::extraIsSet() const
{
    return m_ExtraIsSet;
}

void V0_0_40_job_desc_msg::unsetExtra()
{
    m_ExtraIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getConstraints() const
{
    return m_Constraints;
}

void V0_0_40_job_desc_msg::setConstraints(const utility::string_t& value)
{
    m_Constraints = value;
    m_ConstraintsIsSet = true;
}

bool V0_0_40_job_desc_msg::constraintsIsSet() const
{
    return m_ConstraintsIsSet;
}

void V0_0_40_job_desc_msg::unsetConstraints()
{
    m_ConstraintsIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getGroupId() const
{
    return m_Group_id;
}

void V0_0_40_job_desc_msg::setGroupId(const utility::string_t& value)
{
    m_Group_id = value;
    m_Group_idIsSet = true;
}

bool V0_0_40_job_desc_msg::groupIdIsSet() const
{
    return m_Group_idIsSet;
}

void V0_0_40_job_desc_msg::unsetGroup_id()
{
    m_Group_idIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getHetjobGroup() const
{
    return m_Hetjob_group;
}

void V0_0_40_job_desc_msg::setHetjobGroup(int32_t value)
{
    m_Hetjob_group = value;
    m_Hetjob_groupIsSet = true;
}

bool V0_0_40_job_desc_msg::hetjobGroupIsSet() const
{
    return m_Hetjob_groupIsSet;
}

void V0_0_40_job_desc_msg::unsetHetjob_group()
{
    m_Hetjob_groupIsSet = false;
}
bool V0_0_40_job_desc_msg::isImmediate() const
{
    return m_Immediate;
}

void V0_0_40_job_desc_msg::setImmediate(bool value)
{
    m_Immediate = value;
    m_ImmediateIsSet = true;
}

bool V0_0_40_job_desc_msg::immediateIsSet() const
{
    return m_ImmediateIsSet;
}

void V0_0_40_job_desc_msg::unsetImmediate()
{
    m_ImmediateIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getJobId() const
{
    return m_Job_id;
}

void V0_0_40_job_desc_msg::setJobId(int32_t value)
{
    m_Job_id = value;
    m_Job_idIsSet = true;
}

bool V0_0_40_job_desc_msg::jobIdIsSet() const
{
    return m_Job_idIsSet;
}

void V0_0_40_job_desc_msg::unsetJob_id()
{
    m_Job_idIsSet = false;
}
bool V0_0_40_job_desc_msg::isKillOnNodeFail() const
{
    return m_Kill_on_node_fail;
}

void V0_0_40_job_desc_msg::setKillOnNodeFail(bool value)
{
    m_Kill_on_node_fail = value;
    m_Kill_on_node_failIsSet = true;
}

bool V0_0_40_job_desc_msg::killOnNodeFailIsSet() const
{
    return m_Kill_on_node_failIsSet;
}

void V0_0_40_job_desc_msg::unsetKill_on_node_fail()
{
    m_Kill_on_node_failIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getLicenses() const
{
    return m_Licenses;
}

void V0_0_40_job_desc_msg::setLicenses(const utility::string_t& value)
{
    m_Licenses = value;
    m_LicensesIsSet = true;
}

bool V0_0_40_job_desc_msg::licensesIsSet() const
{
    return m_LicensesIsSet;
}

void V0_0_40_job_desc_msg::unsetLicenses()
{
    m_LicensesIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getMailType()
{
    return m_Mail_type;
}

void V0_0_40_job_desc_msg::setMailType(const std::vector<utility::string_t>& value)
{
    m_Mail_type = value;
    m_Mail_typeIsSet = true;
}

bool V0_0_40_job_desc_msg::mailTypeIsSet() const
{
    return m_Mail_typeIsSet;
}

void V0_0_40_job_desc_msg::unsetMail_type()
{
    m_Mail_typeIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getMailUser() const
{
    return m_Mail_user;
}

void V0_0_40_job_desc_msg::setMailUser(const utility::string_t& value)
{
    m_Mail_user = value;
    m_Mail_userIsSet = true;
}

bool V0_0_40_job_desc_msg::mailUserIsSet() const
{
    return m_Mail_userIsSet;
}

void V0_0_40_job_desc_msg::unsetMail_user()
{
    m_Mail_userIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getMcsLabel() const
{
    return m_Mcs_label;
}

void V0_0_40_job_desc_msg::setMcsLabel(const utility::string_t& value)
{
    m_Mcs_label = value;
    m_Mcs_labelIsSet = true;
}

bool V0_0_40_job_desc_msg::mcsLabelIsSet() const
{
    return m_Mcs_labelIsSet;
}

void V0_0_40_job_desc_msg::unsetMcs_label()
{
    m_Mcs_labelIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getMemoryBinding() const
{
    return m_Memory_binding;
}

void V0_0_40_job_desc_msg::setMemoryBinding(const utility::string_t& value)
{
    m_Memory_binding = value;
    m_Memory_bindingIsSet = true;
}

bool V0_0_40_job_desc_msg::memoryBindingIsSet() const
{
    return m_Memory_bindingIsSet;
}

void V0_0_40_job_desc_msg::unsetMemory_binding()
{
    m_Memory_bindingIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getMemoryBindingType()
{
    return m_Memory_binding_type;
}

void V0_0_40_job_desc_msg::setMemoryBindingType(const std::vector<utility::string_t>& value)
{
    m_Memory_binding_type = value;
    m_Memory_binding_typeIsSet = true;
}

bool V0_0_40_job_desc_msg::memoryBindingTypeIsSet() const
{
    return m_Memory_binding_typeIsSet;
}

void V0_0_40_job_desc_msg::unsetMemory_binding_type()
{
    m_Memory_binding_typeIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getMemoryPerTres() const
{
    return m_Memory_per_tres;
}

void V0_0_40_job_desc_msg::setMemoryPerTres(const utility::string_t& value)
{
    m_Memory_per_tres = value;
    m_Memory_per_tresIsSet = true;
}

bool V0_0_40_job_desc_msg::memoryPerTresIsSet() const
{
    return m_Memory_per_tresIsSet;
}

void V0_0_40_job_desc_msg::unsetMemory_per_tres()
{
    m_Memory_per_tresIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getName() const
{
    return m_Name;
}

void V0_0_40_job_desc_msg::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_40_job_desc_msg::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_40_job_desc_msg::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getNetwork() const
{
    return m_Network;
}

void V0_0_40_job_desc_msg::setNetwork(const utility::string_t& value)
{
    m_Network = value;
    m_NetworkIsSet = true;
}

bool V0_0_40_job_desc_msg::networkIsSet() const
{
    return m_NetworkIsSet;
}

void V0_0_40_job_desc_msg::unsetNetwork()
{
    m_NetworkIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getNice() const
{
    return m_Nice;
}

void V0_0_40_job_desc_msg::setNice(int32_t value)
{
    m_Nice = value;
    m_NiceIsSet = true;
}

bool V0_0_40_job_desc_msg::niceIsSet() const
{
    return m_NiceIsSet;
}

void V0_0_40_job_desc_msg::unsetNice()
{
    m_NiceIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getTasks() const
{
    return m_Tasks;
}

void V0_0_40_job_desc_msg::setTasks(int32_t value)
{
    m_Tasks = value;
    m_TasksIsSet = true;
}

bool V0_0_40_job_desc_msg::tasksIsSet() const
{
    return m_TasksIsSet;
}

void V0_0_40_job_desc_msg::unsetTasks()
{
    m_TasksIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getOpenMode()
{
    return m_Open_mode;
}

void V0_0_40_job_desc_msg::setOpenMode(const std::vector<utility::string_t>& value)
{
    m_Open_mode = value;
    m_Open_modeIsSet = true;
}

bool V0_0_40_job_desc_msg::openModeIsSet() const
{
    return m_Open_modeIsSet;
}

void V0_0_40_job_desc_msg::unsetOpen_mode()
{
    m_Open_modeIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getReservePorts() const
{
    return m_Reserve_ports;
}

void V0_0_40_job_desc_msg::setReservePorts(int32_t value)
{
    m_Reserve_ports = value;
    m_Reserve_portsIsSet = true;
}

bool V0_0_40_job_desc_msg::reservePortsIsSet() const
{
    return m_Reserve_portsIsSet;
}

void V0_0_40_job_desc_msg::unsetReserve_ports()
{
    m_Reserve_portsIsSet = false;
}
bool V0_0_40_job_desc_msg::isOvercommit() const
{
    return m_Overcommit;
}

void V0_0_40_job_desc_msg::setOvercommit(bool value)
{
    m_Overcommit = value;
    m_OvercommitIsSet = true;
}

bool V0_0_40_job_desc_msg::overcommitIsSet() const
{
    return m_OvercommitIsSet;
}

void V0_0_40_job_desc_msg::unsetOvercommit()
{
    m_OvercommitIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getPartition() const
{
    return m_Partition;
}

void V0_0_40_job_desc_msg::setPartition(const utility::string_t& value)
{
    m_Partition = value;
    m_PartitionIsSet = true;
}

bool V0_0_40_job_desc_msg::partitionIsSet() const
{
    return m_PartitionIsSet;
}

void V0_0_40_job_desc_msg::unsetPartition()
{
    m_PartitionIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getDistributionPlaneSize() const
{
    return m_Distribution_plane_size;
}

void V0_0_40_job_desc_msg::setDistributionPlaneSize(int32_t value)
{
    m_Distribution_plane_size = value;
    m_Distribution_plane_sizeIsSet = true;
}

bool V0_0_40_job_desc_msg::distributionPlaneSizeIsSet() const
{
    return m_Distribution_plane_sizeIsSet;
}

void V0_0_40_job_desc_msg::unsetDistribution_plane_size()
{
    m_Distribution_plane_sizeIsSet = false;
}
std::vector<std::shared_ptr<AnyType>>& V0_0_40_job_desc_msg::getPowerFlags()
{
    return m_Power_flags;
}

void V0_0_40_job_desc_msg::setPowerFlags(const std::vector<std::shared_ptr<AnyType>>& value)
{
    m_Power_flags = value;
    m_Power_flagsIsSet = true;
}

bool V0_0_40_job_desc_msg::powerFlagsIsSet() const
{
    return m_Power_flagsIsSet;
}

void V0_0_40_job_desc_msg::unsetPower_flags()
{
    m_Power_flagsIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getPrefer() const
{
    return m_Prefer;
}

void V0_0_40_job_desc_msg::setPrefer(const utility::string_t& value)
{
    m_Prefer = value;
    m_PreferIsSet = true;
}

bool V0_0_40_job_desc_msg::preferIsSet() const
{
    return m_PreferIsSet;
}

void V0_0_40_job_desc_msg::unsetPrefer()
{
    m_PreferIsSet = false;
}
bool V0_0_40_job_desc_msg::isHold() const
{
    return m_Hold;
}

void V0_0_40_job_desc_msg::setHold(bool value)
{
    m_Hold = value;
    m_HoldIsSet = true;
}

bool V0_0_40_job_desc_msg::holdIsSet() const
{
    return m_HoldIsSet;
}

void V0_0_40_job_desc_msg::unsetHold()
{
    m_HoldIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_job_desc_msg::getPriority() const
{
    return m_Priority;
}

void V0_0_40_job_desc_msg::setPriority(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Priority = value;
    m_PriorityIsSet = true;
}

bool V0_0_40_job_desc_msg::priorityIsSet() const
{
    return m_PriorityIsSet;
}

void V0_0_40_job_desc_msg::unsetPriority()
{
    m_PriorityIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getProfile()
{
    return m_Profile;
}

void V0_0_40_job_desc_msg::setProfile(const std::vector<utility::string_t>& value)
{
    m_Profile = value;
    m_ProfileIsSet = true;
}

bool V0_0_40_job_desc_msg::profileIsSet() const
{
    return m_ProfileIsSet;
}

void V0_0_40_job_desc_msg::unsetProfile()
{
    m_ProfileIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getQos() const
{
    return m_Qos;
}

void V0_0_40_job_desc_msg::setQos(const utility::string_t& value)
{
    m_Qos = value;
    m_QosIsSet = true;
}

bool V0_0_40_job_desc_msg::qosIsSet() const
{
    return m_QosIsSet;
}

void V0_0_40_job_desc_msg::unsetQos()
{
    m_QosIsSet = false;
}
bool V0_0_40_job_desc_msg::isReboot() const
{
    return m_Reboot;
}

void V0_0_40_job_desc_msg::setReboot(bool value)
{
    m_Reboot = value;
    m_RebootIsSet = true;
}

bool V0_0_40_job_desc_msg::rebootIsSet() const
{
    return m_RebootIsSet;
}

void V0_0_40_job_desc_msg::unsetReboot()
{
    m_RebootIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getRequiredNodes()
{
    return m_Required_nodes;
}

void V0_0_40_job_desc_msg::setRequiredNodes(const std::vector<utility::string_t>& value)
{
    m_Required_nodes = value;
    m_Required_nodesIsSet = true;
}

bool V0_0_40_job_desc_msg::requiredNodesIsSet() const
{
    return m_Required_nodesIsSet;
}

void V0_0_40_job_desc_msg::unsetRequired_nodes()
{
    m_Required_nodesIsSet = false;
}
bool V0_0_40_job_desc_msg::isRequeue() const
{
    return m_Requeue;
}

void V0_0_40_job_desc_msg::setRequeue(bool value)
{
    m_Requeue = value;
    m_RequeueIsSet = true;
}

bool V0_0_40_job_desc_msg::requeueIsSet() const
{
    return m_RequeueIsSet;
}

void V0_0_40_job_desc_msg::unsetRequeue()
{
    m_RequeueIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getReservation() const
{
    return m_Reservation;
}

void V0_0_40_job_desc_msg::setReservation(const utility::string_t& value)
{
    m_Reservation = value;
    m_ReservationIsSet = true;
}

bool V0_0_40_job_desc_msg::reservationIsSet() const
{
    return m_ReservationIsSet;
}

void V0_0_40_job_desc_msg::unsetReservation()
{
    m_ReservationIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getScript() const
{
    return m_Script;
}

void V0_0_40_job_desc_msg::setScript(const utility::string_t& value)
{
    m_Script = value;
    m_ScriptIsSet = true;
}

bool V0_0_40_job_desc_msg::scriptIsSet() const
{
    return m_ScriptIsSet;
}

void V0_0_40_job_desc_msg::unsetScript()
{
    m_ScriptIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getShared()
{
    return m_Shared;
}

void V0_0_40_job_desc_msg::setShared(const std::vector<utility::string_t>& value)
{
    m_Shared = value;
    m_SharedIsSet = true;
}

bool V0_0_40_job_desc_msg::sharedIsSet() const
{
    return m_SharedIsSet;
}

void V0_0_40_job_desc_msg::unsetShared()
{
    m_SharedIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getExclusive()
{
    return m_Exclusive;
}

void V0_0_40_job_desc_msg::setExclusive(const std::vector<utility::string_t>& value)
{
    m_Exclusive = value;
    m_ExclusiveIsSet = true;
}

bool V0_0_40_job_desc_msg::exclusiveIsSet() const
{
    return m_ExclusiveIsSet;
}

void V0_0_40_job_desc_msg::unsetExclusive()
{
    m_ExclusiveIsSet = false;
}
bool V0_0_40_job_desc_msg::isOversubscribe() const
{
    return m_Oversubscribe;
}

void V0_0_40_job_desc_msg::setOversubscribe(bool value)
{
    m_Oversubscribe = value;
    m_OversubscribeIsSet = true;
}

bool V0_0_40_job_desc_msg::oversubscribeIsSet() const
{
    return m_OversubscribeIsSet;
}

void V0_0_40_job_desc_msg::unsetOversubscribe()
{
    m_OversubscribeIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getSiteFactor() const
{
    return m_Site_factor;
}

void V0_0_40_job_desc_msg::setSiteFactor(int32_t value)
{
    m_Site_factor = value;
    m_Site_factorIsSet = true;
}

bool V0_0_40_job_desc_msg::siteFactorIsSet() const
{
    return m_Site_factorIsSet;
}

void V0_0_40_job_desc_msg::unsetSite_factor()
{
    m_Site_factorIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getSpankEnvironment()
{
    return m_Spank_environment;
}

void V0_0_40_job_desc_msg::setSpankEnvironment(const std::vector<utility::string_t>& value)
{
    m_Spank_environment = value;
    m_Spank_environmentIsSet = true;
}

bool V0_0_40_job_desc_msg::spankEnvironmentIsSet() const
{
    return m_Spank_environmentIsSet;
}

void V0_0_40_job_desc_msg::unsetSpank_environment()
{
    m_Spank_environmentIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getDistribution() const
{
    return m_Distribution;
}

void V0_0_40_job_desc_msg::setDistribution(const utility::string_t& value)
{
    m_Distribution = value;
    m_DistributionIsSet = true;
}

bool V0_0_40_job_desc_msg::distributionIsSet() const
{
    return m_DistributionIsSet;
}

void V0_0_40_job_desc_msg::unsetDistribution()
{
    m_DistributionIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_job_desc_msg::getTimeLimit() const
{
    return m_Time_limit;
}

void V0_0_40_job_desc_msg::setTimeLimit(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Time_limit = value;
    m_Time_limitIsSet = true;
}

bool V0_0_40_job_desc_msg::timeLimitIsSet() const
{
    return m_Time_limitIsSet;
}

void V0_0_40_job_desc_msg::unsetTime_limit()
{
    m_Time_limitIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_job_desc_msg::getTimeMinimum() const
{
    return m_Time_minimum;
}

void V0_0_40_job_desc_msg::setTimeMinimum(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Time_minimum = value;
    m_Time_minimumIsSet = true;
}

bool V0_0_40_job_desc_msg::timeMinimumIsSet() const
{
    return m_Time_minimumIsSet;
}

void V0_0_40_job_desc_msg::unsetTime_minimum()
{
    m_Time_minimumIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getTresBind() const
{
    return m_Tres_bind;
}

void V0_0_40_job_desc_msg::setTresBind(const utility::string_t& value)
{
    m_Tres_bind = value;
    m_Tres_bindIsSet = true;
}

bool V0_0_40_job_desc_msg::tresBindIsSet() const
{
    return m_Tres_bindIsSet;
}

void V0_0_40_job_desc_msg::unsetTres_bind()
{
    m_Tres_bindIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getTresFreq() const
{
    return m_Tres_freq;
}

void V0_0_40_job_desc_msg::setTresFreq(const utility::string_t& value)
{
    m_Tres_freq = value;
    m_Tres_freqIsSet = true;
}

bool V0_0_40_job_desc_msg::tresFreqIsSet() const
{
    return m_Tres_freqIsSet;
}

void V0_0_40_job_desc_msg::unsetTres_freq()
{
    m_Tres_freqIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getTresPerJob() const
{
    return m_Tres_per_job;
}

void V0_0_40_job_desc_msg::setTresPerJob(const utility::string_t& value)
{
    m_Tres_per_job = value;
    m_Tres_per_jobIsSet = true;
}

bool V0_0_40_job_desc_msg::tresPerJobIsSet() const
{
    return m_Tres_per_jobIsSet;
}

void V0_0_40_job_desc_msg::unsetTres_per_job()
{
    m_Tres_per_jobIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getTresPerNode() const
{
    return m_Tres_per_node;
}

void V0_0_40_job_desc_msg::setTresPerNode(const utility::string_t& value)
{
    m_Tres_per_node = value;
    m_Tres_per_nodeIsSet = true;
}

bool V0_0_40_job_desc_msg::tresPerNodeIsSet() const
{
    return m_Tres_per_nodeIsSet;
}

void V0_0_40_job_desc_msg::unsetTres_per_node()
{
    m_Tres_per_nodeIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getTresPerSocket() const
{
    return m_Tres_per_socket;
}

void V0_0_40_job_desc_msg::setTresPerSocket(const utility::string_t& value)
{
    m_Tres_per_socket = value;
    m_Tres_per_socketIsSet = true;
}

bool V0_0_40_job_desc_msg::tresPerSocketIsSet() const
{
    return m_Tres_per_socketIsSet;
}

void V0_0_40_job_desc_msg::unsetTres_per_socket()
{
    m_Tres_per_socketIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getTresPerTask() const
{
    return m_Tres_per_task;
}

void V0_0_40_job_desc_msg::setTresPerTask(const utility::string_t& value)
{
    m_Tres_per_task = value;
    m_Tres_per_taskIsSet = true;
}

bool V0_0_40_job_desc_msg::tresPerTaskIsSet() const
{
    return m_Tres_per_taskIsSet;
}

void V0_0_40_job_desc_msg::unsetTres_per_task()
{
    m_Tres_per_taskIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getUserId() const
{
    return m_User_id;
}

void V0_0_40_job_desc_msg::setUserId(const utility::string_t& value)
{
    m_User_id = value;
    m_User_idIsSet = true;
}

bool V0_0_40_job_desc_msg::userIdIsSet() const
{
    return m_User_idIsSet;
}

void V0_0_40_job_desc_msg::unsetUser_id()
{
    m_User_idIsSet = false;
}
bool V0_0_40_job_desc_msg::isWaitAllNodes() const
{
    return m_Wait_all_nodes;
}

void V0_0_40_job_desc_msg::setWaitAllNodes(bool value)
{
    m_Wait_all_nodes = value;
    m_Wait_all_nodesIsSet = true;
}

bool V0_0_40_job_desc_msg::waitAllNodesIsSet() const
{
    return m_Wait_all_nodesIsSet;
}

void V0_0_40_job_desc_msg::unsetWait_all_nodes()
{
    m_Wait_all_nodesIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getKillWarningFlags()
{
    return m_Kill_warning_flags;
}

void V0_0_40_job_desc_msg::setKillWarningFlags(const std::vector<utility::string_t>& value)
{
    m_Kill_warning_flags = value;
    m_Kill_warning_flagsIsSet = true;
}

bool V0_0_40_job_desc_msg::killWarningFlagsIsSet() const
{
    return m_Kill_warning_flagsIsSet;
}

void V0_0_40_job_desc_msg::unsetKill_warning_flags()
{
    m_Kill_warning_flagsIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getKillWarningSignal() const
{
    return m_Kill_warning_signal;
}

void V0_0_40_job_desc_msg::setKillWarningSignal(const utility::string_t& value)
{
    m_Kill_warning_signal = value;
    m_Kill_warning_signalIsSet = true;
}

bool V0_0_40_job_desc_msg::killWarningSignalIsSet() const
{
    return m_Kill_warning_signalIsSet;
}

void V0_0_40_job_desc_msg::unsetKill_warning_signal()
{
    m_Kill_warning_signalIsSet = false;
}
std::shared_ptr<V0_0_40_uint16_no_val> V0_0_40_job_desc_msg::getKillWarningDelay() const
{
    return m_Kill_warning_delay;
}

void V0_0_40_job_desc_msg::setKillWarningDelay(const std::shared_ptr<V0_0_40_uint16_no_val>& value)
{
    m_Kill_warning_delay = value;
    m_Kill_warning_delayIsSet = true;
}

bool V0_0_40_job_desc_msg::killWarningDelayIsSet() const
{
    return m_Kill_warning_delayIsSet;
}

void V0_0_40_job_desc_msg::unsetKill_warning_delay()
{
    m_Kill_warning_delayIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getCurrentWorkingDirectory() const
{
    return m_Current_working_directory;
}

void V0_0_40_job_desc_msg::setCurrentWorkingDirectory(const utility::string_t& value)
{
    m_Current_working_directory = value;
    m_Current_working_directoryIsSet = true;
}

bool V0_0_40_job_desc_msg::currentWorkingDirectoryIsSet() const
{
    return m_Current_working_directoryIsSet;
}

void V0_0_40_job_desc_msg::unsetCurrent_working_directory()
{
    m_Current_working_directoryIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getCpusPerTask() const
{
    return m_Cpus_per_task;
}

void V0_0_40_job_desc_msg::setCpusPerTask(int32_t value)
{
    m_Cpus_per_task = value;
    m_Cpus_per_taskIsSet = true;
}

bool V0_0_40_job_desc_msg::cpusPerTaskIsSet() const
{
    return m_Cpus_per_taskIsSet;
}

void V0_0_40_job_desc_msg::unsetCpus_per_task()
{
    m_Cpus_per_taskIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getMinimumCpus() const
{
    return m_Minimum_cpus;
}

void V0_0_40_job_desc_msg::setMinimumCpus(int32_t value)
{
    m_Minimum_cpus = value;
    m_Minimum_cpusIsSet = true;
}

bool V0_0_40_job_desc_msg::minimumCpusIsSet() const
{
    return m_Minimum_cpusIsSet;
}

void V0_0_40_job_desc_msg::unsetMinimum_cpus()
{
    m_Minimum_cpusIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getMaximumCpus() const
{
    return m_Maximum_cpus;
}

void V0_0_40_job_desc_msg::setMaximumCpus(int32_t value)
{
    m_Maximum_cpus = value;
    m_Maximum_cpusIsSet = true;
}

bool V0_0_40_job_desc_msg::maximumCpusIsSet() const
{
    return m_Maximum_cpusIsSet;
}

void V0_0_40_job_desc_msg::unsetMaximum_cpus()
{
    m_Maximum_cpusIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getNodes() const
{
    return m_Nodes;
}

void V0_0_40_job_desc_msg::setNodes(const utility::string_t& value)
{
    m_Nodes = value;
    m_NodesIsSet = true;
}

bool V0_0_40_job_desc_msg::nodesIsSet() const
{
    return m_NodesIsSet;
}

void V0_0_40_job_desc_msg::unsetNodes()
{
    m_NodesIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getMinimumNodes() const
{
    return m_Minimum_nodes;
}

void V0_0_40_job_desc_msg::setMinimumNodes(int32_t value)
{
    m_Minimum_nodes = value;
    m_Minimum_nodesIsSet = true;
}

bool V0_0_40_job_desc_msg::minimumNodesIsSet() const
{
    return m_Minimum_nodesIsSet;
}

void V0_0_40_job_desc_msg::unsetMinimum_nodes()
{
    m_Minimum_nodesIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getMaximumNodes() const
{
    return m_Maximum_nodes;
}

void V0_0_40_job_desc_msg::setMaximumNodes(int32_t value)
{
    m_Maximum_nodes = value;
    m_Maximum_nodesIsSet = true;
}

bool V0_0_40_job_desc_msg::maximumNodesIsSet() const
{
    return m_Maximum_nodesIsSet;
}

void V0_0_40_job_desc_msg::unsetMaximum_nodes()
{
    m_Maximum_nodesIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getMinimumBoardsPerNode() const
{
    return m_Minimum_boards_per_node;
}

void V0_0_40_job_desc_msg::setMinimumBoardsPerNode(int32_t value)
{
    m_Minimum_boards_per_node = value;
    m_Minimum_boards_per_nodeIsSet = true;
}

bool V0_0_40_job_desc_msg::minimumBoardsPerNodeIsSet() const
{
    return m_Minimum_boards_per_nodeIsSet;
}

void V0_0_40_job_desc_msg::unsetMinimum_boards_per_node()
{
    m_Minimum_boards_per_nodeIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getMinimumSocketsPerBoard() const
{
    return m_Minimum_sockets_per_board;
}

void V0_0_40_job_desc_msg::setMinimumSocketsPerBoard(int32_t value)
{
    m_Minimum_sockets_per_board = value;
    m_Minimum_sockets_per_boardIsSet = true;
}

bool V0_0_40_job_desc_msg::minimumSocketsPerBoardIsSet() const
{
    return m_Minimum_sockets_per_boardIsSet;
}

void V0_0_40_job_desc_msg::unsetMinimum_sockets_per_board()
{
    m_Minimum_sockets_per_boardIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getSocketsPerNode() const
{
    return m_Sockets_per_node;
}

void V0_0_40_job_desc_msg::setSocketsPerNode(int32_t value)
{
    m_Sockets_per_node = value;
    m_Sockets_per_nodeIsSet = true;
}

bool V0_0_40_job_desc_msg::socketsPerNodeIsSet() const
{
    return m_Sockets_per_nodeIsSet;
}

void V0_0_40_job_desc_msg::unsetSockets_per_node()
{
    m_Sockets_per_nodeIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getThreadsPerCore() const
{
    return m_Threads_per_core;
}

void V0_0_40_job_desc_msg::setThreadsPerCore(int32_t value)
{
    m_Threads_per_core = value;
    m_Threads_per_coreIsSet = true;
}

bool V0_0_40_job_desc_msg::threadsPerCoreIsSet() const
{
    return m_Threads_per_coreIsSet;
}

void V0_0_40_job_desc_msg::unsetThreads_per_core()
{
    m_Threads_per_coreIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getTasksPerNode() const
{
    return m_Tasks_per_node;
}

void V0_0_40_job_desc_msg::setTasksPerNode(int32_t value)
{
    m_Tasks_per_node = value;
    m_Tasks_per_nodeIsSet = true;
}

bool V0_0_40_job_desc_msg::tasksPerNodeIsSet() const
{
    return m_Tasks_per_nodeIsSet;
}

void V0_0_40_job_desc_msg::unsetTasks_per_node()
{
    m_Tasks_per_nodeIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getTasksPerSocket() const
{
    return m_Tasks_per_socket;
}

void V0_0_40_job_desc_msg::setTasksPerSocket(int32_t value)
{
    m_Tasks_per_socket = value;
    m_Tasks_per_socketIsSet = true;
}

bool V0_0_40_job_desc_msg::tasksPerSocketIsSet() const
{
    return m_Tasks_per_socketIsSet;
}

void V0_0_40_job_desc_msg::unsetTasks_per_socket()
{
    m_Tasks_per_socketIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getTasksPerCore() const
{
    return m_Tasks_per_core;
}

void V0_0_40_job_desc_msg::setTasksPerCore(int32_t value)
{
    m_Tasks_per_core = value;
    m_Tasks_per_coreIsSet = true;
}

bool V0_0_40_job_desc_msg::tasksPerCoreIsSet() const
{
    return m_Tasks_per_coreIsSet;
}

void V0_0_40_job_desc_msg::unsetTasks_per_core()
{
    m_Tasks_per_coreIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getTasksPerBoard() const
{
    return m_Tasks_per_board;
}

void V0_0_40_job_desc_msg::setTasksPerBoard(int32_t value)
{
    m_Tasks_per_board = value;
    m_Tasks_per_boardIsSet = true;
}

bool V0_0_40_job_desc_msg::tasksPerBoardIsSet() const
{
    return m_Tasks_per_boardIsSet;
}

void V0_0_40_job_desc_msg::unsetTasks_per_board()
{
    m_Tasks_per_boardIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getNtasksPerTres() const
{
    return m_Ntasks_per_tres;
}

void V0_0_40_job_desc_msg::setNtasksPerTres(int32_t value)
{
    m_Ntasks_per_tres = value;
    m_Ntasks_per_tresIsSet = true;
}

bool V0_0_40_job_desc_msg::ntasksPerTresIsSet() const
{
    return m_Ntasks_per_tresIsSet;
}

void V0_0_40_job_desc_msg::unsetNtasks_per_tres()
{
    m_Ntasks_per_tresIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getMinimumCpusPerNode() const
{
    return m_Minimum_cpus_per_node;
}

void V0_0_40_job_desc_msg::setMinimumCpusPerNode(int32_t value)
{
    m_Minimum_cpus_per_node = value;
    m_Minimum_cpus_per_nodeIsSet = true;
}

bool V0_0_40_job_desc_msg::minimumCpusPerNodeIsSet() const
{
    return m_Minimum_cpus_per_nodeIsSet;
}

void V0_0_40_job_desc_msg::unsetMinimum_cpus_per_node()
{
    m_Minimum_cpus_per_nodeIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_job_desc_msg::getMemoryPerCpu() const
{
    return m_Memory_per_cpu;
}

void V0_0_40_job_desc_msg::setMemoryPerCpu(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Memory_per_cpu = value;
    m_Memory_per_cpuIsSet = true;
}

bool V0_0_40_job_desc_msg::memoryPerCpuIsSet() const
{
    return m_Memory_per_cpuIsSet;
}

void V0_0_40_job_desc_msg::unsetMemory_per_cpu()
{
    m_Memory_per_cpuIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_job_desc_msg::getMemoryPerNode() const
{
    return m_Memory_per_node;
}

void V0_0_40_job_desc_msg::setMemoryPerNode(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Memory_per_node = value;
    m_Memory_per_nodeIsSet = true;
}

bool V0_0_40_job_desc_msg::memoryPerNodeIsSet() const
{
    return m_Memory_per_nodeIsSet;
}

void V0_0_40_job_desc_msg::unsetMemory_per_node()
{
    m_Memory_per_nodeIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getTemporaryDiskPerNode() const
{
    return m_Temporary_disk_per_node;
}

void V0_0_40_job_desc_msg::setTemporaryDiskPerNode(int32_t value)
{
    m_Temporary_disk_per_node = value;
    m_Temporary_disk_per_nodeIsSet = true;
}

bool V0_0_40_job_desc_msg::temporaryDiskPerNodeIsSet() const
{
    return m_Temporary_disk_per_nodeIsSet;
}

void V0_0_40_job_desc_msg::unsetTemporary_disk_per_node()
{
    m_Temporary_disk_per_nodeIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getSelinuxContext() const
{
    return m_Selinux_context;
}

void V0_0_40_job_desc_msg::setSelinuxContext(const utility::string_t& value)
{
    m_Selinux_context = value;
    m_Selinux_contextIsSet = true;
}

bool V0_0_40_job_desc_msg::selinuxContextIsSet() const
{
    return m_Selinux_contextIsSet;
}

void V0_0_40_job_desc_msg::unsetSelinux_context()
{
    m_Selinux_contextIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_job_desc_msg::getRequiredSwitches() const
{
    return m_Required_switches;
}

void V0_0_40_job_desc_msg::setRequiredSwitches(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Required_switches = value;
    m_Required_switchesIsSet = true;
}

bool V0_0_40_job_desc_msg::requiredSwitchesIsSet() const
{
    return m_Required_switchesIsSet;
}

void V0_0_40_job_desc_msg::unsetRequired_switches()
{
    m_Required_switchesIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getStandardError() const
{
    return m_Standard_error;
}

void V0_0_40_job_desc_msg::setStandardError(const utility::string_t& value)
{
    m_Standard_error = value;
    m_Standard_errorIsSet = true;
}

bool V0_0_40_job_desc_msg::standardErrorIsSet() const
{
    return m_Standard_errorIsSet;
}

void V0_0_40_job_desc_msg::unsetStandard_error()
{
    m_Standard_errorIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getStandardInput() const
{
    return m_Standard_input;
}

void V0_0_40_job_desc_msg::setStandardInput(const utility::string_t& value)
{
    m_Standard_input = value;
    m_Standard_inputIsSet = true;
}

bool V0_0_40_job_desc_msg::standardInputIsSet() const
{
    return m_Standard_inputIsSet;
}

void V0_0_40_job_desc_msg::unsetStandard_input()
{
    m_Standard_inputIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getStandardOutput() const
{
    return m_Standard_output;
}

void V0_0_40_job_desc_msg::setStandardOutput(const utility::string_t& value)
{
    m_Standard_output = value;
    m_Standard_outputIsSet = true;
}

bool V0_0_40_job_desc_msg::standardOutputIsSet() const
{
    return m_Standard_outputIsSet;
}

void V0_0_40_job_desc_msg::unsetStandard_output()
{
    m_Standard_outputIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getWaitForSwitch() const
{
    return m_Wait_for_switch;
}

void V0_0_40_job_desc_msg::setWaitForSwitch(int32_t value)
{
    m_Wait_for_switch = value;
    m_Wait_for_switchIsSet = true;
}

bool V0_0_40_job_desc_msg::waitForSwitchIsSet() const
{
    return m_Wait_for_switchIsSet;
}

void V0_0_40_job_desc_msg::unsetWait_for_switch()
{
    m_Wait_for_switchIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getWckey() const
{
    return m_Wckey;
}

void V0_0_40_job_desc_msg::setWckey(const utility::string_t& value)
{
    m_Wckey = value;
    m_WckeyIsSet = true;
}

bool V0_0_40_job_desc_msg::wckeyIsSet() const
{
    return m_WckeyIsSet;
}

void V0_0_40_job_desc_msg::unsetWckey()
{
    m_WckeyIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_job_desc_msg::getX11()
{
    return m_X11;
}

void V0_0_40_job_desc_msg::setX11(const std::vector<utility::string_t>& value)
{
    m_X11 = value;
    m_X11IsSet = true;
}

bool V0_0_40_job_desc_msg::x11IsSet() const
{
    return m_X11IsSet;
}

void V0_0_40_job_desc_msg::unsetX11()
{
    m_X11IsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getX11MagicCookie() const
{
    return m_X11_magic_cookie;
}

void V0_0_40_job_desc_msg::setX11MagicCookie(const utility::string_t& value)
{
    m_X11_magic_cookie = value;
    m_X11_magic_cookieIsSet = true;
}

bool V0_0_40_job_desc_msg::x11MagicCookieIsSet() const
{
    return m_X11_magic_cookieIsSet;
}

void V0_0_40_job_desc_msg::unsetX11_magic_cookie()
{
    m_X11_magic_cookieIsSet = false;
}
utility::string_t V0_0_40_job_desc_msg::getX11TargetHost() const
{
    return m_X11_target_host;
}

void V0_0_40_job_desc_msg::setX11TargetHost(const utility::string_t& value)
{
    m_X11_target_host = value;
    m_X11_target_hostIsSet = true;
}

bool V0_0_40_job_desc_msg::x11TargetHostIsSet() const
{
    return m_X11_target_hostIsSet;
}

void V0_0_40_job_desc_msg::unsetX11_target_host()
{
    m_X11_target_hostIsSet = false;
}
int32_t V0_0_40_job_desc_msg::getX11TargetPort() const
{
    return m_X11_target_port;
}

void V0_0_40_job_desc_msg::setX11TargetPort(int32_t value)
{
    m_X11_target_port = value;
    m_X11_target_portIsSet = true;
}

bool V0_0_40_job_desc_msg::x11TargetPortIsSet() const
{
    return m_X11_target_portIsSet;
}

void V0_0_40_job_desc_msg::unsetX11_target_port()
{
    m_X11_target_portIsSet = false;
}
}
