...
V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required()
{
    m_CPUs = 0;
    m_CPUsIsSet = false;
...
void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::toJson() const
{
...
bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::getCPUs() const
{
    return m_CPUs;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::setCPUs(int32_t value)
{
    m_CPUs = value;
    m_CPUsIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::cPUsIsSet() const
{
    return m_CPUsIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::unsetCPUs()
{
    m_CPUsIsSet = false;
}
std::shared_ptr<V0_0_41_job_desc_msg_memory_per_cpu> V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::getMemoryPerCpu() const
{
    return m_Memory_per_cpu;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::setMemoryPerCpu(const std::shared_ptr<V0_0_41_job_desc_msg_memory_per_cpu>& value)
{
    m_Memory_per_cpu = value;
    m_Memory_per_cpuIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::memoryPerCpuIsSet() const
{
    return m_Memory_per_cpuIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::unsetMemory_per_cpu()
{
    m_Memory_per_cpuIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_job_info_resp_jobs_inner_memory_per_node> V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::getMemoryPerNode() const
{
    return m_Memory_per_node;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::setMemoryPerNode(const std::shared_ptr<V0_0_41_openapi_job_info_resp_jobs_inner_memory_per_node>& value)
{
    m_Memory_per_node = value;
    m_Memory_per_nodeIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::memoryPerNodeIsSet() const
{
    return m_Memory_per_nodeIsSet;
}

void V0_0_41_openapi_slurmdbd_jobs_resp_jobs_inner_required::unsetMemory_per_node()
{
    m_Memory_per_nodeIsSet = false;
}
}
