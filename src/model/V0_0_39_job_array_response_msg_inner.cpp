...
V0_0_39_job_array_response_msg_inner::V0_0_39_job_array_response_msg_inner()
{
    m_Job_id = 0;
    m_Job_idIsSet = false;
    m_Error_code = 0;
...
void V0_0_39_job_array_response_msg_inner::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_job_array_response_msg_inner::toJson() const
{
...
bool V0_0_39_job_array_response_msg_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_39_job_array_response_msg_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_job_array_response_msg_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_39_job_array_response_msg_inner::getJobId() const
{
    return m_Job_id;
}

void V0_0_39_job_array_response_msg_inner::setJobId(int32_t value)
{
    m_Job_id = value;
    m_Job_idIsSet = true;
}

bool V0_0_39_job_array_response_msg_inner::jobIdIsSet() const
{
    return m_Job_idIsSet;
}

void V0_0_39_job_array_response_msg_inner::unsetJob_id()
{
    m_Job_idIsSet = false;
}
int32_t V0_0_39_job_array_response_msg_inner::getErrorCode() const
{
    return m_Error_code;
}

void V0_0_39_job_array_response_msg_inner::setErrorCode(int32_t value)
{
    m_Error_code = value;
    m_Error_codeIsSet = true;
}

bool V0_0_39_job_array_response_msg_inner::errorCodeIsSet() const
{
    return m_Error_codeIsSet;
}

void V0_0_39_job_array_response_msg_inner::unsetError_code()
{
    m_Error_codeIsSet = false;
}
utility::string_t V0_0_39_job_array_response_msg_inner::getError() const
{
    return m_Error;
}

void V0_0_39_job_array_response_msg_inner::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool V0_0_39_job_array_response_msg_inner::errorIsSet() const
{
    return m_ErrorIsSet;
}

void V0_0_39_job_array_response_msg_inner::unsetError()
{
    m_ErrorIsSet = false;
}
utility::string_t V0_0_39_job_array_response_msg_inner::getWhy() const
{
    return m_Why;
}

void V0_0_39_job_array_response_msg_inner::setWhy(const utility::string_t& value)
{
    m_Why = value;
    m_WhyIsSet = true;
}

bool V0_0_39_job_array_response_msg_inner::whyIsSet() const
{
    return m_WhyIsSet;
}

void V0_0_39_job_array_response_msg_inner::unsetWhy()
{
    m_WhyIsSet = false;
}
}
