...
V0_0_39_uint64_no_val::V0_0_39_uint64_no_val()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_39_uint64_no_val::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_uint64_no_val::toJson() const
{
...
bool V0_0_39_uint64_no_val::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_39_uint64_no_val::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_uint64_no_val::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_39_uint64_no_val::isSet() const
{
    return m_set;
}

void V0_0_39_uint64_no_val::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_39_uint64_no_val::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_39_uint64_no_val::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_39_uint64_no_val::isInfinite() const
{
    return m_Infinite;
}

void V0_0_39_uint64_no_val::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_39_uint64_no_val::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_39_uint64_no_val::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int64_t V0_0_39_uint64_no_val::getNumber() const
{
    return m_number;
}

void V0_0_39_uint64_no_val::setNumber(int64_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_39_uint64_no_val::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_39_uint64_no_val::unsetnumber()
{
    m_numberIsSet = false;
}
}
