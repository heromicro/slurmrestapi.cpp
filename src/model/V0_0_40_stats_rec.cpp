...
#include "slurmrestapi/model/V0_0_40_stats_rec.h"
...
V0_0_40_stats_rec::V0_0_40_stats_rec()
{
    m_Time_start = 0L;
...
void V0_0_40_stats_rec::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_stats_rec::toJson() const
{
...
bool V0_0_40_stats_rec::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("RPCs"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_40_stats_rpc>> refVal_setRPCs;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("users"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_40_stats_user>> refVal_setUsers;
...
void V0_0_40_stats_rec::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_stats_rec::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int64_t V0_0_40_stats_rec::getTimeStart() const
{
    return m_Time_start;
}

void V0_0_40_stats_rec::setTimeStart(int64_t value)
{
    m_Time_start = value;
    m_Time_startIsSet = true;
}

bool V0_0_40_stats_rec::timeStartIsSet() const
{
    return m_Time_startIsSet;
}

void V0_0_40_stats_rec::unsetTime_start()
{
    m_Time_startIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_rollup_stats_inner>>& V0_0_40_stats_rec::getRollups()
{
    return m_Rollups;
}

void V0_0_40_stats_rec::setRollups(const std::vector<std::shared_ptr<V0_0_40_rollup_stats_inner>>& value)
{
    m_Rollups = value;
    m_RollupsIsSet = true;
}

bool V0_0_40_stats_rec::rollupsIsSet() const
{
    return m_RollupsIsSet;
}

void V0_0_40_stats_rec::unsetRollups()
{
    m_RollupsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_stats_rpc>>& V0_0_40_stats_rec::getRPCs()
{
    return m_RPCs;
}

void V0_0_40_stats_rec::setRPCs(const std::vector<std::shared_ptr<V0_0_40_stats_rpc>>& value)
{
    m_RPCs = value;
    m_RPCsIsSet = true;
}

bool V0_0_40_stats_rec::rPCsIsSet() const
{
    return m_RPCsIsSet;
}

void V0_0_40_stats_rec::unsetRPCs()
{
    m_RPCsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_stats_user>>& V0_0_40_stats_rec::getUsers()
{
    return m_Users;
}

void V0_0_40_stats_rec::setUsers(const std::vector<std::shared_ptr<V0_0_40_stats_user>>& value)
{
    m_Users = value;
    m_UsersIsSet = true;
}

bool V0_0_40_stats_rec::usersIsSet() const
{
    return m_UsersIsSet;
}

void V0_0_40_stats_rec::unsetUsers()
{
    m_UsersIsSet = false;
}
}
