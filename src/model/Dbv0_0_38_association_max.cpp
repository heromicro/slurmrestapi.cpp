...
Dbv0_0_38_association_max::Dbv0_0_38_association_max()
{
    m_JobsIsSet = false;
    m_PerIsSet = false;
    m_TresIsSet = false;
...
void Dbv0_0_38_association_max::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_association_max::toJson() const
{
...
bool Dbv0_0_38_association_max::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("jobs"))))
    {
        ...
        {
            std::shared_ptr<Dbv0_0_38_association_max_jobs> refVal_setJobs;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("per"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_association_max_per> refVal_setPer;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tres"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_association_max_tres> refVal_setTres;
...
void Dbv0_0_38_association_max::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_association_max::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_38_association_max_jobs> Dbv0_0_38_association_max::getJobs() const
{
    return m_Jobs;
}

void Dbv0_0_38_association_max::setJobs(const std::shared_ptr<Dbv0_0_38_association_max_jobs>& value)
{
    m_Jobs = value;
    m_JobsIsSet = true;
}

bool Dbv0_0_38_association_max::jobsIsSet() const
{
    return m_JobsIsSet;
}

void Dbv0_0_38_association_max::unsetJobs()
{
    m_JobsIsSet = false;
}
std::shared_ptr<Dbv0_0_38_association_max_per> Dbv0_0_38_association_max::getPer() const
{
    return m_Per;
}

void Dbv0_0_38_association_max::setPer(const std::shared_ptr<Dbv0_0_38_association_max_per>& value)
{
    m_Per = value;
    m_PerIsSet = true;
}

bool Dbv0_0_38_association_max::perIsSet() const
{
    return m_PerIsSet;
}

void Dbv0_0_38_association_max::unsetPer()
{
    m_PerIsSet = false;
}
std::shared_ptr<Dbv0_0_38_association_max_tres> Dbv0_0_38_association_max::getTres() const
{
    return m_Tres;
}

void Dbv0_0_38_association_max::setTres(const std::shared_ptr<Dbv0_0_38_association_max_tres>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool Dbv0_0_38_association_max::tresIsSet() const
{
    return m_TresIsSet;
}

void Dbv0_0_38_association_max::unsetTres()
{
    m_TresIsSet = false;
}
}
