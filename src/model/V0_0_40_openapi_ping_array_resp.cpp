...
V0_0_40_openapi_ping_array_resp::V0_0_40_openapi_ping_array_resp()
{
    m_PingsIsSet = false;
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
...
void V0_0_40_openapi_ping_array_resp::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_openapi_ping_array_resp::toJson() const
{
...
bool V0_0_40_openapi_ping_array_resp::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("pings"))))
    {
        ...
        {
            std::vector<std::shared_ptr<V0_0_40_controller_ping>> refVal_setPings;
...
void V0_0_40_openapi_ping_array_resp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_openapi_ping_array_resp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_40_controller_ping>>& V0_0_40_openapi_ping_array_resp::getPings()
{
    return m_Pings;
}

void V0_0_40_openapi_ping_array_resp::setPings(const std::vector<std::shared_ptr<V0_0_40_controller_ping>>& value)
{
    m_Pings = value;
    m_PingsIsSet = true;
}

bool V0_0_40_openapi_ping_array_resp::pingsIsSet() const
{
    return m_PingsIsSet;
}

void V0_0_40_openapi_ping_array_resp::unsetPings()
{
    m_PingsIsSet = false;
}
std::shared_ptr<V0_0_40_openapi_meta> V0_0_40_openapi_ping_array_resp::getMeta() const
{
    return m_Meta;
}

void V0_0_40_openapi_ping_array_resp::setMeta(const std::shared_ptr<V0_0_40_openapi_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_40_openapi_ping_array_resp::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_40_openapi_ping_array_resp::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_openapi_error>>& V0_0_40_openapi_ping_array_resp::getErrors()
{
    return m_Errors;
}

void V0_0_40_openapi_ping_array_resp::setErrors(const std::vector<std::shared_ptr<V0_0_40_openapi_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_40_openapi_ping_array_resp::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_40_openapi_ping_array_resp::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_openapi_warning>>& V0_0_40_openapi_ping_array_resp::getWarnings()
{
    return m_Warnings;
}

void V0_0_40_openapi_ping_array_resp::setWarnings(const std::vector<std::shared_ptr<V0_0_40_openapi_warning>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool V0_0_40_openapi_ping_array_resp::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void V0_0_40_openapi_ping_array_resp::unsetWarnings()
{
    m_WarningsIsSet = false;
}
}
