...
V0_0_41_openapi_reservation_resp_reservations_inner_watts::V0_0_41_openapi_reservation_resp_reservations_inner_watts()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_reservation_resp_reservations_inner_watts::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_reservation_resp_reservations_inner_watts::toJson() const
{
...
bool V0_0_41_openapi_reservation_resp_reservations_inner_watts::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_reservation_resp_reservations_inner_watts::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_reservation_resp_reservations_inner_watts::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_reservation_resp_reservations_inner_watts::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_reservation_resp_reservations_inner_watts::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_reservation_resp_reservations_inner_watts::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_reservation_resp_reservations_inner_watts::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_reservation_resp_reservations_inner_watts::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_reservation_resp_reservations_inner_watts::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_reservation_resp_reservations_inner_watts::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_reservation_resp_reservations_inner_watts::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int32_t V0_0_41_openapi_reservation_resp_reservations_inner_watts::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_reservation_resp_reservations_inner_watts::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_reservation_resp_reservations_inner_watts::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_reservation_resp_reservations_inner_watts::unsetnumber()
{
    m_numberIsSet = false;
}
}
