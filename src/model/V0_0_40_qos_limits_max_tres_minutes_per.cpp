...
V0_0_40_qos_limits_max_tres_minutes_per::V0_0_40_qos_limits_max_tres_minutes_per()
{
    m_QosIsSet = false;
    m_JobIsSet = false;
...
void V0_0_40_qos_limits_max_tres_minutes_per::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_qos_limits_max_tres_minutes_per::toJson() const
{
...
bool V0_0_40_qos_limits_max_tres_minutes_per::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("qos"))))
    {
        ...
        {
            std::vector<std::shared_ptr<V0_0_40_tres>> refVal_setQos;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("account"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_40_tres>> refVal_setAccount;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("user"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_40_tres>> refVal_setUser;
...
void V0_0_40_qos_limits_max_tres_minutes_per::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_qos_limits_max_tres_minutes_per::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_qos_limits_max_tres_minutes_per::getQos()
{
    return m_Qos;
}

void V0_0_40_qos_limits_max_tres_minutes_per::setQos(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Qos = value;
    m_QosIsSet = true;
}

bool V0_0_40_qos_limits_max_tres_minutes_per::qosIsSet() const
{
    return m_QosIsSet;
}

void V0_0_40_qos_limits_max_tres_minutes_per::unsetQos()
{
    m_QosIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_qos_limits_max_tres_minutes_per::getJob()
{
    return m_Job;
}

void V0_0_40_qos_limits_max_tres_minutes_per::setJob(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Job = value;
    m_JobIsSet = true;
}

bool V0_0_40_qos_limits_max_tres_minutes_per::jobIsSet() const
{
    return m_JobIsSet;
}

void V0_0_40_qos_limits_max_tres_minutes_per::unsetJob()
{
    m_JobIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_qos_limits_max_tres_minutes_per::getAccount()
{
    return m_Account;
}

void V0_0_40_qos_limits_max_tres_minutes_per::setAccount(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool V0_0_40_qos_limits_max_tres_minutes_per::accountIsSet() const
{
    return m_AccountIsSet;
}

void V0_0_40_qos_limits_max_tres_minutes_per::unsetAccount()
{
    m_AccountIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_qos_limits_max_tres_minutes_per::getUser()
{
    return m_User;
}

void V0_0_40_qos_limits_max_tres_minutes_per::setUser(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool V0_0_40_qos_limits_max_tres_minutes_per::userIsSet() const
{
    return m_UserIsSet;
}

void V0_0_40_qos_limits_max_tres_minutes_per::unsetUser()
{
    m_UserIsSet = false;
}
}
