...
bool V0_0_39_job_array::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("limits"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_job_array_limits> refVal_setLimits;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("task_id"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_uint32_no_val> refVal_setTaskId;
...
int32_t V0_0_39_job_array::getJobId() const
{
    return m_Job_id;
}

void V0_0_39_job_array::setJobId(int32_t value)
{
    m_Job_id = value;
    m_Job_idIsSet = true;
}

bool V0_0_39_job_array::jobIdIsSet() const
{
    return m_Job_idIsSet;
}

void V0_0_39_job_array::unsetJob_id()
{
    m_Job_idIsSet = false;
}
std::shared_ptr<V0_0_39_job_array_limits> V0_0_39_job_array::getLimits() const
{
    return m_Limits;
}

void V0_0_39_job_array::setLimits(const std::shared_ptr<V0_0_39_job_array_limits>& value)
{
    m_Limits = value;
    m_LimitsIsSet = true;
}

bool V0_0_39_job_array::limitsIsSet() const
{
    return m_LimitsIsSet;
}

void V0_0_39_job_array::unsetLimits()
{
    m_LimitsIsSet = false;
}
std::shared_ptr<V0_0_39_uint32_no_val> V0_0_39_job_array::getTaskId() const
{
    return m_Task_id;
}

void V0_0_39_job_array::setTaskId(const std::shared_ptr<V0_0_39_uint32_no_val>& value)
{
    m_Task_id = value;
    m_Task_idIsSet = true;
}

bool V0_0_39_job_array::taskIdIsSet() const
{
    return m_Task_idIsSet;
}

void V0_0_39_job_array::unsetTask_id()
{
    m_Task_idIsSet = false;
}
