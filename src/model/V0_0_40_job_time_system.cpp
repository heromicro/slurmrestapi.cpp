...
V0_0_40_job_time_system::V0_0_40_job_time_system()
{
    m_Seconds = 0L;
...
void V0_0_40_job_time_system::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_job_time_system::toJson() const
{
...
bool V0_0_40_job_time_system::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_job_time_system::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_job_time_system::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int64_t V0_0_40_job_time_system::getSeconds() const
{
    return m_Seconds;
}

void V0_0_40_job_time_system::setSeconds(int64_t value)
{
    m_Seconds = value;
    m_SecondsIsSet = true;
}

bool V0_0_40_job_time_system::secondsIsSet() const
{
    return m_SecondsIsSet;
}

void V0_0_40_job_time_system::unsetSeconds()
{
    m_SecondsIsSet = false;
}
int64_t V0_0_40_job_time_system::getMicroseconds() const
{
    return m_Microseconds;
}

void V0_0_40_job_time_system::setMicroseconds(int64_t value)
{
    m_Microseconds = value;
    m_MicrosecondsIsSet = true;
}

bool V0_0_40_job_time_system::microsecondsIsSet() const
{
    return m_MicrosecondsIsSet;
}

void V0_0_40_job_time_system::unsetMicroseconds()
{
    m_MicrosecondsIsSet = false;
}
}
