...
#include "slurmrestapi/model/V0_0_39_meta_Slurm.h"
...
V0_0_39_meta_Slurm::V0_0_39_meta_Slurm()
{
...
void V0_0_39_meta_Slurm::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_meta_Slurm::toJson() const
{
...
bool V0_0_39_meta_Slurm::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("version"))))
    {
        ...
        {
            std::shared_ptr<V0_0_39_meta_Slurm_version> refVal_setVersion;
...
void V0_0_39_meta_Slurm::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_meta_Slurm::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_39_meta_Slurm_version> V0_0_39_meta_Slurm::getVersion() const
{
    return m_Version;
}

void V0_0_39_meta_Slurm::setVersion(const std::shared_ptr<V0_0_39_meta_Slurm_version>& value)
{
    m_Version = value;
    m_VersionIsSet = true;
}

bool V0_0_39_meta_Slurm::versionIsSet() const
{
    return m_VersionIsSet;
}

void V0_0_39_meta_Slurm::unsetVersion()
{
    m_VersionIsSet = false;
}
utility::string_t V0_0_39_meta_Slurm::getRelease() const
{
    return m_Release;
}

void V0_0_39_meta_Slurm::setRelease(const utility::string_t& value)
{
    m_Release = value;
    m_ReleaseIsSet = true;
}

bool V0_0_39_meta_Slurm::releaseIsSet() const
{
    return m_ReleaseIsSet;
}

void V0_0_39_meta_Slurm::unsetRelease()
{
    m_ReleaseIsSet = false;
}
}
