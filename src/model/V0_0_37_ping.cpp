...
#include "slurmrestapi/model/V0_0_37_ping.h"
...
void V0_0_37_ping::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_37_ping::toJson() const
{
...
bool V0_0_37_ping::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_37_ping::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_37_ping::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_37_ping::getHostname() const
{
    return m_Hostname;
}

void V0_0_37_ping::setHostname(const utility::string_t& value)
{
    m_Hostname = value;
    m_HostnameIsSet = true;
}

bool V0_0_37_ping::hostnameIsSet() const
{
    return m_HostnameIsSet;
}

void V0_0_37_ping::unsetHostname()
{
    m_HostnameIsSet = false;
}
utility::string_t V0_0_37_ping::getPing() const
{
    return m_Ping;
}

void V0_0_37_ping::setPing(const utility::string_t& value)
{
    m_Ping = value;
    m_PingIsSet = true;
}

bool V0_0_37_ping::pingIsSet() const
{
    return m_PingIsSet;
}

void V0_0_37_ping::unsetPing()
{
    m_PingIsSet = false;
}
utility::string_t V0_0_37_ping::getMode() const
{
    return m_Mode;
}

void V0_0_37_ping::setMode(const utility::string_t& value)
{
    m_Mode = value;
    m_ModeIsSet = true;
}

bool V0_0_37_ping::modeIsSet() const
{
    return m_ModeIsSet;
}

void V0_0_37_ping::unsetMode()
{
    m_ModeIsSet = false;
}
int32_t V0_0_37_ping::getStatus() const
{
    return m_Status;
}

void V0_0_37_ping::setStatus(int32_t value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool V0_0_37_ping::statusIsSet() const
{
    return m_StatusIsSet;
}

void V0_0_37_ping::unsetStatus()
{
    m_StatusIsSet = false;
}
}
