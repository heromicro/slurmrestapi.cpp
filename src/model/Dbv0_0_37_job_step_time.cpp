...
Dbv0_0_37_job_step_time::Dbv0_0_37_job_step_time()
{
    m_Elapsed = 0;
...
void Dbv0_0_37_job_step_time::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_job_step_time::toJson() const
{
...
bool Dbv0_0_37_job_step_time::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_37_job_step_time::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_job_step_time::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t Dbv0_0_37_job_step_time::getElapsed() const
{
    return m_Elapsed;
}

void Dbv0_0_37_job_step_time::setElapsed(int32_t value)
{
    m_Elapsed = value;
    m_ElapsedIsSet = true;
}

bool Dbv0_0_37_job_step_time::elapsedIsSet() const
{
    return m_ElapsedIsSet;
}

void Dbv0_0_37_job_step_time::unsetElapsed()
{
    m_ElapsedIsSet = false;
}
int32_t Dbv0_0_37_job_step_time::getEnd() const
{
    return m_End;
}

void Dbv0_0_37_job_step_time::setEnd(int32_t value)
{
    m_End = value;
    m_EndIsSet = true;
}

bool Dbv0_0_37_job_step_time::endIsSet() const
{
    return m_EndIsSet;
}

void Dbv0_0_37_job_step_time::unsetEnd()
{
    m_EndIsSet = false;
}
int32_t Dbv0_0_37_job_step_time::getStart() const
{
    return m_Start;
}

void Dbv0_0_37_job_step_time::setStart(int32_t value)
{
    m_Start = value;
    m_StartIsSet = true;
}

bool Dbv0_0_37_job_step_time::startIsSet() const
{
    return m_StartIsSet;
}

void Dbv0_0_37_job_step_time::unsetStart()
{
    m_StartIsSet = false;
}
int32_t Dbv0_0_37_job_step_time::getSuspended() const
{
    return m_Suspended;
}

void Dbv0_0_37_job_step_time::setSuspended(int32_t value)
{
    m_Suspended = value;
    m_SuspendedIsSet = true;
}

bool Dbv0_0_37_job_step_time::suspendedIsSet() const
{
    return m_SuspendedIsSet;
}

void Dbv0_0_37_job_step_time::unsetSuspended()
{
    m_SuspendedIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_time_system> Dbv0_0_37_job_step_time::getSystem() const
{
    return m_System;
}

void Dbv0_0_37_job_step_time::setSystem(const std::shared_ptr<Dbv0_0_37_job_time_system>& value)
{
    m_System = value;
    m_SystemIsSet = true;
}

bool Dbv0_0_37_job_step_time::systemIsSet() const
{
    return m_SystemIsSet;
}

void Dbv0_0_37_job_step_time::unsetSystem()
{
    m_SystemIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_time_total> Dbv0_0_37_job_step_time::getTotal() const
{
    return m_Total;
}

void Dbv0_0_37_job_step_time::setTotal(const std::shared_ptr<Dbv0_0_37_job_time_total>& value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool Dbv0_0_37_job_step_time::totalIsSet() const
{
    return m_TotalIsSet;
}

void Dbv0_0_37_job_step_time::unsetTotal()
{
    m_TotalIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_time_user> Dbv0_0_37_job_step_time::getUser() const
{
    return m_User;
}

void Dbv0_0_37_job_step_time::setUser(const std::shared_ptr<Dbv0_0_37_job_time_user>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Dbv0_0_37_job_step_time::userIsSet() const
{
    return m_UserIsSet;
}

void Dbv0_0_37_job_step_time::unsetUser()
{
    m_UserIsSet = false;
}
}
