...
V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::V0_0_41_openapi_nodes_resp_nodes_inner_resume_after()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::toJson() const
{
...
bool V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int64_t V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::setNumber(int64_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_nodes_resp_nodes_inner_resume_after::unsetnumber()
{
    m_numberIsSet = false;
}
}
