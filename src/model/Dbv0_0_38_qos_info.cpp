...
Dbv0_0_38_qos_info::Dbv0_0_38_qos_info()
{
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
    m_QosIsSet = false;
...
void Dbv0_0_38_qos_info::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_qos_info::toJson() const
{
...
bool Dbv0_0_38_qos_info::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_38_qos_info::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_qos_info::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_38_meta> Dbv0_0_38_qos_info::getMeta() const
{
    return m_Meta;
}

void Dbv0_0_38_qos_info::setMeta(const std::shared_ptr<Dbv0_0_38_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool Dbv0_0_38_qos_info::metaIsSet() const
{
    return m_MetaIsSet;
}

void Dbv0_0_38_qos_info::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_error>>& Dbv0_0_38_qos_info::getErrors()
{
    return m_Errors;
}

void Dbv0_0_38_qos_info::setErrors(const std::vector<std::shared_ptr<Dbv0_0_38_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool Dbv0_0_38_qos_info::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void Dbv0_0_38_qos_info::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_qos>>& Dbv0_0_38_qos_info::getQos()
{
    return m_Qos;
}

void Dbv0_0_38_qos_info::setQos(const std::vector<std::shared_ptr<Dbv0_0_38_qos>>& value)
{
    m_Qos = value;
    m_QosIsSet = true;
}

bool Dbv0_0_38_qos_info::qosIsSet() const
{
    return m_QosIsSet;
}

void Dbv0_0_38_qos_info::unsetQos()
{
    m_QosIsSet = false;
}
}
