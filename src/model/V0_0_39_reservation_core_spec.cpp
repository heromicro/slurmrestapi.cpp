...
V0_0_39_reservation_core_spec::V0_0_39_reservation_core_spec()
{
...
void V0_0_39_reservation_core_spec::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_reservation_core_spec::toJson() const
{
...
bool V0_0_39_reservation_core_spec::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_39_reservation_core_spec::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_reservation_core_spec::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_39_reservation_core_spec::getNode() const
{
    return m_Node;
}

void V0_0_39_reservation_core_spec::setNode(const utility::string_t& value)
{
    m_Node = value;
    m_NodeIsSet = true;
}

bool V0_0_39_reservation_core_spec::nodeIsSet() const
{
    return m_NodeIsSet;
}

void V0_0_39_reservation_core_spec::unsetNode()
{
    m_NodeIsSet = false;
}
utility::string_t V0_0_39_reservation_core_spec::getCore() const
{
    return m_Core;
}

void V0_0_39_reservation_core_spec::setCore(const utility::string_t& value)
{
    m_Core = value;
    m_CoreIsSet = true;
}

bool V0_0_39_reservation_core_spec::coreIsSet() const
{
    return m_CoreIsSet;
}

void V0_0_39_reservation_core_spec::unsetCore()
{
    m_CoreIsSet = false;
}
}
