...
V0_0_40_assoc_max_jobs_per::V0_0_40_assoc_max_jobs_per()
{
    m_CountIsSet = false;
...
void V0_0_40_assoc_max_jobs_per::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_assoc_max_jobs_per::toJson() const
{
...
bool V0_0_40_assoc_max_jobs_per::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("submitted"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint32_no_val> refVal_setSubmitted;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("wall_clock"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_40_uint32_no_val> refVal_setWallClock;
...
void V0_0_40_assoc_max_jobs_per::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_assoc_max_jobs_per::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_assoc_max_jobs_per::getCount() const
{
    return m_Count;
}

void V0_0_40_assoc_max_jobs_per::setCount(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool V0_0_40_assoc_max_jobs_per::countIsSet() const
{
    return m_CountIsSet;
}

void V0_0_40_assoc_max_jobs_per::unsetCount()
{
    m_CountIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_assoc_max_jobs_per::getAccruing() const
{
    return m_Accruing;
}

void V0_0_40_assoc_max_jobs_per::setAccruing(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Accruing = value;
    m_AccruingIsSet = true;
}

bool V0_0_40_assoc_max_jobs_per::accruingIsSet() const
{
    return m_AccruingIsSet;
}

void V0_0_40_assoc_max_jobs_per::unsetAccruing()
{
    m_AccruingIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_assoc_max_jobs_per::getSubmitted() const
{
    return m_Submitted;
}

void V0_0_40_assoc_max_jobs_per::setSubmitted(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Submitted = value;
    m_SubmittedIsSet = true;
}

bool V0_0_40_assoc_max_jobs_per::submittedIsSet() const
{
    return m_SubmittedIsSet;
}

void V0_0_40_assoc_max_jobs_per::unsetSubmitted()
{
    m_SubmittedIsSet = false;
}
std::shared_ptr<V0_0_40_uint32_no_val> V0_0_40_assoc_max_jobs_per::getWallClock() const
{
    return m_Wall_clock;
}

void V0_0_40_assoc_max_jobs_per::setWallClock(const std::shared_ptr<V0_0_40_uint32_no_val>& value)
{
    m_Wall_clock = value;
    m_Wall_clockIsSet = true;
}

bool V0_0_40_assoc_max_jobs_per::wallClockIsSet() const
{
    return m_Wall_clockIsSet;
}

void V0_0_40_assoc_max_jobs_per::unsetWall_clock()
{
    m_Wall_clockIsSet = false;
}
}
