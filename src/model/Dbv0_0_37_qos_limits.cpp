...
#include "slurmrestapi/model/Dbv0_0_37_qos_limits.h"
...
Dbv0_0_37_qos_limits::Dbv0_0_37_qos_limits()
{
    m_Factor = 0.0;
    m_FactorIsSet = false;
    m_MaxIsSet = false;
...
void Dbv0_0_37_qos_limits::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_qos_limits::toJson() const
{
...
bool Dbv0_0_37_qos_limits::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("max"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_qos_limits_max> refVal_setMax;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("min"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_qos_limits_min> refVal_setMin;
...
void Dbv0_0_37_qos_limits::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_qos_limits::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
double Dbv0_0_37_qos_limits::getFactor() const
{
    return m_Factor;
}

void Dbv0_0_37_qos_limits::setFactor(double value)
{
    m_Factor = value;
    m_FactorIsSet = true;
}

bool Dbv0_0_37_qos_limits::factorIsSet() const
{
    return m_FactorIsSet;
}

void Dbv0_0_37_qos_limits::unsetFactor()
{
    m_FactorIsSet = false;
}
std::shared_ptr<Dbv0_0_37_qos_limits_max> Dbv0_0_37_qos_limits::getMax() const
{
    return m_Max;
}

void Dbv0_0_37_qos_limits::setMax(const std::shared_ptr<Dbv0_0_37_qos_limits_max>& value)
{
    m_Max = value;
    m_MaxIsSet = true;
}

bool Dbv0_0_37_qos_limits::maxIsSet() const
{
    return m_MaxIsSet;
}

void Dbv0_0_37_qos_limits::unsetMax()
{
    m_MaxIsSet = false;
}
std::shared_ptr<Dbv0_0_37_qos_limits_min> Dbv0_0_37_qos_limits::getMin() const
{
    return m_Min;
}

void Dbv0_0_37_qos_limits::setMin(const std::shared_ptr<Dbv0_0_37_qos_limits_min>& value)
{
    m_Min = value;
    m_MinIsSet = true;
}

bool Dbv0_0_37_qos_limits::minIsSet() const
{
    return m_MinIsSet;
}

void Dbv0_0_37_qos_limits::unsetMin()
{
    m_MinIsSet = false;
}
}
