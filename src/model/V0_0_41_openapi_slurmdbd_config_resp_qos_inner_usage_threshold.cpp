...
V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::toJson() const
{
...
bool V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
double V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::setNumber(double value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_slurmdbd_config_resp_qos_inner_usage_threshold::unsetnumber()
{
    m_numberIsSet = false;
}
}
