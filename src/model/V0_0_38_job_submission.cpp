...
V0_0_38_job_submission::V0_0_38_job_submission()
{
...
void V0_0_38_job_submission::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_38_job_submission::toJson() const
{
...
bool V0_0_38_job_submission::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("job"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_38_job_properties> refVal_setJob;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("jobs"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_38_job_properties>> refVal_setJobs;
...
void V0_0_38_job_submission::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_38_job_submission::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_38_job_submission::getScript() const
{
    return m_Script;
}

void V0_0_38_job_submission::setScript(const utility::string_t& value)
{
    m_Script = value;
    m_ScriptIsSet = true;
}

bool V0_0_38_job_submission::scriptIsSet() const
{
    return m_ScriptIsSet;
}

void V0_0_38_job_submission::unsetScript()
{
    m_ScriptIsSet = false;
}
std::shared_ptr<V0_0_38_job_properties> V0_0_38_job_submission::getJob() const
{
    return m_Job;
}

void V0_0_38_job_submission::setJob(const std::shared_ptr<V0_0_38_job_properties>& value)
{
    m_Job = value;
    m_JobIsSet = true;
}

bool V0_0_38_job_submission::jobIsSet() const
{
    return m_JobIsSet;
}

void V0_0_38_job_submission::unsetJob()
{
    m_JobIsSet = false;
}
std::vector<std::shared_ptr<V0_0_38_job_properties>>& V0_0_38_job_submission::getJobs()
{
    return m_Jobs;
}

void V0_0_38_job_submission::setJobs(const std::vector<std::shared_ptr<V0_0_38_job_properties>>& value)
{
    m_Jobs = value;
    m_JobsIsSet = true;
}

bool V0_0_38_job_submission::jobsIsSet() const
{
    return m_JobsIsSet;
}

void V0_0_38_job_submission::unsetJobs()
{
    m_JobsIsSet = false;
}
}
