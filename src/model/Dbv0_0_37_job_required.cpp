...
Dbv0_0_37_job_required::Dbv0_0_37_job_required()
{
    m_CPUs = 0;
    m_CPUsIsSet = false;
    m_Memory = 0;
...
void Dbv0_0_37_job_required::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_job_required::toJson() const
{
...
bool Dbv0_0_37_job_required::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_37_job_required::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_job_required::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t Dbv0_0_37_job_required::getCPUs() const
{
    return m_CPUs;
}

void Dbv0_0_37_job_required::setCPUs(int32_t value)
{
    m_CPUs = value;
    m_CPUsIsSet = true;
}

bool Dbv0_0_37_job_required::cPUsIsSet() const
{
    return m_CPUsIsSet;
}

void Dbv0_0_37_job_required::unsetCPUs()
{
    m_CPUsIsSet = false;
}
int32_t Dbv0_0_37_job_required::getMemory() const
{
    return m_Memory;
}

void Dbv0_0_37_job_required::setMemory(int32_t value)
{
    m_Memory = value;
    m_MemoryIsSet = true;
}

bool Dbv0_0_37_job_required::memoryIsSet() const
{
    return m_MemoryIsSet;
}

void Dbv0_0_37_job_required::unsetMemory()
{
    m_MemoryIsSet = false;
}
}
