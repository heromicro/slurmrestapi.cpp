...
V0_0_40_openapi_shares_resp::V0_0_40_openapi_shares_resp()
{
    m_SharesIsSet = false;
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
...
void V0_0_40_openapi_shares_resp::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_openapi_shares_resp::toJson() const
{
...
bool V0_0_40_openapi_shares_resp::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("shares"))))
    {
        ...
        {
            std::shared_ptr<V0_0_40_shares_resp_msg> refVal_setShares;
...
void V0_0_40_openapi_shares_resp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_openapi_shares_resp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_40_shares_resp_msg> V0_0_40_openapi_shares_resp::getShares() const
{
    return m_Shares;
}

void V0_0_40_openapi_shares_resp::setShares(const std::shared_ptr<V0_0_40_shares_resp_msg>& value)
{
    m_Shares = value;
    m_SharesIsSet = true;
}

bool V0_0_40_openapi_shares_resp::sharesIsSet() const
{
    return m_SharesIsSet;
}

void V0_0_40_openapi_shares_resp::unsetShares()
{
    m_SharesIsSet = false;
}
std::shared_ptr<V0_0_40_openapi_meta> V0_0_40_openapi_shares_resp::getMeta() const
{
    return m_Meta;
}

void V0_0_40_openapi_shares_resp::setMeta(const std::shared_ptr<V0_0_40_openapi_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_40_openapi_shares_resp::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_40_openapi_shares_resp::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_openapi_error>>& V0_0_40_openapi_shares_resp::getErrors()
{
    return m_Errors;
}

void V0_0_40_openapi_shares_resp::setErrors(const std::vector<std::shared_ptr<V0_0_40_openapi_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_40_openapi_shares_resp::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_40_openapi_shares_resp::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_openapi_warning>>& V0_0_40_openapi_shares_resp::getWarnings()
{
    return m_Warnings;
}

void V0_0_40_openapi_shares_resp::setWarnings(const std::vector<std::shared_ptr<V0_0_40_openapi_warning>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool V0_0_40_openapi_shares_resp::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void V0_0_40_openapi_shares_resp::unsetWarnings()
{
    m_WarningsIsSet = false;
}
}
