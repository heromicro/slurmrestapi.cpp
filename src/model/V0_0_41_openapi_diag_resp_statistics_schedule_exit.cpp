...
V0_0_41_openapi_diag_resp_statistics_schedule_exit::V0_0_41_openapi_diag_resp_statistics_schedule_exit()
{
    m_End_job_queue = 0;
...
void V0_0_41_openapi_diag_resp_statistics_schedule_exit::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_diag_resp_statistics_schedule_exit::toJson() const
{
...
bool V0_0_41_openapi_diag_resp_statistics_schedule_exit::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_diag_resp_statistics_schedule_exit::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_diag_resp_statistics_schedule_exit::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_41_openapi_diag_resp_statistics_schedule_exit::getEndJobQueue() const
{
    return m_End_job_queue;
}

void V0_0_41_openapi_diag_resp_statistics_schedule_exit::setEndJobQueue(int32_t value)
{
    m_End_job_queue = value;
    m_End_job_queueIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_schedule_exit::endJobQueueIsSet() const
{
    return m_End_job_queueIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_schedule_exit::unsetEnd_job_queue()
{
    m_End_job_queueIsSet = false;
}
int32_t V0_0_41_openapi_diag_resp_statistics_schedule_exit::getDefaultQueueDepth() const
{
    return m_Default_queue_depth;
}

void V0_0_41_openapi_diag_resp_statistics_schedule_exit::setDefaultQueueDepth(int32_t value)
{
    m_Default_queue_depth = value;
    m_Default_queue_depthIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_schedule_exit::defaultQueueDepthIsSet() const
{
    return m_Default_queue_depthIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_schedule_exit::unsetDefault_queue_depth()
{
    m_Default_queue_depthIsSet = false;
}
int32_t V0_0_41_openapi_diag_resp_statistics_schedule_exit::getMaxJobStart() const
{
    return m_Max_job_start;
}

void V0_0_41_openapi_diag_resp_statistics_schedule_exit::setMaxJobStart(int32_t value)
{
    m_Max_job_start = value;
    m_Max_job_startIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_schedule_exit::maxJobStartIsSet() const
{
    return m_Max_job_startIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_schedule_exit::unsetMax_job_start()
{
    m_Max_job_startIsSet = false;
}
int32_t V0_0_41_openapi_diag_resp_statistics_schedule_exit::getMaxRpcCnt() const
{
    return m_Max_rpc_cnt;
}

void V0_0_41_openapi_diag_resp_statistics_schedule_exit::setMaxRpcCnt(int32_t value)
{
    m_Max_rpc_cnt = value;
    m_Max_rpc_cntIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_schedule_exit::maxRpcCntIsSet() const
{
    return m_Max_rpc_cntIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_schedule_exit::unsetMax_rpc_cnt()
{
    m_Max_rpc_cntIsSet = false;
}
int32_t V0_0_41_openapi_diag_resp_statistics_schedule_exit::getMaxSchedTime() const
{
    return m_Max_sched_time;
}

void V0_0_41_openapi_diag_resp_statistics_schedule_exit::setMaxSchedTime(int32_t value)
{
    m_Max_sched_time = value;
    m_Max_sched_timeIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_schedule_exit::maxSchedTimeIsSet() const
{
    return m_Max_sched_timeIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_schedule_exit::unsetMax_sched_time()
{
    m_Max_sched_timeIsSet = false;
}
int32_t V0_0_41_openapi_diag_resp_statistics_schedule_exit::getLicenses() const
{
    return m_Licenses;
}

void V0_0_41_openapi_diag_resp_statistics_schedule_exit::setLicenses(int32_t value)
{
    m_Licenses = value;
    m_LicensesIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_schedule_exit::licensesIsSet() const
{
    return m_LicensesIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_schedule_exit::unsetLicenses()
{
    m_LicensesIsSet = false;
}
}
