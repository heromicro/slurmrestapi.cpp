...
Dbv0_0_38_error::Dbv0_0_38_error()
{
    m_Error_number = 0;
...
void Dbv0_0_38_error::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_error::toJson() const
{
...
bool Dbv0_0_38_error::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_38_error::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_error::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t Dbv0_0_38_error::getErrorNumber() const
{
    return m_Error_number;
}

void Dbv0_0_38_error::setErrorNumber(int32_t value)
{
    m_Error_number = value;
    m_Error_numberIsSet = true;
}

bool Dbv0_0_38_error::errorNumberIsSet() const
{
    return m_Error_numberIsSet;
}

void Dbv0_0_38_error::unsetError_number()
{
    m_Error_numberIsSet = false;
}
utility::string_t Dbv0_0_38_error::getError() const
{
    return m_Error;
}

void Dbv0_0_38_error::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool Dbv0_0_38_error::errorIsSet() const
{
    return m_ErrorIsSet;
}

void Dbv0_0_38_error::unsetError()
{
    m_ErrorIsSet = false;
}
utility::string_t Dbv0_0_38_error::getSource() const
{
    return m_Source;
}

void Dbv0_0_38_error::setSource(const utility::string_t& value)
{
    m_Source = value;
    m_SourceIsSet = true;
}

bool Dbv0_0_38_error::sourceIsSet() const
{
    return m_SourceIsSet;
}

void Dbv0_0_38_error::unsetSource()
{
    m_SourceIsSet = false;
}
utility::string_t Dbv0_0_38_error::getDescription() const
{
    return m_Description;
}

void Dbv0_0_38_error::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool Dbv0_0_38_error::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void Dbv0_0_38_error::unsetDescription()
{
    m_DescriptionIsSet = false;
}
}
