...
V0_0_41_openapi_instances_resp::V0_0_41_openapi_instances_resp()
{
...
void V0_0_41_openapi_instances_resp::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_instances_resp::toJson() const
{
...
bool V0_0_41_openapi_instances_resp::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_instances_resp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_instances_resp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_41_openapi_slurmdbd_config_resp_instances_inner>>& V0_0_41_openapi_instances_resp::getInstances()
{
    return m_Instances;
}

void V0_0_41_openapi_instances_resp::setInstances(const std::vector<std::shared_ptr<V0_0_41_openapi_slurmdbd_config_resp_instances_inner>>& value)
{
    m_Instances = value;
    m_InstancesIsSet = true;
}

bool V0_0_41_openapi_instances_resp::instancesIsSet() const
{
    return m_InstancesIsSet;
}

void V0_0_41_openapi_instances_resp::unsetInstances()
{
    m_InstancesIsSet = false;
}
std::shared_ptr<V0_0_41_openapi_shares_resp_meta> V0_0_41_openapi_instances_resp::getMeta() const
{
    return m_Meta;
}

void V0_0_41_openapi_instances_resp::setMeta(const std::shared_ptr<V0_0_41_openapi_shares_resp_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_41_openapi_instances_resp::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_41_openapi_instances_resp::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_errors_inner>>& V0_0_41_openapi_instances_resp::getErrors()
{
    return m_Errors;
}

void V0_0_41_openapi_instances_resp::setErrors(const std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_errors_inner>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_41_openapi_instances_resp::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_41_openapi_instances_resp::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_warnings_inner>>& V0_0_41_openapi_instances_resp::getWarnings()
{
    return m_Warnings;
}

void V0_0_41_openapi_instances_resp::setWarnings(const std::vector<std::shared_ptr<V0_0_41_openapi_shares_resp_warnings_inner>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool V0_0_41_openapi_instances_resp::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void V0_0_41_openapi_instances_resp::unsetWarnings()
{
    m_WarningsIsSet = false;
}
}
