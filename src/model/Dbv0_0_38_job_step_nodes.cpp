...
Dbv0_0_38_job_step_nodes::Dbv0_0_38_job_step_nodes()
{
    m_Count = 0;
    m_CountIsSet = false;
...
void Dbv0_0_38_job_step_nodes::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_job_step_nodes::toJson() const
{
...
bool Dbv0_0_38_job_step_nodes::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_38_job_step_nodes::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_job_step_nodes::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t Dbv0_0_38_job_step_nodes::getCount() const
{
    return m_Count;
}

void Dbv0_0_38_job_step_nodes::setCount(int32_t value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool Dbv0_0_38_job_step_nodes::countIsSet() const
{
    return m_CountIsSet;
}

void Dbv0_0_38_job_step_nodes::unsetCount()
{
    m_CountIsSet = false;
}
utility::string_t Dbv0_0_38_job_step_nodes::getRange() const
{
    return m_Range;
}

void Dbv0_0_38_job_step_nodes::setRange(const utility::string_t& value)
{
    m_Range = value;
    m_RangeIsSet = true;
}

bool Dbv0_0_38_job_step_nodes::rangeIsSet() const
{
    return m_RangeIsSet;
}

void Dbv0_0_38_job_step_nodes::unsetRange()
{
    m_RangeIsSet = false;
}
}
