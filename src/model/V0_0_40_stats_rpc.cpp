...
V0_0_40_stats_rpc::V0_0_40_stats_rpc()
{
...
void V0_0_40_stats_rpc::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_stats_rpc::toJson() const
{
...
bool V0_0_40_stats_rpc::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_stats_rpc::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_stats_rpc::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_stats_rpc::getRpc() const
{
    return m_Rpc;
}

void V0_0_40_stats_rpc::setRpc(const utility::string_t& value)
{
    m_Rpc = value;
    m_RpcIsSet = true;
}

bool V0_0_40_stats_rpc::rpcIsSet() const
{
    return m_RpcIsSet;
}

void V0_0_40_stats_rpc::unsetRpc()
{
    m_RpcIsSet = false;
}
int32_t V0_0_40_stats_rpc::getCount() const
{
    return m_Count;
}

void V0_0_40_stats_rpc::setCount(int32_t value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool V0_0_40_stats_rpc::countIsSet() const
{
    return m_CountIsSet;
}

void V0_0_40_stats_rpc::unsetCount()
{
    m_CountIsSet = false;
}
std::shared_ptr<V0_0_40_stats_rpc_time> V0_0_40_stats_rpc::getTime() const
{
    return m_Time;
}

void V0_0_40_stats_rpc::setTime(const std::shared_ptr<V0_0_40_stats_rpc_time>& value)
{
    m_Time = value;
    m_TimeIsSet = true;
}

bool V0_0_40_stats_rpc::timeIsSet() const
{
    return m_TimeIsSet;
}

void V0_0_40_stats_rpc::unsetTime()
{
    m_TimeIsSet = false;
}
}
