...
#include "slurmrestapi/model/Dbv0_0_37_qos_limits_min.h"
...
Dbv0_0_37_qos_limits_min::Dbv0_0_37_qos_limits_min()
{
...
void Dbv0_0_37_qos_limits_min::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_qos_limits_min::toJson() const
{
...
bool Dbv0_0_37_qos_limits_min::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tres"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_qos_limits_min_tres> refVal_setTres;
...
void Dbv0_0_37_qos_limits_min::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_qos_limits_min::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t Dbv0_0_37_qos_limits_min::getPriorityThreshold() const
{
    return m_Priority_threshold;
}

void Dbv0_0_37_qos_limits_min::setPriorityThreshold(int32_t value)
{
    m_Priority_threshold = value;
    m_Priority_thresholdIsSet = true;
}

bool Dbv0_0_37_qos_limits_min::priorityThresholdIsSet() const
{
    return m_Priority_thresholdIsSet;
}

void Dbv0_0_37_qos_limits_min::unsetPriority_threshold()
{
    m_Priority_thresholdIsSet = false;
}
std::shared_ptr<Dbv0_0_37_qos_limits_min_tres> Dbv0_0_37_qos_limits_min::getTres() const
{
    return m_Tres;
}

void Dbv0_0_37_qos_limits_min::setTres(const std::shared_ptr<Dbv0_0_37_qos_limits_min_tres>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool Dbv0_0_37_qos_limits_min::tresIsSet() const
{
    return m_TresIsSet;
}

void Dbv0_0_37_qos_limits_min::unsetTres()
{
    m_TresIsSet = false;
}
}
