...
bool Dbv0_0_39_meta::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("plugin"))))
    {
        ...
        {
            std::shared_ptr<V0_0_39_meta_plugin> refVal_setPlugin;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("Slurm"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_39_meta_Slurm> refVal_setSlurm;
...
std::shared_ptr<V0_0_39_meta_plugin> Dbv0_0_39_meta::getPlugin() const
{
    return m_Plugin;
}

void Dbv0_0_39_meta::setPlugin(const std::shared_ptr<V0_0_39_meta_plugin>& value)
{
    m_Plugin = value;
    m_PluginIsSet = true;
}
...
std::shared_ptr<V0_0_39_meta_Slurm> Dbv0_0_39_meta::getSlurm() const
{
    return m_Slurm;
}

void Dbv0_0_39_meta::setSlurm(const std::shared_ptr<V0_0_39_meta_Slurm>& value)
{
    m_Slurm = value;
    m_SlurmIsSet = true;
}
