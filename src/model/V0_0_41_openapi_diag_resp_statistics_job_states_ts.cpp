...
V0_0_41_openapi_diag_resp_statistics_job_states_ts::V0_0_41_openapi_diag_resp_statistics_job_states_ts()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_diag_resp_statistics_job_states_ts::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_diag_resp_statistics_job_states_ts::toJson() const
{
...
bool V0_0_41_openapi_diag_resp_statistics_job_states_ts::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_diag_resp_statistics_job_states_ts::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_diag_resp_statistics_job_states_ts::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_diag_resp_statistics_job_states_ts::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_diag_resp_statistics_job_states_ts::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_job_states_ts::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_job_states_ts::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_diag_resp_statistics_job_states_ts::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_diag_resp_statistics_job_states_ts::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_job_states_ts::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_job_states_ts::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int64_t V0_0_41_openapi_diag_resp_statistics_job_states_ts::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_diag_resp_statistics_job_states_ts::setNumber(int64_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_job_states_ts::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_job_states_ts::unsetnumber()
{
    m_numberIsSet = false;
}
}
