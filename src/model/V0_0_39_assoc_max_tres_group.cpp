...
V0_0_39_assoc_max_tres_group::V0_0_39_assoc_max_tres_group()
{
...
void V0_0_39_assoc_max_tres_group::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_assoc_max_tres_group::toJson() const
{
...
bool V0_0_39_assoc_max_tres_group::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("minutes"))))
    {
        ...
        {
            std::vector<std::shared_ptr<V0_0_39_tres>> refVal_setMinutes;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("active"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_39_tres>> refVal_setActive;
...
void V0_0_39_assoc_max_tres_group::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_assoc_max_tres_group::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_39_tres>>& V0_0_39_assoc_max_tres_group::getMinutes()
{
    return m_Minutes;
}

void V0_0_39_assoc_max_tres_group::setMinutes(const std::vector<std::shared_ptr<V0_0_39_tres>>& value)
{
    m_Minutes = value;
    m_MinutesIsSet = true;
}

bool V0_0_39_assoc_max_tres_group::minutesIsSet() const
{
    return m_MinutesIsSet;
}

void V0_0_39_assoc_max_tres_group::unsetMinutes()
{
    m_MinutesIsSet = false;
}
std::vector<std::shared_ptr<V0_0_39_tres>>& V0_0_39_assoc_max_tres_group::getActive()
{
    return m_Active;
}

void V0_0_39_assoc_max_tres_group::setActive(const std::vector<std::shared_ptr<V0_0_39_tres>>& value)
{
    m_Active = value;
    m_ActiveIsSet = true;
}

bool V0_0_39_assoc_max_tres_group::activeIsSet() const
{
    return m_ActiveIsSet;
}

void V0_0_39_assoc_max_tres_group::unsetActive()
{
    m_ActiveIsSet = false;
}
}
