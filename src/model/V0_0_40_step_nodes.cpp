...
V0_0_40_step_nodes::V0_0_40_step_nodes()
{
    m_Count = 0;
    m_CountIsSet = false;
...
void V0_0_40_step_nodes::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_step_nodes::toJson() const
{
...
bool V0_0_40_step_nodes::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_step_nodes::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_step_nodes::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_40_step_nodes::getCount() const
{
    return m_Count;
}

void V0_0_40_step_nodes::setCount(int32_t value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool V0_0_40_step_nodes::countIsSet() const
{
    return m_CountIsSet;
}

void V0_0_40_step_nodes::unsetCount()
{
    m_CountIsSet = false;
}
utility::string_t V0_0_40_step_nodes::getRange() const
{
    return m_Range;
}

void V0_0_40_step_nodes::setRange(const utility::string_t& value)
{
    m_Range = value;
    m_RangeIsSet = true;
}

bool V0_0_40_step_nodes::rangeIsSet() const
{
    return m_RangeIsSet;
}

void V0_0_40_step_nodes::unsetRange()
{
    m_RangeIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_step_nodes::getList()
{
    return m_List;
}

void V0_0_40_step_nodes::setList(const std::vector<utility::string_t>& value)
{
    m_List = value;
    m_ListIsSet = true;
}

bool V0_0_40_step_nodes::listIsSet() const
{
    return m_ListIsSet;
}

void V0_0_40_step_nodes::unsetList()
{
    m_ListIsSet = false;
}
}
