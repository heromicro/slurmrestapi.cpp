...
V0_0_41_job_desc_msg_rlimits_fsize::V0_0_41_job_desc_msg_rlimits_fsize()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_job_desc_msg_rlimits_fsize::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_job_desc_msg_rlimits_fsize::toJson() const
{
...
bool V0_0_41_job_desc_msg_rlimits_fsize::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_job_desc_msg_rlimits_fsize::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_job_desc_msg_rlimits_fsize::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_job_desc_msg_rlimits_fsize::isSet() const
{
    return m_set;
}

void V0_0_41_job_desc_msg_rlimits_fsize::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_job_desc_msg_rlimits_fsize::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_job_desc_msg_rlimits_fsize::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_job_desc_msg_rlimits_fsize::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_job_desc_msg_rlimits_fsize::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_job_desc_msg_rlimits_fsize::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_job_desc_msg_rlimits_fsize::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int64_t V0_0_41_job_desc_msg_rlimits_fsize::getNumber() const
{
    return m_number;
}

void V0_0_41_job_desc_msg_rlimits_fsize::setNumber(int64_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_job_desc_msg_rlimits_fsize::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_job_desc_msg_rlimits_fsize::unsetnumber()
{
    m_numberIsSet = false;
}
}
