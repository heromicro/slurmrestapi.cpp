...
V0_0_40_job_required::V0_0_40_job_required()
{
    m_CPUs = 0;
    m_CPUsIsSet = false;
...
void V0_0_40_job_required::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_job_required::toJson() const
{
...
bool V0_0_40_job_required::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_job_required::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_job_required::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_40_job_required::getCPUs() const
{
    return m_CPUs;
}

void V0_0_40_job_required::setCPUs(int32_t value)
{
    m_CPUs = value;
    m_CPUsIsSet = true;
}

bool V0_0_40_job_required::cPUsIsSet() const
{
    return m_CPUsIsSet;
}

void V0_0_40_job_required::unsetCPUs()
{
    m_CPUsIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_job_required::getMemoryPerCpu() const
{
    return m_Memory_per_cpu;
}

void V0_0_40_job_required::setMemoryPerCpu(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Memory_per_cpu = value;
    m_Memory_per_cpuIsSet = true;
}

bool V0_0_40_job_required::memoryPerCpuIsSet() const
{
    return m_Memory_per_cpuIsSet;
}

void V0_0_40_job_required::unsetMemory_per_cpu()
{
    m_Memory_per_cpuIsSet = false;
}
std::shared_ptr<V0_0_40_uint64_no_val> V0_0_40_job_required::getMemoryPerNode() const
{
    return m_Memory_per_node;
}

void V0_0_40_job_required::setMemoryPerNode(const std::shared_ptr<V0_0_40_uint64_no_val>& value)
{
    m_Memory_per_node = value;
    m_Memory_per_nodeIsSet = true;
}

bool V0_0_40_job_required::memoryPerNodeIsSet() const
{
    return m_Memory_per_nodeIsSet;
}

void V0_0_40_job_required::unsetMemory_per_node()
{
    m_Memory_per_nodeIsSet = false;
}
}
