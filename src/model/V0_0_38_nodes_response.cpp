...
V0_0_38_nodes_response::V0_0_38_nodes_response()
{
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
    m_NodesIsSet = false;
...
void V0_0_38_nodes_response::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_38_nodes_response::toJson() const
{
...
bool V0_0_38_nodes_response::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("nodes"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_38_node>> refVal_setNodes;
...
void V0_0_38_nodes_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_38_nodes_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_38_meta> V0_0_38_nodes_response::getMeta() const
{
    return m_Meta;
}

void V0_0_38_nodes_response::setMeta(const std::shared_ptr<V0_0_38_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_38_nodes_response::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_38_nodes_response::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_38_error>>& V0_0_38_nodes_response::getErrors()
{
    return m_Errors;
}

void V0_0_38_nodes_response::setErrors(const std::vector<std::shared_ptr<V0_0_38_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_38_nodes_response::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_38_nodes_response::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_38_node>>& V0_0_38_nodes_response::getNodes()
{
    return m_Nodes;
}

void V0_0_38_nodes_response::setNodes(const std::vector<std::shared_ptr<V0_0_38_node>>& value)
{
    m_Nodes = value;
    m_NodesIsSet = true;
}

bool V0_0_38_nodes_response::nodesIsSet() const
{
    return m_NodesIsSet;
}

void V0_0_38_nodes_response::unsetNodes()
{
    m_NodesIsSet = false;
}
}
