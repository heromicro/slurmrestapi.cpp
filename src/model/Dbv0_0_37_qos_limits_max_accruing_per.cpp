...
Dbv0_0_37_qos_limits_max_accruing_per::Dbv0_0_37_qos_limits_max_accruing_per()
{
    m_Account = 0;
...
void Dbv0_0_37_qos_limits_max_accruing_per::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_qos_limits_max_accruing_per::toJson() const
{
...
bool Dbv0_0_37_qos_limits_max_accruing_per::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_37_qos_limits_max_accruing_per::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_qos_limits_max_accruing_per::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t Dbv0_0_37_qos_limits_max_accruing_per::getAccount() const
{
    return m_Account;
}

void Dbv0_0_37_qos_limits_max_accruing_per::setAccount(int32_t value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool Dbv0_0_37_qos_limits_max_accruing_per::accountIsSet() const
{
    return m_AccountIsSet;
}

void Dbv0_0_37_qos_limits_max_accruing_per::unsetAccount()
{
    m_AccountIsSet = false;
}
int32_t Dbv0_0_37_qos_limits_max_accruing_per::getUser() const
{
    return m_User;
}

void Dbv0_0_37_qos_limits_max_accruing_per::setUser(int32_t value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Dbv0_0_37_qos_limits_max_accruing_per::userIsSet() const
{
    return m_UserIsSet;
}

void Dbv0_0_37_qos_limits_max_accruing_per::unsetUser()
{
    m_UserIsSet = false;
}
}
