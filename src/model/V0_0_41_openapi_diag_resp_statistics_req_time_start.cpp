...
V0_0_41_openapi_diag_resp_statistics_req_time_start::V0_0_41_openapi_diag_resp_statistics_req_time_start()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_diag_resp_statistics_req_time_start::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_diag_resp_statistics_req_time_start::toJson() const
{
...
bool V0_0_41_openapi_diag_resp_statistics_req_time_start::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_diag_resp_statistics_req_time_start::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_diag_resp_statistics_req_time_start::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_diag_resp_statistics_req_time_start::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_diag_resp_statistics_req_time_start::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_req_time_start::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_req_time_start::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_diag_resp_statistics_req_time_start::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_diag_resp_statistics_req_time_start::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_req_time_start::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_req_time_start::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int64_t V0_0_41_openapi_diag_resp_statistics_req_time_start::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_diag_resp_statistics_req_time_start::setNumber(int64_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_diag_resp_statistics_req_time_start::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_diag_resp_statistics_req_time_start::unsetnumber()
{
    m_numberIsSet = false;
}
}
