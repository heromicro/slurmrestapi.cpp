...
V0_0_41_openapi_shares_resp_shares_shares_inner_shares::V0_0_41_openapi_shares_resp_shares_shares_inner_shares()
{
    m_set = false;
    m_setIsSet = false;
    m_Infinite = false;
...
void V0_0_41_openapi_shares_resp_shares_shares_inner_shares::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_41_openapi_shares_resp_shares_shares_inner_shares::toJson() const
{
...
bool V0_0_41_openapi_shares_resp_shares_shares_inner_shares::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_41_openapi_shares_resp_shares_shares_inner_shares::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_41_openapi_shares_resp_shares_shares_inner_shares::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
bool V0_0_41_openapi_shares_resp_shares_shares_inner_shares::isSet() const
{
    return m_set;
}

void V0_0_41_openapi_shares_resp_shares_shares_inner_shares::setSet(bool value)
{
    m_set = value;
    m_setIsSet = true;
}

bool V0_0_41_openapi_shares_resp_shares_shares_inner_shares::setIsSet() const
{
    return m_setIsSet;
}

void V0_0_41_openapi_shares_resp_shares_shares_inner_shares::unsetset()
{
    m_setIsSet = false;
}
bool V0_0_41_openapi_shares_resp_shares_shares_inner_shares::isInfinite() const
{
    return m_Infinite;
}

void V0_0_41_openapi_shares_resp_shares_shares_inner_shares::setInfinite(bool value)
{
    m_Infinite = value;
    m_InfiniteIsSet = true;
}

bool V0_0_41_openapi_shares_resp_shares_shares_inner_shares::infiniteIsSet() const
{
    return m_InfiniteIsSet;
}

void V0_0_41_openapi_shares_resp_shares_shares_inner_shares::unsetInfinite()
{
    m_InfiniteIsSet = false;
}
int32_t V0_0_41_openapi_shares_resp_shares_shares_inner_shares::getNumber() const
{
    return m_number;
}

void V0_0_41_openapi_shares_resp_shares_shares_inner_shares::setNumber(int32_t value)
{
    m_number = value;
    m_numberIsSet = true;
}

bool V0_0_41_openapi_shares_resp_shares_shares_inner_shares::numberIsSet() const
{
    return m_numberIsSet;
}

void V0_0_41_openapi_shares_resp_shares_shares_inner_shares::unsetnumber()
{
    m_numberIsSet = false;
}
}
