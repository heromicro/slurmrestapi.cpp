...
#include "slurmrestapi/model/V0_0_40_job_submit_response_msg.h"
...
V0_0_40_job_submit_response_msg::V0_0_40_job_submit_response_msg()
{
    m_Job_id = 0;
    m_Job_idIsSet = false;
...
void V0_0_40_job_submit_response_msg::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_job_submit_response_msg::toJson() const
{
...
bool V0_0_40_job_submit_response_msg::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_job_submit_response_msg::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_job_submit_response_msg::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_40_job_submit_response_msg::getJobId() const
{
    return m_Job_id;
}

void V0_0_40_job_submit_response_msg::setJobId(int32_t value)
{
    m_Job_id = value;
    m_Job_idIsSet = true;
}

bool V0_0_40_job_submit_response_msg::jobIdIsSet() const
{
    return m_Job_idIsSet;
}

void V0_0_40_job_submit_response_msg::unsetJob_id()
{
    m_Job_idIsSet = false;
}
utility::string_t V0_0_40_job_submit_response_msg::getStepId() const
{
    return m_Step_id;
}

void V0_0_40_job_submit_response_msg::setStepId(const utility::string_t& value)
{
    m_Step_id = value;
    m_Step_idIsSet = true;
}

bool V0_0_40_job_submit_response_msg::stepIdIsSet() const
{
    return m_Step_idIsSet;
}

void V0_0_40_job_submit_response_msg::unsetStep_id()
{
    m_Step_idIsSet = false;
}
int32_t V0_0_40_job_submit_response_msg::getErrorCode() const
{
    return m_Error_code;
}

void V0_0_40_job_submit_response_msg::setErrorCode(int32_t value)
{
    m_Error_code = value;
    m_Error_codeIsSet = true;
}

bool V0_0_40_job_submit_response_msg::errorCodeIsSet() const
{
    return m_Error_codeIsSet;
}

void V0_0_40_job_submit_response_msg::unsetError_code()
{
    m_Error_codeIsSet = false;
}
utility::string_t V0_0_40_job_submit_response_msg::getError() const
{
    return m_Error;
}

void V0_0_40_job_submit_response_msg::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool V0_0_40_job_submit_response_msg::errorIsSet() const
{
    return m_ErrorIsSet;
}

void V0_0_40_job_submit_response_msg::unsetError()
{
    m_ErrorIsSet = false;
}
utility::string_t V0_0_40_job_submit_response_msg::getJobSubmitUserMsg() const
{
    return m_Job_submit_user_msg;
}

void V0_0_40_job_submit_response_msg::setJobSubmitUserMsg(const utility::string_t& value)
{
    m_Job_submit_user_msg = value;
    m_Job_submit_user_msgIsSet = true;
}

bool V0_0_40_job_submit_response_msg::jobSubmitUserMsgIsSet() const
{
    return m_Job_submit_user_msgIsSet;
}

void V0_0_40_job_submit_response_msg::unsetJob_submit_user_msg()
{
    m_Job_submit_user_msgIsSet = false;
}
}
