...
V0_0_40_bf_exit_fields::V0_0_40_bf_exit_fields()
{
    m_End_job_queue = 0;
...
void V0_0_40_bf_exit_fields::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_bf_exit_fields::toJson() const
{
...
bool V0_0_40_bf_exit_fields::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_bf_exit_fields::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_bf_exit_fields::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_40_bf_exit_fields::getEndJobQueue() const
{
    return m_End_job_queue;
}

void V0_0_40_bf_exit_fields::setEndJobQueue(int32_t value)
{
    m_End_job_queue = value;
    m_End_job_queueIsSet = true;
}

bool V0_0_40_bf_exit_fields::endJobQueueIsSet() const
{
    return m_End_job_queueIsSet;
}

void V0_0_40_bf_exit_fields::unsetEnd_job_queue()
{
    m_End_job_queueIsSet = false;
}
int32_t V0_0_40_bf_exit_fields::getBfMaxJobStart() const
{
    return m_Bf_max_job_start;
}

void V0_0_40_bf_exit_fields::setBfMaxJobStart(int32_t value)
{
    m_Bf_max_job_start = value;
    m_Bf_max_job_startIsSet = true;
}

bool V0_0_40_bf_exit_fields::bfMaxJobStartIsSet() const
{
    return m_Bf_max_job_startIsSet;
}

void V0_0_40_bf_exit_fields::unsetBf_max_job_start()
{
    m_Bf_max_job_startIsSet = false;
}
int32_t V0_0_40_bf_exit_fields::getBfMaxJobTest() const
{
    return m_Bf_max_job_test;
}

void V0_0_40_bf_exit_fields::setBfMaxJobTest(int32_t value)
{
    m_Bf_max_job_test = value;
    m_Bf_max_job_testIsSet = true;
}

bool V0_0_40_bf_exit_fields::bfMaxJobTestIsSet() const
{
    return m_Bf_max_job_testIsSet;
}

void V0_0_40_bf_exit_fields::unsetBf_max_job_test()
{
    m_Bf_max_job_testIsSet = false;
}
int32_t V0_0_40_bf_exit_fields::getBfMaxTime() const
{
    return m_Bf_max_time;
}

void V0_0_40_bf_exit_fields::setBfMaxTime(int32_t value)
{
    m_Bf_max_time = value;
    m_Bf_max_timeIsSet = true;
}

bool V0_0_40_bf_exit_fields::bfMaxTimeIsSet() const
{
    return m_Bf_max_timeIsSet;
}

void V0_0_40_bf_exit_fields::unsetBf_max_time()
{
    m_Bf_max_timeIsSet = false;
}
int32_t V0_0_40_bf_exit_fields::getBfNodeSpaceSize() const
{
    return m_Bf_node_space_size;
}

void V0_0_40_bf_exit_fields::setBfNodeSpaceSize(int32_t value)
{
    m_Bf_node_space_size = value;
    m_Bf_node_space_sizeIsSet = true;
}

bool V0_0_40_bf_exit_fields::bfNodeSpaceSizeIsSet() const
{
    return m_Bf_node_space_sizeIsSet;
}

void V0_0_40_bf_exit_fields::unsetBf_node_space_size()
{
    m_Bf_node_space_sizeIsSet = false;
}
int32_t V0_0_40_bf_exit_fields::getStateChanged() const
{
    return m_State_changed;
}

void V0_0_40_bf_exit_fields::setStateChanged(int32_t value)
{
    m_State_changed = value;
    m_State_changedIsSet = true;
}

bool V0_0_40_bf_exit_fields::stateChangedIsSet() const
{
    return m_State_changedIsSet;
}

void V0_0_40_bf_exit_fields::unsetState_changed()
{
    m_State_changedIsSet = false;
}
}
