...
#include "slurmrestapi/model/Dbv0_0_37_qos_limits_max_tres_per.h"
...
Dbv0_0_37_qos_limits_max_tres_per::Dbv0_0_37_qos_limits_max_tres_per()
{
...
void Dbv0_0_37_qos_limits_max_tres_per::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_qos_limits_max_tres_per::toJson() const
{
...
bool Dbv0_0_37_qos_limits_max_tres_per::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("node"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>> refVal_setNode;
...
void Dbv0_0_37_qos_limits_max_tres_per::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_qos_limits_max_tres_per::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& Dbv0_0_37_qos_limits_max_tres_per::getAccount()
{
    return m_Account;
}

void Dbv0_0_37_qos_limits_max_tres_per::setAccount(const std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool Dbv0_0_37_qos_limits_max_tres_per::accountIsSet() const
{
    return m_AccountIsSet;
}

void Dbv0_0_37_qos_limits_max_tres_per::unsetAccount()
{
    m_AccountIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& Dbv0_0_37_qos_limits_max_tres_per::getJob()
{
    return m_Job;
}

void Dbv0_0_37_qos_limits_max_tres_per::setJob(const std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& value)
{
    m_Job = value;
    m_JobIsSet = true;
}

bool Dbv0_0_37_qos_limits_max_tres_per::jobIsSet() const
{
    return m_JobIsSet;
}

void Dbv0_0_37_qos_limits_max_tres_per::unsetJob()
{
    m_JobIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& Dbv0_0_37_qos_limits_max_tres_per::getNode()
{
    return m_Node;
}

void Dbv0_0_37_qos_limits_max_tres_per::setNode(const std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& value)
{
    m_Node = value;
    m_NodeIsSet = true;
}

bool Dbv0_0_37_qos_limits_max_tres_per::nodeIsSet() const
{
    return m_NodeIsSet;
}

void Dbv0_0_37_qos_limits_max_tres_per::unsetNode()
{
    m_NodeIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& Dbv0_0_37_qos_limits_max_tres_per::getUser()
{
    return m_User;
}

void Dbv0_0_37_qos_limits_max_tres_per::setUser(const std::vector<std::shared_ptr<Dbv0_0_37_tres_list_inner>>& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Dbv0_0_37_qos_limits_max_tres_per::userIsSet() const
{
    return m_UserIsSet;
}

void Dbv0_0_37_qos_limits_max_tres_per::unsetUser()
{
    m_UserIsSet = false;
}
}
