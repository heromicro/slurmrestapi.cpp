...
Dbv0_0_38_qos_preempt::Dbv0_0_38_qos_preempt()
{
    m_ListIsSet = false;
    m_ModeIsSet = false;
    m_Exempt_time = 0;
...
void Dbv0_0_38_qos_preempt::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_qos_preempt::toJson() const
{
...
bool Dbv0_0_38_qos_preempt::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Dbv0_0_38_qos_preempt::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_qos_preempt::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<utility::string_t>& Dbv0_0_38_qos_preempt::getList()
{
    return m_List;
}

void Dbv0_0_38_qos_preempt::setList(const std::vector<utility::string_t>& value)
{
    m_List = value;
    m_ListIsSet = true;
}

bool Dbv0_0_38_qos_preempt::listIsSet() const
{
    return m_ListIsSet;
}

void Dbv0_0_38_qos_preempt::unsetList()
{
    m_ListIsSet = false;
}
std::vector<utility::string_t>& Dbv0_0_38_qos_preempt::getMode()
{
    return m_Mode;
}

void Dbv0_0_38_qos_preempt::setMode(const std::vector<utility::string_t>& value)
{
    m_Mode = value;
    m_ModeIsSet = true;
}

bool Dbv0_0_38_qos_preempt::modeIsSet() const
{
    return m_ModeIsSet;
}

void Dbv0_0_38_qos_preempt::unsetMode()
{
    m_ModeIsSet = false;
}
int32_t Dbv0_0_38_qos_preempt::getExemptTime() const
{
    return m_Exempt_time;
}

void Dbv0_0_38_qos_preempt::setExemptTime(int32_t value)
{
    m_Exempt_time = value;
    m_Exempt_timeIsSet = true;
}

bool Dbv0_0_38_qos_preempt::exemptTimeIsSet() const
{
    return m_Exempt_timeIsSet;
}

void Dbv0_0_38_qos_preempt::unsetExempt_time()
{
    m_Exempt_timeIsSet = false;
}
}
