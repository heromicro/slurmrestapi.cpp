...
V0_0_40_openapi_tres_resp::V0_0_40_openapi_tres_resp()
{
    m_TRESIsSet = false;
    m_MetaIsSet = false;
    m_ErrorsIsSet = false;
...
void V0_0_40_openapi_tres_resp::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_openapi_tres_resp::toJson() const
{
...
bool V0_0_40_openapi_tres_resp::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_openapi_tres_resp::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_openapi_tres_resp::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<V0_0_40_tres>>& V0_0_40_openapi_tres_resp::getTRES()
{
    return m_TRES;
}

void V0_0_40_openapi_tres_resp::setTRES(const std::vector<std::shared_ptr<V0_0_40_tres>>& value)
{
    m_TRES = value;
    m_TRESIsSet = true;
}

bool V0_0_40_openapi_tres_resp::tRESIsSet() const
{
    return m_TRESIsSet;
}

void V0_0_40_openapi_tres_resp::unsetTRES()
{
    m_TRESIsSet = false;
}
std::shared_ptr<V0_0_40_openapi_meta> V0_0_40_openapi_tres_resp::getMeta() const
{
    return m_Meta;
}

void V0_0_40_openapi_tres_resp::setMeta(const std::shared_ptr<V0_0_40_openapi_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool V0_0_40_openapi_tres_resp::metaIsSet() const
{
    return m_MetaIsSet;
}

void V0_0_40_openapi_tres_resp::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_openapi_error>>& V0_0_40_openapi_tres_resp::getErrors()
{
    return m_Errors;
}

void V0_0_40_openapi_tres_resp::setErrors(const std::vector<std::shared_ptr<V0_0_40_openapi_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool V0_0_40_openapi_tres_resp::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void V0_0_40_openapi_tres_resp::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::vector<std::shared_ptr<V0_0_40_openapi_warning>>& V0_0_40_openapi_tres_resp::getWarnings()
{
    return m_Warnings;
}

void V0_0_40_openapi_tres_resp::setWarnings(const std::vector<std::shared_ptr<V0_0_40_openapi_warning>>& value)
{
    m_Warnings = value;
    m_WarningsIsSet = true;
}

bool V0_0_40_openapi_tres_resp::warningsIsSet() const
{
    return m_WarningsIsSet;
}

void V0_0_40_openapi_tres_resp::unsetWarnings()
{
    m_WarningsIsSet = false;
}
}
