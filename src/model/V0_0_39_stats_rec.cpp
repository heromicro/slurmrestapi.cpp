...
bool V0_0_39_stats_rec::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("rollups"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<V0_0_39_rollup_stats_inner>> refVal_setRollups;
...
std::vector<std::shared_ptr<V0_0_39_rollup_stats_inner>>& V0_0_39_stats_rec::getRollups()
{
    return m_Rollups;
}

void V0_0_39_stats_rec::setRollups(const std::vector<std::shared_ptr<V0_0_39_rollup_stats_inner>>& value)
{
    m_Rollups = value;
    m_RollupsIsSet = true;
}
