...
Dbv0_0_38_diag_statistics_RPCs_inner::Dbv0_0_38_diag_statistics_RPCs_inner()
{
...
void Dbv0_0_38_diag_statistics_RPCs_inner::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_diag_statistics_RPCs_inner::toJson() const
{
...
bool Dbv0_0_38_diag_statistics_RPCs_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("time"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_diag_statistics_RPCs_inner_time> refVal_setTime;
...
void Dbv0_0_38_diag_statistics_RPCs_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_diag_statistics_RPCs_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Dbv0_0_38_diag_statistics_RPCs_inner::getRpc() const
{
    return m_Rpc;
}

void Dbv0_0_38_diag_statistics_RPCs_inner::setRpc(const utility::string_t& value)
{
    m_Rpc = value;
    m_RpcIsSet = true;
}

bool Dbv0_0_38_diag_statistics_RPCs_inner::rpcIsSet() const
{
    return m_RpcIsSet;
}

void Dbv0_0_38_diag_statistics_RPCs_inner::unsetRpc()
{
    m_RpcIsSet = false;
}
int32_t Dbv0_0_38_diag_statistics_RPCs_inner::getCount() const
{
    return m_Count;
}

void Dbv0_0_38_diag_statistics_RPCs_inner::setCount(int32_t value)
{
    m_Count = value;
    m_CountIsSet = true;
}

bool Dbv0_0_38_diag_statistics_RPCs_inner::countIsSet() const
{
    return m_CountIsSet;
}

void Dbv0_0_38_diag_statistics_RPCs_inner::unsetCount()
{
    m_CountIsSet = false;
}
std::shared_ptr<Dbv0_0_38_diag_statistics_RPCs_inner_time> Dbv0_0_38_diag_statistics_RPCs_inner::getTime() const
{
    return m_Time;
}

void Dbv0_0_38_diag_statistics_RPCs_inner::setTime(const std::shared_ptr<Dbv0_0_38_diag_statistics_RPCs_inner_time>& value)
{
    m_Time = value;
    m_TimeIsSet = true;
}

bool Dbv0_0_38_diag_statistics_RPCs_inner::timeIsSet() const
{
    return m_TimeIsSet;
}

void Dbv0_0_38_diag_statistics_RPCs_inner::unsetTime()
{
    m_TimeIsSet = false;
}
}
