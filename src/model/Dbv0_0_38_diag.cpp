...
void Dbv0_0_38_diag::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_38_diag::toJson() const
{
...
bool Dbv0_0_38_diag::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("statistics"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_38_diag_statistics> refVal_setStatistics;
...
void Dbv0_0_38_diag::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_38_diag::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_38_meta> Dbv0_0_38_diag::getMeta() const
{
    return m_Meta;
}

void Dbv0_0_38_diag::setMeta(const std::shared_ptr<Dbv0_0_38_meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool Dbv0_0_38_diag::metaIsSet() const
{
    return m_MetaIsSet;
}

void Dbv0_0_38_diag::unsetMeta()
{
    m_MetaIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_38_error>>& Dbv0_0_38_diag::getErrors()
{
    return m_Errors;
}

void Dbv0_0_38_diag::setErrors(const std::vector<std::shared_ptr<Dbv0_0_38_error>>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}

bool Dbv0_0_38_diag::errorsIsSet() const
{
    return m_ErrorsIsSet;
}

void Dbv0_0_38_diag::unsetErrors()
{
    m_ErrorsIsSet = false;
}
std::shared_ptr<Dbv0_0_38_diag_statistics> Dbv0_0_38_diag::getStatistics() const
{
    return m_Statistics;
}

void Dbv0_0_38_diag::setStatistics(const std::shared_ptr<Dbv0_0_38_diag_statistics>& value)
{
    m_Statistics = value;
    m_StatisticsIsSet = true;
}

bool Dbv0_0_38_diag::statisticsIsSet() const
{
    return m_StatisticsIsSet;
}

void Dbv0_0_38_diag::unsetStatistics()
{
    m_StatisticsIsSet = false;
}
}
