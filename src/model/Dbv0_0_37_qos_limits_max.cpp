...
#include "slurmrestapi/model/Dbv0_0_37_qos_limits_max.h"
...
Dbv0_0_37_qos_limits_max::Dbv0_0_37_qos_limits_max()
{
...
void Dbv0_0_37_qos_limits_max::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_qos_limits_max::toJson() const
{
...
bool Dbv0_0_37_qos_limits_max::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("wall_clock"))))
    {
        ...
        {
            std::shared_ptr<Dbv0_0_37_qos_limits_max_wall_clock> refVal_setWallClock;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("jobs"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_qos_limits_max_jobs> refVal_setJobs;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("accruing"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_qos_limits_max_accruing> refVal_setAccruing;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tres"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_qos_limits_max_tres> refVal_setTres;
...
void Dbv0_0_37_qos_limits_max::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_qos_limits_max::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Dbv0_0_37_qos_limits_max_wall_clock> Dbv0_0_37_qos_limits_max::getWallClock() const
{
    return m_Wall_clock;
}

void Dbv0_0_37_qos_limits_max::setWallClock(const std::shared_ptr<Dbv0_0_37_qos_limits_max_wall_clock>& value)
{
    m_Wall_clock = value;
    m_Wall_clockIsSet = true;
}

bool Dbv0_0_37_qos_limits_max::wallClockIsSet() const
{
    return m_Wall_clockIsSet;
}

void Dbv0_0_37_qos_limits_max::unsetWall_clock()
{
    m_Wall_clockIsSet = false;
}
std::shared_ptr<Dbv0_0_37_qos_limits_max_jobs> Dbv0_0_37_qos_limits_max::getJobs() const
{
    return m_Jobs;
}

void Dbv0_0_37_qos_limits_max::setJobs(const std::shared_ptr<Dbv0_0_37_qos_limits_max_jobs>& value)
{
    m_Jobs = value;
    m_JobsIsSet = true;
}

bool Dbv0_0_37_qos_limits_max::jobsIsSet() const
{
    return m_JobsIsSet;
}

void Dbv0_0_37_qos_limits_max::unsetJobs()
{
    m_JobsIsSet = false;
}
std::shared_ptr<Dbv0_0_37_qos_limits_max_accruing> Dbv0_0_37_qos_limits_max::getAccruing() const
{
    return m_Accruing;
}

void Dbv0_0_37_qos_limits_max::setAccruing(const std::shared_ptr<Dbv0_0_37_qos_limits_max_accruing>& value)
{
    m_Accruing = value;
    m_AccruingIsSet = true;
}

bool Dbv0_0_37_qos_limits_max::accruingIsSet() const
{
    return m_AccruingIsSet;
}

void Dbv0_0_37_qos_limits_max::unsetAccruing()
{
    m_AccruingIsSet = false;
}
std::shared_ptr<Dbv0_0_37_qos_limits_max_tres> Dbv0_0_37_qos_limits_max::getTres() const
{
    return m_Tres;
}

void Dbv0_0_37_qos_limits_max::setTres(const std::shared_ptr<Dbv0_0_37_qos_limits_max_tres>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool Dbv0_0_37_qos_limits_max::tresIsSet() const
{
    return m_TresIsSet;
}

void Dbv0_0_37_qos_limits_max::unsetTres()
{
    m_TresIsSet = false;
}
}
