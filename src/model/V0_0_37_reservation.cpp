...
#include "slurmrestapi/model/V0_0_37_reservation.h"
...
V0_0_37_reservation::V0_0_37_reservation()
{
...
void V0_0_37_reservation::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_37_reservation::toJson() const
{
...
bool V0_0_37_reservation::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("purge_completed"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<V0_0_37_reservation_purge_completed> refVal_setPurgeCompleted;
...
void V0_0_37_reservation::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_37_reservation::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_37_reservation::getAccounts() const
{
    return m_Accounts;
}

void V0_0_37_reservation::setAccounts(const utility::string_t& value)
{
    m_Accounts = value;
    m_AccountsIsSet = true;
}

bool V0_0_37_reservation::accountsIsSet() const
{
    return m_AccountsIsSet;
}

void V0_0_37_reservation::unsetAccounts()
{
    m_AccountsIsSet = false;
}
utility::string_t V0_0_37_reservation::getBurstBuffer() const
{
    return m_Burst_buffer;
}

void V0_0_37_reservation::setBurstBuffer(const utility::string_t& value)
{
    m_Burst_buffer = value;
    m_Burst_bufferIsSet = true;
}

bool V0_0_37_reservation::burstBufferIsSet() const
{
    return m_Burst_bufferIsSet;
}

void V0_0_37_reservation::unsetBurst_buffer()
{
    m_Burst_bufferIsSet = false;
}
int32_t V0_0_37_reservation::getCoreCount() const
{
    return m_Core_count;
}

void V0_0_37_reservation::setCoreCount(int32_t value)
{
    m_Core_count = value;
    m_Core_countIsSet = true;
}

bool V0_0_37_reservation::coreCountIsSet() const
{
    return m_Core_countIsSet;
}

void V0_0_37_reservation::unsetCore_count()
{
    m_Core_countIsSet = false;
}
int32_t V0_0_37_reservation::getCoreSpecCnt() const
{
    return m_Core_spec_cnt;
}

void V0_0_37_reservation::setCoreSpecCnt(int32_t value)
{
    m_Core_spec_cnt = value;
    m_Core_spec_cntIsSet = true;
}

bool V0_0_37_reservation::coreSpecCntIsSet() const
{
    return m_Core_spec_cntIsSet;
}

void V0_0_37_reservation::unsetCore_spec_cnt()
{
    m_Core_spec_cntIsSet = false;
}
int32_t V0_0_37_reservation::getEndTime() const
{
    return m_End_time;
}

void V0_0_37_reservation::setEndTime(int32_t value)
{
    m_End_time = value;
    m_End_timeIsSet = true;
}

bool V0_0_37_reservation::endTimeIsSet() const
{
    return m_End_timeIsSet;
}

void V0_0_37_reservation::unsetEnd_time()
{
    m_End_timeIsSet = false;
}
utility::string_t V0_0_37_reservation::getFeatures() const
{
    return m_Features;
}

void V0_0_37_reservation::setFeatures(const utility::string_t& value)
{
    m_Features = value;
    m_FeaturesIsSet = true;
}

bool V0_0_37_reservation::featuresIsSet() const
{
    return m_FeaturesIsSet;
}

void V0_0_37_reservation::unsetFeatures()
{
    m_FeaturesIsSet = false;
}
std::vector<utility::string_t>& V0_0_37_reservation::getFlags()
{
    return m_Flags;
}

void V0_0_37_reservation::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool V0_0_37_reservation::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void V0_0_37_reservation::unsetFlags()
{
    m_FlagsIsSet = false;
}
utility::string_t V0_0_37_reservation::getGroups() const
{
    return m_Groups;
}

void V0_0_37_reservation::setGroups(const utility::string_t& value)
{
    m_Groups = value;
    m_GroupsIsSet = true;
}

bool V0_0_37_reservation::groupsIsSet() const
{
    return m_GroupsIsSet;
}

void V0_0_37_reservation::unsetGroups()
{
    m_GroupsIsSet = false;
}
utility::string_t V0_0_37_reservation::getLicenses() const
{
    return m_Licenses;
}

void V0_0_37_reservation::setLicenses(const utility::string_t& value)
{
    m_Licenses = value;
    m_LicensesIsSet = true;
}

bool V0_0_37_reservation::licensesIsSet() const
{
    return m_LicensesIsSet;
}

void V0_0_37_reservation::unsetLicenses()
{
    m_LicensesIsSet = false;
}
int32_t V0_0_37_reservation::getMaxStartDelay() const
{
    return m_Max_start_delay;
}

void V0_0_37_reservation::setMaxStartDelay(int32_t value)
{
    m_Max_start_delay = value;
    m_Max_start_delayIsSet = true;
}

bool V0_0_37_reservation::maxStartDelayIsSet() const
{
    return m_Max_start_delayIsSet;
}

void V0_0_37_reservation::unsetMax_start_delay()
{
    m_Max_start_delayIsSet = false;
}
utility::string_t V0_0_37_reservation::getName() const
{
    return m_Name;
}

void V0_0_37_reservation::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool V0_0_37_reservation::nameIsSet() const
{
    return m_NameIsSet;
}

void V0_0_37_reservation::unsetName()
{
    m_NameIsSet = false;
}
int32_t V0_0_37_reservation::getNodeCount() const
{
    return m_Node_count;
}

void V0_0_37_reservation::setNodeCount(int32_t value)
{
    m_Node_count = value;
    m_Node_countIsSet = true;
}

bool V0_0_37_reservation::nodeCountIsSet() const
{
    return m_Node_countIsSet;
}

void V0_0_37_reservation::unsetNode_count()
{
    m_Node_countIsSet = false;
}
utility::string_t V0_0_37_reservation::getNodeList() const
{
    return m_Node_list;
}

void V0_0_37_reservation::setNodeList(const utility::string_t& value)
{
    m_Node_list = value;
    m_Node_listIsSet = true;
}

bool V0_0_37_reservation::nodeListIsSet() const
{
    return m_Node_listIsSet;
}

void V0_0_37_reservation::unsetNode_list()
{
    m_Node_listIsSet = false;
}
utility::string_t V0_0_37_reservation::getPartition() const
{
    return m_Partition;
}

void V0_0_37_reservation::setPartition(const utility::string_t& value)
{
    m_Partition = value;
    m_PartitionIsSet = true;
}

bool V0_0_37_reservation::partitionIsSet() const
{
    return m_PartitionIsSet;
}

void V0_0_37_reservation::unsetPartition()
{
    m_PartitionIsSet = false;
}
std::shared_ptr<V0_0_37_reservation_purge_completed> V0_0_37_reservation::getPurgeCompleted() const
{
    return m_Purge_completed;
}

void V0_0_37_reservation::setPurgeCompleted(const std::shared_ptr<V0_0_37_reservation_purge_completed>& value)
{
    m_Purge_completed = value;
    m_Purge_completedIsSet = true;
}

bool V0_0_37_reservation::purgeCompletedIsSet() const
{
    return m_Purge_completedIsSet;
}

void V0_0_37_reservation::unsetPurge_completed()
{
    m_Purge_completedIsSet = false;
}
int32_t V0_0_37_reservation::getStartTime() const
{
    return m_Start_time;
}

void V0_0_37_reservation::setStartTime(int32_t value)
{
    m_Start_time = value;
    m_Start_timeIsSet = true;
}

bool V0_0_37_reservation::startTimeIsSet() const
{
    return m_Start_timeIsSet;
}

void V0_0_37_reservation::unsetStart_time()
{
    m_Start_timeIsSet = false;
}
int32_t V0_0_37_reservation::getWatts() const
{
    return m_Watts;
}

void V0_0_37_reservation::setWatts(int32_t value)
{
    m_Watts = value;
    m_WattsIsSet = true;
}

bool V0_0_37_reservation::wattsIsSet() const
{
    return m_WattsIsSet;
}

void V0_0_37_reservation::unsetWatts()
{
    m_WattsIsSet = false;
}
utility::string_t V0_0_37_reservation::getTres() const
{
    return m_Tres;
}

void V0_0_37_reservation::setTres(const utility::string_t& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool V0_0_37_reservation::tresIsSet() const
{
    return m_TresIsSet;
}

void V0_0_37_reservation::unsetTres()
{
    m_TresIsSet = false;
}
utility::string_t V0_0_37_reservation::getUsers() const
{
    return m_Users;
}

void V0_0_37_reservation::setUsers(const utility::string_t& value)
{
    m_Users = value;
    m_UsersIsSet = true;
}

bool V0_0_37_reservation::usersIsSet() const
{
    return m_UsersIsSet;
}

void V0_0_37_reservation::unsetUsers()
{
    m_UsersIsSet = false;
}
}
