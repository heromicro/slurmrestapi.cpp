...
V0_0_40_partition_info_nodes::V0_0_40_partition_info_nodes()
{
...
void V0_0_40_partition_info_nodes::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_partition_info_nodes::toJson() const
{
...
bool V0_0_40_partition_info_nodes::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_partition_info_nodes::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_partition_info_nodes::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t V0_0_40_partition_info_nodes::getAllowedAllocation() const
{
    return m_Allowed_allocation;
}

void V0_0_40_partition_info_nodes::setAllowedAllocation(const utility::string_t& value)
{
    m_Allowed_allocation = value;
    m_Allowed_allocationIsSet = true;
}

bool V0_0_40_partition_info_nodes::allowedAllocationIsSet() const
{
    return m_Allowed_allocationIsSet;
}

void V0_0_40_partition_info_nodes::unsetAllowed_allocation()
{
    m_Allowed_allocationIsSet = false;
}
utility::string_t V0_0_40_partition_info_nodes::getConfigured() const
{
    return m_Configured;
}

void V0_0_40_partition_info_nodes::setConfigured(const utility::string_t& value)
{
    m_Configured = value;
    m_ConfiguredIsSet = true;
}

bool V0_0_40_partition_info_nodes::configuredIsSet() const
{
    return m_ConfiguredIsSet;
}

void V0_0_40_partition_info_nodes::unsetConfigured()
{
    m_ConfiguredIsSet = false;
}
int32_t V0_0_40_partition_info_nodes::getTotal() const
{
    return m_Total;
}

void V0_0_40_partition_info_nodes::setTotal(int32_t value)
{
    m_Total = value;
    m_TotalIsSet = true;
}

bool V0_0_40_partition_info_nodes::totalIsSet() const
{
    return m_TotalIsSet;
}

void V0_0_40_partition_info_nodes::unsetTotal()
{
    m_TotalIsSet = false;
}
}
