...
#include "slurmrestapi/model/Dbv0_0_37_job.h"
...
void Dbv0_0_37_job::validate()
{
    // TODO: implement validation
}

web::json::value Dbv0_0_37_job::toJson() const
{
...
bool Dbv0_0_37_job::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("comment"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_job_comment> refVal_setComment;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("array"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_job_array> refVal_setArray;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("time"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_job_time> refVal_setTime;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("association"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_association_short_info> refVal_setAssociation;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("derived_exit_code"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_job_exit_code> refVal_setDerivedExitCode;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("exit_code"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_job_exit_code> refVal_setExitCode;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("het"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_job_het> refVal_setHet;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("mcs"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_job_mcs> refVal_setMcs;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("required"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_job_required> refVal_setRequired;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("reservation"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_job_reservation> refVal_setReservation;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("state"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_job_state> refVal_setState;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("steps"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<Dbv0_0_37_job_step>> refVal_setSteps;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("tres"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_job_tres> refVal_setTres;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("wckey"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<Dbv0_0_37_job_wckey> refVal_setWckey;
...
void Dbv0_0_37_job::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Dbv0_0_37_job::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Dbv0_0_37_job::getAccount() const
{
    return m_Account;
}

void Dbv0_0_37_job::setAccount(const utility::string_t& value)
{
    m_Account = value;
    m_AccountIsSet = true;
}

bool Dbv0_0_37_job::accountIsSet() const
{
    return m_AccountIsSet;
}

void Dbv0_0_37_job::unsetAccount()
{
    m_AccountIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_comment> Dbv0_0_37_job::getComment() const
{
    return m_Comment;
}

void Dbv0_0_37_job::setComment(const std::shared_ptr<Dbv0_0_37_job_comment>& value)
{
    m_Comment = value;
    m_CommentIsSet = true;
}

bool Dbv0_0_37_job::commentIsSet() const
{
    return m_CommentIsSet;
}

void Dbv0_0_37_job::unsetComment()
{
    m_CommentIsSet = false;
}
utility::string_t Dbv0_0_37_job::getAllocationNodes() const
{
    return m_Allocation_nodes;
}

void Dbv0_0_37_job::setAllocationNodes(const utility::string_t& value)
{
    m_Allocation_nodes = value;
    m_Allocation_nodesIsSet = true;
}

bool Dbv0_0_37_job::allocationNodesIsSet() const
{
    return m_Allocation_nodesIsSet;
}

void Dbv0_0_37_job::unsetAllocation_nodes()
{
    m_Allocation_nodesIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_array> Dbv0_0_37_job::getArray() const
{
    return m_array;
}

void Dbv0_0_37_job::setArray(const std::shared_ptr<Dbv0_0_37_job_array>& value)
{
    m_array = value;
    m_arrayIsSet = true;
}

bool Dbv0_0_37_job::arrayIsSet() const
{
    return m_arrayIsSet;
}

void Dbv0_0_37_job::unsetarray()
{
    m_arrayIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_time> Dbv0_0_37_job::getTime() const
{
    return m_Time;
}

void Dbv0_0_37_job::setTime(const std::shared_ptr<Dbv0_0_37_job_time>& value)
{
    m_Time = value;
    m_TimeIsSet = true;
}

bool Dbv0_0_37_job::timeIsSet() const
{
    return m_TimeIsSet;
}

void Dbv0_0_37_job::unsetTime()
{
    m_TimeIsSet = false;
}
std::shared_ptr<Dbv0_0_37_association_short_info> Dbv0_0_37_job::getAssociation() const
{
    return m_Association;
}

void Dbv0_0_37_job::setAssociation(const std::shared_ptr<Dbv0_0_37_association_short_info>& value)
{
    m_Association = value;
    m_AssociationIsSet = true;
}

bool Dbv0_0_37_job::associationIsSet() const
{
    return m_AssociationIsSet;
}

void Dbv0_0_37_job::unsetAssociation()
{
    m_AssociationIsSet = false;
}
utility::string_t Dbv0_0_37_job::getCluster() const
{
    return m_Cluster;
}

void Dbv0_0_37_job::setCluster(const utility::string_t& value)
{
    m_Cluster = value;
    m_ClusterIsSet = true;
}

bool Dbv0_0_37_job::clusterIsSet() const
{
    return m_ClusterIsSet;
}

void Dbv0_0_37_job::unsetCluster()
{
    m_ClusterIsSet = false;
}
utility::string_t Dbv0_0_37_job::getConstraints() const
{
    return m_Constraints;
}

void Dbv0_0_37_job::setConstraints(const utility::string_t& value)
{
    m_Constraints = value;
    m_ConstraintsIsSet = true;
}

bool Dbv0_0_37_job::constraintsIsSet() const
{
    return m_ConstraintsIsSet;
}

void Dbv0_0_37_job::unsetConstraints()
{
    m_ConstraintsIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_exit_code> Dbv0_0_37_job::getDerivedExitCode() const
{
    return m_Derived_exit_code;
}

void Dbv0_0_37_job::setDerivedExitCode(const std::shared_ptr<Dbv0_0_37_job_exit_code>& value)
{
    m_Derived_exit_code = value;
    m_Derived_exit_codeIsSet = true;
}

bool Dbv0_0_37_job::derivedExitCodeIsSet() const
{
    return m_Derived_exit_codeIsSet;
}

void Dbv0_0_37_job::unsetDerived_exit_code()
{
    m_Derived_exit_codeIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_exit_code> Dbv0_0_37_job::getExitCode() const
{
    return m_Exit_code;
}

void Dbv0_0_37_job::setExitCode(const std::shared_ptr<Dbv0_0_37_job_exit_code>& value)
{
    m_Exit_code = value;
    m_Exit_codeIsSet = true;
}

bool Dbv0_0_37_job::exitCodeIsSet() const
{
    return m_Exit_codeIsSet;
}

void Dbv0_0_37_job::unsetExit_code()
{
    m_Exit_codeIsSet = false;
}
std::vector<utility::string_t>& Dbv0_0_37_job::getFlags()
{
    return m_Flags;
}

void Dbv0_0_37_job::setFlags(const std::vector<utility::string_t>& value)
{
    m_Flags = value;
    m_FlagsIsSet = true;
}

bool Dbv0_0_37_job::flagsIsSet() const
{
    return m_FlagsIsSet;
}

void Dbv0_0_37_job::unsetFlags()
{
    m_FlagsIsSet = false;
}
utility::string_t Dbv0_0_37_job::getGroup() const
{
    return m_Group;
}

void Dbv0_0_37_job::setGroup(const utility::string_t& value)
{
    m_Group = value;
    m_GroupIsSet = true;
}

bool Dbv0_0_37_job::groupIsSet() const
{
    return m_GroupIsSet;
}

void Dbv0_0_37_job::unsetGroup()
{
    m_GroupIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_het> Dbv0_0_37_job::getHet() const
{
    return m_Het;
}

void Dbv0_0_37_job::setHet(const std::shared_ptr<Dbv0_0_37_job_het>& value)
{
    m_Het = value;
    m_HetIsSet = true;
}

bool Dbv0_0_37_job::hetIsSet() const
{
    return m_HetIsSet;
}

void Dbv0_0_37_job::unsetHet()
{
    m_HetIsSet = false;
}
int32_t Dbv0_0_37_job::getJobId() const
{
    return m_Job_id;
}

void Dbv0_0_37_job::setJobId(int32_t value)
{
    m_Job_id = value;
    m_Job_idIsSet = true;
}

bool Dbv0_0_37_job::jobIdIsSet() const
{
    return m_Job_idIsSet;
}

void Dbv0_0_37_job::unsetJob_id()
{
    m_Job_idIsSet = false;
}
utility::string_t Dbv0_0_37_job::getName() const
{
    return m_Name;
}

void Dbv0_0_37_job::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool Dbv0_0_37_job::nameIsSet() const
{
    return m_NameIsSet;
}

void Dbv0_0_37_job::unsetName()
{
    m_NameIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_mcs> Dbv0_0_37_job::getMcs() const
{
    return m_Mcs;
}

void Dbv0_0_37_job::setMcs(const std::shared_ptr<Dbv0_0_37_job_mcs>& value)
{
    m_Mcs = value;
    m_McsIsSet = true;
}

bool Dbv0_0_37_job::mcsIsSet() const
{
    return m_McsIsSet;
}

void Dbv0_0_37_job::unsetMcs()
{
    m_McsIsSet = false;
}
utility::string_t Dbv0_0_37_job::getNodes() const
{
    return m_Nodes;
}

void Dbv0_0_37_job::setNodes(const utility::string_t& value)
{
    m_Nodes = value;
    m_NodesIsSet = true;
}

bool Dbv0_0_37_job::nodesIsSet() const
{
    return m_NodesIsSet;
}

void Dbv0_0_37_job::unsetNodes()
{
    m_NodesIsSet = false;
}
utility::string_t Dbv0_0_37_job::getPartition() const
{
    return m_Partition;
}

void Dbv0_0_37_job::setPartition(const utility::string_t& value)
{
    m_Partition = value;
    m_PartitionIsSet = true;
}

bool Dbv0_0_37_job::partitionIsSet() const
{
    return m_PartitionIsSet;
}

void Dbv0_0_37_job::unsetPartition()
{
    m_PartitionIsSet = false;
}
int32_t Dbv0_0_37_job::getPriority() const
{
    return m_Priority;
}

void Dbv0_0_37_job::setPriority(int32_t value)
{
    m_Priority = value;
    m_PriorityIsSet = true;
}

bool Dbv0_0_37_job::priorityIsSet() const
{
    return m_PriorityIsSet;
}

void Dbv0_0_37_job::unsetPriority()
{
    m_PriorityIsSet = false;
}
utility::string_t Dbv0_0_37_job::getQos() const
{
    return m_Qos;
}

void Dbv0_0_37_job::setQos(const utility::string_t& value)
{
    m_Qos = value;
    m_QosIsSet = true;
}

bool Dbv0_0_37_job::qosIsSet() const
{
    return m_QosIsSet;
}

void Dbv0_0_37_job::unsetQos()
{
    m_QosIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_required> Dbv0_0_37_job::getRequired() const
{
    return m_Required;
}

void Dbv0_0_37_job::setRequired(const std::shared_ptr<Dbv0_0_37_job_required>& value)
{
    m_Required = value;
    m_RequiredIsSet = true;
}

bool Dbv0_0_37_job::requiredIsSet() const
{
    return m_RequiredIsSet;
}

void Dbv0_0_37_job::unsetRequired()
{
    m_RequiredIsSet = false;
}
utility::string_t Dbv0_0_37_job::getKillRequestUser() const
{
    return m_Kill_request_user;
}

void Dbv0_0_37_job::setKillRequestUser(const utility::string_t& value)
{
    m_Kill_request_user = value;
    m_Kill_request_userIsSet = true;
}

bool Dbv0_0_37_job::killRequestUserIsSet() const
{
    return m_Kill_request_userIsSet;
}

void Dbv0_0_37_job::unsetKill_request_user()
{
    m_Kill_request_userIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_reservation> Dbv0_0_37_job::getReservation() const
{
    return m_Reservation;
}

void Dbv0_0_37_job::setReservation(const std::shared_ptr<Dbv0_0_37_job_reservation>& value)
{
    m_Reservation = value;
    m_ReservationIsSet = true;
}

bool Dbv0_0_37_job::reservationIsSet() const
{
    return m_ReservationIsSet;
}

void Dbv0_0_37_job::unsetReservation()
{
    m_ReservationIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_state> Dbv0_0_37_job::getState() const
{
    return m_State;
}

void Dbv0_0_37_job::setState(const std::shared_ptr<Dbv0_0_37_job_state>& value)
{
    m_State = value;
    m_StateIsSet = true;
}

bool Dbv0_0_37_job::stateIsSet() const
{
    return m_StateIsSet;
}

void Dbv0_0_37_job::unsetState()
{
    m_StateIsSet = false;
}
std::vector<std::shared_ptr<Dbv0_0_37_job_step>>& Dbv0_0_37_job::getSteps()
{
    return m_Steps;
}

void Dbv0_0_37_job::setSteps(const std::vector<std::shared_ptr<Dbv0_0_37_job_step>>& value)
{
    m_Steps = value;
    m_StepsIsSet = true;
}

bool Dbv0_0_37_job::stepsIsSet() const
{
    return m_StepsIsSet;
}

void Dbv0_0_37_job::unsetSteps()
{
    m_StepsIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_tres> Dbv0_0_37_job::getTres() const
{
    return m_Tres;
}

void Dbv0_0_37_job::setTres(const std::shared_ptr<Dbv0_0_37_job_tres>& value)
{
    m_Tres = value;
    m_TresIsSet = true;
}

bool Dbv0_0_37_job::tresIsSet() const
{
    return m_TresIsSet;
}

void Dbv0_0_37_job::unsetTres()
{
    m_TresIsSet = false;
}
utility::string_t Dbv0_0_37_job::getUser() const
{
    return m_User;
}

void Dbv0_0_37_job::setUser(const utility::string_t& value)
{
    m_User = value;
    m_UserIsSet = true;
}

bool Dbv0_0_37_job::userIsSet() const
{
    return m_UserIsSet;
}

void Dbv0_0_37_job::unsetUser()
{
    m_UserIsSet = false;
}
std::shared_ptr<Dbv0_0_37_job_wckey> Dbv0_0_37_job::getWckey() const
{
    return m_Wckey;
}

void Dbv0_0_37_job::setWckey(const std::shared_ptr<Dbv0_0_37_job_wckey>& value)
{
    m_Wckey = value;
    m_WckeyIsSet = true;
}

bool Dbv0_0_37_job::wckeyIsSet() const
{
    return m_WckeyIsSet;
}

void Dbv0_0_37_job::unsetWckey()
{
    m_WckeyIsSet = false;
}
utility::string_t Dbv0_0_37_job::getWorkingDirectory() const
{
    return m_Working_directory;
}

void Dbv0_0_37_job::setWorkingDirectory(const utility::string_t& value)
{
    m_Working_directory = value;
    m_Working_directoryIsSet = true;
}

bool Dbv0_0_37_job::workingDirectoryIsSet() const
{
    return m_Working_directoryIsSet;
}

void Dbv0_0_37_job::unsetWorking_directory()
{
    m_Working_directoryIsSet = false;
}
}
