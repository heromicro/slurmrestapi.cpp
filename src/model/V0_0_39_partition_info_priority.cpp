...
V0_0_39_partition_info_priority::V0_0_39_partition_info_priority()
{
    m_Job_factor = 0;
...
void V0_0_39_partition_info_priority::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_39_partition_info_priority::toJson() const
{
...
bool V0_0_39_partition_info_priority::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_39_partition_info_priority::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_39_partition_info_priority::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
int32_t V0_0_39_partition_info_priority::getJobFactor() const
{
    return m_Job_factor;
}

void V0_0_39_partition_info_priority::setJobFactor(int32_t value)
{
    m_Job_factor = value;
    m_Job_factorIsSet = true;
}

bool V0_0_39_partition_info_priority::jobFactorIsSet() const
{
    return m_Job_factorIsSet;
}

void V0_0_39_partition_info_priority::unsetJob_factor()
{
    m_Job_factorIsSet = false;
}
int32_t V0_0_39_partition_info_priority::getTier() const
{
    return m_Tier;
}

void V0_0_39_partition_info_priority::setTier(int32_t value)
{
    m_Tier = value;
    m_TierIsSet = true;
}

bool V0_0_39_partition_info_priority::tierIsSet() const
{
    return m_TierIsSet;
}

void V0_0_39_partition_info_priority::unsetTier()
{
    m_TierIsSet = false;
}
}
