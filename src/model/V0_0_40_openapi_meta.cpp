...
V0_0_40_openapi_meta::V0_0_40_openapi_meta()
{
    m_PluginIsSet = false;
    m_ClientIsSet = false;
...
void V0_0_40_openapi_meta::validate()
{
    // TODO: implement validation
}

web::json::value V0_0_40_openapi_meta::toJson() const
{
...
bool V0_0_40_openapi_meta::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void V0_0_40_openapi_meta::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool V0_0_40_openapi_meta::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<V0_0_40_openapi_meta_plugin> V0_0_40_openapi_meta::getPlugin() const
{
    return m_Plugin;
}

void V0_0_40_openapi_meta::setPlugin(const std::shared_ptr<V0_0_40_openapi_meta_plugin>& value)
{
    m_Plugin = value;
    m_PluginIsSet = true;
}

bool V0_0_40_openapi_meta::pluginIsSet() const
{
    return m_PluginIsSet;
}

void V0_0_40_openapi_meta::unsetPlugin()
{
    m_PluginIsSet = false;
}
std::shared_ptr<V0_0_40_openapi_meta_client> V0_0_40_openapi_meta::getClient() const
{
    return m_Client;
}

void V0_0_40_openapi_meta::setClient(const std::shared_ptr<V0_0_40_openapi_meta_client>& value)
{
    m_Client = value;
    m_ClientIsSet = true;
}

bool V0_0_40_openapi_meta::clientIsSet() const
{
    return m_ClientIsSet;
}

void V0_0_40_openapi_meta::unsetClient()
{
    m_ClientIsSet = false;
}
std::vector<utility::string_t>& V0_0_40_openapi_meta::getCommand()
{
    return m_Command;
}

void V0_0_40_openapi_meta::setCommand(const std::vector<utility::string_t>& value)
{
    m_Command = value;
    m_CommandIsSet = true;
}

bool V0_0_40_openapi_meta::commandIsSet() const
{
    return m_CommandIsSet;
}

void V0_0_40_openapi_meta::unsetCommand()
{
    m_CommandIsSet = false;
}
std::shared_ptr<V0_0_40_openapi_meta_slurm> V0_0_40_openapi_meta::getSlurm() const
{
    return m_Slurm;
}

void V0_0_40_openapi_meta::setSlurm(const std::shared_ptr<V0_0_40_openapi_meta_slurm>& value)
{
    m_Slurm = value;
    m_SlurmIsSet = true;
}

bool V0_0_40_openapi_meta::slurmIsSet() const
{
    return m_SlurmIsSet;
}

void V0_0_40_openapi_meta::unsetSlurm()
{
    m_SlurmIsSet = false;
}
}
